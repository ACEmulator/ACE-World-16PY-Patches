...
VALUES (41224, 'ace41224-ironbladelieutenant', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (41224,  6, 0, 2, 0, 440, 0, 0) /* MeleeDefense        Trained */
     , (41224,  7, 0, 2, 0, 440, 0, 0) /* MissileDefense      Trained */
     , (41224, 15, 0, 2, 0, 430, 0, 0) /* MagicDefense        Trained */
     , (41224, 16, 0, 2, 0, 800, 0, 0) /* ManaConversion      Trained */
     , (41224, 31, 0, 3, 0, 420, 0, 0) /* CreatureEnchantment Specialized */
     , (41224, 33, 0, 2, 0, 420, 0, 0) /* LifeMagic           Trained */
     , (41224, 34, 0, 2, 0, 420, 0, 0) /* WarMagic            Trained */
     , (41224, 41, 0, 2, 0, 260, 0, 0) /* TwoHandedCombat     Trained */
     , (41224, 44, 0, 2, 0, 260, 0, 0) /* HeavyWeapons        Trained */
     , (41224, 45, 0, 2, 0, 380, 0, 0) /* LightWeapons        Trained */
     , (41224, 46, 0, 2, 0, 260, 0, 0) /* FinesseWeapons      Trained */
     , (41224, 47, 0, 2, 0, 380, 0, 0) /* MissileWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (41224,  0,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41224,  1,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41224,  2,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41224,  3,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41224,  4,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41224,  5,  4, 110,  0.4,  650,  550,  550,  550,  550,  550,  350,  500,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41224,  6,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41224,  7,  4,  0,    0,  650,  550,  550,  550,  550,  550,  350,  500,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41224,  8,  4, 110,  0.4,  650,  550,  550,  550,  550,  550,  350,  500,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
