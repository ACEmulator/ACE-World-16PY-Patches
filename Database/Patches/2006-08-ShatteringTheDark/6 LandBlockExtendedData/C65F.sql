...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C65F00A, 33836, 0xC65F000F, 29.991, 155.361, 6, 0.707107, 0, 0, -0.707107, False, '2019-02-10 00:00:00'); /* Trap Door */
/* @teleloc 0xC65F000F [29.991000 155.361000 6.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C65F010, 33837, 0xC65F0100, 32.878, 158.67, 6.005, 0.7071068, 0, 0, -0.7071068,  False, '2019-02-10 00:00:00'); /* Unfriendly Barkeeper */
