...
VALUES (87569, 'ace87569-ruschkaspectofgrael', 10, '2021-10-07 19:20:29') /* Creature */;
...
VALUES (87569,   1, True ) /* Stuck */
     ...
     , (87569, 101, True ) /* CanGenerateRare */
     , (87569, 102, True ) /* CorpseGeneratedRare */;
...
VALUES (87569,   1,   33559975) /* Setup */
     , (87569,   2,  150994951) /* MotionTable */
     , (87569,   3,  536871101) /* SoundTable */
     , (87569,   4,  805306372) /* CombatTable */
     , (87569,   6,   67115447) /* PaletteBase */
     , (87569,   8,  100677373) /* Icon */
     , (87569,  22,  872415364) /* PhysicsEffectTable */
...
VALUES (87569,  0,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87569,  1,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87569,  2,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87569,  3,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87569,  4,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87569,  5,  4, 65,  0.5,  400,  360,  200,  440,  320,  200,  400,  320,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87569,  6,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87569,  7,  4,  0,    0,  400,  360,  200,  440,  320,  200,  400,  320,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87569,  8,  4, 50,  0.4,  400,  360,  200,  440,  320,  200,  400,  320,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (87569,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87569,  5 /* HeartBeat */,   0.14, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87569,  5 /* HeartBeat */,   0.19, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87569,  5 /* HeartBeat */,    0.2, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87569,  5 /* HeartBeat */,    0.1, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
