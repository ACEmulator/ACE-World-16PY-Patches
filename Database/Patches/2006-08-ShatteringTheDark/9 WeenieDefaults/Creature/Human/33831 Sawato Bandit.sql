...
VALUES (33831, 'ace33831-sawatobandit', 10, '2021-04-05 02:51:04') /* Creature */;
...
VALUES (33831,  0,  4,  0,    0,  540,  270,  270,  270,  270,  270,  270,  270,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (33831,  1,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (33831,  2,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (33831,  3,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (33831,  4,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (33831,  5,  4,  200, 0.75,  300,  150,  150,  150,  150,  150,  150,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (33831,  6,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (33831,  7,  4,  0,    0,  390,  195,  195,  195,  195,  195,  195,  195,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (33831,  8,  4,  200, 0.75,  320,  160,  160,  160,  160,  160,  160,  160,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (33831, 46, 0, 2, 0, 400, 0, 0) /* FinesseWeapons */
     , (33831, 44, 0, 2, 0, 400, 0, 0) /* HeavyWeapons */
     , (33831, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons */
     , (33831, 15, 0, 2, 0, 360, 0, 0) /* MagicDefense */
     , (33831,  6, 0, 2, 0, 350, 0, 0) /* MeleeDefense */
     , (33831,  7, 0, 2, 0, 380, 0, 0) /* MissileDefense */
     , (33831, 47, 0, 2, 0, 350, 0, 0) /* MissileWeapons */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (33831,10, 31706,  1, 0,  0.5, False) /* Create Hollow Crossbow (31706) for WieldTreasure */
     , (33831,10, 31704,  1, 0,  0.5, False) /* Create Tachi (31704) for WieldTreasure */
     , (33831, 2, 21352,  1,20,    0, False) /* Create Deadly Chorizite Quarrel (21352) for Wield */
     ...
     , (33831, 2, 27226,  1,39,    0, False) /* Create Loafers (28610) for Wield */
