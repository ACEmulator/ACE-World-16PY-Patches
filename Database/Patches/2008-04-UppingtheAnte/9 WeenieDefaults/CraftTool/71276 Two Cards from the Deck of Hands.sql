...
VALUES (71276, 'ace71276-twocardsfromthedeckofhands', 51, '2019-02-10 00:00:00') /* Stackable */;
...
VALUES (71276,   1, 'Two Cards from the Deck of Hands') /* Name */
     , (71276,  16, 'Combine these cards with the other cards from the Deck of Hands to complete the deck.') /* LongDesc */
     , (71276,  20, 'Sets of Two Cards from the Deck of Hands') /* PluralName */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (71276,   1,   33560546) /* Setup */
     , (71276,   3,  536870932) /* SoundTable */
     , (71276,   8,  100689860) /* Icon */
     , (71276,  22,  872415275) /* PhysicsEffectTable */;
