...
VALUES (45173, 'ace45173-pyrechampion', 10, '2019-08-22 00:00:00') /* Creature */;
...
VALUES (45173,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (45173,  7, 0, 3, 0, 397, 0, 0) /* MissileDefense      Specialized */
     , (45173, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (45173, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (45173, 33, 0, 3, 0, 280, 0, 0) /* LifeMagic           Specialized */
     , (45173, 34, 0, 3, 0, 280, 0, 0) /* WarMagic            Specialized */
     , (45173, 44, 0, 3, 0, 565, 0, 0) /* Heavy Weapons       Specialized */
     , (45173, 45, 0, 3, 0, 565, 0, 0) /* Light Weapons       Specialized */
     , (45173, 46, 0, 3, 0, 565, 0, 0) /* Finesse Weapons     Specialized */
     , (45173, 47, 0, 3, 0, 565, 0, 0) /* Missile Weapons     Specialized */
     , (45173, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45173,  0,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45173,  1,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45173,  2,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45173,  3,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45173,  4,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45173,  5,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45173,  6,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45173,  7,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45173,  8,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45173, 2, 35096,  1, 0, 0, False) /* Create Pyre Blade (35096) for Wield */
     ...
     , (45173, 9, 38714,  0, 0, 0.20, False) /* Create Pyre Skeleton Jaw (38714) for ContainTreasure */
     , (45173, 9,     0,  0, 0, 0.80, False) /* Create nothing for ContainTreasure */
     , (45173, 9, 35105,  1, 0, 0.20, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (45173, 9,     0,  0, 0, 0.80, False) /* Create nothing for ContainTreasure */
