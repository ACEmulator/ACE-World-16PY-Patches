...
VALUES (45173,  6, 0, 2, 0, 709, 0, 0) /* MeleeDefense        Trained */
     , (45173,  7, 0, 2, 0, 149, 0, 0) /* MissileDefense      Trained */
     , (45173, 15, 0, 2, 0, 170, 0, 0) /* MagicDefense        Trained */
     , (45173, 16, 0, 2, 0, 360, 0, 0) /* ManaConversion      Trained */
     , (45173, 31, 0, 2, 0, 360, 0, 0) /* CreatureEnchantment Trained */
     , (45173, 33, 0, 2, 0, 360, 0, 0) /* LifeMagic           Trained */
     , (45173, 34, 0, 2, 0, 360, 0, 0) /* WarMagic            Trained */
     , (45173, 41, 0, 2, 0, 728, 0, 0) /* TwoHandedCombat     Trained */
     , (45173, 44, 0, 2, 0, 728, 0, 0) /* HeavyWeapons        Trained */
     , (45173, 45, 0, 2, 0, 728, 0, 0) /* LightWeapons        Trained */
     , (45173, 46, 0, 2, 0, 728, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45173,  0,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45173,  1,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45173,  2,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45173,  3,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45173,  4,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45173,  5,  4, 75, 0.75,  280,  280,  280,  280,  280,  280,  280,  280,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45173,  6,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45173,  7,  4,  0,    0,  280,  280,  280,  280,  280,  280,  280,  280,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45173,  8,  4, 75, 0.75,  280,  280,  280,  280,  280,  280,  280,  280,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
