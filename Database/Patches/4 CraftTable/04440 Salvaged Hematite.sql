...
VALUES (4440, 0, 30 /* MagicItemTinkering */, 0, 2, 0, 0, 'You apply the Hematite.', 0, 0, 'You apply the Hematite, but in the process you destroy the target.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 1, 1, NULL, 0, '2021-11-01 00:00:00');
...
VALUES (4440, 21053 /* Salvaged Hematite */,   294 /* Amulet */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   295 /* Bracelet */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   297 /* Ring */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   621 /* Heavy Bracelet */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   622 /* Necklace */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   623 /* Heavy Necklace */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,   624 /* Ring */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,  1443 /* Ring */, '2021-11-01 00:00:00')
     , (4440, 21053 /* Salvaged Hematite */,  2367 /* Gorget */, '2021-11-01 00:00:00');
