...
DELETE FROM `cook_book` WHERE `recipe_Id` = 6771;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (6771, 20023 /* Isparian Weapons Modifying Tool */, 46243 /* Blackfire Chilling Isparian Two Handed Sword */, '2021-11-01 00:00:00');
