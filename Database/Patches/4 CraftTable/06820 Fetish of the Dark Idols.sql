...
VALUES (6820, 0, 0, 0, 0, 0, 1, 'You attach the Fetish of the Dark Idols to the Slingshot.', 0, 1, '', 1, 1, '', 0, 0, '', 1, 1, '', 0, 0, '', 0, '2021-11-01 00:00:00');

INSERT INTO `recipe_requirements_int` (`recipe_Id`, `index`, `stat`, `value`, `enum`, `message`)
VALUES (6820, 0, 105, 1, 2, 'The target item cannot be enchanted!') /* Target.ItemWorkmanship LessThan 1 */
     , (6820, 0, 166, 14, 6, 'You have already empowered this weapon with the ability to slay creatures and it cannot be further modified.') /* Target.SlayerCreatureType - Undead Equal 14 */
     , (6820, 0, 166, 30, 6, 'You have already empowered this weapon with the ability to slay creatures and it cannot be further modified.') /* Target.SlayerCreatureType - Skeleton Equal 30 */
     , (6820, 0, 166, 89, 6, 'You have already empowered this weapon with the ability to slay creatures and it cannot be further modified.') /* Target.SlayerCreatureType - Mukkir Equal 89 */
     , (6820, 0, 166, 101, 6, 'You have already empowered this weapon with the ability to slay creatures and it cannot be further modified.') /* Target.SlayerCreatureType - Anekshay Equal 101 */
...
VALUES (6820, True, 0, 0, 0, False, 939524166, 1, 0);
...
VALUES (6820, 27795 /* Fetish of the Dark Idols */, 31818 /* Piercing Slingshot */, '2021-11-01 00:00:00');
