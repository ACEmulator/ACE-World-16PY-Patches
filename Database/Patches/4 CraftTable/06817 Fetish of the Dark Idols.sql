...
VALUES (6817, 0, 0, 0, 0, 0, 1, 'You attach the Fetish of the Dark Idols to the Slingshot.', 0, 1, '', 1, 1, '', 0, 0, '', 1, 1, '', 0, 0, '', 0, '2022-05-08 00:00:00');

INSERT INTO `recipe_requirements_int` (`recipe_Id`, `index`, `stat`, `value`, `enum`, `message`)
VALUES (6817, 0, 105, 1, 2, 'The target item cannot be enchanted!') /* Target.ItemWorkmanship LessThan 1 */
     , (6817, 0, 311, 2, 10, 'You have already empowered this weapon with the ability to slay creatures and it cannot be further modified.') /* Target.ImbueStackingBits HasBits 2 */
...
VALUES (6817, 27795 /* Fetish of the Dark Idols */, 31815 /* Electric Slingshot */, '2022-05-08 00:00:00');
