...
VALUES (6172, 0, 0, 0, 0, 0, 1, 'You attach the Fetish of the Dark Idols to the arbalest.', 0, 1, '', 1, 1, '', 0, 0, '', 1, 1, '', 0, 0, '', 0, '2021-11-01 00:00:00');
...
VALUES (@parent_id, 0,   1, 'Dark Arbalest', 1, 1) /* On Source.SuccessTarget SetValue Name to Target */;

DELETE FROM `cook_book` WHERE `recipe_Id` = 6172;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (6172, 27795 /* Fetish of the Dark Idols */, 30616 /* Arbalest */, '2021-11-01 00:00:00')
     , (6172, 27795 /* Fetish of the Dark Idols */, 47852 /* Arbalest */, '2021-11-01 00:00:00');
