...
VALUES (6806, 0, 0, 0, 0, 29371 /* Blooded Platinum Invader Lord Helm */, 1, 'You smear the blood on the helm and the helm thrums briefly with magical power..', 29371 /* Blooded Platinum Invader Lord Helm */, 0, 'You smear the blood on the helm and the helm thrums briefly with magical power..', 1, 1, NULL, 1, 1, NULL, 1, 1, NULL, 1, 1, NULL, 0, '2021-11-01 00:00:00');

DELETE FROM `cook_book` WHERE `recipe_Id` = 6806;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (6806, 29372 /* Royal Blood */, 29370 /* Platinum Invader Lord Helm */, '2021-11-01 00:00:00');
