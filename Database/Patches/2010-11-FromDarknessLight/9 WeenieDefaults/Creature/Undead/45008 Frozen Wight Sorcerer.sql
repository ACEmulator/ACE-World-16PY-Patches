...
VALUES (45008, 'ace45008-frozenwightsorcerer', 10, '2020-05-10 00:00:00') /* Creature */;
...
VALUES (45008,   1, True ) /* Stuck */
     ...
     , (45008,  11, False) /* IgnoreCollisions */
...
VALUES (45008,   1,  5) /* HeartbeatInterval */
     ...
     , (45008,   5,  2) /* ManaRate */
     , (45008,  12,  0) /* Shade */
     , (45008,  13,  0.37) /* ArmorModVsSlash */
     , (45008,  14,  0.37) /* ArmorModVsPierce */
     , (45008,  15,  0.50) /* ArmorModVsBludgeon */
     , (45008,  16,  0.30) /* ArmorModVsCold */
     , (45008,  17,  0.60) /* ArmorModVsFire */
     , (45008,  18,  0.40) /* ArmorModVsAcid */
     , (45008,  19,  0.33) /* ArmorModVsElectric */
     , (45008,  27,     3) /* RotationSpeed */
     , (45008,  31,    33) /* VisualAwarenessRange */
     , (45008,  34,     2) /* PowerupTime */
     , (45008,  36,     1) /* ChargeSpeed */
     , (45008,  39,   1.1) /* DefaultScale */
     , (45008,  64,  0.57) /* ResistSlash */
     , (45008,  65,  0.57) /* ResistPierce */
     , (45008,  66,  0.86) /* ResistBludgeon */
     , (45008,  67,  0.90) /* ResistFire */
     , (45008,  68,  0.30) /* ResistCold */
     , (45008,  69,  0.70) /* ResistAcid */
     , (45008,  70,  0.40) /* ResistElectric */
...
VALUES (45008,   1,   33561142) /* Setup */
     ...
     , (45008,   4,  805306368) /* CombatTable */    
     , (45008,   6,   67110722) /* PaletteBase */
     , (45008,   7,  268435558) /* ClothingBase */
     , (45008,   8,  100669124) /* Icon */
...
VALUES (45008,  6, 0, 3, 0, 360, 0,    0) /* MeleeDefense        Specialized */
     ...
     , (45008, 41, 0, 3, 0, 445, 0,    0) /* Two Handed          Specialized */
     , (45008, 44, 0, 3, 0, 445, 0,    0) /* Heavy Weapons       Specialized */
     , (45008, 45, 0, 3, 0, 445, 0,    0) /* Light Weapons       Specialized */
     , (45008, 46, 0, 3, 0, 445, 0,    0) /* Finesse Weapons     Specialized */
     , (45008, 47, 0, 3, 0, 445, 0,    0) /* Missile Weapons     Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45008,  0,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45008,  1,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45008,  2,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45008,  3,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45008,  4,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45008,  5,  4, 400, 0.75, 225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45008,  6,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45008,  7,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45008,  8,  4, 400, 0.75, 225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (45008,  6193,    2.1)  /* Halo of Frost II */
     , (45008,  2138,    2.1)  /* Blizzard */
     , (45008,  2136,    2.1)  /* Icy Torment */
     , (45008,  2125,    2.1)  /* Incantation of Frost Arc */
