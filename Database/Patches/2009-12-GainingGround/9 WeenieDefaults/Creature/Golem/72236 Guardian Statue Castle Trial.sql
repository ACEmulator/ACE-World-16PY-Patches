...
VALUES (72236, 'ace72236-guardianstatue', 10, '2020-07-23 03:33:46') /* Creature */;
...
VALUES (72236,   1,       5) /* HeartbeatInterval */
     ...
     , (72236,  31,      24) /* VisualAwarenessRange */
...
VALUES (72236,   1,   33558554) /* Setup */
     , (72236,   2,  150995432) /* MotionTable */
     , (72236,   3,  536870933) /* SoundTable */
     , (72236,   4,  805306426) /* CombatTable */
     , (72236,   7,  268437288) /* ClothingBase */
     , (72236,   8,  100675661) /* Icon */;
...
VALUES (72236, 1, 7750, 0, 0, 8000) /* MaxHealth */
     , (72236, 3, 5000, 0, 0, 4500) /* MaxStamina */
     , (72236, 5, 4600, 0, 0, 5000) /* MaxMana */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72236,  2074,    2.05)  /* Gossamer Flesh */
     , (72236,  2166,   2.053)  /* Tusker's Gift */
     , (72236,  2212,   2.056)  /* Wrath of Adja */
     , (72236,  2264,   2.059)  /* Wrath of Harlune */
     , (72236,  2318,   2.063)  /* Gravity Well */
     , (72236,  2320,   2.067)  /* Wrath of the Hieromancer */
     , (72236,  4427,   2.071)  /* Incantation of Shock Arc */
     , (72236,  4455,   2.077)  /* Incantation of Shock Wave */;
...
VALUES (72236,  6, 0, 3, 0, 340, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (72236, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (72236, 32, 0, 3, 0, 300, 0, 0) /* ItemEnchantment     Specialized */
     , (72236, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (72236, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */;
     
INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72236,  0,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 1,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (72236, 10,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 3,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (72236, 13,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (72236, 16,  4,  0,    0,  650,  682,  650,  618,  618,  780,  780,  618,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */
