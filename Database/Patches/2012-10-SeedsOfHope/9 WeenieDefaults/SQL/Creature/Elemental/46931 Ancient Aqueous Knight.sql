...
VALUES (46931,   1,         16) /* ItemType - Creature */
     ...
     , (46931,  16,         32) /* ItemUseable - No */
     , (46931,  25,        220) /* Level */
     , (46931,  27,          0) /* ArmorType - None */
     , (46931,  68,          5) /* TargetingTactic - Random, LastDamager */
     , (46931,  93,       3080) /* PhysicsState - ReportCollisions, Gravity */
...
VALUES (46931,   1,       5) /* HeartbeatInterval */
     ...
     , (46931,  18,     1.1) /* ArmorModVsAcid */
     , (46931,  19,     1.1) /* ArmorModVsElectric */
     , (46931,  31,      20) /* VisualAwarenessRange */
     , (46931,  39,     1.3) /* DefaultScale */
     , (46931,  44,      -1) /* TimeToRot */
     , (46931,  65,     0.3) /* ResistPierce */
     , (46931,  66,     0.3) /* ResistBludgeon */
     , (46931,  67,       0) /* ResistFire */
     , (46931,  68,     0.4) /* ResistCold */
     , (46931,  69,     0.3) /* ResistAcid */
     , (46931,  70,     0.3) /* ResistElectric */
...
VALUES (46931,   1,   33559686) /* Setup */
     ...
     , (46931,   7,  268437042) /* ClothingBase */
     , (46931,   8,  100672514) /* Icon */
     , (46931,  22,  872415322) /* PhysicsEffectTable */
     , (46931,  35,        461) /* DeathTreasureType - Loot Tier: 6 */
...
VALUES (46931,  6, 0, 3, 0, 395, 0, 0) /* MeleeDefense        Specialized */
     , (46931,  7, 0, 3, 0, 410, 0, 0) /* MissileDefense      Specialized */
     , (46931, 14, 0, 3, 0, 170, 0, 0) /* ArcaneLore          Specialized */
     , (46931, 15, 0, 3, 0, 205, 0, 0) /* MagicDefense        Specialized */
     , (46931, 24, 0, 3, 0, 100, 0, 0) /* Run                 Specialized */
     , (46931, 31, 0, 3, 0, 115, 0, 0) /* CreatureEnchantment Specialized */
     , (46931, 33, 0, 3, 0, 115, 0, 0) /* LifeMagic           Specialized */
     , (46931, 34, 0, 3, 0, 115, 0, 0) /* WarMagic            Specialized */
     , (46931, 45, 0, 3, 0, 410, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (46931,  0, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46931,  1, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46931,  2, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46931,  3, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46931,  4, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46931,  5, 16, 85, 0.75,  200,  200,  200,  200,  200,  200,  220,  220,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46931,  6, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46931,  7, 16,  0,    0,  200,  200,  200,  200,  200,  200,  220,  220,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46931,  8, 16, 85, 0.75,  200,  200,  200,  200,  200,  200,  220,  220,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
