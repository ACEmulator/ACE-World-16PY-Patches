...
VALUES (72598, 'ace72598-spectralnanjouzaikan', 10, '2021-08-25 02:46:08') /* Creature */;
...
VALUES (72598,   1,   33561479) /* Setup */
     , (72598,   2,  150994945) /* MotionTable */
     , (72598,   3,  536870942) /* SoundTable */
     , (72598,   4,  805306368) /* CombatTable */
     , (72598,   6,   67108990) /* PaletteBase */
     , (72598,   7,  268437544) /* ClothingBase */
     , (72598,   8,  100669124) /* Icon */
     , (72598,  22,  872415269) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72598,  0,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72598,  1,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72598,  2,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72598,  3,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72598,  4,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72598,  5,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72598,  6,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72598,  7,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72598,  8,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72598, 2, 46648,  1, 0,    0, False) /* Create Spectral Lightning Nodachi (46648) for Wield */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     ...
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72599,  0, 0,    1, False) /* Create Spectral Nanjou Zaikan's Sword (72599) for Contain */
     , (72598, 9, 72600,  0, 0,    1, False) /* Create Legendary Key (72600) for Contain */
     , (72598, 9, 72600,  0, 0,    1, False) /* Create Legendary Key (72600) for Contain */
     , (72598, 9, 72600,  0, 0,    1, False) /* Create Legendary Key (72600) for Contain */
     , (72598, 9, 72600,  0, 0,    1, False) /* Create Legendary Key (72600) for Contain */
     , (72598, 9, 72600,  0, 0,    1, False) /* Create Legendary Key (72600) for Contain */
