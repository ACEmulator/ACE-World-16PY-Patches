...
VALUES (72587, 'ace72587-spectralnanjoukaibinn', 10, '2021-08-25 07:18:00') /* Creature */;
...
VALUES (72587,   1,   33561479) /* Setup */
     , (72587,   2,  150994945) /* MotionTable */
     , (72587,   3,  536870942) /* SoundTable */
     , (72587,   4,  805306368) /* CombatTable */
     , (72587,   6,   67108990) /* PaletteBase */
     , (72587,   7,  268437544) /* ClothingBase */
     , (72587,   8,  100669124) /* Icon */
     , (72587,  22,  872415269) /* PhysicsEffectTable */
     , (72587,  35,       2000) /* DeathTreasureType - Loot Tier: 8 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72587,  0,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72587,  1,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72587,  2,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72587,  3,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72587,  4,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72587,  5,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72587,  6,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72587,  7,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72587,  8,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72587, 33, 0, 2, 0, 170, 0, 0) /* LifeMagic */
     , (72587, 34, 0, 2, 0, 170, 0, 0) /* WarMagic */
     , (72587, 31, 0, 2, 0, 170, 0, 0) /* CreatureMagic */
     , (72587, 43, 0, 2, 0, 170, 0, 0) /* VoidMagic */
     , (72587, 44, 0, 2, 0, 400, 0, 0) /* HeavyWeapons */
     , (72587, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons */
     , (72587, 41, 0, 2, 0, 400, 0, 0) /* TwoHanded */
     , (72587, 46, 0, 2, 0, 457, 0, 0) /* FinesseWeapons */
     , (72587, 51, 0, 2, 0, 457, 0, 0) /* SneakAttack */
     , (72587, 49, 0, 2, 0, 457, 0, 0) /* DualWield */
     , (72587, 15, 0, 2, 0, 373, 0, 0) /* MagicDefense */
     , (72587,  6, 0, 2, 0, 547, 0, 0) /* MeleeDefense */
     , (72587,  7, 0, 2, 0, 660, 0, 0) /* MissileDefense */;
...
VALUES (72587, 2, 46372,  1, 0,    0, False) /* Create Spectral Tachi (46373) for Wield */
     , (72587, 2, 46375,  1, 0,    0, False) /* Create Spectral Nekode (46375) for Wield */
     , (72587, 9, 72594,  0, 0,    1, False) /* Create Lower Chamber Door Key (72594) for Contain */;
