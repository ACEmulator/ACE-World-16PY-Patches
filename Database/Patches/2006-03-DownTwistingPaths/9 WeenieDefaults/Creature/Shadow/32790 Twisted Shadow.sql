...
VALUES (32790, 'ace32790-twistedshadow', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (32790,   1, True ) /* Stuck */
     ...
     , (32790,  11, False) /* IgnoreCollisions */
...
VALUES (32790,   1,       5) /* HeartbeatInterval */
     ...
     , (32790,  14,     0.83) /* ArmorModVsPierce */
...
VALUES (32790,   1, 'Twisted Shadow') /* Name */
     , (32790,   3, 'Female') /* Sex */
     , (32790,   4, 'Aluvian') /* HeritageGroup */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (32790,   1,   33556251) /* Setup */
     , (32790,   2,  150995091) /* MotionTable */
     , (32790,   3,  536870914) /* SoundTable */
     , (32790,   4,  805306408) /* CombatTable */
     , (32790,   6,   67108990) /* PaletteBase */
...
VALUES (32790,   1,   650, 0, 0, 660) /* MaxHealth */
     , (32790,   3,   720, 0, 0, 740) /* MaxStamina */
     , (32790,   5,   740, 0, 0, 760) /* MaxMana */;
...
VALUES (32790,  0,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (32790,  1,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (32790,  2,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (32790,  3,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (32790,  4,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (32790,  5,  4, 65, 0.45,  390,  300,  360,  369,  333,  300,  341,  341,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (32790,  6,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (32790,  7,  4,  0,    0,  390,  300,  360,  369,  333,  300,  341,  341,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (32790,  8,  4, 65, 0.45,  390,  300,  360,  369,  333,  300,  341,  341,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (32790, 9,  6058, -1, 0, 0.2, False) /* Create Dark Shard (6058) for ContainTreasure */
