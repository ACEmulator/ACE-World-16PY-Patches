...
VALUES (87079,   1,   33554867) /* Setup */
     , (87079,   2,  150994947) /* MotionTable */
     , (87079,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87079, 2, 272105728, 171.499, 108.111, 41.66, 0.712737, 0, 0, 0.701432) /* Destination */
