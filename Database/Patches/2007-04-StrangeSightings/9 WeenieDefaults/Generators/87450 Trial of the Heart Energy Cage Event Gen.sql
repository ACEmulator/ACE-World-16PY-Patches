...
VALUES (87450, 'ace87450-TrialoftheHeartEnergyCageEventGen', 1, '2021-06-22 10:00:00') /* Generic */;
...
VALUES (87450,   1,   33555051) /* Setup */
     , (87450,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87450, -1, 36653, 1, 1, 1, 1, 4, 0, 0, 0, 10420504, 110, -70, -54, 1, 0, 0, 0) /* Generate Energy Cage (36653) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (87450, -1, 36652, 1, 1, 1, 1, 4, 0, 0, 0, 10420504, 110, -70, -54, 0.519099, 0, 0, 0.854714) /* Generate Energy Cage (36652) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
