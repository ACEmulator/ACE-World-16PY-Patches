...
VALUES (87451, 'ace87451-TrialoftheHeartLordKresovusEventGen', 1, '2021-06-22 10:00:00') /* Generic */;
...
VALUES (87451,   1,   33555051) /* Setup */
     , (87451,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87451, -1, 36689, 1, 1, 1, 1, 4, 0, 0, 0, 10420504, 110, -70, -53.99, 0.453596, 0, 0, 0.891207) /* Generate Lord Kresovus (36689) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
