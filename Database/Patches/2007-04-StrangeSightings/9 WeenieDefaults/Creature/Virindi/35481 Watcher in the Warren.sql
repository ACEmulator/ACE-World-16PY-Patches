...
VALUES (35481,   1,   33558343) /* Setup */
     ...
     , (35481,   7,  268436609) /* ClothingBase */
...
VALUES (35481,  0,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35481,  1,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35481,  2,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (35481,  3,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35481,  4,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (35481,  5,  1, 175, 0.75,  600,  485,  600,  600,  600,  485,  600,  600,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35481, 17,  1,  0,    0,  600,  485,  600,  600,  600,  485,  600,  600,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
