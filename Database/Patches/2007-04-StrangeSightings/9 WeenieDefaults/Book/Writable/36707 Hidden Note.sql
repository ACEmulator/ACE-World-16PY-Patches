...
VALUES (36707, 'ace36707-hiddennote', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (36707,   1,   33554773) /* Setup */
     , (36707,   3,  536870932) /* SoundTable */
     , (36707,   8,  100668176) /* Icon */
     , (36707,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (36707, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (36707, 0, 4294967295, 'Phlynt, Agent of the Hidden Hand', 'prewritten', False, '
