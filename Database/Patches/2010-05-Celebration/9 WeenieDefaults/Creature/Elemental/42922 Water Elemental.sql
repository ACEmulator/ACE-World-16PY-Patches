...
VALUES (42922,   1,       5) /* HeartbeatInterval */
     ...
     , (42922,   3, 0.899999976158142) /* HealthRate */
     , (42922,   4,     0.5) /* StaminaRate */
     , (42922,   5,       2) /* ManaRate */
     , (42922,  13,       1) /* ArmorModVsSlash */
     , (42922,  14,       1) /* ArmorModVsPierce */
     , (42922,  15,       1) /* ArmorModVsBludgeon */
     , (42922,  16, 0.79999997615814) /* ArmorModVsCold */
     , (42922,  17, 1.10000002384186) /* ArmorModVsFire */
     , (42922,  18,       1) /* ArmorModVsAcid */
     , (42922,  19,       1) /* ArmorModVsElectric */
     , (42922,  31,      20) /* VisualAwarenessRange */
     , (42922,  39,     1.6) /* DefaultScale */
     , (42922,  64, 0.449999988079071) /* ResistSlash */
     , (42922,  65, 0.449999988079071) /* ResistPierce */
     , (42922,  66, 0.449999988079071) /* ResistBludgeon */
     , (42922,  67, 0.649999976158142) /* ResistFire */
     , (42922,  68, 0.899999976158142) /* ResistCold */
     , (42922,  69, 0.649999976158142) /* ResistAcid */
...
VALUES (42922,  0, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (42922,  1, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (42922,  2, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (42922,  3, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (42922,  4, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (42922,  5,  8, 45, 0.75,  260,  260,  260,  260,  286,  286,  260,  260,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (42922,  6, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (42922,  7, 32,  0,    0,  260,  260,  260,  260,  286,  286,  260,  260,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (42922,  8, 64, 45, 0.75,  260,  260,  260,  260,  286,  286,  260,  260,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
