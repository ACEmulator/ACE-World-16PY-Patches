...
VALUES (33739, 'ace33739-parfalsleech', 10, '2020-06-23 00:00:00') /* Creature */;
...
VALUES (33739,   1,       5) /* HeartbeatInterval */
     ...
     , (33739,  14,    0.85) /* ArmorModVsPierce */
     , (33739,  15,    0.85) /* ArmorModVsBludgeon */
     , (33739,  16,    0.95) /* ArmorModVsCold */
     , (33739,  17,    0.85) /* ArmorModVsFire */
     , (33739,  18,    0.95) /* ArmorModVsAcid */
     , (33739,  19,    0.85) /* ArmorModVsElectric */
     ...
     , (33739,  64,       1) /* ResistSlash */
     , (33739,  65,     0.5) /* ResistPierce */
     , (33739,  66,     0.5) /* ResistBludgeon */
     , (33739,  67,     0.5) /* ResistFire */
     , (33739,  68,     0.9) /* ResistCold */
     , (33739,  69,     0.9) /* ResistAcid */
...
VALUES (33739,   1,   33559712) /* Setup */
     ...
     , (33739,   4,  805306410) /* CombatTable */
     , (33739,   6,   67116764) /* PaletteBase */
     , (33739,   7,  268437049) /* ClothingBase */
     , (33739,   8,  100670961) /* Icon */
     , (33739,  22,  872415416) /* PhysicsEffectTable */
     , (33739,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (33739,  0,  4, 200, 0.75,  650,  650,  553,  553,  618,  553,  618,  553,    0, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (33739, 16,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (33739, 21,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (33739, 24,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (33739, 25,  4, 200,  0.5,  650,  650,  553,  553,  618,  553,  618,  553,    0, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;
