...
VALUES (40286, 'ace40286-parfalsleech', 10, '2020-06-23 00:00:00') /* Creature */;
...
VALUES (40286,   1,       5) /* HeartbeatInterval */
     ...
     , (40286,  14,    0.85) /* ArmorModVsPierce */
     , (40286,  15,    0.85) /* ArmorModVsBludgeon */
     ...
     , (40286,  64,       1) /* ResistSlash */
     , (40286,  65,     0.5) /* ResistPierce */
     , (40286,  66,     0.5) /* ResistBludgeon */
     , (40286,  67,     0.5) /* ResistFire */
     , (40286,  68,     0.9) /* ResistCold */
     , (40286,  69,     0.9) /* ResistAcid */
...
VALUES (40286,   1,   33559712) /* Setup */
     ...
     , (40286,   4,  805306410) /* CombatTable */
     , (40286,   6,   67116764) /* PaletteBase */
     , (40286,   7,  268437049) /* ClothingBase */
     , (40286,   8,  100670961) /* Icon */
     , (40286,  22,  872415416) /* PhysicsEffectTable */
     , (40286,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (40286,  0,  4, 200, 0.75,  650,  650,  553,  553,  618,  553,  618,  553,    0, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (40286, 16,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (40286, 21,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (40286, 24,  4,  0,    0,  650,  650,  553,  553,  618,  553,  618,  553,    0, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (40286, 25,  4, 200,  0.5,  650,  650,  553,  553,  618,  553,  618,  553,    0, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;
