...
VALUES (40292, 'ace40292-degenerateshadow', 10, '2020-06-23 00:00:00') /* Creature */;
...
VALUES (40292,   1,   33556251) /* Setup */
     ...
     , (40292,   4,  805306368) /* CombatTable */
     , (40292,   6,   67108990) /* PaletteBase */
     , (40292,   7,  268435871) /* ClothingBase */
     , (40292,   8,  100670398) /* Icon */
     , (40292,  22,  872415331) /* PhysicsEffectTable */
     , (40292,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (40292, 45, 0, 3, 0, 308, 0, 0) /* LightWeapons        Specialized */
     , (40292, 47, 0, 3, 0, 220, 0, 0) /* MissileWeapons      Specialized */
     , (40292, 46, 0, 3, 0, 293, 0, 0) /* FinesseWeapons      Specialized */
     , (40292,  6, 0, 3, 0, 310, 0, 0) /* MeleeDefense        Specialized */
...
VALUES (40292,  0,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (40292,  1,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (40292,  2,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (40292,  3,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (40292,  4,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (40292,  5,  4, 50, 0.75,  500,  500,  400,  425,  300,  550,  350,  375,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (40292,  6,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (40292,  7,  4,  0,    0,  500,  500,  400,  425,  300,  550,  350,  375,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (40292,  8,  4, 60, 0.75,   60,   60,   48,   51,   36,   66,   42,   45,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (40292,  2140,  2.036)  /* Alset's Coil */
