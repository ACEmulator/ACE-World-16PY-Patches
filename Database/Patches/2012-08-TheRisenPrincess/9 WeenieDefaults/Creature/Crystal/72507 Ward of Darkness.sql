...
VALUES (72507, 'ace72507-wardofdarkness', 10, '2021-08-13 06:42:06') /* Creature */;
...
VALUES (72507,   1,       5) /* HeartbeatInterval */
     ...
     , (72507,   5,       2) /* ManaRate */
     , (72507,  12,       0) /* Shade */
     , (72507,  13,     1.0) /* ArmorModVsSlash */
     , (72507,  14,     1.0) /* ArmorModVsPierce */
     , (72507,  15,     1.0) /* ArmorModVsBludgeon */
     , (72507,  16,     1.0) /* ArmorModVsCold */
     , (72507,  17,     1.0) /* ArmorModVsFire */
     , (72507,  18,     1.0) /* ArmorModVsAcid */
     , (72507,  19,     1.0) /* ArmorModVsElectric */
...
VALUES (72507,   1,   33560014) /* Setup */
     , (72507,   2,  150995261) /* MotionTable */
     , (72507,   3,  536870933) /* SoundTable */
     , (72507,   8,  100671183) /* Icon */
     , (72507,  22,  872415328) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72507,  0,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72507,  1,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72507,  2,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72507,  3,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72507,  4,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72507,  5,  4,  1, 0.75,  400,  100,  100,  100,  100,  100,  100,  100,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72507,  6,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72507,  7,  4,  0,    0,  400,  100,  100,  100,  100,  100,  100,  100,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72507,  8,  4,  1, 0.75,  400,  100,  100,  100,  100,  100,  100,  100,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
