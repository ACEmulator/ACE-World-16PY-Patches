...
VALUES (46539,   1,       5) /* HeartbeatInterval */
     ...
     , (46539,  14,     1.0) /* ArmorModVsPierce */
     , (46539,  15,    0.95) /* ArmorModVsBludgeon */
     , (46539,  16,     1.0) /* ArmorModVsCold */
     , (46539,  17,    0.95) /* ArmorModVsFire */
     , (46539,  18,     1.0) /* ArmorModVsAcid */
     , (46539,  19,     1.0) /* ArmorModVsElectric */
...
VALUES (46539,  0,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46539,  1,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46539,  2,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46539,  3,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46539,  4,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46539,  5,  4, 600, 0.75,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46539,  6,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46539,  7,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46539,  8,  4, 600, 0.75,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (46539, 2, 46387,  1, 0, 0, False) /* Create Spectral Frost Nodachi (46387) for Wield */
     , (46539, 9, 48954,  0, 0, 0.01, False) /* Create Burning Sands Keyring (48954) for Contain Treasure */
     , (46539, 9,     0,  0, 0, 0.99, False) /* Create nothing for Contain Treasure */;
...
VALUES (46539,  33, 0, 2, 0, 200, 0, 0) /* LifeMagic */
     , (46539,  34, 0, 2, 0, 200, 0, 0) /* WarMagic */
     , (46539,  31, 0, 2, 0, 200, 0, 0) /* CreatureMagic */
     , (46539,  43, 0, 2, 0, 200, 0, 0) /* VoidMagic */
     , (46539,  44, 0, 2, 0, 413, 0, 0) /* HeavyWeapons */
     , (46539,  45, 0, 2, 0, 413, 0, 0) /* LightWeapons */
     , (46539,  41, 0, 2, 0, 413, 0, 0) /* TwoHanded */
     , (46539,  46, 0, 2, 0, 480, 0, 0) /* FinesseWeapons */
     , (46539,  47, 0, 2, 0, 230, 0, 0) /* MissileWeapons */
     , (46539,  15, 0, 2, 0, 366, 0, 0) /* MagicDefense */
     , (46539,   6, 0, 2, 0, 550, 0, 0) /* MeleeDefense */
     , (46539,   7, 0, 2, 0, 660, 0, 0) /* MissileDefense */;
