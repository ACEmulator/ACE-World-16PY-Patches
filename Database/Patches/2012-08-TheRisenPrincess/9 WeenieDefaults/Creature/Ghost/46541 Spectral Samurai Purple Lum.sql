...
VALUES (46541,   1,       5) /* HeartbeatInterval */
     ...
     , (46541,  14,     1.0) /* ArmorModVsPierce */
     , (46541,  15,    0.95) /* ArmorModVsBludgeon */
     , (46541,  16,     1.0) /* ArmorModVsCold */
     , (46541,  17,     1.0) /* ArmorModVsFire */
     , (46541,  18,    0.95) /* ArmorModVsAcid */
     , (46541,  19,     1.0) /* ArmorModVsElectric */
...
VALUES (46541,  0,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46541,  1,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46541,  2,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46541,  3,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46541,  4,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46541,  5,  4, 600, 0.75,  440,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46541,  6,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46541,  7,  4,  0,    0,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46541,  8,  4, 600, 0.75,  440,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (46541, 2, 46648,  1, 0, 0, False) /* Create Spectral Lightning Nodachi (46648) for Wield */
     , (46541, 9, 48954,  0, 0, 0.01, False) /* Create Burning Sands Keyring (48954) for Contain Treasure */
     , (46541, 9,     0,  0, 0, 0.99, False) /* Create nothing for Contain Treasure */;
...
VALUES (46541,  33, 0, 2, 0, 200, 0, 0) /* LifeMagic */
     , (46541,  34, 0, 2, 0, 200, 0, 0) /* WarMagic */
     , (46541,  31, 0, 2, 0, 200, 0, 0) /* CreatureMagic */
     , (46541,  43, 0, 2, 0, 200, 0, 0) /* VoidMagic */
     , (46541,  44, 0, 2, 0, 413, 0, 0) /* HeavyWeapons */
     , (46541,  45, 0, 2, 0, 413, 0, 0) /* LightWeapons */
     , (46541,  41, 0, 2, 0, 413, 0, 0) /* TwoHanded */
     , (46541,  46, 0, 2, 0, 480, 0, 0) /* FinesseWeapons */
     , (46541,  47, 0, 2, 0, 230, 0, 0) /* MissileWeapons */
     , (46541,  15, 0, 2, 0, 366, 0, 0) /* MagicDefense */
     , (46541,   6, 0, 2, 0, 550, 0, 0) /* MeleeDefense */
     , (46541,   7, 0, 2, 0, 660, 0, 0) /* MissileDefense */;
