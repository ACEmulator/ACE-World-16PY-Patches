...
VALUES (72532, '72532-spectralsamuraidaimyo', 10, '2020-12-04 11:46:51') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (72532,   1,         16) /* ItemType - Creature */
     , (72532,   2,         77) /* CreatureType - Ghost */
     , (72532,   3,         21) /* PALETTE - Black */
...
VALUES (72532,   1,       5) /* HeartbeatInterval */
     ...
     , (72532, 166,     1.0) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72532,   1, 'Spectral Samurai Daimyo') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72532,   1,   33561500) /* Setup */
     , (72532,   2,  150994945) /* MotionTable */
     , (72532,   3,  536870942) /* SoundTable */
     , (72532,   4,  805306368) /* CombatTable */
     , (72532,   6,   67108990) /* PaletteBase */
     , (72532,   7,  268437548) /* ClothingBase */
     , (72532,   8,  100671323) /* Icon */
     , (72532,  22,  872415269) /* PhysicsEffectTable */
     , (72532,  31,      72535) /* LinkedPortalOne */
     , (72532,  35,       2000) /* DeathTreasureType - Loot Tier: 8 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72532,  0,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72532,  1,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72532,  2,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72532,  3,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72532,  4,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72532,  5,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72532,  6,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72532,  7,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
...
VALUES (72532,  33, 0, 2, 0, 270, 0, 0) /* LifeMagic */
     ...
     , (72532,  44, 0, 2, 0, 513, 0, 0) /* HeavyWeapons */
     , (72532,  45, 0, 2, 0, 513, 0, 0) /* LightWeapons */
     , (72532,  41, 0, 2, 0, 513, 0, 0) /* TwoHanded */
     , (72532,  46, 0, 2, 0, 580, 0, 0) /* FinesseWeapons */
