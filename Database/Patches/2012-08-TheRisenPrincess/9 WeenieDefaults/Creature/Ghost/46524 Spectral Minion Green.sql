...
VALUES (46524, 'ace46524-spectralminion', 10, '2020-12-20 06:43:05') /* Creature */;
...
VALUES (46524,   1,       5) /* HeartbeatInterval */
     ...
     , (46524,  15,     1.0) /* ArmorModVsBludgeon */
     , (46524,  16,     1.0) /* ArmorModVsCold */
     , (46524,  17,     1.0) /* ArmorModVsFire */
     , (46524,  18,     1.0) /* ArmorModVsAcid */
...
VALUES (46524,   1,   33561493) /* Setup */
     ...
     , (46524,   7,  268437543) /* ClothingBase */
...
VALUES (46524,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46524,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46524,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46524,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46524,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46524,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46524,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46524,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46524,  8,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (46524, 2, 46368,  1, 0, 0, False) /* Create Spectral Acid Nekode (46368) for Wield */
     , (46524, 9, 48954,  0, 0, 0.01, False) /* Create Burning Sands Keyring (48954) for Contain Treasure */
     , (46524, 9,     0,  0, 0, 0.99, False) /* Create nothing for Contain Treasure */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (46524,  44, 0, 2, 0, 507, 0, 0) /* HeavyWeapons */
     , (46524,  45, 0, 2, 0, 507, 0, 0) /* LightWeapons */
     , (46524,  41, 0, 2, 0, 507, 0, 0) /* TwoHanded */
     , (46524,  46, 0, 2, 0, 540, 0, 0) /* FinesseWeapons */
     , (46524,  15, 0, 2, 0, 379, 0, 0) /* MagicDefense */
     , (46524,   6, 0, 2, 0, 400, 0, 0) /* MeleeDefense */
     , (46524,   7, 0, 2, 0, 620, 0, 0) /* MissileDefense */;
