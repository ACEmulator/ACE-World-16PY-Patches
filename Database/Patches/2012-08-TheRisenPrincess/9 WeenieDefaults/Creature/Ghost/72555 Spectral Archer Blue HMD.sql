...
VALUES (72555, 'ace72555-spectralarcher', 10, '2020-10-23 23:53:26') /* Creature */;
...
VALUES (72555,   1,       5) /* HeartbeatInterval */
     ...
     , (72555,   5,       1) /* ManaRate */
     , (72555,  13,     1.0) /* ArmorModVsSlash */
     , (72555,  14,     1.0) /* ArmorModVsPierce */
     , (72555,  15,     1.0) /* ArmorModVsBludgeon */
     , (72555,  16,     1.0) /* ArmorModVsCold */
     , (72555,  17,    0.95) /* ArmorModVsFire */
     , (72555,  18,     1.0) /* ArmorModVsAcid */
     , (72555,  19,     1.0) /* ArmorModVsElectric */
     , (72555,  31,      30) /* VisualAwarenessRange */
     , (72555,  34,       1) /* PowerupTime */
     , (72555,  36,       1) /* ChargeSpeed */
...
VALUES (72555,   1,   33561478) /* Setup */
     , (72555,   2,  150994945) /* MotionTable */
     , (72555,   3,  536870942) /* SoundTable */
     , (72555,   4,  805306368) /* CombatTable */
     , (72555,   7,  268437543) /* ClothingBase */
     , (72555,   8,  100669124) /* Icon */
     , (72555,  22,  872415269) /* PhysicsEffectTable */
...
VALUES (72555,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72555,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72555,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72555,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72555,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72555,  5,  4, 200, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72555,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72555,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72555,  8,  4, 200, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
