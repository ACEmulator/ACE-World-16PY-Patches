...
VALUES (46613,   1,       5) /* HeartbeatInterval */
     ...
     , (46613,   5,       2) /* ManaRate */
     , (46613,  12,     0.5) /* Shade */
     , (46613,  13,     1.0) /* ArmorModVsSlash */
     , (46613,  14,     1.0) /* ArmorModVsPierce */
     , (46613,  15,    0.95) /* ArmorModVsBludgeon */
     , (46613,  16,     1.0) /* ArmorModVsCold */
     , (46613,  17,     1.0) /* ArmorModVsFire */
     , (46613,  18,     1.0) /* ArmorModVsAcid */
...
VALUES (46613,  0,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46613,  1,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46613,  2,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46613,  3,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46613,  4,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46613,  5,  4, 90, 0.75,  500,  277,  315,  350,  294,  294,  294,  294,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46613,  6,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46613,  7,  4,  0,    0,  500,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46613,  8,  4, 90, 0.75,  500,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (46613,  44, 0, 2, 0, 493, 0, 0) /* HeavyWeapons */
     , (46613,  45, 0, 2, 0, 493, 0, 0) /* LightWeapons */
     , (46613,  41, 0, 2, 0, 493, 0, 0) /* TwoHanded */
     , (46613,  46, 0, 2, 0, 550, 0, 0) /* FinesseWeapons */
     , (46613,  15, 0, 2, 0, 414, 0, 0) /* MagicDefense */
     , (46613,   6, 0, 2, 0, 460, 0, 0) /* MeleeDefense */
     , (46613,   7, 0, 2, 0, 576, 0, 0) /* MissileDefense */;
