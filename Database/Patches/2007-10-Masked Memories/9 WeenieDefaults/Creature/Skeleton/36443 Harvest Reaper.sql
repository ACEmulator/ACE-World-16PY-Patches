...
VALUES (36443, 'ace36443-harvestreaper', 10, '2020-10-04 00:00:00') /* Creature */;
...
VALUES (36443,   1,   33560386) /* Setup */
     ...
     , (36443,   7,  268437220) /* ClothingBase */
...
VALUES (36443, 45, 0, 3, 0, 345, 0, 0) /* LightWeapons        Specialized */
     , (36443,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
...
VALUES (36443,  0,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (36443,  1,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (36443,  2,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (36443,  3,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (36443,  4,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (36443,  5,  4, 90, 0.75,  500,  570,  570,  480,  560,  550,  700,  650,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (36443,  6,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (36443,  7,  4,  0,    0,  500,  570,  570,  480,  560,  550,  700,  650,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (36443,  8,  4, 95, 0.75,  500,  570,  570,  480,  560,  550,  700,  650,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (36443, 10, 36436,  1, 0, 0, False) /* Create Harvester's Blade (36436) for WieldTreasure */
     , (36443,  9, 32207,  1, 0, 0.4, False) /* Create Candy Corn (32207) for ContainTreasure */
