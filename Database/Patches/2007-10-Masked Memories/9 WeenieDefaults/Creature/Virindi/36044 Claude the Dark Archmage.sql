...
VALUES (36044, 'ace36044-claudethedarkarchmage', 10, '2021-06-14 08:59:37') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (36044,   1,      16) /* ItemType - Creature */
     , (36044,   2,      19) /* CreatureType - Virindi */
     , (36044,   3,       3) /* PaletteTemplate */
...
VALUES (36044,   1,       5) /* HeartbeatInterval */
     ...
     , (36044,  15,     1.0) /* ArmorModVsBludgeon */
     , (36044,  16,     1.0) /* ArmorModVsCold */
     , (36044,  17,    0.85) /* ArmorModVsFire */
     , (36044,  18,     0.9) /* ArmorModVsAcid */
     , (36044,  19,     1.0) /* ArmorModVsElectric */
...
VALUES (36044,  1,  33560380) /* Setup */
     ...
     , (36044,  7, 268435648) /* ClothingBase */
     , (36044,  8, 100667943) /* Icon */
     , (36044, 22, 872415273) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (36044,  0,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (36044,  1,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (36044,  2,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (36044,  3,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (36044,  4,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (36044,  5,  1, 600, 0.75,  500,  500,  500,  500,  360,  500,  500,  360,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (36044, 17,  1,  0,    0,  500,  500,  500,  500,  360,  500,  500,  360,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
...
VALUES (36044, 31, 0, 2, 0, 300, 0, 0) /* CreatureMagic */
     , (36044, 46, 0, 2, 0, 400, 0, 0) /* FinesseWeapons */
     , (36044, 44, 0, 2, 0, 400, 0, 0) /* HeavyWeapons */
     , (36044, 33, 0, 2, 0, 300, 0, 0) /* LifeMagic */
     , (36044, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons */
     , (36044, 15, 0, 2, 0, 350, 0, 0) /* MagicDefense */
     , (36044, 16, 0, 2, 0, 300, 0, 0) /* ManaConversion */
     , (36044,  6, 0, 2, 0, 400, 0, 0) /* MeleeDefense */
     , (36044,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense */
     , (36044, 34, 0, 2, 0, 300, 0, 0) /* WarMagic */;
...
VALUES (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
     , (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
     , (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
     , (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
     , (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
     , (36044, 9, 36064,  0, 0,   1, False) /* Create (36064) for Contain */
