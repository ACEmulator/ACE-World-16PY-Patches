...
VALUES (72410, 'ace72410-virindidesecrator', 10, '2021-06-18 09:20:29') /* Creature */;
...
VALUES (72410,   1,   33558343) /* Setup */
     , (72410,   2,  150994984) /* MotionTable */
     , (72410,   3,  536870930) /* SoundTable */
     , (72410,   4,  805306381) /* CombatTable */
     , (72410,   6,   67114250) /* PaletteBase */
     , (72410,   7,  268436609) /* ClothingBase */
     , (72410,   8,  100674323) /* Icon */
     , (72410,  22,  872415273) /* PhysicsEffectTable */
     , (72410,  35,        461) /* DeathTreasureType - Loot Tier: 6 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72410,  0,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72410,  1,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72410,  2,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (72410,  3,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72410,  4,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (72410,  5,  1, 50, 0.75,  420,  210,  210,  210,  210,  210,  210,  210,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72410, 17,  1,  0,    0,  420,  210,  210,  210,  210,  210,  210,  210,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
...
VALUES (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
     , (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
     , (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
     , (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
     , (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
     , (72410, 9, 36065,  0, 0,    1, False) /* Create (36065) for Contain */
