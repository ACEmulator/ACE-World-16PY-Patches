Use:
	- InqQuest: FoundSeantheSpeedy
		QuestSuccess:
			- InqQuestBitsOn: ExplorationMarkersFoundInGroupI, 0x100
				QuestSuccess:
				...
				QuestFailure:
					...
					- SetQuestBitsOn: ExplorationMarkersFoundInGroupI, 0x100
...
#GotoSet: Group_Stamp
#	- DirectBroadcast: You have found one of the Sky Diver markers.
#	- StampQuest: ExplorationMarkersSkyDiverFound
