...
VALUES (1032, 'portalzaikhal', 7, '2020-03-30 00:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1032,   1,      65536) /* ItemType - Portal */
     , (1032,  16,          1) /* ItemUseable - No */
     , (1032,  93,       3092) /* PhysicsState - Ethereal, ReportCollisions, Gravity, LightingOn */
     , (1032, 111,         49) /* PortalBitmask - Unrestricted */;
