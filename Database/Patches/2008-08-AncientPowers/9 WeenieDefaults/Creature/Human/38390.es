Give: Corrupted Mana Shard (80306)
    ...
    - InqQuestBitsOff: SocietyMember, 0x7
        QuestSuccess:
            ...
            - SetQuestBitsOn: SocietyMember, 0x4
            - StampQuest: RadiantBloodMember
            ...
            - Tell: Welcome to the Society of the Radiant Blood! Nearby, you will find a portal into our Stronghold, where you will find several important people to your future within our Society.
            - SetIntStat: Faction1Bits, 0x4
            - SetIntStat: SocietyRankRadblo, 1
...
Use:
    - TurnToTarget
    - InqQuestBitsOn: SocietyFlag, 0x4
        QuestSuccess:
            - InqQuestBitsOff: SocietyMember, 0x7
                QuestSuccess:
