Give: Corrupted Mana Shard (80306)
    ...
    - InqQuestBitsOff: SocietyMember, 0x7
        QuestSuccess:
            ...
            - SetQuestBitsOn: SocietyMember, 0x2
            - StampQuest: EldrytchWebMember
            ...
            - Tell: Welcome to the Society of the Eldrytch Web! Nearby, you will find a portal into our Stronghold, where you will find several important people to your future within our Society.
            - SetIntStat: Faction1Bits, 0x2
            - SetIntStat: SocietyRankEldweb, 1
            - Give: Eldrytch Web Initiate Armor Writ (38393)
            - AwardLevelProportionalXP: 20%, Max: 198,157,237
            - Give: Initiate's Treasure Key (38314)
            - Give: Eldrytch Web Initiate's Handbook (38398)
...
Use:
    ...
    - InqQuestBitsOn: SocietyFlag, 0x2
        QuestSuccess:
            - InqQuestBitsOff: SocietyMember, 0x7
                QuestSuccess:
                    - Tell: Greetings. My name is Arturus. It is my honor and duty to aid people who wish to join our Society to prove themselves and be properly initiated to our Society.
                ...
                QuestFailure:
                    - InqQuestBitsOn: SocietyMember, 0x2
                        QuestSuccess:
