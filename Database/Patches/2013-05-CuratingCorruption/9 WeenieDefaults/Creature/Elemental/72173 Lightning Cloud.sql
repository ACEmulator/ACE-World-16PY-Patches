...
VALUES (72173, 'ace72173-lightningcloud', 10, '2020-07-23 03:33:58') /* Creature */;
...
VALUES (72173,   1,   33560373) /* Setup */
     , (72173,   2,  150995290) /* MotionTable */
     , (72173,   3,  536871001) /* SoundTable */
     , (72173,   4,  805306368) /* CombatTable */
     , (72173,   8,  100670581) /* Icon */
     , (72173,  22,  872415389) /* PhysicsEffectTable */;
...
VALUES (72173,  0, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72173,  1, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72173,  2, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72173,  3, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72173,  4, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72173,  5, 64, 75, 0.75,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72173,  6, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72173,  7, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72173,  8, 64, 75, 0.75,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72173,  4452,   3.0)  /* Incantation of Lightning Streak */;
