...
VALUES (51287, 'ace51287-virindiclandestine', 10, '2021-01-06 09:34:50') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51287,   1,         16) /* ItemType - Creature */
     , (51287,   2,         19) /* CreatureType - Virindi */
     , (51287,   3,          3) /* PaletteTemplate */
...
VALUES (51287,   1,   5) /* HeartbeatInterval */
     ...
     , (51287,  14, 1.0) /* ArmorModVsPierce */
     , (51287,  15, 1.0) /* ArmorModVsBludgeon */
     , (51287,  16, 1.0) /* ArmorModVsCold */
     , (51287,  17, 0.8) /* ArmorModVsFire */
     , (51287,  18, 0.8) /* ArmorModVsAcid */
     , (51287,  19, 1.0) /* ArmorModVsElectric */
     ...
     , (51287, 165, 1.0) /* ArmorModVsNether */
     , (51287, 166, 1.0) /* ResistNether */;
...
VALUES (51287,  1,  33561227) /* Setup */
     ...
     , (51287,  7, 268437423) /* Clothingbase */
     , (51287,  8, 100667943) /* Icon */
     , (51287, 22, 872415273) /* PhysicsEffectTable */
     , (51287, 45,      1000) /* DeathTreasureType */;
...
VALUES (51287,  0,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51287,  1,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51287,  2,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (51287,  3,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51287,  4,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (51287,  5,  1, 175, 0.75,  500,  500,  500,  500,  500,  500,  500,  500,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51287, 17,  1,  0,    0,  500,  500,  500,  500,  500,  500,  500,  500,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
