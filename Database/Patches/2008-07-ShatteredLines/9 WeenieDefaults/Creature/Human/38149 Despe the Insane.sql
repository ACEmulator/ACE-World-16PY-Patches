...
VALUES (38149,   1,       5) /* HeartbeatInterval */
     ...
     , (38149,   3, 0.100000001490116) /* HealthRate */
     , (38149,   4,       3) /* StaminaRate */
     , (38149,   5,       1) /* ManaRate */
     , (38149,  12,     0.5) /* Shade */
     , (38149,  13,    1.75) /* ArmorModVsSlash */
     , (38149,  14,    1.75) /* ArmorModVsPierce */
     , (38149,  15, 1.60000002384186) /* ArmorModVsBludgeon */
     , (38149,  16, 1.35000002384186) /* ArmorModVsCold */
     , (38149,  17, 1.35000002384186) /* ArmorModVsFire */
     , (38149,  18, 1.35000002384186) /* ArmorModVsAcid */
     , (38149,  19, 1.20000004768372) /* ArmorModVsElectric */
     , (38149,  31,      12) /* VisualAwarenessRange */
     , (38149,  34,       1) /* PowerupTime */
     , (38149,  36,       1) /* ChargeSpeed */
     , (38149,  54,       3) /* UseRadius */
     , (38149,  64, 0.400000005960464) /* ResistSlash */
     , (38149,  65, 0.400000005960464) /* ResistPierce */
     , (38149,  66,     0.5) /* ResistBludgeon */
     , (38149,  67,     0.5) /* ResistFire */
     , (38149,  68, 0.600000023841858) /* ResistCold */
     , (38149,  69, 0.600000023841858) /* ResistAcid */
     , (38149,  70, 0.860000023841858) /* ResistElectric */
...
VALUES (38149,   1,   33554433) /* Setup */
     ...
     , (38149,   7,  268437297) /* ClothingBase */
...
VALUES (38149,  0,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38149,  1,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38149,  2,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38149,  3,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38149,  4,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38149,  5,  4, 95,  0.4,  415,  452,  452,  415,  415,  305,  415,  305,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38149,  6,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38149,  7,  4,  0,    0,  415,  452,  452,  415,  415,  305,  415,  305,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38149,  8,  4, 95,  0.4,  415,  452,  452,  415,  415,  305,  415,  305,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38149,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38149,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38149,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38149,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38149,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
