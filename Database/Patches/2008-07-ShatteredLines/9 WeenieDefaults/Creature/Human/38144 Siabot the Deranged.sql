...
VALUES (38144,   1,       5) /* HeartbeatInterval */
     ...
     , (38144,   3, 0.100000001490116) /* HealthRate */
     , (38144,   4,       3) /* StaminaRate */
     , (38144,   5,       1) /* ManaRate */
     , (38144,  12,     0.5) /* Shade */
     , (38144,  13,    1.75) /* ArmorModVsSlash */
     , (38144,  14,    1.75) /* ArmorModVsPierce */
     , (38144,  15, 1.60000002384186) /* ArmorModVsBludgeon */
     , (38144,  16, 1.35000002384186) /* ArmorModVsCold */
     , (38144,  17, 1.35000002384186) /* ArmorModVsFire */
     , (38144,  18, 1.35000002384186) /* ArmorModVsAcid */
     , (38144,  19, 1.20000004768372) /* ArmorModVsElectric */
     , (38144,  31,      12) /* VisualAwarenessRange */
     , (38144,  34,       1) /* PowerupTime */
     , (38144,  36,       1) /* ChargeSpeed */
     , (38144,  54,       3) /* UseRadius */
     , (38144,  64, 0.400000005960464) /* ResistSlash */
     , (38144,  65, 0.400000005960464) /* ResistPierce */
     , (38144,  66,     0.5) /* ResistBludgeon */
     , (38144,  67,     0.5) /* ResistFire */
     , (38144,  68, 0.600000023841858) /* ResistCold */
     , (38144,  69, 0.600000023841858) /* ResistAcid */
     , (38144,  70, 0.860000023841858) /* ResistElectric */
...
VALUES (38144,   1,   33554433) /* Setup */
     ...
     , (38144,   7,  268437297) /* ClothingBase */
...
VALUES (38144,  0,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38144,  1,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38144,  2,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38144,  3,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38144,  4,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38144,  5,  4, 95,  0.4,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38144,  6,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38144,  7,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38144,  8,  4, 95,  0.4,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38144,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38144,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38144,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38144,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38144,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
