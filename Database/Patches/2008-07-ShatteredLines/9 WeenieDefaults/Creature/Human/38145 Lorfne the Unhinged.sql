...
VALUES (38145,   1,       5) /* HeartbeatInterval */
     ...
     , (38145,   3, 0.100000001490116) /* HealthRate */
     , (38145,   4,       3) /* StaminaRate */
     , (38145,   5,       1) /* ManaRate */
     , (38145,  12,     0.5) /* Shade */
     , (38145,  13,    1.75) /* ArmorModVsSlash */
     , (38145,  14,    1.75) /* ArmorModVsPierce */
     , (38145,  15, 1.60000002384186) /* ArmorModVsBludgeon */
     , (38145,  16, 1.35000002384186) /* ArmorModVsCold */
     , (38145,  17, 1.35000002384186) /* ArmorModVsFire */
     , (38145,  18, 1.35000002384186) /* ArmorModVsAcid */
     , (38145,  19, 1.20000004768372) /* ArmorModVsElectric */
     , (38145,  31,      12) /* VisualAwarenessRange */
     , (38145,  34,       1) /* PowerupTime */
     , (38145,  36,       1) /* ChargeSpeed */
     , (38145,  54,       3) /* UseRadius */
     , (38145,  64, 0.400000005960464) /* ResistSlash */
     , (38145,  65, 0.400000005960464) /* ResistPierce */
     , (38145,  66,     0.5) /* ResistBludgeon */
     , (38145,  67,     0.5) /* ResistFire */
     , (38145,  68, 0.600000023841858) /* ResistCold */
     , (38145,  69, 0.600000023841858) /* ResistAcid */
     , (38145,  70, 0.860000023841858) /* ResistElectric */
...
VALUES (38145,   1,   33554433) /* Setup */
     ...
     , (38145,   7,  268437297) /* ClothingBase */
...
VALUES (38145,  0,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38145,  1,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38145,  2,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38145,  3,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38145,  4,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38145,  5,  4, 95,  0.4,  420,  452,  452,  420,  420,  310,  420,  310,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38145,  6,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38145,  7,  4,  0,    0,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38145,  8,  4, 95,  0.4,  420,  452,  452,  420,  420,  310,  420,  310,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38145,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38145,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38145,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38145,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38145,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
