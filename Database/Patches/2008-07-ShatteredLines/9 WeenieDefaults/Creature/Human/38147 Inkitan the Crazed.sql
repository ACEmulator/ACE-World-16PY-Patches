...
VALUES (38147,   1,       5) /* HeartbeatInterval */
     ...
     , (38147,   3, 0.100000001490116) /* HealthRate */
     , (38147,   4,       3) /* StaminaRate */
     , (38147,   5,       1) /* ManaRate */
     , (38147,  12,     0.5) /* Shade */
     , (38147,  13,    1.75) /* ArmorModVsSlash */
     , (38147,  14,    1.75) /* ArmorModVsPierce */
     , (38147,  15, 1.60000002384186) /* ArmorModVsBludgeon */
     , (38147,  16, 1.35000002384186) /* ArmorModVsCold */
     , (38147,  17, 1.35000002384186) /* ArmorModVsFire */
     , (38147,  18, 1.35000002384186) /* ArmorModVsAcid */
     , (38147,  19, 1.20000004768372) /* ArmorModVsElectric */
     , (38147,  31,      12) /* VisualAwarenessRange */
     , (38147,  34,       1) /* PowerupTime */
     , (38147,  36,       1) /* ChargeSpeed */
     , (38147,  54,       3) /* UseRadius */
     , (38147,  64, 0.400000005960464) /* ResistSlash */
     , (38147,  65, 0.400000005960464) /* ResistPierce */
     , (38147,  66,     0.5) /* ResistBludgeon */
     , (38147,  67,     0.5) /* ResistFire */
     , (38147,  68, 0.600000023841858) /* ResistCold */
     , (38147,  69, 0.600000023841858) /* ResistAcid */
     , (38147,  70, 0.860000023841858) /* ResistElectric */
...
VALUES (38147,   1,   33554433) /* Setup */
     ...
     , (38147,   7,  268437297) /* ClothingBase */
     , (38147,   8,  100667446) /* Icon */
     , (38147,  22,  872415236) /* PhysicsEffectTable */
     , (38147,  32,       3502) /* WieldedTreasureType - 
                                   Wield Throwing Club (23655) | Probability: 34.5%
                                   Wield Tachi (23702) | Probability: 34.5%
                                   Wield Frost Throwing Club (23663) | Probability: 34.5%
                                   Wield Yumi (23736) | Probability: 34.5%
                                   Wield 100x Greater Arrow (5304) | Probability: 100% */
...
VALUES (38147,  0,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38147,  1,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38147,  2,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38147,  3,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38147,  4,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38147,  5,  4, 95,  0.4,  380,  452,  452,  380,  380,  288,  380,  288,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38147,  6,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38147,  7,  4,  0,    0,  380,  452,  452,  380,  380,  288,  380,  288,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38147,  8,  4, 95,  0.4,  380,  452,  452,  380,  380,  288,  380,  288,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38147,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38147,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38147,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38147,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38147,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
