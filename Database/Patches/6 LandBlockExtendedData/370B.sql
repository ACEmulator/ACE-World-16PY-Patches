...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7370B00C,  7507, 0x370B001D, 80.7815, 113.636, -0.89, 0.011185, 0, 0, 0.999937,  True, '2020-09-14 23:43:32'); /* Coral Golem */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7370B00F, 40468, 0x370B0024, 97.4087, 87.2951, -0.889, -0.008047, 0, 0, 0.999968,  True, '2020-09-14 23:44:23'); /* Deep-sea Lava Golem */
/* @teleloc 0x370B0024 [97.408699 87.295097 -0.889000] -0.008047 0.000000 0.000000 0.999968 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7370B010, 40468, 0x370B001C, 85.1645, 90.9295, -0.889, -0.818356, 0, 0, -0.574711,  True, '2020-09-14 23:44:45'); /* Deep-sea Lava Golem */
