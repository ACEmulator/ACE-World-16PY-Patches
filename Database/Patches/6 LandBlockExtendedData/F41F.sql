...
VALUES (0x7F41F001,  7924, 0xF41F0032, 145.652, 45.1853, -0.0945, 0.267498, 0, 0, -0.963558, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator ( 5 Min.) */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7F41F00A, 33786, 0xF41F002C, 130.482, 77.251, -0.163, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Shadow-Infested Black Spear Temple */
