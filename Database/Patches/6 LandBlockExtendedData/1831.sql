...
VALUES (0x71831000,  7932, 0x1831000E, 30.2294, 130.125, 89.5369, 0.218962, 0, 0, -0.975733, False, '2021-11-01 00:00:00'); /* Linkable Monster Generator ( 4 Min.) */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71831002, 28653, 0x18310011, 71.2413, 16.5389, 76.0063, 0.992618, 0, 0, 0.121284,  True, '2021-11-01 00:00:00'); /* Viamontian Knight */
