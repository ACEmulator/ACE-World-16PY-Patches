...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70B0C008,  4219, 0x0B0C0027, 104.81, 152.957, 109.804, -0.997383, 0, 0, -0.072292, False, '2020-11-25 09:20:13'); /* Linkable Monster Generator ( 7 Min.) */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70B0C009, 87070, 0x0B0C0027, 106.419, 153.249, 109.888, -0.997383, 0, 0, -0.072292,  True, '2020-11-25 09:20:35'); /* Spawn Watcher */
