...
VALUES (0x7482F001, 37605, 0x482F0111, 36, 70, -10.4, -0.707107, 0, 0, -0.707107, False, '2019-02-10 00:00:00'); /* Blight Rat Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F009, 37604, 0x482F0103, 40.6955, 82.2053, -15.592, 0.995653, 0, 0, 0.093139,  True, '2019-02-10 00:00:00'); /* Blight Rat */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F00B, 37604, 0x482F0118, 36.9486, 79.8787, -10.392, 0.996125, 0, 0, 0.087953,  True, '2019-02-10 00:00:00'); /* Blight Rat */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F00D, 37604, 0x482F011C, 42.116, 68.6272, -15.592, 0.995103, 0, 0, -0.098839,  True, '2019-02-10 00:00:00'); /* Blight Rat */
/* @teleloc 0x482F011C [42.116001 68.627197 -15.592000] 0.995103 0.000000 0.000000 -0.098839 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F012, 37604, 0x482F000C, 36.3999, 75.8288, 0.008, -0.948641, 0, 0, -0.316356,  True, '2019-02-10 00:00:00'); /* Blight Rat */
/* @teleloc 0x482F000C [36.399899 75.828796 0.008000] -0.948641 0.000000 0.000000 -0.316356 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F013, 37604, 0x482F000C, 27.0871, 84.6312, 0.008, -0.016955, 0, 0, -0.999856,  True, '2019-02-10 00:00:00'); /* Blight Rat */
/* @teleloc 0x482F000C [27.087099 84.631203 0.008000] -0.016955 0.000000 0.000000 -0.999856 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7482F014, 37604, 0x482F000C, 42.0426, 77.3939, 0.008, -0.633235, 0, 0, 0.773959,  True, '2019-02-10 00:00:00'); /* Blight Rat */
