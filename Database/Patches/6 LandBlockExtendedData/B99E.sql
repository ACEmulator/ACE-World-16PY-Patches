...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B99E0BF, 87429, 0xB99E0006, 10.3964, 131.714, 70.2746, -0.017071, 0, 0, 0.999854, False, '2021-05-19 16:53:25'); /* Drudge Fort Outer Wall Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B99E0C4, 87397, 0xB99E0015, 55.6746, 98.3855, 57.6142, -0.052279, 0, 0, 0.998633, False, '2021-05-27 09:38:39'); /* Drudge Fort Outside Wall Generator */
