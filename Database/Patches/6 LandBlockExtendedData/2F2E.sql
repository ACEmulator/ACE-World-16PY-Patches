...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F2E1C8,  7924, 0x2F2E0030, 128.341, 170.086, 146.055, 0.999997, 0, 0, -0.00223, False, '2020-12-01 07:13:14'); /* Linkable Monster Generator ( 5 Min.) */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F2E1C9, 87062, 0x2F2E0030, 128.334, 168.544, 146.005, 0.999997, 0, 0, -0.00223,  True, '2020-12-01 07:13:21'); /* AerbaxPortal Controller */
/* @teleloc 0x2F2E0030 [128.334000 168.544006 146.005005] 0.999997 0.000000 0.000000 -0.002230 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F2E1CA, 87148, 0x2F2E002B, 128.366, 67.7607, 125.63, -0.999236, 0, 0, 0.039083, False, '2021-03-15 11:05:43'); /* Aerbax's Shadow Booter Gen */
