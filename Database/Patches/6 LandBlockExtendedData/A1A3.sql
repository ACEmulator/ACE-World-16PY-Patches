...
VALUES (0x7A1A3000, 13227, 0xA1A30034, 165.793, 75.1871, 89.5555, -0.068824, 0, 0, -0.997629, False, '2021-11-01 00:00:00'); /* Jacque the Woodsman */
/* @teleloc 0xA1A30034 [165.792999 75.187103 89.555496] -0.068824 0.000000 0.000000 -0.997629 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A3004,  4980, 0xA1A30109, 136.537, 155.916, 36.85, 0.965424, 0, 0, -0.260686, False, '2021-11-01 00:00:00'); /* Refreshing Fountain */
/* @teleloc 0xA1A30109 [136.537003 155.916000 36.849998] 0.965424 0.000000 0.000000 -0.260686 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A3008, 44076, 0xA1A30116, 120.735, 157.753, 36.805, 0.672391, 0, 0, -0.740196, False, '2021-11-01 00:00:00'); /* Laurana */
/* @teleloc 0xA1A30116 [120.735001 157.753006 36.805000] 0.672391 0.000000 0.000000 -0.740196 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A300C, 44351, 0xA1A30102, 148.49, 129.385, 36.8167, -0.382683, 0, 0, 0.92388, False, '2021-11-01 00:00:00'); /* Surface */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A3010, 24888, 0xA1A3010A, 126.626, 120.927, 36.8042, -1, 0, 0, 0,  True, '2021-11-01 00:00:00'); /* Pyreal Target Drudge */
/* @teleloc 0xA1A3010A [126.625999 120.927002 36.804199] -1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A3011, 24888, 0xA1A3010A, 131.011, 120.96, 36.8042, -1, 0, 0, 0,  True, '2021-11-01 00:00:00'); /* Pyreal Target Drudge */
/* @teleloc 0xA1A3010A [131.011002 120.959999 36.804199] -1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A1A3012, 24888, 0xA1A3010A, 128.841, 120.921, 36.8042, -1, 0, 0, 0,  True, '2021-11-01 00:00:00'); /* Pyreal Target Drudge */
