...
VALUES (49173, 'ace49173-skeletonminion', 71, '2021-07-12 02:40:09') /* CombatPet */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (49173,   1,         16) /* ItemType - Creature */
     , (49173,   2,         30) /* CreatureType - Skeleton */
     , (49173,   3,          2) /* PaletteTemplate - Blue */
...
VALUES (49173,  12,     0.5) /* Shade */
     , (49173,  31,      25) /* VisualAwarenessRange */
     , (49173,  77,       1) /* PhysicsScriptIntensity */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (49173,   1, 'Skeleton') /* Name */;
...
VALUES (49173,   1,   33561495) /* Setup */
     ...
     , (49173,   7,  268437543) /* ClothingBase */
...
VALUES (49173,  0, 64, 141, 0.75,  400,  400,  400,  400,  400,  400,  400,  400,  400, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49173,  5, 64, 141, 0.75,  400,  400,  400,  400,  400,  400,  400,  400,  400, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49173,  8, 64, 141, 0.75,  400,  400,  400,  400,  400,  400,  400,  400,  400, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
