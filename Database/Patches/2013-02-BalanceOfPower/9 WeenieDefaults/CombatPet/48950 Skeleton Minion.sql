...
VALUES (48950, 'ace48950-skeletonminion', 71, '2019-12-06 16:49:20') /* CombatPet */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (48950,   1,         16) /* ItemType - Creature */
     , (48950,   2,         30) /* CreatureType - Skeleton */
     , (48950,   6,        255) /* ItemsCapacity */
     , (48950,   7,        255) /* ContainersCapacity */
...
VALUES (48950,  31,      25) /* VisualAwarenessRange */
     , (48950,  77,       1) /* PhysicsScriptIntensity */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (48950,   1, 'Skeleton Minion') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (48950,   1,   33561494) /* Setup */
     , (48950,   2,  150994945) /* MotionTable */
     , (48950,   3,  536870942) /* SoundTable */
     , (48950,   4,  805306368) /* CombatTable */
     , (48950,   8,  100671323) /* Icon */
     , (48950,  22,  872415269) /* PhysicsEffectTable */;
...
VALUES (48950,   1,    90, 0, 0, 670) /* MaxHealth */
     , (48950,   3,   180, 0, 0, 930) /* MaxStamina */
     , (48950,   5,   110, 0, 0, 460) /* MaxMana */;
...
VALUES (48950,  0, 16, 80, 0.75,  370,  370,  370,  370,  370,  370,  370,  370,  370, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (48950,  5, 16, 80, 0.75,  370,  370,  370,  370,  370,  370,  370,  370,  370, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (48950,  8, 16, 80, 0.75,  370,  370,  370,  370,  370,  370,  370,  370,  370, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (48950, 2, 48985,  1, 0, 0, False) /* Create Flaming Hatchet (48985) for Wield */;
