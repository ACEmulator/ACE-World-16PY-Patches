...
VALUES (48958, 'ace48958-knight', 71, '2019-12-06 16:49:20') /* CombatPet */;
...
VALUES (48958,  31,      25) /* VisualAwarenessRange */
     , (48958,  39, 1.29999995231628) /* DefaultScale */
     , (48958,  77,       1) /* PhysicsScriptIntensity */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (48958,   1, 'Knight') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (48958,   1,   33559683) /* Setup */
     , (48958,   2,  150994945) /* MotionTable */
     , (48958,   4,  805306368) /* CombatTable - default, verify */
     , (48958,   3,  536871002) /* SoundTable */
     , (48958,   6,   67116522) /* PaletteBase */
     , (48958,   7,  268437044) /* ClothingBase */
     , (48958,   8,  100670274) /* Icon */
     , (48958,  22,  872415363) /* PhysicsEffectTable */;
...
VALUES (48958,   1,   120, 0, 0, 1370) /* MaxHealth */
     , (48958,   3,   240, 0, 0, 1740) /* MaxStamina */
     , (48958,   5,   170, 0, 0, 1070) /* MaxMana */;
...
VALUES (48958,  0, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,  570, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (48958,  5, 16, 200, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,  570, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (48958,  8, 16, 200, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,  570, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
