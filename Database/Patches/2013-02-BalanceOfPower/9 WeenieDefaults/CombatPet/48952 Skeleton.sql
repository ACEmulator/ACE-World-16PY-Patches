...
VALUES (48952, 'ace48952-skeleton', 71, '2021-07-12 10:02:41') /* CombatPet */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (48952,   1,         16) /* ItemType - Creature */
     , (48952,   2,         30) /* CreatureType - Skeleton */
     , (48952,   3,         39) /* PaletteTemplate - Black */
...
VALUES (48952,  12,  0.5455) /* Shade */
     , (48952,  31,      25) /* VisualAwarenessRange */
...
VALUES (48952,   1,   33561494) /* Setup */
     ...
     , (48952,   7,  268437545) /* ClothingBase */
...
VALUES (48952,  0, 16, 172, 0.75,  430,  430,  430,  430,  430,  430,  430,  430,  430, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (48952,  5, 16, 172, 0.75,  430,  430,  430,  430,  430,  430,  430,  430,  430, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (48952,  8, 16, 172, 0.75,  430,  430,  430,  430,  430,  430,  430,  430,  430, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
