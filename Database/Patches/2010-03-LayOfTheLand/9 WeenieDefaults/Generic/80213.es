ReceiveLocalSignal: UseEnchantedManaStone
    - InqQuest: MehirResearchComplete0310
        QuestFailure:
            ...
            - InqQuestBitsOn: MenhirResearchRingsComplete, 0x2000
                QuestSuccess:
                    - DirectBroadcast: This signature has already been lit.
                QuestFailure:
                    - SetQuestBitsOn: MenhirResearchRingsComplete, 0x2000
                    - DirectBroadcast: This signature lights the fourteenth ring of the mana stone.
