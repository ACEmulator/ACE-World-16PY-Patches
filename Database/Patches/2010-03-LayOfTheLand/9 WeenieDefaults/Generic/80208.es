ReceiveLocalSignal: UseEnchantedManaStone
    - InqQuest: MehirResearchComplete0310
        QuestFailure:
            ...
            - InqQuestBitsOn: MenhirResearchRingsComplete, 0x100
                QuestSuccess:
                    - DirectBroadcast: This signature has already been lit.
                QuestFailure:
                    - SetQuestBitsOn: MenhirResearchRingsComplete, 0x100
                    - DirectBroadcast: This signature lights the ninth ring of the mana stone.
