...
VALUES (72332, 'ace72332-frozenwightcaptain', 10, '2020-10-09 00:00:00') /* Creature */;
...
VALUES (72332,   1,   33561142) /* Setup */
     , (72332,   2,  150994967) /* MotionTable */
     , (72332,   3,  536870934) /* SoundTable */
     , (72332,   4,  805306368) /* CombatTable */
     , (72332,   6,   67110722) /* PaletteBase */
     , (72332,   7,  268435558) /* ClothingBase */
     , (72332,   8,  100667942) /* Icon */
     , (72332,  22,  872415272) /* PhysicsEffectTable */
...
VALUES (72332,  6, 0, 3, 0, 360, 0,    0) /* MeleeDefense        Specialized */
     ...
     , (72332, 41, 0, 3, 0, 445, 0,    0) /* Two Handed          Specialized */
     , (72332, 44, 0, 3, 0, 445, 0,    0) /* Heavy Weapons       Specialized */
     , (72332, 45, 0, 3, 0, 445, 0,    0) /* Light Weapons       Specialized */
     , (72332, 46, 0, 3, 0, 445, 0,    0) /* Finesse Weapons     Specialized */
     , (72332, 47, 0, 3, 0, 445, 0,    0) /* Missile Weapons     Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72332,  0,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72332,  1,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72332,  2,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72332,  3,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72332,  4,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72332,  5,  4, 250, 0.75, 350,  350,  350,  350,  350,  350,  350,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72332,  6,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72332,  7,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72332,  8,  4, 255, 0.75, 350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72332,  6190,   2.01)  /* Horizon's Blades */
...
VALUES (72331, 9, 48908,  1, 0, 0.01, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (72332, 9, 45649,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72332, 9, 45668,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72332, 9, 45669,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72332, 9, 45671,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72332, 9, 72286,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72332, 9, 72287,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
