...
VALUES (72330, 'ace72330-gurogsoldier', 10, '2019-11-18 22:17:59') /* Creature */;
...
VALUES (72330,   1,   33561132) /* Setup */
     , (72330,   2,  150995368) /* MotionTable */
     , (72330,   3,  536871125) /* SoundTable */
     , (72330,   4,  805306368) /* CombatTable */
     , (72330,   8,  100674350) /* Icon */
     , (72330,  22,  872415437) /* PhysicsEffectTable */
...
VALUES (72330,  6, 0, 3, 0, 470, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (72330, 41, 0, 3, 0, 400, 0, 0) /* Two Handed Weapons  Specialized */
...
VALUES (72330,  0,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72330,  1,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72330,  2,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72330,  3,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72330,  4,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72330,  5,  4, 200, 0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72330,  6,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72330,  7,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72330,  8,  4, 200, 0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72330, 10, 43397,  0, 0, 1, False) /* Create Frost Great Axe (43397) for WieldTreasure */
     , (72330, 9, 48908,  1, 0, 0.02, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     , (72330, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (72330, 9, 44864,  0, 0, 0.02, False) /* Create 44864 Gurog Arm for ContainTreasure */
     , (72330, 9, 44868,  0, 0, 0.02, False) /* Create 44868 Gurog Torso with a Head for ContainTreasure */
     , (72330, 9, 44870,  0, 0, 0.02, False) /* Create 44870 Gurog Leg for ContainTreasure */
     , (72330, 9,     0,  0, 0, 0.94, False) /* Create nothing for ContainTreasure */
     , (72330, 9, 45649,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72330, 9, 45668,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72330, 9, 45669,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72330, 9, 45671,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72330, 9, 72286,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72330, 9, 72287,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
