...
VALUES (72328, 'ace72328-guroghenchman', 10, '2019-11-18 22:17:54') /* Creature */;
...
VALUES (72328,   1, 'Gurog Henchman') /* Name */
     , (72328,  45, 'guroghenchmenkillcount') /* KillQuest */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72328,   1,   33561130) /* Setup */
     , (72328,   2,  150995368) /* MotionTable */
     , (72328,   3,  536871125) /* SoundTable */
     , (72328,   4,  805306368) /* CombatTable */
     , (72328,   8,  100674350) /* Icon */
     , (72328,  22,  872415437) /* PhysicsEffectTable */
...
VALUES (72328,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (72328, 44, 0, 3, 0, 400, 0, 0) /* Heavy Weapons       Specialized */
...
VALUES (72328,  0,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72328,  1,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72328,  2,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72328,  3,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72328,  4,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72328,  5,  4, 180,  0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72328,  6,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72328,  7,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72328,  8,  4, 180,  0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72328, 9, 48908,  1, 0, 0.02, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (72328, 9, 44864,  0, 0, 0.02, False) /* Create 44864 Gurog Arm for ContainTreasure */
     , (72328, 9, 44868,  0, 0, 0.02, False) /* Create 44868 Gurog Torso with a Head for ContainTreasure */
     , (72328, 9, 44870,  0, 0, 0.02, False) /* Create 44870 Gurog Leg for ContainTreasure */
     , (72328, 9,     0,  0, 0, 0.94, False) /* Create nothing for ContainTreasure */
     , (72328, 9, 45649,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72328, 9, 45668,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72328, 9, 45669,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72328, 9, 45671,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72328, 9, 72286,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72328, 9, 72287,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
