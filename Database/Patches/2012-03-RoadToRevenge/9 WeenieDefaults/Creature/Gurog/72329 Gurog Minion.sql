...
VALUES (72329, 'ace72329-gurogminion', 10, '2019-11-18 22:17:49') /* Creature */;
...
VALUES (72329,   1, 'Gurog Minion') /* Name */
     , (72329,  45, 'gurogminionkillcount') /* KillQuest */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72329,   1,   33561131) /* Setup */
     , (72329,   2,  150995368) /* MotionTable */
     , (72329,   3,  536871125) /* SoundTable */
     , (72329,   4,  805306368) /* CombatTable */
     , (72329,   8,  100674350) /* Icon */
     , (72329,  22,  872415437) /* PhysicsEffectTable */
...
VALUES (72329,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (72329, 44, 0, 3, 0, 345, 0, 0) /* Heavy Weapons       Specialized */
...
VALUES (72329,  0,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72329,  1,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72329,  2,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72329,  3,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72329,  4,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72329,  5,  4, 150, 0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72329,  6,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72329,  7,  4,  0,    0,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72329,  8,  4, 150, 0.5,  500,  525,  650,  500,  650,  500,  525,  600,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72329, 9, 48908,  1, 0, 0.02, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (72329, 9, 44864,  0, 0, 0.02, False) /* Create 44864 Gurog Arm for ContainTreasure */
     , (72329, 9, 44868,  0, 0, 0.02, False) /* Create 44868 Gurog Torso with a Head for ContainTreasure */
     , (72329, 9, 44870,  0, 0, 0.02, False) /* Create 44870 Gurog Leg for ContainTreasure */
     , (72329, 9,     0,  0, 0, 0.94, False) /* Create nothing for ContainTreasure */
     , (72329, 9, 45649,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72329, 9, 45668,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72329, 9, 45669,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72329, 9, 45671,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72329, 9, 72286,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
     , (72329, 9, 72287,  1, 0, 0.1, False) /* Create Stone Tablet for ContainTreasure */
