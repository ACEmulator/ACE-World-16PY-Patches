...
VALUES (87354, 'ace-87354Monouga120HugeGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87354,   1,   33555051) /* Setup */
     , (87354,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87354, -1, 87352, 1, 1, 1, 1, 4, 0, 0, 0, 10551565, 76.6898, -64.2042, -17.995, 0.705095, 0, 0, -0.709113) /* Generate Huge Imprisoned Monouga (87352) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
