...
VALUES (87355, 'ace-87355Monouga150GiantGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87355,   1,   33555051) /* Setup */
     , (87355,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87355, -1, 35748, 1, 1, 1, 1, 4, 0, 0, 0, 10617095, 74.3302, -63.001, -17.995, 0.377355, 0, 0, 0.926069) /* Generate Giant Imprisoned Monouga (35748) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
