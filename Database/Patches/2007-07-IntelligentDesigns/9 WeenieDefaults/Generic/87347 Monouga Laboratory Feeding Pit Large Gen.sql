...
VALUES (87347, 'ace-87347Monouga80FPLargeGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87347,   1,   33555051) /* Setup */
     , (87347,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87347, -1, 87348, 1, 1, 1, 1, 4, 0, 0, 0, 443744669, 102.265, 24.6103, 202.405, -0.03972, 0, 0, -0.999211) /* Generate Large Imprisoned Monouga (87348) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
