...
VALUES (87356, 'ace87356-tuskerexperimentorb', 8, '2021-04-07 08:24:56') /* Book */;
...
VALUES (87356,   1,   33556994) /* Setup */
     , (87356,   3,  536870932) /* SoundTable */
     , (87356,   8,  100671418) /* Icon */
     , (87356,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (87356, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (87356, 0, 4294967295, 'Aerbax', 'prewritten', False, 'The behavior of the simulacra Mudmouth, while not precisely in the vein of a Tusker, has still worked admirably to lull Oolutanaga. The confluence of an easily influenced leader, an established power base, and a being who has already undergone extensive modification cannot be denied to grant an excellent chance for a positive outcome to this experiment. Mudmouth should be able to continue to control Oolutanaga until the final procedure is enacted upon him.')
     , (87356, 1, 4294967295, 'Aerbax', 'prewritten', False, 'All is not well as far as this experiment is concerned, however. Some Isparians have begun to interfere with Mudmouth''s activities. The prognosis for the experiment would be grim if Mudmouth were to be excised from his position - the benefit of this experiment is not simply to create a more powerful Tusker, but rather one that can rule over the rest while still bearing my influence, in order to utilize the strength inherent to Tuskers. However, as the constraints of the experiment are non-interference, Mudmouth must fare for himself as is best. Continued observation will demonstrate best whether Tuskers have the spark necessary to reign supreme among the children.');
