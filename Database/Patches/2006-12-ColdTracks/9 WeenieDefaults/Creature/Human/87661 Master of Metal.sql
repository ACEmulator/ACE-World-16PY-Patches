...
VALUES (87661, 'ace87661-masterofmetal', 10, '2021-10-22 13:59:08') /* Creature */;
...
VALUES (87661,  6, 0, 3, 0, 255, 0, 0) /* MeleeDefense        Specialized */
     , (87661,  7, 0, 3, 0, 201, 0, 0) /* MissileDefense      Specialized */
     , (87661, 15, 0, 3, 0, 159, 0, 0) /* MagicDefense        Specialized */
     ...
     , (87661, 45, 0, 3, 0, 287, 0, 0) /* LightWeapons        Specialized */
     , (87661, 47, 0, 3, 0, 235, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (87661,  0,  4,  0,    0,  225,  203,  203,  203,  180,   68,   98,  135,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87661,  1,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87661,  2,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87661,  3,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87661,  4,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87661,  5,  4,  4, 0.75,  265,  239,  239,  239,  212,   80,  112,  189,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87661,  6,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87661,  7,  4,  0,    0,  265,  239,  239,  239,  212,   80,  112,  189,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87661,  8,  4,  8, 0.75,  265,  239,  239,  239,  212,   80,  112,  189,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (87661,    97,   2.04)  /* Whirling Blade VI */
     , (87661,   234,   2.04)  /* Vulnerability Other VI */
     , (87661,   285,   2.05)  /* Magic Yield Other VI */
     , (87661,  1327,   2.05)  /* Imperil Other VI */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (87661, 2, 33973,  0, 0, 1, False) /* Create Shou-jen Jika-Tabi (33973) for Wield */
     , (87661, 2, 33975,  0, 0, 1, False) /* Create Shou-jen Shozoku Jacket (33975) for Wield */
     , (87661, 2, 33974,  0, 0, 1, False) /* Create Shou-jen Shozoku Sleeve Gauntlets (33974) for Wield */
     , (87661, 2, 33977,  0, 0, 1, False) /* Create Shou-jen Shozoku Trousers (33977) for Wield */
     , (87661, 2, 33976,  0, 0, 1, False) /* Create Shou-jen Shozoku Mask (33976) for Wield */
     , (87661, 9, 87662,  1, 0, 1, False) /* Create Medallion of Metal (87662) for ContainTreasure */;
