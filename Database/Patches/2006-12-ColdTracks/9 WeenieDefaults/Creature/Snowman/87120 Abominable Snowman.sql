...
VALUES (87120, 'ace87120-abominablesnowman', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (87120,   1,   33559810) /* Setup */
     , (87120,   2,  150995088) /* MotionTable */
     , (87120,   3,  536871000) /* SoundTable */
     , (87120,   4,  805306406) /* CombatTable */
     , (87120,   8,  100669125) /* Icon */
     , (87120,  22,  872415346) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (87120,  16, 2045939743) /* ActivationTarget */;
...
VALUES (87120,  0,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87120,  1,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87120,  2,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87120,  3,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87120,  4,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87120,  5,  4,  3, 0.75,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87120,  6,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87120,  7,  4,  0,    0,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87120,  8,  4,  3, 0.75,  400,  480,  480,  480, 1000,  390,  480,  480,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
