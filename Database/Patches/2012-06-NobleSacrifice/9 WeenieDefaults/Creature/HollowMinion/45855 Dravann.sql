...
VALUES (45855,   1,       5) /* HeartbeatInterval */
     ...
     , (45855,   5,       1) /* ManaRate */
     , (45855,  12,     0.5) /* Shade */
     , (45855,  13,    0.76) /* ArmorModVsSlash */
     , (45855,  14,    0.76) /* ArmorModVsPierce */
     , (45855,  15,    0.68) /* ArmorModVsBludgeon */
     , (45855,  16,    0.84) /* ArmorModVsCold */
     , (45855,  17,    0.64) /* ArmorModVsFire */
     , (45855,  18,    0.76) /* ArmorModVsAcid */
     , (45855,  19,    0.64) /* ArmorModVsElectric */
     , (45855,  31,      12) /* VisualAwarenessRange */
     , (45855,  34,       1) /* PowerupTime */
     , (45855,  36,       1) /* ChargeSpeed */
     , (45855,  39,     1.1) /* DefaultScale */
     ...
     , (45855, 165,     1.0) /* ArmorModVsNether */
     , (45855, 166,     1.0) /* ResistNether */;
...
VALUES (45855,  0,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45855,  1,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45855,  2,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (45855,  3,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45855,  4,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (45855,  5,  4, 40, 0.75,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45855, 17,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
