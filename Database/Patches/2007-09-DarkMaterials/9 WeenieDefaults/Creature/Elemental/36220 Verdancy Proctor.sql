...
VALUES (36220, 'ace36220-verdancyproctor', 10, '2021-06-18 01:04:39') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (36220,   1,         16) /* ItemType - Creature */
     , (36220,   2,         62) /* CreatureType - Elemental */
     , (36220,   3,          8) /* PaletteTemplate */
...
VALUES (36220,   1,   33559882) /* Setup */
     ...
     , (36220,   7,  268437114) /* ClothingBase */
...
/* @teleloc 0xED0230 [300.000000 -270.000000 -11.995500] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (36220,  0, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (36220,  1, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (36220,  2, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (36220,  3, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (36220,  4, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (36220,  5, 32,400, 0.75,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (36220,  6, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (36220,  7, 32,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (36220,  8, 32,400, 0.75,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (36220, 31, 0, 2, 0, 280, 0, 0) /* CreatureMagic */
     , (36220, 33, 0, 2, 0, 280, 0, 0) /* LifeMagic */
     , (36220, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons */
     , (36220, 15, 0, 2, 0, 280, 0, 0) /* MagicDefense */
     , (36220,  6, 0, 2, 0, 310, 0, 0) /* MeleeDefense */
     , (36220,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense */
     , (36220, 34, 0, 2, 0, 280, 0, 0) /* WarMagic */;
