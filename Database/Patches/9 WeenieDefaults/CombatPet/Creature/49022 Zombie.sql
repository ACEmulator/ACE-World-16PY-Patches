...
VALUES (49022, 'ace49022-zombie', 71, '2022-12-04 19:04:52') /* CombatPet */;
...
VALUES (49022,   1, 0x02001A96) /* Setup */
     , (49022,   2, 0x09000001) /* MotionTable */
     , (49022,   3, 0x20000016) /* SoundTable */
     , (49022,   4, 0x30000000) /* CombatTable */
     , (49022,   6, 0x0400007E) /* PaletteBase */
     , (49022,   8, 0x06001226) /* Icon */
     , (49022,  22, 0x34000028) /* PhysicsEffectTable */;
...
VALUES (49022,  0, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (49022,  1, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (49022,  2, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (49022,  3, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (49022,  4, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (49022,  5, 16, 825, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (49022,  6, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (49022,  7, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (49022,  8, 16, 825, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (49022, 2, 48991,  1, 1, 0, False) /* Create Flaming Hatchet (48991) for Wield */
     ...
     , (49022, 2, 87373,  1, 14, 0.00001, False) /* Create Haebrean Tassets (87373) for Wield */
     , (49022, 2, 87374,  1, 14, 0.2364, False) /* Create Haebrean Pauldrons (87374) for Wield */
     , (49022, 2, 87375,  1, 14, 0.00001, False) /* Create Haebrean Boots (87375) for Wield */
     , (49022, 2, 87376,  1, 14, 0.00001, False) /* Create Haebrean Greaves (87376) for Wield */
