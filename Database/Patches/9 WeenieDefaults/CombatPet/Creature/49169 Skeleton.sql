...
VALUES (49169, 'ace49169-skeleton', 71, '2022-12-04 19:04:52') /* CombatPet */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (49169,   1,         16) /* ItemType - Creature */
     , (49169,   2,         30) /* CreatureType - Skeleton */
     , (49169,   3,         39) /* PaletteTemplate - Black */
...
VALUES (49169,  12,   0.546) /* Shade */
     , (49169,  31,      25) /* VisualAwarenessRange */
...
VALUES (49169,   1, 0x02001B95) /* Setup */
     ...
     , (49169,   4, 0x30000000) /* CombatTable */
     , (49169,   6, 0x0400007E) /* PaletteBase */
     , (49169,   7, 0x10000829) /* ClothingBase */
...
VALUES (49169,  0, 32, 248, 0.75,  530,  530,  530,  530,  530,  530,  530,  530,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (49169,  1, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (49169,  2, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (49169,  3, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (49169,  4, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (49169,  5, 32, 248, 0.75,  530,  530,  530,  530,  530,  530,  530,  530,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (49169,  6, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (49169,  7, 32,  0,    0,  530,  530,  530,  530,  530,  530,  530,  530,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (49169,  8, 32, 248, 0.75,  530,  530,  530,  530,  530,  530,  530,  530,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
