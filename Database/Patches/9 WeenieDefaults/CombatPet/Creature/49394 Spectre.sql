...
VALUES (49394, 'ace49394-spectre', 71, '2022-12-04 19:04:52') /* CombatPet */;
...
VALUES (49394,   1, 0x02001120) /* Setup */
     , (49394,   2, 0x09000166) /* MotionTable */
     , (49394,   3, 0x200000B6) /* SoundTable */
     , (49394,   4, 0x30000000) /* CombatTable */
     , (49394,   6, 0x040018F3) /* PaletteBase */
     , (49394,   7, 0x10000563) /* ClothingBase */
     , (49394,   8, 0x06003447) /* Icon */
     , (49394,  22, 0x340000AB) /* PhysicsEffectTable */;
...
VALUES (49394,  0, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (49394,  1, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (49394,  2, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (49394,  3, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 1, 0.23,  0.3,    0, 0.23,  0.3,    0, 0.23,  0.3,    0, 0.23,  0.3,    0) /* UpperArm */
     , (49394,  4, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (49394,  5, 32, 115, 0.75,  310,  310,  310,  310,  310,  310,  310,  310,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (49394,  6, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (49394,  7, 32,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (49394,  8, 32, 115, 0.75,  310,  310,  310,  310,  310,  310,  310,  310,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
