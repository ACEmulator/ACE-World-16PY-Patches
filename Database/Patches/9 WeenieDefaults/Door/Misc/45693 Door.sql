...
VALUES (45693, 'ace45693-door', 19, '2021-11-01 00:00:00') /* Door */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (45693,   1,        128) /* ItemType - Misc */
     , (45693,  16,          1) /* ItemUseable - No */
     , (45693,  19,          0) /* Value */
     , (45693,  93,         24) /* PhysicsState - ReportCollisions, IgnoreCollisions */
     , (45693, 290,          1) /* HearLocalSignals */
     , (45693, 291,         80) /* HearLocalSignalsRadius */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (45693,   1, True ) /* Stuck */
     , (45693,   2, False) /* Open */
     , (45693,  34, True ) /* DefaultOpen */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (45693,  11,     180) /* ResetInterval */
     , (45693,  54,       2) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (45693,   1, 'Door') /* Name */
     , (45693,  14, 'This door cannot be activated from here.') /* Use */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (45693,   1, 0x02000281) /* Setup */
     , (45693,   2, 0x09000016) /* MotionTable */
     , (45693,   3, 0x20000022) /* SoundTable */
     , (45693,   8, 0x06001412) /* Icon */
     , (45693,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45693, 37 /* ReceiveLocalSignal */,      1, NULL, NULL, NULL, 'OpenDoor1', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45693, 37 /* ReceiveLocalSignal */,      1, NULL, NULL, NULL, 'CloseDoor1', NULL, NULL, NULL);
