...
VALUES (6906, 'bowcompositedmg1def1spd3atk3', 3, '2022-06-03 16:20:09') /* MissileLauncher */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (6906,   1,        256) /* ItemType - MissileWeapon */
     , (6906,   3,         40) /* PaletteTemplate - Bronze */
     , (6906,   5,       1520) /* EncumbranceVal */
     , (6906,   8,        140) /* Mass */
     ...
     , (6906, 106,        250) /* ItemSpellcraft */
     , (6906, 107,        500) /* ItemCurMana */
     ...
     , (6906, 158,          2) /* WieldRequirements - RawSkill */
     , (6906, 159,         47) /* WieldSkillType - MissileWeapons */
     , (6906, 160,        240) /* WieldDifficulty */
...
VALUES (6906,   5,   -0.05) /* ManaRate */
     ...
     , (6906,  29,    1.08) /* WeaponDefense */
     , (6906,  39,     1.1) /* DefaultScale */
     , (6906,  62,    1.06) /* WeaponOffense */
     , (6906,  63,    1.65) /* DamageMod */
     , (6906, 155,     1.0) /* IgnoreArmor */
     , (6906, 156,    0.05) /* ProcSpellRate */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (6906,   1, 'Composite Bow with Handle') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (6906,   1, 0x02000878) /* Setup */
     , (6906,   3, 0x20000014) /* SoundTable */
     , (6906,   6, 0x04000FA5) /* PaletteBase */
     , (6906,   7, 0x10000222) /* ClothingBase */
     , (6906,   8, 0x06001CCD) /* Icon */
     , (6906,  22, 0x3400002B) /* PhysicsEffectTable */
     , (6906,  55,       1492) /* ProcSpell - Brittlemail VI */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (6906,  1605,      2)  /* Aura of Defender Self VI */
     , (6906,  2058,      2)  /* Boon of Refinement */
     , (6906,  2096,      2)  /* Aura of Infected Caress */
     , (6906,  1627,      2)  /* Aura of Swift Killer Self VI */
     , (6906,  2206,      2)  /* Missile Weapon Mastery Other VII */;
