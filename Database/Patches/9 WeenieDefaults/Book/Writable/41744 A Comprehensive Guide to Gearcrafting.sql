...
VALUES (41744, 'ace41744-acomprehensiveguidetogearcrafting', 8, '2021-11-17 16:56:08') /* Book */;
...
VALUES (41744, 0, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'A Comprehensive Guide to Gearcrafting: 
...
In the wake of the Gearknight''s appearance in Dereth comes an opportunity for great advancement. The balance of magical means with that of technology can only increase our understanding of the world and offer new solutions we can use to cope with our challenges. This guide intends to describe the practice of Gearcrafting in its state of inception.')
     , (41744, 1, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'The Trinket: 
...
(These items occupy a trinket slot on your character, this slot is displayed below the necklace slot)')
     , (41744, 2, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Gearcrafting and Trinkets: 
...
The most advanced form of Gearcrafting includes the way it interacts with trinkets. All trinkets possessing magic seem to have further innate magics that can be tapped into. The closest analog to the process of activating these magics is that of Tinkering and Imbuing items as has long been the practice of a variety of crafters around Dereth. However Gearcrafting trinkets have a set of differences and some very specific rules.')
     , (41744, 3, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Rule 1 - There are only three possible upgrades to any Trinket
...
slot will offer absolutely no bonus outside of that of the highest tier spell.')
     , (41744, 4, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Rule 5 - The Minor and Moderate upgrades can be completed with no chance of failure by a Gearcrafter of the appropriate skill level.
...
Sub 3 - Majors Spells are activated with a Major Armature')
     , (41744, 5, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'As it is with normal tinkering you will need vast quantities (a bag containing 100 units of a specific material) of salvage. The types of salvage you will be using are very specific to Gearcrafting.
...
Ruby
Sapphire')
     , (41744, 6, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Each of these salvages on its own is completely inert. Only when applied to the correct armature is your salvage ready for use on a trinket. This armature facilitates the application of the material to the trinket as well as activating the magical reagents available in the material itself.
...
Major Gearcrafting Armature - Available at only the most prestigious of shops')
     , (41744, 7, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Once activated each salvaged material will trigger a specific type of magic in the trinket.
...
Pyreal - Understanding (increase earned experience)')
     , (41744, 8, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Each of these salvage types will have a different level of effect based on the type of armature it is applied to.
...
Pyreal - Minor 2% Experience Gain, Moderate 4% Experience Gain, Major 6% Experience Gain')
     , (41744, 9, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'The process of preparing an armature is simple and has no risk of failure.
...
Sub 2 - The material will not be expended, this process only uses trace amounts of the material and there is no effect on the bag of salvage itself.')
     , (41744, 10, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Step 4 - Apply a bag of the same type of salvage, or the same bag of salvage to the prepared armature.
...
Trapped Virindi Essences - Allows those with sufficient Deception to trick the Virindi essence into amplifying their knowledge of Arcane Lore.')
     , (41744, 13, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Level of Effect of Devices:
Horns of Leadership:
...
Platinum - Adds 10 to Health of Fellowship')
     , (41744, 14, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Medals of Loyalty:
...
Platinum (Mana) - Adds 10 to Mana of Fellowship')
     , (41744, 15, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Examination Lenses:
...
Incomparable Lense - Flawless Pyreal - Similar to Imperil Other VII')
     , (41744, 16, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Trapped Virindi Essences:
...
Sub 1 - This will allow the Horn to be used.')
     , (41744, 19, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Medals of Loyalty:
Step 1 - Smelt a Scarab
Sub 1 - This process requires a smelting pot.
...
Sub 1 - This will create a Medal of the type of metal and enhancing the corresponding secondary attribute to the type of Refining Polish used.')
     , (41744, 20, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Medals of Loyalty:
Step 1 - Smelt a Scarab
Sub 1 - This process requires a smelting pot.
Sub 2 - This process requires a scarab. Medals use Copper, Silver, Gold, Pyreal or Platinum Scarabs depending on level. See description above to determine level.
Step 2 - pour smelted metal into a Medal Mold
...
Step 3 - Use a Stamina or Mana Refining Polish on the medal
Sub 1 - This will create a Medal of the type of metal and enhancing the corresponding secondary attribute to the type of Refining Polish used.')
     , (41744, 21, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Examination Lenses:
Step 1 - Smelt a Scarab
Sub 1 - This process requires a smelting pot.
...
Sub 1 - The Examination Lense is now ready for use.')
     , (41744, 22, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Trapped Virindi Essences:
Step 1 - Smelt a Scarab
Sub 1 - This process requires a smelting pot.
Sub 2 - This process requires a scarab. Medals use Copper, Silver, Gold, Pyreal or Platinum Scarabs depending on level. See description above to determine level.
Step 2 - pour smelted metal into a Metal Sheet Form
...
Sub 1 - Your saw is now ready to cut but blades can be broken in crafting.')
     , (41744, 23, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Step 4 - Use your Jeweler''s Saw to cut a setting from your Metal Sheet
...
Lense Frame + Finished Lense = Framed Lense')
     , (41744, 25, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Smelting Pot + Lead Scarab = Smelting Pot of Lead
...
Smelting Pot + Platinum Scarab = Smelting Pot of Platinum')
     , (41744, 26, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Smelting Pot of Copper + Metal Sheet Form = Sheet Metal (Copper)
...
Jeweler''s Saw + Sheet Metal (Platinum) = Platinum Setting')
     , (41744, 27, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Lapping Plate + Yellow Virindi Gem = Cut Yellow Gem
...
Cut Purple Gem + Platinum Setting = Virindi Consul Essence')
     , (41744, 28, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Forming Hammer + Sheet Metal (Copper) = Copper Horn
...
Leather Strap + Platinum Horn = Platinum Horn of Leadership')
     , (41744, 29, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Smelting Pot of Copper + Mold Medal = Copper Medal
...
Refining Polish (Mana) + Platinum Medal = Platinum Medal of Intellect')
     , (41744, 30, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Smelting Pot of Lead + Mold Handle = Lead Handle
...
Lense Framed + Flawless Handle = Incomparable Lense')
     , (41744, 31, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Armatures are first prepared:
...
Salvaged Amber (100) + Major Gearcrafting Armature = Major Gearcrafting Armature')
     , (41744, 32, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Salvaged Diamond (100) + Minor Gearcrafting Armature = Minor Gearcrafting Armature
...
Salvaged Diamond (100) + Major Gearcrafting Armature = Major Gearcrafting Armature')
     , (41744, 33, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Salvaged Gromnie Hide (100) + Minor Gearcrafting Armature = Minor Gearcrafting Armature
...
Salvaged Gromnie Hide (100) + Major Gearcrafting Armature = Major Gearcrafting Armature')
     , (41744, 34, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Salvaged Pyreal (100) + Minor Gearcrafting Armature = Minor Gearcrafting Armature
...
Salvaged Pyreal (100) + Major Gearcrafting Armature = Major Gearcrafting Armature')
     , (41744, 35, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Salvaged Ruby (100) + Minor Gearcrafting Armature = Minor Gearcrafting Armature
...
Salvaged Ruby (100) + Major Gearcrafting Armature = Major Gearcrafting Armature')
     , (41744, 36, 0xFFFFFFFF, 'Gearcrafting Committee', 'prewritten', True, 'Salvaged Sapphire (100) + Minor Gearcrafting Armature = Minor Gearcrafting Armature
