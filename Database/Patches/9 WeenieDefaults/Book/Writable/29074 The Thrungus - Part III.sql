...
VALUES (29074, 'bookthrungusexplorer3', 8, '2021-11-01 00:00:00') /* Book */;
...
VALUES (29074,   1,       8192) /* ItemType - Writable */
     ...
     , (29074,  53,        101) /* PlacementPosition - Resting */
...
VALUES (29074, 0, 0xFFFFFFFF, 'Sir Binwas Loc', 'prewritten', True, 'It was not long before the thief revealed himself. At first, I thought I had passed from waking into dreaming. I was standing there in the darkened alcove, eyes trained on the niche wherein I had placed the trinkets. I was alone in the silent halls. I could neither see nor hear any other man. I waited for hours. Over time, I began to fear that my trap had been laid for naught. Perhaps I had been spotted. Perhaps the thief had finished his assault on the Royal Hall just as I had formulated my plan of capture. Or perhaps the lazy fiend had simply decided to take the night off.')
     , (29074, 1, 0xFFFFFFFF, 'Sir Binwas Loc', 'prewritten', True, 'I despaired that the night would pass without incident until I noticed a shape in the gloom of the darkened hallways. Its silhouette gradually separated from the darkness around it, as if it had been there all along and my eyes were only now able to pick it out from its shadowy surroundings. Had it been here all along? Had I truly not seen this thing until now? I was shocked that I could miss such a thing. But more startling than that was the nature of the shape. It was a large mushroom, seemingly planted in the stone floor of the Royal Hall! A mushroom half as tall as a man!')
     , (29074, 2, 0xFFFFFFFF, 'Sir Binwas Loc', 'prewritten', True, 'Several questions crossed my mind. The first of which being, "How does a mushroom grow from stone?" But before I had much time to ponder these questions, I witnessed a most miraculous sight. And this sight is what caused me to question my sanity that night. The mushroom... moved.
...
I dared not shout at the beast, not wishing to make myself more of a spectacle than I already had.')
     , (29074, 5, 0xFFFFFFFF, 'Sir Binwas Loc', 'prewritten', True, 'But it was no use. The Royal Guard came running from all directions at the sound of my raucous pursuit. They called to me to halt until they recognized my face. Then calls of "Sir Loc chases the thief!" rang throughout the Royal Hall.
...
I tracked the creature into the hallway where the guests'' quarters were located. The door to one of the rooms slammed shut just as I rounded the corner. I ran to the door and smashed it to pieces with one powerful kick.')
     , (29074, 6, 0xFFFFFFFF, 'Sir Binwas Loc', 'prewritten', True, 'But I was too late. The outer window had been shattered; the thief had fled. I ducked my head out into the chill night air and looked for any trace of the mushroom figure on the streets below.
