...
VALUES (29327, 'booksalvagingacademy', 8, '2021-11-01 00:00:00') /* Book */;
...
VALUES (29327, 0, 0x7FFFFFFF, 'Training Master', 'prewritten', True, 'COMBAT 
...
(Click on the green arrow to read more!)')
     , (29327, 1, 0x7FFFFFFF, 'Training Master', 'prewritten', True, 'Select a target by clicking on it or its dot on the compass. 
...
(Click on the green arrow to read more!)')
     , (29327, 2, 0x7FFFFFFF, 'Training Master', 'prewritten', True, 'Your target''s health is displayed below its name in the bottom-right corner of the screen. When your target runs out of health, it will die. Double-click on its corpse to check for loot! 
...
(Click on the green arrow to read more!)')
     , (29327, 3, 0x7FFFFFFF, 'Training Master', 'prewritten', True, '
