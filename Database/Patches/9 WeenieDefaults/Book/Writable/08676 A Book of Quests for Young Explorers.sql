...
VALUES (8676, 'booknewbiequests', 8, '2022-11-05 05:26:30') /* Book */;
...
')
     , (8676, 3, 0xFFFFFFFF, '', 'prewritten', False, 'The reward you will receive depends on what town stamped letter is being turned in at which town. Keep in mind that in order to encourage exploration and give you experience in using the Town Network, which many of us use to travel around Dereth, Society Agents will no longer accept letters from their own towns!
...
')
     , (8676, 4, 0xFFFFFFFF, '', 'prewritten', False, 'I wish you the best of luck in your journey.   
...
')
     , (8676, 5, 0xFFFFFFFF, '', 'prewritten', False, 'Al-Arqas
     ...
     Rewards:
        ...
        Yanshi Letter: Axe    
')
     , (8676, 6, 0xFFFFFFFF, '', 'prewritten', False, 'Lytelthorpe
...
')
     , (8676, 8, 0xFFFFFFFF, '', 'prewritten', False, 'Rithwic
...
')
     , (8676, 9, 0xFFFFFFFF, '', 'prewritten', False, 'Samsur
     ...
     Rewards:
        ...
        Yanshi Letter: Bow
')
     , (8676, 10, 0xFFFFFFFF, '', 'prewritten', False, 'Yanshi
