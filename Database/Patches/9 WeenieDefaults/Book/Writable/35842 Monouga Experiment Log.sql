...
VALUES (35842, 'ace35842-monougaexperimentlog', 8, '2021-04-07 08:21:35') /* Book */;
...
VALUES (35842, 0, 4294967295, 'Aerbax', 'prewritten', False, 'The Monouga specimens that I have obtained have shown distinctly different rates of progression. While the other two are powerful, and I will retain them for study, only one has demonstrated enough power and aptitude to be a candidate for the procedure. The interference in their supplying has affected all three specimens, but not to such an extent as to ruin the study. ')
     , (35842, 1, 4294967295, 'Aerbax', 'prewritten', False, 'I will begin the procedure soon. The sheer size of this creature should be enough for it to be a champion to my forces. Unlike the rest, this is not meant to be a leader...simply a destroyer.
