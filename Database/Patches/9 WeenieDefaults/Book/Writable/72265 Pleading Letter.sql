...
VALUES (72265, 'ace72265-pleadingletter', 8, '2021-05-09 12:29:26') /* Book */;
...
VALUES (72265,   1,   33554773) /* Setup */
     , (72265,   3,  536870932) /* SoundTable */
     , (72265,   8,  100668176) /* Icon */
     , (72265,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (72265, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (72265, 0, 4294967295, 'Laylana', 'prewritten', False, 'To Lord Cynreft Mhoire, noble ruler of the House of Mhoire and my husbands friend and benefactor.
