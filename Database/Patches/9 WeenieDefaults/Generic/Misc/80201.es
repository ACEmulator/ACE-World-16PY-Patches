ReceiveLocalSignal: UseEnchantedManaStone
    - InqQuest: MehirResearchComplete0310
        QuestFailure:
            ...
            - InqQuestBitsOn: MenhirResearchRingsComplete, 0x2
                QuestSuccess:
                    - DirectBroadcast: This signature has already been lit.
                QuestFailure:
                    - SetQuestBitsOn: MenhirResearchRingsComplete, 0x2
                    - DirectBroadcast: This signature lights the second ring of the mana stone.
