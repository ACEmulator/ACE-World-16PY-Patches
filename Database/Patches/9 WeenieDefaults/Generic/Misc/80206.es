ReceiveLocalSignal: UseEnchantedManaStone
    - InqQuest: MehirResearchComplete0310
        QuestFailure:
            ...
            - InqQuestBitsOn: MenhirResearchRingsComplete, 0x40
                QuestSuccess:
                    - DirectBroadcast: This signature has already been lit.
                QuestFailure:
                    - SetQuestBitsOn: MenhirResearchRingsComplete, 0x40
                    - DirectBroadcast: This signature lights the seventh ring of the mana stone.
