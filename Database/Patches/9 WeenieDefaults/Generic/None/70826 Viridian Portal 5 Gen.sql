DELETE FROM `weenie` WHERE `class_Id` = 70826;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (70826, 'ace70826-viridianportal5gen', 1, '2021-11-01 00:00:00') /* Generic */;
...
VALUES (70826,   1, True ) /* Stuck */
     , (70826,  11, True ) /* IgnoreCollisions */
     , (70826,  18, True ) /* Visibility */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (70826,  41,       0) /* RegenerationInterval */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (70826,   1, 'Viridian Portal 5 Gen') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (70826,   1, 0x0200026B) /* Setup */
     , (70826,   8, 0x06001066) /* Icon */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (70826, 37 /* ReceiveLocalSignal */,      1, NULL, NULL, NULL, 'viridianportal5', NULL, NULL, NULL);
