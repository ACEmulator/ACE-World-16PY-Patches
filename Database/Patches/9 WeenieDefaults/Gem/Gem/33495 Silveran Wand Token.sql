...
VALUES (33495, 'ace33495-silveranwandtoken', 38, '2021-11-01 00:00:00') /* Gem */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (33495,   1,       2048) /* ItemType - Gem */
     , (33495,   5,         10) /* EncumbranceVal */
     , (33495,  16,          1) /* ItemUseable - No */
     , (33495,  33,          1) /* Bonded - Bonded */
     , (33495,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (33495, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (33495,  22, True ) /* Inscribable */
     , (33495,  23, True ) /* DestroyOnSell */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (33495,   1, 'Silveran Wand Token') /* Name */
     , (33495,  16, 'This token represents a Silveran Wand.  You may only pick up one Silveran weapon token.  Turn it in to the Rossu Morta Chamberlain to receive your reward.') /* LongDesc */
     , (33495,  37, 'CanPickupSilveranToken') /* QuestRestriction */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (33495,   1, 0x020015B8) /* Setup */
     , (33495,   3, 0x20000014) /* SoundTable */
     , (33495,   8, 0x0600644D) /* Icon */
     , (33495,  22, 0x3400002B) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (33495, 10 /* PickUp */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
