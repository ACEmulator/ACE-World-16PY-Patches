...
VALUES (33490, 'ace33490-silveranstafftoken', 38, '2021-11-01 00:00:00') /* Gem */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (33490,   1,       2048) /* ItemType - Gem */
     , (33490,   5,         10) /* EncumbranceVal */
     , (33490,  16,          1) /* ItemUseable - No */
     , (33490,  33,          1) /* Bonded - Bonded */
     , (33490,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (33490, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (33490,  22, True ) /* Inscribable */
     , (33490,  23, True ) /* DestroyOnSell */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (33490,   1, 'Silveran Staff Token') /* Name */
     , (33490,  16, 'This token represents a Silveran Staff.  You may only pick up one Silveran weapon token.  Turn it in to the Rossu Morta Chamberlain to receive your reward.') /* LongDesc */
     , (33490,  37, 'CanPickupSilveranToken') /* QuestRestriction */;
...
VALUES (33490, 10 /* PickUp */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
