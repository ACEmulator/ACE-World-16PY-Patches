...
VALUES (33493, 'ace33493-silverancrossbowtoken', 38, '2021-11-01 00:00:00') /* Gem */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (33493,   1,       2048) /* ItemType - Gem */
     , (33493,   5,         10) /* EncumbranceVal */
     , (33493,  16,          1) /* ItemUseable - No */
     , (33493,  33,          1) /* Bonded - Bonded */
     , (33493,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (33493, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (33493,  22, True ) /* Inscribable */
     , (33493,  23, True ) /* DestroyOnSell */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (33493,   1, 'Silveran Crossbow Token') /* Name */
     , (33493,  16, 'This token represents a Silveran Crossbow.  You may only pick up one Silveran weapon token.  Turn it in to the Rossu Morta Chamberlain to receive your reward.') /* LongDesc */
     , (33493,  37, 'CanPickupSilveranToken') /* QuestRestriction */;
...
VALUES (33493, 10 /* PickUp */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
