...
VALUES (87342, 'ace87342-surface', 7, '2019-02-04 06:52:23') /* Portal */;
...
VALUES (87342,   1, True ) /* Stuck */
     ...
     , (87342,  88, True ) /* PortalShowDestination */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (87342,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (87342,   1, 'Surface') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (87342,   1,   33554867) /* Setup */
     , (87342,   2,  150994947) /* MotionTable */
     , (87342,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87342, 2, 456392960, 44.0304, 30.2777, 64.805, 0.88664, 0, 0, 0.46246) /* Destination */
