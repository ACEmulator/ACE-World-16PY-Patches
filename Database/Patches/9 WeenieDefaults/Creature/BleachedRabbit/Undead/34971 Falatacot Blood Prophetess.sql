...
VALUES (34971,   1,   33558437) /* Setup */
     ...
     , (34971,   7,  268436672) /* ClothingBase */
...
VALUES (34971,  6, 0, 3, 0, 375, 0, 0) /* MeleeDefense        Specialized */
     , (34971,  7, 0, 3, 0, 355, 0, 0) /* MissileDefense      Specialized */
     ...
     , (34971, 31, 0, 3, 0, 345, 0, 0) /* CreatureEnchantment Specialized */
     , (34971, 33, 0, 3, 0, 345, 0, 0) /* LifeMagic           Specialized */
     , (34971, 34, 0, 3, 0, 345, 0, 0) /* WarMagic            Specialized */
...
VALUES (34971,  0,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34971,  1,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34971,  2,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34971,  3,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34971,  4,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34971,  5,  4,  5, 0.75,  425,  595,  455,  638,  475,  305,  477,  477,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34971,  6,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34971,  7,  4,  0,    0,  425,  595,  455,  638,  475,  305,  477,  477,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34971,  8,  4,  5, 0.75,  425,  595,  455,  638,  475,  305,  477,  477,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
