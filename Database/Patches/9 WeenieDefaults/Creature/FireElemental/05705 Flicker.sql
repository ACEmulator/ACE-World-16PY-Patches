...
VALUES (5705, 'fireelementalflicker', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (5705,   1,       5) /* HeartbeatInterval */
     ...
     , (5705,   3,     0.6) /* HealthRate */
     , (5705,   4,     0.5) /* StaminaRate */
     , (5705,   5,       2) /* ManaRate */
     , (5705,  13,    0.67) /* ArmorModVsSlash */
     , (5705,  14,     0.9) /* ArmorModVsPierce */
     , (5705,  15,     0.9) /* ArmorModVsBludgeon */
     , (5705,  16,       1) /* ArmorModVsCold */
     , (5705,  17,     100) /* ArmorModVsFire */
     , (5705,  18,    0.98) /* ArmorModVsAcid */
     , (5705,  19,    2.15) /* ArmorModVsElectric */
     , (5705,  31,      15) /* VisualAwarenessRange */
     , (5705,  39,     0.5) /* DefaultScale */
     , (5705,  64,    0.65) /* ResistSlash */
     , (5705,  65,    0.65) /* ResistPierce */
     , (5705,  66,    0.65) /* ResistBludgeon */
     , (5705,  67,       0) /* ResistFire */
     , (5705,  68,     1.1) /* ResistCold */
     , (5705,  69,    0.65) /* ResistAcid */
     , (5705,  70,    0.65) /* ResistElectric */
...
VALUES (5705,  6, 0, 3, 0,  10, 0, 0) /* MeleeDefense        Specialized */
     , (5705,  7, 0, 3, 0,  25, 0, 0) /* MissileDefense      Specialized */
     , (5705, 14, 0, 3, 0,  20, 0, 0) /* ArcaneLore          Specialized */
     , (5705, 15, 0, 3, 0,  12, 0, 0) /* MagicDefense        Specialized */
     , (5705, 20, 0, 3, 0,  20, 0, 0) /* Deception           Specialized */
     , (5705, 24, 0, 3, 0,  50, 0, 0) /* Run                 Specialized */
     , (5705, 31, 0, 3, 0,  20, 0, 0) /* CreatureEnchantment Specialized */
     , (5705, 33, 0, 3, 0,  20, 0, 0) /* LifeMagic           Specialized */
     , (5705, 34, 0, 3, 0,  20, 0, 0) /* WarMagic            Specialized */
     , (5705, 45, 0, 3, 0,  20, 0, 0) /* LightWeapons        Specialized */;
