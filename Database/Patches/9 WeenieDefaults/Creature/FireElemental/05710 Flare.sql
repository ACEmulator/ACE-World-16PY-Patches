...
VALUES (5710, 'fireelementalflare', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (5710,   1,       5) /* HeartbeatInterval */
     ...
     , (5710,   3,     0.6) /* HealthRate */
     , (5710,   4,     0.5) /* StaminaRate */
     , (5710,   5,       2) /* ManaRate */
     , (5710,  13,    0.58) /* ArmorModVsSlash */
     , (5710,  14,    0.58) /* ArmorModVsPierce */
     , (5710,  15,    0.58) /* ArmorModVsBludgeon */
     , (5710,  16,       1) /* ArmorModVsCold */
     , (5710,  17,     100) /* ArmorModVsFire */
     , (5710,  18,    0.65) /* ArmorModVsAcid */
     , (5710,  19,    0.38) /* ArmorModVsElectric */
     , (5710,  31,      18) /* VisualAwarenessRange */
     , (5710,  39,       1) /* DefaultScale */
     , (5710,  64,    0.65) /* ResistSlash */
     , (5710,  65,    0.65) /* ResistPierce */
     , (5710,  66,    0.65) /* ResistBludgeon */
     , (5710,  67,       0) /* ResistFire */
     , (5710,  68,     1.1) /* ResistCold */
     , (5710,  69,    0.65) /* ResistAcid */
     , (5710,  70,    0.65) /* ResistElectric */
...
VALUES (5710,  0, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (5710,  1, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (5710,  2, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (5710,  3, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (5710,  4, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (5710,  5, 16,  8, 0.75,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (5710,  6, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (5710,  7, 16,  0,    0,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (5710,  8, 16,  8, 0.75,   90,   52,   52,   52,   90, 9000,   59,   34,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (5710,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (5710, 414) /* PLAYER_DEATH_EVENT */;
