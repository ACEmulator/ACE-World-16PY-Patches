...
VALUES (5712,   1,       5) /* HeartbeatInterval */
     ...
     , (5712,   3,     0.9) /* HealthRate */
     , (5712,   4,     0.5) /* StaminaRate */
     , (5712,   5,       2) /* ManaRate */
     , (5712,  13,    0.83) /* ArmorModVsSlash */
     , (5712,  14,    0.83) /* ArmorModVsPierce */
     , (5712,  15,    0.83) /* ArmorModVsBludgeon */
     , (5712,  16,       1) /* ArmorModVsCold */
     , (5712,  17,     100) /* ArmorModVsFire */
     , (5712,  18,    0.86) /* ArmorModVsAcid */
     , (5712,  19,    0.74) /* ArmorModVsElectric */
     , (5712,  31,      20) /* VisualAwarenessRange */
     , (5712,  39,     1.7) /* DefaultScale */
     , (5712,  41,     300) /* RegenerationInterval */
     , (5712,  43,      10) /* GeneratorRadius */
     , (5712,  64,    0.45) /* ResistSlash */
     , (5712,  65,    0.45) /* ResistPierce */
     , (5712,  66,    0.45) /* ResistBludgeon */
     , (5712,  67,       0) /* ResistFire */
     , (5712,  68,    0.65) /* ResistCold */
     , (5712,  69,     0.3) /* ResistAcid */
     , (5712,  70,     0.3) /* ResistElectric */
...
VALUES (5712,   1, 'Inferno') /* Name */
     , (5712,  45, 'KilltaskElemental_0609') /* KillQuest */;
...
VALUES (5712,   1, 0x020006A3) /* Setup */
     ...
     , (5712,  22, 0x34000075) /* PhysicsEffectTable */
     , (5712,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (5712, 2,  5709,  3, 0, 0, False) /* Create Ball of fire (5709) for Wield */
     ...
     , (5712, 9, 33959,  0, 0, 0.05, False) /* Create Crystal of Fiery Elemental Essence (33959) for ContainTreasure */
     , (5712, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */;
