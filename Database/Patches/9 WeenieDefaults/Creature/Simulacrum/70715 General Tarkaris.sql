...
VALUES (70715, 'ace70715-generaltarkaris', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (70715,   1,         16) /* ItemType - Creature */
     , (70715,   2,         59) /* CreatureType - Simulacrum */
     , (70715,   3,          3) /* PaletteTemplate - BluePurple */
     , (70715,   6,         -1) /* ItemsCapacity */
     , (70715,   7,         -1) /* ContainersCapacity */
...
VALUES (70715,   1, 0x02000001) /* Setup */
     , (70715,   2, 0x090000C5) /* MotionTable */
     , (70715,   3, 0x20000083) /* SoundTable */
     , (70715,   4, 0x30000000) /* CombatTable */
     , (70715,   7, 0x100006CA) /* ClothingBase */
     , (70715,   8, 0x06001036) /* Icon */
     , (70715,  22, 0x34000095) /* PhysicsEffectTable */;
...
VALUES (70715,  0,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (70715,  1,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (70715,  2,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (70715,  3,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (70715,  4,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (70715,  5,  4,  4, 0.75,  450,  675,  765,  675,  765,  360,  540,  765,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (70715,  6,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (70715,  7,  4,  0,    0,  450,  675,  765,  675,  765,  360,  540,  765,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (70715,  8,  4,  8, 0.75,  450,  675,  765,  675,  765,  360,  540,  765,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
