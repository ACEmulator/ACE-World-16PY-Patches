...
VALUES (45155, 'ace45155-pyrechampion', 10, '2024-10-29 16:22:18') /* Creature */;
...
VALUES (45155,   1, 'Pyre Champion') /* Name */
     ...
     , (45155,  49, 'KillTaskMGHPyreChampion') /* KillQuest2 */;
...
VALUES (45155,  6, 0, 3, 0, 450, 0, 0) /* MeleeDefense        Specialized */
     , (45155,  7, 0, 3, 0, 460, 0, 0) /* MissileDefense      Specialized */
     , (45155, 15, 0, 3, 0, 320, 0, 0) /* MagicDefense        Specialized */
     , (45155, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (45155, 33, 0, 3, 0, 210, 0, 0) /* LifeMagic           Specialized */
     , (45155, 34, 0, 3, 0, 210, 0, 0) /* WarMagic            Specialized */
     , (45155, 44, 0, 3, 0, 525, 0, 0) /* HeavyWeapons        Specialized */
     , (45155, 45, 0, 3, 0, 525, 0, 0) /* LightWeapons        Specialized */
     , (45155, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45155,  0,  4,  0,    0,  445,  311,  311,  293,  383,  383,  338,  338,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45155,  1,  4,  0,    0,  440,  311,  311,  293,  383,  383,  338,  338,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45155,  2,  4,  0,    0,  340,  311,  311,  293,  383,  383,  338,  338,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45155,  3,  4,  0,    0,  435,  311,  311,  293,  383,  383,  338,  338,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45155,  4,  4,  0,    0,  440,  311,  311,  293,  383,  383,  338,  338,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45155,  5,  4, 275, 0.75,  350,  311,  311,  293,  383,  383,  338,  338,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45155,  6,  4,  0,    0,  340,  311,  311,  293,  383,  383,  338,  338,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45155,  7,  4,  0,    0,  450,  311,  311,  293,  383,  383,  338,  338,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45155,  8,  4, 275, 0.75,  340,  311,  311,  293,  383,  383,  338,  338,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45155, 2, 35096,  1, 0, 0, False) /* Create Pyre Blade (35096) for Wield */
     ...
     , (45155, 9, 37260,  0, 0, 0.003, False) /* Create The Jester (37260) for ContainTreasure */
     , (45155, 9,     0,  0, 0, 0.919, False) /* Create nothing for ContainTreasure */
