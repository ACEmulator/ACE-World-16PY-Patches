...
VALUES (5683, 'skeletonseared', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (5683,   1,         16) /* ItemType - Creature */
     ...
     , (5683,  25,         20) /* Level */
     , (5683,  27,          0) /* ArmorType - None */
     , (5683,  40,          1) /* CombatMode - NonCombat */
     , (5683,  68,          5) /* TargetingTactic - Random, LastDamager */
     ...
     , (5683, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (5683,   1,       5) /* HeartbeatInterval */
     ...
     , (5683,   3,     0.1) /* HealthRate */
     , (5683,   4,     0.5) /* StaminaRate */
     , (5683,   5,       2) /* ManaRate */
     , (5683,  13,    0.37) /* ArmorModVsSlash */
     , (5683,  14,    0.16) /* ArmorModVsPierce */
     , (5683,  15,     0.5) /* ArmorModVsBludgeon */
     , (5683,  16,    0.05) /* ArmorModVsCold */
     , (5683,  17,    0.82) /* ArmorModVsFire */
     , (5683,  18,    0.17) /* ArmorModVsAcid */
     , (5683,  19,    0.33) /* ArmorModVsElectric */
     , (5683,  31,      24) /* VisualAwarenessRange */
     , (5683,  34,     1.1) /* PowerupTime */
     , (5683,  36,       1) /* ChargeSpeed */
     , (5683,  64,    0.58) /* ResistSlash */
     , (5683,  65,    0.25) /* ResistPierce */
     , (5683,  66,       1) /* ResistBludgeon */
     , (5683,  67,    0.75) /* ResistFire */
     , (5683,  68,     0.3) /* ResistCold */
     , (5683,  69,    0.42) /* ResistAcid */
     , (5683,  70,     0.4) /* ResistElectric */
...
VALUES (5683,   1, 0x02000059) /* Setup */
     ...
     , (5683,  35,        453) /* DeathTreasureType - Loot Tier: 1 */;
...
VALUES (5683,  6, 0, 3, 0,  60, 0, 436.077087402344) /* MeleeDefense        Specialized */
     ...
     , (5683, 44, 0, 3, 0, 120, 0, 436.077087402344) /* HeavyWeapons        Specialized */
     , (5683, 45, 0, 3, 0, 120, 0, 436.077087402344) /* LightWeapons        Specialized */
     , (5683, 46, 0, 3, 0, 120, 0, 436.077087402344) /* FinesseWeapons      Specialized */
     , (5683, 47, 0, 3, 0,  60, 0, 436.077087402344) /* MissileWeapons      Specialized */;
...
VALUES (5683,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (5683, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5683,  5 /* HeartBeat */,    0.8, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (5683, 9,  3687,  0, 0, 0.1, False) /* Create Skeleton's Skull (3687) for ContainTreasure */
     , (5683, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */;
