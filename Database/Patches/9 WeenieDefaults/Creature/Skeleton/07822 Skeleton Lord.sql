...
VALUES (7822, 'skeletonlord-melee', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (7822,   1,       5) /* HeartbeatInterval */
     ...
     , (7822,   3,     0.1) /* HealthRate */
     , (7822,   4,     0.5) /* StaminaRate */
     , (7822,   5,       2) /* ManaRate */
     , (7822,  13,    0.37) /* ArmorModVsSlash */
     , (7822,  14,    0.16) /* ArmorModVsPierce */
     , (7822,  15,     0.5) /* ArmorModVsBludgeon */
     , (7822,  16,    0.05) /* ArmorModVsCold */
     , (7822,  17,    0.82) /* ArmorModVsFire */
     , (7822,  18,    0.17) /* ArmorModVsAcid */
     , (7822,  19,    0.33) /* ArmorModVsElectric */
     , (7822,  31,      16) /* VisualAwarenessRange */
     , (7822,  34,       1) /* PowerupTime */
     , (7822,  36,       1) /* ChargeSpeed */
     , (7822,  64,    0.58) /* ResistSlash */
     , (7822,  65,    0.25) /* ResistPierce */
     , (7822,  66,       1) /* ResistBludgeon */
     , (7822,  67,     0.9) /* ResistFire */
     , (7822,  68,     0.3) /* ResistCold */
     , (7822,  69,    0.42) /* ResistAcid */
     , (7822,  70,     0.4) /* ResistElectric */
...
VALUES (7822,  6, 0, 3, 0,  50, 0, 0) /* MeleeDefense        Specialized */
     , (7822,  7, 0, 3, 0, 150, 0, 0) /* MissileDefense      Specialized */
     , (7822, 14, 0, 3, 0, 110, 0, 0) /* ArcaneLore          Specialized */
     , (7822, 15, 0, 3, 0, 100, 0, 0) /* MagicDefense        Specialized */
     , (7822, 20, 0, 2, 0, 120, 0, 0) /* Deception           Trained */
     , (7822, 44, 0, 3, 0, 100, 0, 0) /* HeavyWeapons        Specialized */
     , (7822, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */
     , (7822, 46, 0, 3, 0,  50, 0, 0) /* FinesseWeapons      Specialized */
     , (7822, 47, 0, 3, 0, 140, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7822,  0,  4,  0,    0,   90,   33,   14,   45,    5,   74,   15,   30,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (7822,  8,  4,  5, 0.75,   75,   28,   12,   38,    4,   61,   13,   25,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (7822,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7822, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7822,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7822,  5 /* HeartBeat */,    0.8, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7822,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
