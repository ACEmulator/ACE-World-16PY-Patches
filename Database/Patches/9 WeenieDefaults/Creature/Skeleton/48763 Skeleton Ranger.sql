...
VALUES (48763, 'ace48763-skeletonranger', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (48763,   1,       5) /* HeartbeatInterval */
     ...
     , (48763,   5,       2) /* ManaRate */
     , (48763,  12,       0) /* Shade */
     , (48763,  13,    0.69) /* ArmorModVsSlash */
     , (48763,  14,    0.69) /* ArmorModVsPierce */
     , (48763,  15,    0.65) /* ArmorModVsBludgeon */
     , (48763,  16,    0.85) /* ArmorModVsCold */
     , (48763,  17,    0.85) /* ArmorModVsFire */
     , (48763,  18,    0.75) /* ArmorModVsAcid */
     , (48763,  19,    0.75) /* ArmorModVsElectric */
     , (48763,  31,      25) /* VisualAwarenessRange */
     , (48763,  34,       1) /* PowerupTime */
     , (48763,  36,       1) /* ChargeSpeed */
     , (48763,  55,      75) /* HomeRadius */
     , (48763,  64,    0.58) /* ResistSlash */
     , (48763,  65,    0.58) /* ResistPierce */
     , (48763,  66,    0.66) /* ResistBludgeon */
     , (48763,  67,     0.3) /* ResistFire */
     ...
     , (48763,  80,       3) /* AiUseMagicDelay */
     , (48763, 104,      10) /* ObviousRadarRange */
     , (48763, 122,       2) /* AiAcquireHealth */
     , (48763, 125,       1) /* ResistHealthDrain */
     , (48763, 166,    0.82) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (48763,   1, 'Skeleton Ranger') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (48763,   1, 0x020016A6) /* Setup */
     , (48763,   2, 0x09000025) /* MotionTable */
     , (48763,   3, 0x2000001E) /* SoundTable */
     , (48763,   4, 0x30000000) /* CombatTable */
     , (48763,   6, 0x04001DEA) /* PaletteBase */
     , (48763,   7, 0x10000610) /* ClothingBase */
...
VALUES (48763,  0,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (48763,  1,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (48763,  2,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (48763,  3,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (48763,  4,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (48763,  5,  4, 75, 0.75,  280,  193,  193,  182,  238,  238,  210,  210,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (48763,  6,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (48763,  7,  4,  0,    0,  280,  193,  193,  182,  238,  238,  210,  210,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (48763,  8,  4, 75, 0.75,  280,  193,  193,  182,  238,  238,  210,  210,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (@parent_id,  0,   8 /* Say */, 0, 0, NULL, 'I will roast your carcass for this insolence!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
