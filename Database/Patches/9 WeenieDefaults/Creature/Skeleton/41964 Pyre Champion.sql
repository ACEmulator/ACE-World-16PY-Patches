...
VALUES (41964, 'ace41964-pyrechampion', 10, '2024-10-29 16:22:18') /* Creature */;
...
VALUES (41964,  6, 0, 3, 0, 450, 0, 0) /* MeleeDefense        Specialized */
     , (41964,  7, 0, 3, 0, 460, 0, 0) /* MissileDefense      Specialized */
     , (41964, 15, 0, 3, 0, 320, 0, 0) /* MagicDefense        Specialized */
     , (41964, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (41964, 33, 0, 3, 0, 210, 0, 0) /* LifeMagic           Specialized */
     , (41964, 34, 0, 3, 0, 210, 0, 0) /* WarMagic            Specialized */
     , (41964, 44, 0, 3, 0, 525, 0, 0) /* HeavyWeapons        Specialized */
     , (41964, 45, 0, 3, 0, 525, 0, 0) /* LightWeapons        Specialized */
     , (41964, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (41964,  0,  4,  0,    0,  445,  307,  307,  289,  378,  378,  334,  334,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41964,  1,  4,  0,    0,  440,  304,  304,  286,  374,  374,  330,  330,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41964,  2,  4,  0,    0,  340,  235,  235,  221,  289,  289,  255,  255,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41964,  3,  4,  0,    0,  435,  300,  300,  283,  370,  370,  326,  326,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41964,  4,  4,  0,    0,  440,  304,  304,  286,  374,  374,  330,  330,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41964,  5,  4, 275, 0.75,  350,  241,  241,  228,  298,  298,  263,  263,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41964,  6,  4,  0,    0,  340,  235,  235,  221,  289,  289,  255,  255,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41964,  7,  4,  0,    0,  450,  311,  311,  293,  383,  383,  338,  338,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41964,  8,  4, 275, 0.75,  340,  235,  235,  221,  289,  289,  255,  255,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41964, 2, 35096,  1, 0, 0, False) /* Create Pyre Blade (35096) for Wield */
     ...
     , (41964, 9, 37260,  0, 0, 0.003, False) /* Create The Jester (37260) for ContainTreasure */
     , (41964, 9,     0,  0, 0, 0.919, False) /* Create nothing for ContainTreasure */;
