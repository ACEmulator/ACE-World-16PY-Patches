...
VALUES (41963, 'ace41963-pyreskeleton', 10, '2025-08-05 05:31:31') /* Creature */;
...
VALUES (41963,   1, 0x020016A6) /* Setup */
     , (41963,   2, 0x09000025) /* MotionTable */
     , (41963,   3, 0x2000001E) /* SoundTable */
     , (41963,   4, 0x30000000) /* CombatTable */
     , (41963,   6, 0x04001DEA) /* PaletteBase */
     , (41963,   7, 0x10000610) /* ClothingBase */
     , (41963,   8, 0x060016C4) /* Icon */
     , (41963,  22, 0x34000025) /* PhysicsEffectTable */
     , (41963,  35,       2105) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (41963,  0,  4,  0,    0,  375,  259,  259,  244,  319,  319,  281,  281,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41963,  1,  4,  0,    0,  370,  255,  255,  241,  315,  315,  278,  278,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41963,  2,  4,  0,    0,  340,  235,  235,  221,  289,  289,  255,  255,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41963,  3,  4,  0,    0,  435,  300,  300,  283,  370,  370,  326,  326,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41963,  4,  4,  0,    0,  435,  300,  300,  283,  370,  370,  326,  326,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41963,  5,  4, 275, 0.75,  350,  241,  241,  228,  298,  298,  263,  263,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41963,  6,  4,  0,    0,  350,  241,  241,  228,  298,  298,  263,  263,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41963,  7,  4,  0,    0,  350,  241,  241,  228,  298,  298,  263,  263,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41963,  8,  4, 275, 0.75,  340,  235,  235,  221,  289,  289,  255,  255,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41963, 2, 35095,  1, 0, 0, False) /* Create Pyre Claw (35095) for Wield */
     , (41963, 9, 38714,  0, 0, 0.75, False) /* Create Pyre Skeleton Jaw (38714) for ContainTreasure */
     , (41963, 9,     0,  0, 0, 0.25, False) /* Create nothing for ContainTreasure */
     , (41963, 9, 35105,  1, 0, 0.5, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (41963, 9,     0,  0, 0, 0.5, False) /* Create nothing for ContainTreasure */
