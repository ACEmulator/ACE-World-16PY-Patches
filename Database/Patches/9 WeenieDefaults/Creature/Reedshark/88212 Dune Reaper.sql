...
VALUES (88212, 'ace88212-dunereaper', 10, '2023-05-15 03:25:02') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (88212,   1,         16) /* ItemType - Creature */
     , (88212,   2,         16) /* CreatureType - Reedshark */
     , (88212,   3,         44) /* PaletteTemplate - TanRed */
...
VALUES (88212,   1,       5) /* HeartbeatInterval */
     ...
     , (88212,  15,     0.7) /* ArmorModVsBludgeon */
     , (88212,  16,       1) /* ArmorModVsCold */
     , (88212,  17,    0.65) /* ArmorModVsFire */
     , (88212,  18,    0.65) /* ArmorModVsAcid */
     ...
     , (88212,  67,     0.6) /* ResistFire */
     , (88212,  68,     0.3) /* ResistCold */
     , (88212,  69,     0.5) /* ResistAcid */
...
VALUES (88212,   1, 250, 0, 0) /* Strength */
     , (88212,   2, 300, 0, 0) /* Endurance */
     , (88212,   3, 270, 0, 0) /* Quickness */
     , (88212,   4, 250, 0, 0) /* Coordination */
     , (88212,   5, 210, 0, 0) /* Focus */
     , (88212,   6, 190, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (88212,   1,  2500, 0, 0, 2650) /* MaxHealth */
     , (88212,   3,  3000, 0, 0, 3300) /* MaxStamina */
     , (88212,   5,   500, 0, 0, 690) /* MaxMana */;
...
VALUES (88212,  0,  2, 600, 0.75,  500,  300,  250,  350,  500,  325,  325,  500,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (88212, 10,  2, 600,  0.5,  500,  300,  250,  350,  500,  325,  325,  500,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (88212, 13,  2, 600,  0.5,  500,  300,  250,  350,  500,  325,  325,  500,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (88212, 16,  4, 600,    0,  500,  300,  250,  350,  500,  325,  325,  500,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;
