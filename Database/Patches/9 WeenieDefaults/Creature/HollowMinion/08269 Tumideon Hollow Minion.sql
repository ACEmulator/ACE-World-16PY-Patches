...
VALUES (8269, 'hollowminiontumideon', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (8269,   1,       5) /* HeartbeatInterval */
     ...
     , (8269,   3,     0.7) /* HealthRate */
     , (8269,   4,     0.5) /* StaminaRate */
     , (8269,   5,       2) /* ManaRate */
     , (8269,  12,     0.5) /* Shade */
     , (8269,  13,    0.76) /* ArmorModVsSlash */
     , (8269,  14,    0.76) /* ArmorModVsPierce */
     , (8269,  15,    0.68) /* ArmorModVsBludgeon */
     , (8269,  16,    0.84) /* ArmorModVsCold */
     , (8269,  17,    0.64) /* ArmorModVsFire */
     , (8269,  18,    0.76) /* ArmorModVsAcid */
     , (8269,  19,    0.64) /* ArmorModVsElectric */
     , (8269,  31,      12) /* VisualAwarenessRange */
     , (8269,  34,       1) /* PowerupTime */
     , (8269,  36,       1) /* ChargeSpeed */
     , (8269,  64,     0.5) /* ResistSlash */
     , (8269,  65,     0.5) /* ResistPierce */
     , (8269,  66,    0.33) /* ResistBludgeon */
     , (8269,  67,    0.25) /* ResistFire */
     , (8269,  68,    0.67) /* ResistCold */
...
VALUES (8269,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8269, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8269,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8269,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
