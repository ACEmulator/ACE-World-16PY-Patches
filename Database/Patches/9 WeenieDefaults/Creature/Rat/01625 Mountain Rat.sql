...
VALUES (1625, 'ratmountain', 10, '2022-08-22 03:09:27') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1625,   1,         16) /* ItemType - Creature */
     , (1625,   2,         10) /* CreatureType - Rat */
     , (1625,   3,         51) /* PaletteTemplate - MidGrey */
...
VALUES (1625,   1,       5) /* HeartbeatInterval */
     ...
     , (1625,   3,     0.3) /* HealthRate */
     , (1625,   4,       5) /* StaminaRate */
     , (1625,   5,       2) /* ManaRate */
     , (1625,  12,     0.5) /* Shade */
     , (1625,  13,    0.18) /* ArmorModVsSlash */
     , (1625,  14,    0.38) /* ArmorModVsPierce */
     , (1625,  15,     0.8) /* ArmorModVsBludgeon */
     , (1625,  16,    0.38) /* ArmorModVsCold */
     , (1625,  17,    0.55) /* ArmorModVsFire */
     , (1625,  18,     0.8) /* ArmorModVsAcid */
     , (1625,  19,     0.8) /* ArmorModVsElectric */
     , (1625,  31,      25) /* VisualAwarenessRange */
     , (1625,  34,       2) /* PowerupTime */
     , (1625,  36,       1) /* ChargeSpeed */
     , (1625,  39,       3) /* DefaultScale */
     , (1625,  64,     0.8) /* ResistSlash */
     , (1625,  65,    0.85) /* ResistPierce */
     , (1625,  66,       1) /* ResistBludgeon */
     , (1625,  67,    0.85) /* ResistFire */
     , (1625,  68,    0.85) /* ResistCold */
...
VALUES (1625,   1, 0x0200003D) /* Setup */
     , (1625,   2, 0x0900000E) /* MotionTable */
     , (1625,   3, 0x2000000F) /* SoundTable */
     , (1625,   4, 0x30000013) /* CombatTable */
     , (1625,   6, 0x040001B4) /* PaletteBase */
     , (1625,   7, 0x10000063) /* ClothingBase */
     , (1625,   8, 0x0600103B) /* Icon */
     , (1625,  19, 0x00000054) /* ActivationAnimation */
     , (1625,  22, 0x34000023) /* PhysicsEffectTable */
...
VALUES (1625,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1625, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,  0.175, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1625,  5 /* HeartBeat */,  0.175, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
