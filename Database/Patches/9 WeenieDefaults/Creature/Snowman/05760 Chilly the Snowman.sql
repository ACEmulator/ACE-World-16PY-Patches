...
VALUES (5760, 'snowmanfrosty', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (5760,   1,       5) /* HeartbeatInterval */
     ...
     , (5760,   3,     0.6) /* HealthRate */
     , (5760,   4,       3) /* StaminaRate */
     , (5760,   5,       1) /* ManaRate */
     , (5760,  13,       1) /* ArmorModVsSlash */
     , (5760,  14,     1.4) /* ArmorModVsPierce */
     , (5760,  15,       1) /* ArmorModVsBludgeon */
     , (5760,  16,     0.1) /* ArmorModVsCold */
     , (5760,  17,     0.3) /* ArmorModVsFire */
...
VALUES (5760,  6, 0, 3, 0,  36, 0, 0) /* MeleeDefense        Specialized */
     , (5760,  7, 0, 3, 0,  32, 0, 0) /* MissileDefense      Specialized */
     , (5760, 14, 0, 3, 0,  80, 0, 0) /* ArcaneLore          Specialized */
     , (5760, 15, 0, 3, 0,  10, 0, 0) /* MagicDefense        Specialized */
     , (5760, 20, 0, 3, 0,   1, 0, 0) /* Deception           Specialized */
     , (5760, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (5760, 31, 0, 3, 0,  30, 0, 0) /* CreatureEnchantment Specialized */
     , (5760, 33, 0, 3, 0,  30, 0, 0) /* LifeMagic           Specialized */
     , (5760, 34, 0, 3, 0,  30, 0, 0) /* WarMagic            Specialized */
     , (5760, 45, 0, 3, 0,  50, 0, 0) /* LightWeapons        Specialized */
     , (5760, 47, 0, 3, 0,   0, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (5760,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5760,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5760,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5760,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5760,  5 /* HeartBeat */,  0.031, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);

SET @parent_id = LAST_INSERT_ID();

INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id,  0,   8 /* Say */, 0, 0, NULL, 'Happy Birthday!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0x00000000, 0, 0, 0, 0, 0, 0, 0);
