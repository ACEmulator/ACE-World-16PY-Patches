...
VALUES (46144, 'ace46144-penguinguardian', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (46144,   1, 0x02001252) /* Setup */
     ...
     , (46144,   4, 0x30000040) /* CombatTable */
     , (46144,   6, 0x04001D43) /* PaletteBase */
     , (46144,   7, 0x100005D1) /* ClothingBase */
...
VALUES (46144,  6, 0, 3, 0, 135, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (46144, 45, 0, 3, 0,  85, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (46144,  0,  2, 175,  0.6,  600,  780,  600,  660,  480,  480,  600,  480,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46144,  1,  4, 175,  0.3,  600,  780,  600,  660,  480,  480,  600,  480,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46144,  2,  4, 175,  0.4,  600,  780,  600,  660,  480,  480,  600,  480,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46144,  3,  4, 175,  0.3,  600,  780,  600,  660,  480,  480,  600,  480,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46144,  4,  4, 175,  0.4,  600,  780,  600,  660,  480,  480,  600,  480,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46144,  5,  4, 190,  0.4,  600,  780,  600,  660,  480,  480,  600,  480,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46144,  6,  4, 175,  0.3,  600,  780,  600,  660,  480,  480,  600,  480,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46144,  7,  4, 175,  0.4,  600,  780,  600,  660,  480,  480,  600,  480,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46144,  8,  4, 180,  0.4,  600,  780,  600,  660,  480,  480,  600,  480,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
     , (46144, 22, 32, 175,  0.3,  600,  780,  600,  660,  480,  480,  600,  480,    0, 0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Breath */;
...
VALUES (46144,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46144,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46144,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
