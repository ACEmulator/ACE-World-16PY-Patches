...
VALUES (28665, 'penguinrebellious', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (28665,   1, 0x02001252) /* Setup */
     ...
     , (28665,   4, 0x30000040) /* CombatTable */
     , (28665,   6, 0x0400197C) /* PaletteBase */
     , (28665,   7, 0x10000599) /* ClothingBase */
...
VALUES (28665,  0,  2, 10,  0.6,  115,  150,  115,  127,  113,   92,  115,  113,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28665,  1,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28665,  2,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28665,  3,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28665,  4,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28665,  5,  4, 10,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28665,  6,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28665,  7,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28665,  8,  4, 10,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (28665,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28665,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
