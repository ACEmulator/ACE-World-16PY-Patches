...
VALUES (28658, 'penguinsycophantic', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (28658,   1, 0x02001252) /* Setup */
     ...
     , (28658,   4, 0x30000040) /* CombatTable */
     , (28658,   6, 0x0400197C) /* PaletteBase */
     , (28658,   7, 0x10000599) /* ClothingBase */
...
VALUES (28658,  0,  2, 12,  0.6,  115,  150,  115,  127,  113,   92,  115,  113,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28658,  1,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28658,  2,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28658,  3,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28658,  4,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28658,  5,  4, 13,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28658,  6,  4, 100,  0.3,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28658,  7,  4, 100,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28658,  8,  4, 12,  0.4,  115,  150,  115,  127,  113,   92,  115,  113,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (28658,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (28658, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28658,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28658,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28658,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
