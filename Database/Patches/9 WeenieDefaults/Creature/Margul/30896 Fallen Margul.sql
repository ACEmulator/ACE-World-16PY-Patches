...
VALUES (30896, 'margulbossuber0205', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (30896,   1,       5) /* HeartbeatInterval */
     ...
     , (30896,   5,       1) /* ManaRate */
     , (30896,  12,     0.5) /* Shade */
     , (30896,  13,    1.05) /* ArmorModVsSlash */
     , (30896,  14,       1) /* ArmorModVsPierce */
     , (30896,  15,    0.95) /* ArmorModVsBludgeon */
     , (30896,  16,    0.95) /* ArmorModVsCold */
     , (30896,  17,     1.2) /* ArmorModVsFire */
     , (30896,  18,     1.2) /* ArmorModVsAcid */
     , (30896,  19,    0.95) /* ArmorModVsElectric */
     , (30896,  31,      24) /* VisualAwarenessRange */
     , (30896,  34,       1) /* PowerupTime */
     , (30896,  36,       1) /* ChargeSpeed */
     , (30896,  39,     0.6) /* DefaultScale */
     , (30896,  64,    0.85) /* ResistSlash */
     , (30896,  65,    0.85) /* ResistPierce */
     , (30896,  66,    0.95) /* ResistBludgeon */
     , (30896,  67,    0.75) /* ResistFire */
     , (30896,  68,    0.95) /* ResistCold */
     , (30896,  69,    0.75) /* ResistAcid */
     , (30896,  70,    0.95) /* ResistElectric */
...
VALUES (30896,   1, 'Fallen Margul') /* Name */
     , (30896,  45, 'KilltaskFallenCreature_0609') /* KillQuest */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (30896,   1, 0x0200101A) /* Setup */
     , (30896,   2, 0x0900013F) /* MotionTable */
     , (30896,   3, 0x200000A8) /* SoundTable */
     , (30896,   4, 0x3000003A) /* CombatTable */
     , (30896,   6, 0x040016E8) /* PaletteBase */
     , (30896,   7, 0x100004FD) /* ClothingBase */
     , (30896,   8, 0x0600304D) /* Icon */
     , (30896,  19, 0x00000055) /* ActivationAnimation */
     , (30896,  22, 0x340000A9) /* PhysicsEffectTable */
...
VALUES (30896,  0,  2, 165, 0.75,  650,  683,  650,  618,  618,  780,  780,  618,    0, 1,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (30896, 10,  1, 165, 0.75,  650,  683,  650,  618,  618,  780,  780,  618,    0, 3,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (30896, 13,  1, 165, 0.75,  650,  683,  650,  618,  618,  780,  780,  618,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (30896, 16,  4,  0,    0,  650,  683,  650,  618,  618,  780,  780,  618,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30896,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30896,  5 /* HeartBeat */,  0.055, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30896,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30896,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30896,  5 /* HeartBeat */,  0.055, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (30896, 9, 30873,  0, 0, 1, False) /* Create Spear of the Fallen (30873) for ContainTreasure */
     , (30896, 9, 30857,  0, 0, 1, False) /* Create Sezzherei's Lair (30857) for ContainTreasure */;
