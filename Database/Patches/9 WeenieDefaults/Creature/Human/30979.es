		...
		QuestFailure:
			- InqQuest: ThrungusChipsDone
				QuestSuccess: 
					...
					- StampQuest: DeathAllureCD
					- Goto: Reward
				QuestFailure:
					- InqQuest: DeathAllureStarted
						QuestSuccess:
						...
						QuestFailure:
							...
							- Delay: 1, Tell: Seek me out if you should need more of these.
							- StampQuest: DeathAllureStarted
...
GotoSet: Reward, Probability: 0.25
	- Give: Grand Casino Key (38992)
	- Goto: Cleanup

GotoSet: Reward, Probability: 0.5
	- Give: Writ of Refuge (11710)
	- Goto: Cleanup

GotoSet: Reward, Probability: 0.75
...
GotoSet: Cleanup
	- EraseQuest: ThrungusChipsDone
	- EraseQuest: DeathAllureStarted
