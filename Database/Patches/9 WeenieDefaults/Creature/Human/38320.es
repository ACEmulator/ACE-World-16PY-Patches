Use:
    - TurnToTarget
    - InqQuest: EnlightenedEldrytchWebMaster
        QuestSuccess:
            - Tell: Welcome back, Master and comrade in arms.
            - SetIntStat: SocietyRankEldweb, 1001
            - EraseQuest: EnlightenedEldrytchWebMaster
        QuestFailure:
                ...
                TestFailure:
                    - InqIntStat: SocietyRankEldweb, 998 - 1000
                        TestSuccess:
                            ...
                            - Give: Eldrytch Web Trade Token (38237), 10
                        ...
                        TestFailure:
                            - InqIntStat: SocietyRankEldweb, 601 - 997
                                TestSuccess:
                                    - Tell: Greetings, Lord.
                                TestFailure:
                                    - InqIntStat: SocietyRankEldweb, 598 - 600
                                        ...
                                        TestFailure:
                                            - InqIntStat: SocietyRankEldweb, 301 - 597
                                                TestSuccess:
                                                ...
                                                TestFailure:
                                                    - InqIntStat: SocietyRankEldweb, 298 - 300
                                                        ...
                                                        TestFailure:
                                                            - InqIntStat: SocietyRankEldweb, 101 - 297
                                                                TestSuccess:
                                                                ...
                                                                TestFailure:
                                                                    - InqIntStat: SocietyRankEldweb, 98 - 100
                                                                        ...
                                                                        TestFailure:
                                                                            - InqIntStat: SocietyRankEldweb, 1 - 97
                                                                                TestSuccess:
