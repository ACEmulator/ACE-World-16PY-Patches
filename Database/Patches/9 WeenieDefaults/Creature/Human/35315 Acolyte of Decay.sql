...
VALUES (35315, 'ace35315-acolyteofdecay', 10, '2021-11-08 06:01:47') /* Creature */;
...
VALUES (35315,  6, 0, 3, 0, 251, 0, 0) /* MeleeDefense        Specialized */
     , (35315,  7, 0, 3, 0, 189, 0, 0) /* MissileDefense      Specialized */
     , (35315, 15, 0, 3, 0, 167, 0, 0) /* MagicDefense        Specialized */
     , (35315, 24, 0, 3, 0,  20, 0, 0) /* Run                 Specialized */
     , (35315, 33, 0, 3, 0, 200, 0, 0) /* LifeMagic           Specialized */
     , (35315, 34, 0, 3, 0, 200, 0, 0) /* WarMagic            Specialized */
     , (35315, 45, 0, 3, 0, 267, 0, 0) /* LightWeapons        Specialized */
     , (35315, 47, 0, 3, 0, 233, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (35315,  0,  4,  0,    0,  215,  203,  203,  203,   90,   90,  205,   90,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35315,  1,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35315,  2,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (35315,  3,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35315,  4,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (35315,  5,  4,  4, 0.75,  255,  239,  239,  239,  106,  106,  239,   80,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35315,  6,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (35315,  7,  4,  0,    0,  255,  239,  239,  239,  106,  106,  239,   80,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (35315,  8,  4,  8, 0.75,  255,  239,  239,  239,  106,  106,  239,   80,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (35315,    97,   2.02)  /* Whirling Blade VI */
     , (35315,   234,   2.02)  /* Vulnerability Other VI */
     , (35315,   285,   2.02)  /* Magic Yield Other VI */
     , (35315,  1327,   2.02)  /* Imperil Other VI */;
