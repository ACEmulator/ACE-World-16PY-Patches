...
VALUES (35125, 'ace35125-disgracednanjoushoujen', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (35125,   1,         16) /* ItemType - Creature */
     , (35125,   2,         31) /* CreatureType - Human */
     , (35125,   3,          9) /* PaletteTemplate - Grey */
...
VALUES (35125,   1, 0x02000001) /* Setup */
     ...
     , (35125,   4, 0x30000000) /* CombatTable */
     , (35125,   6, 0x0400007E) /* PaletteBase */
     , (35125,   7, 0x100006C7) /* ClothingBase */
...
VALUES (35125,  6, 0, 3, 0, 325, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (35125, 11, 0, 3, 0, 340, 0, 0) /* Sword               Specialized */
...
VALUES (35125,  0,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35125,  1,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35125,  2,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (35125,  3,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35125,  4,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (35125,  5,  4,  4, 0.75,  250,  225,  225,  225,  225,  100,   75,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35125,  6,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (35125,  7,  4,  0,    0,  250,  225,  225,  225,  225,  100,   75,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (35125,  8,  4,  8, 0.75,  250,  225,  225,  225,  225,  100,   75,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
