...
HeartBeat: Style: NonCombat, Substyle: Ready, Probability: 0.001
    - Say: Despite our disaster I am still accepting items. Have you a drudge charm, swamp stone, rat tail, or such? I'll pay you good money or items if you give them to me.

HeartBeat: Style: NonCombat, Substyle: Ready, Probability: 0.002
    - Say: Did you know there are other people who collect other items, like gromnie teeth?  You might find them in towns that have not been destroyed!
...
HeartBeat: Style: NonCombat, Substyle: Ready, Probability: 0.004
    - Say: I'm particularly interested in the spine of the sandy armoredillo.  I may be able to use that to make my own tent! Get that to me and I'll give you a health potion.  I'll also pay the same for swamp stones and the scalps of banderlings.
...
Use:
    ...
    - Delay: 1, Tell: Disaster may have befallen us but I am still interested in monster trophies from common rats,  red phyntos wasps, armoredillos, drudges, mosswarts and banderlings. If you give me such an item, I will reward you with money or an item. With regret, I don't deal in hides.
