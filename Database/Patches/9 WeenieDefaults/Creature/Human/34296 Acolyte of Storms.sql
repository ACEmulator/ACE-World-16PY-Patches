...
VALUES (34296, 'ace34296-acolyteofstorms', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (34296,  6, 0, 3, 0, 260, 0, 0) /* MeleeDefense        Specialized */
     , (34296,  7, 0, 3, 0, 194, 0, 0) /* MissileDefense      Specialized */
     , (34296, 15, 0, 3, 0, 179, 0, 0) /* MagicDefense        Specialized */
     , (34296, 24, 0, 3, 0,  20, 0, 0) /* Run                 Specialized */
     , (34296, 33, 0, 3, 0, 180, 0, 0) /* LifeMagic           Specialized */
     , (34296, 34, 0, 3, 0, 180, 0, 0) /* WarMagic            Specialized */
     , (34296, 44, 0, 3, 0, 297, 0, 0) /* HeavyWeapons        Specialized */
     , (34296, 45, 0, 3, 0, 297, 0, 0) /* LightWeapons        Specialized */
     , (34296, 47, 0, 3, 0, 225, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (34296,  0,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34296,  1,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34296,  2,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34296,  3,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34296,  4,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34296,  5,  4,  4, 0.75,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34296,  6,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34296,  7,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34296,  8,  4,  8, 0.75,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
