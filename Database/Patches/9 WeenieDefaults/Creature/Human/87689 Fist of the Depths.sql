...
VALUES (87689, 'ace87689-fistofthedepths', 10, '2021-10-25 21:27:28') /* Creature */;
...
VALUES (87689,  6, 0, 3, 0, 260, 0, 0) /* MeleeDefense        Specialized */
     , (87689,  7, 0, 3, 0, 199, 0, 0) /* MissileDefense      Specialized */
     , (87689, 15, 0, 3, 0, 163, 0, 0) /* MagicDefense        Specialized */
     , (87689, 24, 0, 3, 0,  20, 0, 0) /* Run                 Specialized */
     , (87689, 33, 0, 3, 0, 175, 0, 0) /* LifeMagic           Specialized */
     , (87689, 34, 0, 3, 0, 175, 0, 0) /* WarMagic            Specialized */
     , (87689, 45, 0, 3, 0, 293, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (87689,  0,  4,  0,    0,  215,  203,  203,  203,   90,   90,   90,   90,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87689,  1,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87689,  2,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87689,  3,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87689,  4,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87689,  5,  4,  4, 0.75,  255,  239,  239,  239,  239,  126,   80,  239,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87689,  6,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87689,  7,  4,  0,    0,  255,  239,  239,  239,  239,  126,   80,  239,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87689,  8,  4,  8, 0.75,  255,  239,  239,  239,  239,  126,   80,  239,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (87689,    97,   2.01)  /* Whirling Blade VI */
     , (87689,   234,   2.01)  /* Vulnerability Other VI */
     , (87689,   285,   2.01)  /* Magic Yield Other VI */
     , (87689,  1327,   2.01)  /* Imperil Other VI */;
