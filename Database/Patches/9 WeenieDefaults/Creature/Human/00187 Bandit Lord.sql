...
VALUES (187, 'banditlord', 10, '2005-02-09 10:00:00') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (187,   1,         16) /* ItemType - Creature */
     , (187,   2,         31) /* CreatureType - Human */
     , (187,   6,         -1) /* ItemsCapacity */
     , (187,   7,         -1) /* ContainersCapacity */
     , (187,   8,        120) /* Mass */
     , (187,  16,          1) /* ItemUseable - No */
     , (187,  25,        110) /* Level */
     , (187,  27,          0) /* ArmorType - None */
     , (187,  68,         13) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (187,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (187, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
     , (187, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (187, 146,      21490) /* XpOverride */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (187,   1, True ) /* Stuck */
     , (187,  11, False) /* IgnoreCollisions */
     , (187,  12, True ) /* ReportCollisions */
     , (187,  13, False) /* Ethereal */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (187,   1,       5) /* HeartbeatInterval */
     , (187,   2,       0) /* HeartbeatTimestamp */
     , (187,   3,    0.16) /* HealthRate */
     , (187,   4,       5) /* StaminaRate */
     , (187,   5,       1) /* ManaRate */
     , (187,  13,     0.9) /* ArmorModVsSlash */
     , (187,  14,       1) /* ArmorModVsPierce */
     , (187,  15,     1.1) /* ArmorModVsBludgeon */
     , (187,  16,     0.4) /* ArmorModVsCold */
     , (187,  17,     0.4) /* ArmorModVsFire */
     , (187,  18,       1) /* ArmorModVsAcid */
     , (187,  19,     0.6) /* ArmorModVsElectric */
     , (187,  31,      30) /* VisualAwarenessRange */
     , (187,  64,    0.35) /* ResistSlash */
     , (187,  65,    0.35) /* ResistPierce */
     , (187,  66,    0.35) /* ResistBludgeon */
     , (187,  67,    0.35) /* ResistFire */
     , (187,  68,    0.35) /* ResistCold */
     , (187,  69,    0.35) /* ResistAcid */
     , (187,  70,    0.35) /* ResistElectric */
     , (187,  71,       1) /* ResistHealthBoost */
     , (187,  72,       1) /* ResistStaminaDrain */
     , (187,  73,       1) /* ResistStaminaBoost */
     , (187,  74,       1) /* ResistManaDrain */
     , (187,  75,       1) /* ResistManaBoost */
     , (187, 104,      10) /* ObviousRadarRange */
     , (187, 117,     0.5) /* FocusedProbability */
     , (187, 125,       1) /* ResistHealthDrain */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (187,   1, 'Bandit Lord') /* Name */
     , (187,   3, 'Male') /* Sex */
     , (187,   4, 'Aluvian') /* HeritageGroup */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (187,   1, 0x02000001) /* Setup */
     , (187,   2, 0x09000001) /* MotionTable */
     , (187,   3, 0x20000001) /* SoundTable */
     , (187,   4, 0x30000000) /* CombatTable */
     , (187,   8, 0x06001036) /* Icon */
     , (187,  22, 0x34000004) /* PhysicsEffectTable */
     , (187,  32,        429) /* WieldedTreasureType - 
                                   # Set: 1
                                   ...
                                   # Set: 3
                                   |  33.00% chance of Celdon Breastplate (6044) | Palette: Red (14)
                                   |  34.00% chance of Celdon Breastplate (6044) | Palette: Green (8)
                                   |  33.00% chance of Celdon Breastplate (6044) | Palette: Blue (2)
                                   # Set: 4
                                   |  33.00% chance of Celdon Girth (6043) | Palette: Red (14)
                                   |  34.00% chance of Celdon Girth (6043) | Palette: Green (8)
                                   |  33.00% chance of Celdon Girth (6043) | Palette: Blue (2)
                                   # Set: 5
                                   |  33.00% chance of Celdon Sleeves (6048) | Palette: Red (14)
                                   |  34.00% chance of Celdon Sleeves (6048) | Palette: Green (8)
                                   |  33.00% chance of Celdon Sleeves (6048) | Palette: Blue (2)
                                   # Set: 6
                                   |  33.00% chance of Celdon Leggings (6045) | Palette: Red (14)
                                   |  34.00% chance of Celdon Leggings (6045) | Palette: Green (8)
                                   |  33.00% chance of Celdon Leggings (6045) | Palette: Blue (2)
                                   # Set: 7
                                   |  33.00% chance of Sollerets (107) | Palette: Red (14)
                                   |  34.00% chance of Sollerets (107) | Palette: Green (8)
                                   |  33.00% chance of Sollerets (107) | Palette: Blue (2)
                                   # Set: 8
                                   |  33.00% chance of Covenant Helm (21156) | Palette: Red (14)
                                   |  34.00% chance of Covenant Helm (21156) | Palette: Green (8)
                                   |  33.00% chance of Covenant Helm (21156) | Palette: Blue (2)
                                   # Set: 9
                                   |  33.00% chance of Covenant Gauntlets (21153) | Palette: Red (14)
                                   |  34.00% chance of Covenant Gauntlets (21153) | Palette: Green (8)
                                   |  33.00% chance of Covenant Gauntlets (21153) | Palette: Blue (2)
                                   # Set: 10
                                   |   5.00% chance of Heavy Crossbow (23665)
                                   |         with
                                   ...
                                   |  25.00% chance of Yaoji (23710)
                                   |  25.00% chance of Fire Tachi (23707)
                                   |  25.00% chance of Tachi (23700)
                                   |   5.00% chance of Overlord's Sword (4912)
                                   # Set: 11
                                   | 100.00% chance of Shield of the Simulacra (12155) */
     , (187,  35,        448) /* DeathTreasureType - Loot Tier: 4 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (187,   1, 220, 0, 0) /* Strength */
     , (187,   2, 200, 0, 0) /* Endurance */
     , (187,   3, 200, 0, 0) /* Quickness */
     , (187,   4, 220, 0, 0) /* Coordination */
     , (187,   5,  60, 0, 0) /* Focus */
     , (187,   6,  60, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (187,   1,   110, 0, 0, 210) /* MaxHealth */
     , (187,   3,   120, 0, 0, 320) /* MaxStamina */
     , (187,   5,     0, 0, 0, 60) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (187,  3, 0, 3, 0, 130, 0, 269.35957332316735) /* Crossbow            Specialized */
     , (187,  6, 0, 3, 0, 270, 0, 269.35957332316735) /* MeleeDefense        Specialized */
     , (187,  7, 0, 3, 0, 350, 0, 269.35957332316735) /* MissileDefense      Specialized */
     , (187, 11, 0, 3, 0, 225, 0, 269.35957332316735) /* Sword               Specialized */
     , (187, 14, 0, 3, 0, 250, 0, 269.35957332316735) /* ArcaneLore          Specialized */
     , (187, 15, 0, 3, 0, 285, 0, 269.35957332316735) /* MagicDefense        Specialized */;
...
VALUES (187,  0,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (187,  3,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (187,  4,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (187,  5,  4,  2, 0.75,  225,  203,  225,  248,   90,   90,  225,  135,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (187,  6,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (187,  7,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (187,  8,  4,  2, 0.75,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (187,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (187, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (187, 9, 40522,  0, 0, 0.01, False) /* Create Contact Instructions (40522) for ContainTreasure */
     , (187, 9, 40523,  0, 0, 0.01, False) /* Create Contact Instructions (40523) for ContainTreasure */
     , (187, 9, 40524,  0, 0, 0.01, False) /* Create Contact Instructions (40524) for ContainTreasure */
     , (187, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */;
