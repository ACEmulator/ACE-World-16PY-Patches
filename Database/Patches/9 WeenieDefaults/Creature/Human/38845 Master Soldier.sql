...
VALUES (38845, 'ace38845-mastersoldier', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (38845,   1,       5) /* HeartbeatInterval */
     ...
     , (38845,  66,     0.6) /* ResistBludgeon */
     , (38845,  67,     0.4) /* ResistFire */
     , (38845,  68,     0.7) /* ResistCold */
     , (38845,  69,     0.4) /* ResistAcid */
     , (38845,  70,     0.7) /* ResistElectric */
...
VALUES (38845,   1, 0x02000001) /* Setup */
     ...
     , (38845,   4, 0x30000000) /* CombatTable */
     , (38845,   7, 0x10000756) /* ClothingBase */
...
VALUES (38845,  6, 0, 2, 0, 360, 0, 0) /* MeleeDefense        Trained */
     , (38845,  7, 0, 2, 0, 380, 0, 0) /* MissileDefense      Trained */
     , (38845, 15, 0, 2, 0, 350, 0, 0) /* MagicDefense        Trained */
     , (38845, 16, 0, 2, 0, 240, 0, 0) /* ManaConversion      Trained */
     , (38845, 31, 0, 2, 0, 240, 0, 0) /* CreatureEnchantment Trained */
     , (38845, 33, 0, 2, 0, 270, 0, 0) /* LifeMagic           Trained */
     , (38845, 34, 0, 2, 0, 270, 0, 0) /* WarMagic            Trained */
     , (38845, 41, 0, 2, 0, 483, 0, 0) /* TwoHandedCombat     Trained */
     , (38845, 43, 0, 2, 0, 270, 0, 0) /* VoidMagic           Trained */
     , (38845, 44, 0, 2, 0, 483, 0, 0) /* HeavyWeapons        Trained */
     , (38845, 45, 0, 2, 0, 483, 0, 0) /* LightWeapons        Trained */
     , (38845, 46, 0, 2, 0, 483, 0, 0) /* FinesseWeapons      Trained */
     , (38845, 47, 0, 3, 0, 380, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (38845,  0,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38845,  1,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38845,  2,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38845,  3,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38845,  4,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38845,  5,  4, 120, 0.75,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38845,  6,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38845,  7,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38845,  8,  4, 120, 0.75,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
