...
VALUES (35666, 'ace35666-mastersacolyte', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (35666,   1,         16) /* ItemType - Creature */
     , (35666,   2,         31) /* CreatureType - Human */
     , (35666,   3,          9) /* PaletteTemplate - Grey */
...
VALUES (35666,   1,       5) /* HeartbeatInterval */
     ...
     , (35666,  17,     0.6) /* ArmorModVsFire */
     , (35666,  18,     0.6) /* ArmorModVsAcid */
     , (35666,  19,     0.6) /* ArmorModVsElectric */
     , (35666,  31,      22) /* VisualAwarenessRange */
     , (35666,  39,       1) /* DefaultScale */
     , (35666,  64,     0.5) /* ResistSlash */
     , (35666,  65,     0.5) /* ResistPierce */
     , (35666,  66,     0.5) /* ResistBludgeon */
     , (35666,  67,     0.8) /* ResistFire */
     , (35666,  68,     0.5) /* ResistCold */
     , (35666,  69,     0.8) /* ResistAcid */
...
VALUES (35666,   1, 0x02000001) /* Setup */
     ...
     , (35666,   4, 0x30000000) /* CombatTable */
     , (35666,   6, 0x0400007E) /* PaletteBase */
     , (35666,   7, 0x100006C7) /* ClothingBase */
...
VALUES (35666,  6, 0, 3, 0, 325, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (35666, 11, 0, 3, 0, 340, 0, 0) /* Sword               Specialized */
     , (35666, 15, 0, 3, 0, 275, 0, 0) /* MagicDefense        Specialized */
...
VALUES (35666,  0,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35666,  1,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35666,  2,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (35666,  3,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35666,  4,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (35666,  5,  4,  4, 0.75,  350,  315,  315,  315,  315,  210,  210,  210,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35666,  6,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (35666,  7,  4,  0,    0,  350,  315,  315,  315,  315,  210,  210,  210,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (35666,  8,  4,  8, 0.75,  350,  315,  315,  315,  315,  210,  210,  210,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
