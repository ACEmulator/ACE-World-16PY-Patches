...
VALUES (1210, 'mercenary', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (1210,   1,         16) /* ItemType - Creature */
     ...
     , (1210,  25,        115) /* Level */
     , (1210,  27,          0) /* ArmorType - None */
     , (1210,  40,          2) /* CombatMode - Melee */
     , (1210,  68,         13) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (1210,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (1210, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
...
VALUES (1210,   1, 0x02000001) /* Setup */
     ...
     , (1210,  32,        433) /* WieldedTreasureType - 
                                   ...
                                   Wield Koujia Breastplate (6003) | Palette: Red (14) | Probability: 33%
                                   Wield Koujia Breastplate (6003) | Palette: Green (8) | Probability: 34%
                                   Wield Koujia Breastplate (6003) | Palette: Blue (2) | Probability: 33%
                                   Wield Koujia Sleeves (6005) | Palette: Red (14) | Probability: 33%
                                   Wield Koujia Sleeves (6005) | Palette: Green (8) | Probability: 34%
                                   Wield Koujia Sleeves (6005) | Palette: Blue (2) | Probability: 33%
                                   Wield Koujia Leggings (6004) | Palette: Red (14) | Probability: 33%
                                   Wield Koujia Leggings (6004) | Palette: Green (8) | Probability: 34%
                                   Wield Koujia Leggings (6004) | Palette: Blue (2) | Probability: 33%
                                   ...
                                   Wield Yumi (23734) | Probability: 5%
     ...
     , (1210,  35,        452) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (1210, 2, 25557,  0, 0, 0, False) /* Create Eye Patch (25557) for Wield */
     ...
     , (1210, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     ...
     , (1210, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (1210, 9, 37088,  1, 0, 0.05, False) /* Create Invitation to the Battle Burrows (37088) for ContainTreasure */
     , (1210, 9,     0,  1, 0, 0.95, False) /* Create nothing for ContainTreasure */;
