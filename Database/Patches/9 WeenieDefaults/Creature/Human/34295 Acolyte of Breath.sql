...
VALUES (34295, 'ace34295-acolyteofbreath', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (34295,   1, 0x02000001) /* Setup */
     ...
     , (34295,  35,        454) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (34295,  6, 0, 3, 0, 260, 0, 0) /* MeleeDefense        Specialized */
     , (34295,  7, 0, 3, 0, 194, 0, 0) /* MissileDefense      Specialized */
     , (34295, 15, 0, 3, 0, 179, 0, 0) /* MagicDefense        Specialized */
     , (34295, 24, 0, 3, 0,  20, 0, 0) /* Run                 Specialized */
     , (34295, 33, 0, 3, 0, 180, 0, 0) /* LifeMagic           Specialized */
     , (34295, 34, 0, 3, 0, 180, 0, 0) /* WarMagic            Specialized */
     , (34295, 44, 0, 3, 0, 297, 0, 0) /* HeavyWeapons        Specialized */
     , (34295, 45, 0, 3, 0, 297, 0, 0) /* LightWeapons        Specialized */
     , (34295, 47, 0, 3, 0, 225, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (34295,  0,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34295,  1,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34295,  2,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34295,  3,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34295,  4,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34295,  5,  4,  4, 0.75,  180,  225,  250,  275,  275,  150,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34295,  6,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34295,  7,  4,  0,    0,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34295,  8,  4,  8, 0.75,  180,  225,  250,  275,  275,  150,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (34295, 2, 33973,  0, 0, 1, False) /* Create Shou-jen Jika-Tabi (33973) for Wield */
     , (34295, 2, 33975,  0, 0, 1, False) /* Create Shou-jen Shozoku Jacket (33975) for Wield */
     , (34295, 2, 33974,  0, 0, 1, False) /* Create Shou-jen Shozoku Sleeve Gauntlets (33974) for Wield */
     , (34295, 2, 33977,  0, 0, 1, False) /* Create Shou-jen Shozoku Trousers (33977) for Wield */;
