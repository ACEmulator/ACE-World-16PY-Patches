...
VALUES (42262, 'ace42262-masterarcher', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (42262,   1,         16) /* ItemType - Creature */
     ...
     , (42262, 281,          4) /* Faction1Bits - RadiantBlood */
...
VALUES (42262,   1,       5) /* HeartbeatInterval */
     ...
     , (42262,  66,     0.6) /* ResistBludgeon */
     , (42262,  67,     0.4) /* ResistFire */
     , (42262,  68,     0.7) /* ResistCold */
     , (42262,  69,     0.4) /* ResistAcid */
     , (42262,  70,     0.7) /* ResistElectric */
...
VALUES (42262,   1, 0x02000001) /* Setup */
     ...
     , (42262,   4, 0x30000000) /* CombatTable */
     , (42262,   7, 0x10000758) /* ClothingBase */
...
VALUES (42262,  6, 0, 2, 0, 450, 0, 0) /* MeleeDefense        Trained */
     , (42262,  7, 0, 2, 0, 350, 0, 0) /* MissileDefense      Trained */
     , (42262, 15, 0, 2, 0, 350, 0, 0) /* MagicDefense        Trained */
     , (42262, 16, 0, 2, 0, 240, 0, 0) /* ManaConversion      Trained */
     , (42262, 31, 0, 2, 0, 240, 0, 0) /* CreatureEnchantment Trained */
     , (42262, 33, 0, 2, 0, 270, 0, 0) /* LifeMagic           Trained */
     , (42262, 34, 0, 2, 0, 270, 0, 0) /* WarMagic            Trained */
     , (42262, 41, 0, 2, 0, 483, 0, 0) /* TwoHandedCombat     Trained */
     , (42262, 43, 0, 2, 0, 270, 0, 0) /* VoidMagic           Trained */
     , (42262, 44, 0, 2, 0, 483, 0, 0) /* HeavyWeapons        Trained */
     , (42262, 45, 0, 2, 0, 483, 0, 0) /* LightWeapons        Trained */
     , (42262, 46, 0, 2, 0, 483, 0, 0) /* FinesseWeapons      Trained */
     , (42262, 47, 0, 3, 0, 380, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (42262,  0,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (42262,  1,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (42262,  2,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (42262,  3,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (42262,  4,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (42262,  5,  4, 120, 0.75,  400,  340,  360,  284,  260,  400,  400,  260,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (42262,  6,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (42262,  7,  4,  0,    0,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (42262,  8,  4, 120, 0.75,  400,  340,  360,  284,  260,  400,  400,  260,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (42262, 2, 38848,  1, 0, 0, False) /* Create Lightning Longbow (38848) for Wield */
     , (42262, 2, 38849, 250, 0, 0, False) /* Create Raider Lightning Arrow (38849) for Wield */;
