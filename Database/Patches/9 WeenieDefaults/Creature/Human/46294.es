Use:
    ...
    - InqIntStat: 25, 50 - 999
        TestSuccess:
            - InqQuest: LadyDaneelOreCollectionCompleted_0612
                QuestSuccess: 
                    - Tell: Thank you again for your assistance. I'll likely have another task for you soon, if you wish it.
                    - DirectBroadcast: %tqt
                QuestFailure:
                    - InqQuest: LadyDaneelOreCollectionStarted_0612
                        QuestSuccess:
                            - Tell: How goes the collecting? It's not too dangerous out there, is it?
                        QuestFailure:
                            - Tell: Greetings, I am known as Lady Dan'eel Trianna. I am a researcher in the newly reforming Lyceum at Knorr. I have been sent here by Lord Asheron to enlist help in the gathering of several components needed in a ritual of exceptional importance.
                            ...
                            - Delay: 1, Tell: To aid us in this, I am prepared to reward Adventurers of sufficient experience for their efforts in collecting 10 pieces of Alb'arean Ore. Alb'arean Ore was sacred to the third sister, who was considered the Lady of Twilight and Rest. We've been able to locate a supply of this ore in the area held by the Gearknights along the Inner Sea.
                            ...
                            - StampQuest: LadyDaneelOreCollectionStarted_0612
        TestFailure:
...
Refuse: Albarean Ore (46286)
    - TurnToTarget
    - InqQuest: LadyDaneelOreCollectionCompleted_0612
        QuestSuccess:
            - Tell: Thank you again for your assistance. Please return later I may need more of these.
        QuestFailure:
            - InqOwnsItems: 46286, 10
                TestSuccess:
                    - TakeItems: 46286, 10
                    - Tell: Ahh, a full stack of 10 Alb'arean Ore. Thank you. Please, accept this reward for your service to the Lyceum, Lord Asheron and all those whom this ritual will help save.
                    - AwardXP: 1,000,000
                    - Give: 24477
                    - StampQuest: LadyDaneelOreCollectionCompleted_0612
                    - SetQuestBitsOn: ResearchingtheLostRitualsComplete_0612, 0x1
                    - EraseQuest: LadyDaneelOreCollectionStarted_0612
                    - Goto: CheckSisters
                TestFailure:
