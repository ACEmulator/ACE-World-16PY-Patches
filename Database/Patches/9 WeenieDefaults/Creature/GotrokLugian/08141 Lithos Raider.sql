...
VALUES (8141, 'lugianlithosraider', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (8141,   1,       5) /* HeartbeatInterval */
     ...
     , (8141,   3,     0.6) /* HealthRate */
     , (8141,   4,       4) /* StaminaRate */
     , (8141,   5,       2) /* ManaRate */
     , (8141,  12,     0.5) /* Shade */
     , (8141,  13,    0.56) /* ArmorModVsSlash */
     , (8141,  14,    0.56) /* ArmorModVsPierce */
     , (8141,  15,    0.56) /* ArmorModVsBludgeon */
     , (8141,  16,    0.34) /* ArmorModVsCold */
     , (8141,  17,    0.14) /* ArmorModVsFire */
     , (8141,  18,    0.85) /* ArmorModVsAcid */
     , (8141,  19,     0.8) /* ArmorModVsElectric */
     , (8141,  31,      22) /* VisualAwarenessRange */
     , (8141,  34,       2) /* PowerupTime */
     , (8141,  36,       1) /* ChargeSpeed */
     , (8141,  64,    0.66) /* ResistSlash */
     , (8141,  65,    0.66) /* ResistPierce */
     , (8141,  66,    0.66) /* ResistBludgeon */
     , (8141,  67,    0.25) /* ResistFire */
     , (8141,  68,    0.42) /* ResistCold */
     , (8141,  69,     0.9) /* ResistAcid */
...
VALUES (8141,   1, 0x02000A0B) /* Setup */
     , (8141,   2, 0x09000006) /* MotionTable */
     , (8141,   3, 0x2000000A) /* SoundTable */
     , (8141,   4, 0x30000003) /* CombatTable */
     , (8141,   6, 0x040010C6) /* PaletteBase */
     , (8141,   7, 0x100002BE) /* ClothingBase */
     , (8141,   8, 0x06001037) /* Icon */
     , (8141,  22, 0x3400001E) /* PhysicsEffectTable */
...
VALUES (8141,  6, 0, 3, 0, 170, 0, 0) /* MeleeDefense        Specialized */
     , (8141,  7, 0, 3, 0, 270, 0, 0) /* MissileDefense      Specialized */
     , (8141, 15, 0, 3, 0, 210, 0, 0) /* MagicDefense        Specialized */
     , (8141, 20, 0, 2, 0,  30, 0, 0) /* Deception           Trained */
     , (8141, 22, 0, 2, 0, 140, 0, 0) /* Jump                Trained */
     , (8141, 24, 0, 2, 0,  50, 0, 0) /* Run                 Trained */
     , (8141, 45, 0, 3, 0, 110, 0, 0) /* LightWeapons        Specialized */
     , (8141, 47, 0, 3, 0,  75, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (8141,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8141, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8141,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
