...
VALUES (8140, 'lugianlaigusraider', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (8140,   1,       5) /* HeartbeatInterval */
     ...
     , (8140,   3,     0.3) /* HealthRate */
     , (8140,   4,       4) /* StaminaRate */
     , (8140,   5,       2) /* ManaRate */
     , (8140,  12,     0.5) /* Shade */
     , (8140,  13,    0.49) /* ArmorModVsSlash */
     , (8140,  14,    0.49) /* ArmorModVsPierce */
     , (8140,  15,    0.49) /* ArmorModVsBludgeon */
     , (8140,  16,    0.22) /* ArmorModVsCold */
     , (8140,  17,    0.11) /* ArmorModVsFire */
     , (8140,  18,    0.83) /* ArmorModVsAcid */
     , (8140,  19,     0.8) /* ArmorModVsElectric */
     , (8140,  31,      16) /* VisualAwarenessRange */
     , (8140,  34,       2) /* PowerupTime */
     , (8140,  36,       1) /* ChargeSpeed */
     , (8140,  64,    0.66) /* ResistSlash */
     , (8140,  65,    0.66) /* ResistPierce */
     , (8140,  66,    0.66) /* ResistBludgeon */
     , (8140,  67,     0.3) /* ResistFire */
     , (8140,  68,    0.42) /* ResistCold */
     , (8140,  69,     0.9) /* ResistAcid */
...
VALUES (8140,   1, 0x02000A0B) /* Setup */
     , (8140,   2, 0x09000006) /* MotionTable */
     , (8140,   3, 0x2000000A) /* SoundTable */
     , (8140,   4, 0x30000003) /* CombatTable */
     , (8140,   6, 0x040010C6) /* PaletteBase */
     , (8140,   7, 0x100002B8) /* ClothingBase */
     , (8140,   8, 0x06001037) /* Icon */
     , (8140,  22, 0x3400001E) /* PhysicsEffectTable */
...
VALUES (8140,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8140, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8140,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
