...
VALUES (8139, 'lugiangigasraider', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (8139,   1,       5) /* HeartbeatInterval */
     ...
     , (8139,   3,     0.7) /* HealthRate */
     , (8139,   4,       4) /* StaminaRate */
     , (8139,   5,       2) /* ManaRate */
     , (8139,  12,     0.5) /* Shade */
     , (8139,  13,    0.57) /* ArmorModVsSlash */
     , (8139,  14,    0.57) /* ArmorModVsPierce */
     , (8139,  15,    0.57) /* ArmorModVsBludgeon */
     , (8139,  16,    0.36) /* ArmorModVsCold */
     , (8139,  17,    0.17) /* ArmorModVsFire */
     , (8139,  18,    0.86) /* ArmorModVsAcid */
     , (8139,  19,     0.8) /* ArmorModVsElectric */
     , (8139,  31,      23) /* VisualAwarenessRange */
     , (8139,  34,       3) /* PowerupTime */
     , (8139,  36,       1) /* ChargeSpeed */
     , (8139,  64,    0.66) /* ResistSlash */
     , (8139,  65,    0.66) /* ResistPierce */
     , (8139,  66,    0.66) /* ResistBludgeon */
     , (8139,  67,    0.25) /* ResistFire */
     , (8139,  68,    0.42) /* ResistCold */
     , (8139,  69,     0.9) /* ResistAcid */
...
VALUES (8139,   1, 0x02000A0B) /* Setup */
     , (8139,   2, 0x09000006) /* MotionTable */
     , (8139,   3, 0x2000000A) /* SoundTable */
     , (8139,   4, 0x30000003) /* CombatTable */
     , (8139,   6, 0x040010C6) /* PaletteBase */
     , (8139,   7, 0x100002B9) /* ClothingBase */
     , (8139,   8, 0x06001037) /* Icon */
     , (8139,  22, 0x3400001E) /* PhysicsEffectTable */
...
VALUES (8139,  0,  4,  2,  0.3,  145,   83,   83,   83,   52,   25,  125,  116,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (8139,  6,  4,  2,  0.3,  150,   85,   85,   85,   54,   26,  129,  120,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (8139,  7,  4, 25,  0.3,  150,   85,   85,   85,   54,   26,  129,  120,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (8139,  8,  4, 20, 0.75,  150,   85,   85,   85,   54,   26,  129,  120,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (8139,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8139, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8139,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
