...
VALUES (7551, 'lugianextasminer', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (7551,   1,       5) /* HeartbeatInterval */
     ...
     , (7551,   3,     0.9) /* HealthRate */
     , (7551,   4,       4) /* StaminaRate */
     , (7551,   5,       2) /* ManaRate */
     , (7551,  12,     0.5) /* Shade */
     , (7551,  13,    0.57) /* ArmorModVsSlash */
     , (7551,  14,    0.57) /* ArmorModVsPierce */
     , (7551,  15,    0.57) /* ArmorModVsBludgeon */
     , (7551,  16,    0.36) /* ArmorModVsCold */
     , (7551,  17,    0.17) /* ArmorModVsFire */
     , (7551,  18,    0.86) /* ArmorModVsAcid */
     , (7551,  19,     0.8) /* ArmorModVsElectric */
     , (7551,  31,      23) /* VisualAwarenessRange */
     , (7551,  34,       3) /* PowerupTime */
     , (7551,  36,       1) /* ChargeSpeed */
     , (7551,  64,    0.66) /* ResistSlash */
     , (7551,  65,    0.66) /* ResistPierce */
     , (7551,  66,    0.66) /* ResistBludgeon */
     , (7551,  67,    0.25) /* ResistFire */
     , (7551,  68,    0.42) /* ResistCold */
     , (7551,  69,     0.9) /* ResistAcid */
...
VALUES (7551,   1, 0x02000A0B) /* Setup */
     ...
     , (7551,   4, 0x30000003) /* CombatTable */
     , (7551,   6, 0x040010C6) /* PaletteBase */
     , (7551,   7, 0x100002BD) /* ClothingBase */
     ...
     , (7551,  32,        303) /* WieldedTreasureType - 
                                   ...
                                   Wield Lugian Axe (7577) | Probability: 60.000004%
...
VALUES (7551,  6, 0, 3, 0, 280, 0, 0) /* MeleeDefense        Specialized */
     , (7551,  7, 0, 3, 0, 390, 0, 0) /* MissileDefense      Specialized */
     , (7551, 15, 0, 3, 0, 280, 0, 0) /* MagicDefense        Specialized */
     , (7551, 20, 0, 2, 0,  80, 0, 0) /* Deception           Trained */
     , (7551, 22, 0, 2, 0,  80, 0, 0) /* Jump                Trained */
     , (7551, 24, 0, 2, 0,  45, 0, 0) /* Run                 Trained */
     , (7551, 45, 0, 3, 0, 250, 0, 0) /* LightWeapons        Specialized */
     , (7551, 47, 0, 3, 0, 190, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7551,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7551, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7551,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
