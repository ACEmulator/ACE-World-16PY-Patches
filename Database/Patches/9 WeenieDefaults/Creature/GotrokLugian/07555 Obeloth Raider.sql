...
VALUES (7555, 'lugianobelothminer', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7555,   1,       5) /* HeartbeatInterval */
     ...
     , (7555,   3,     0.6) /* HealthRate */
     , (7555,   4,       4) /* StaminaRate */
     , (7555,   5,       2) /* ManaRate */
     , (7555,  12,     0.5) /* Shade */
     , (7555,  13,    0.51) /* ArmorModVsSlash */
     , (7555,  14,    0.51) /* ArmorModVsPierce */
     , (7555,  15,    0.51) /* ArmorModVsBludgeon */
     , (7555,  16,    0.26) /* ArmorModVsCold */
     , (7555,  17,    0.03) /* ArmorModVsFire */
     , (7555,  18,    0.84) /* ArmorModVsAcid */
     , (7555,  19,     0.8) /* ArmorModVsElectric */
     , (7555,  31,      16) /* VisualAwarenessRange */
     , (7555,  34,       3) /* PowerupTime */
     , (7555,  36,       1) /* ChargeSpeed */
     , (7555,  64,    0.66) /* ResistSlash */
     , (7555,  65,    0.66) /* ResistPierce */
     , (7555,  66,    0.66) /* ResistBludgeon */
     , (7555,  67,    0.25) /* ResistFire */
     , (7555,  68,    0.42) /* ResistCold */
     , (7555,  69,     0.9) /* ResistAcid */
...
VALUES (7555,   1, 0x02000A0B) /* Setup */
     ...
     , (7555,   4, 0x30000003) /* CombatTable */
     , (7555,   6, 0x040010C6) /* PaletteBase */
     , (7555,   7, 0x100002BB) /* ClothingBase */
...
VALUES (7555,  6, 0, 3, 0, 145, 0, 0) /* MeleeDefense        Specialized */
     , (7555,  7, 0, 3, 0, 245, 0, 0) /* MissileDefense      Specialized */
     , (7555, 15, 0, 3, 0, 175, 0, 0) /* MagicDefense        Specialized */
     , (7555, 20, 0, 2, 0,  40, 0, 0) /* Deception           Trained */
     , (7555, 22, 0, 2, 0, 140, 0, 0) /* Jump                Trained */
     , (7555, 24, 0, 2, 0,  50, 0, 0) /* Run                 Trained */
     , (7555, 45, 0, 3, 0,  95, 0, 0) /* LightWeapons        Specialized */
     , (7555, 47, 0, 3, 0,  75, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7555,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7555, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7555,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
