...
VALUES (9399, 'lugiancommanderlinvak', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (9399,   1,       5) /* HeartbeatInterval */
     ...
     , (9399,   3,     0.9) /* HealthRate */
     , (9399,   4,       4) /* StaminaRate */
     , (9399,   5,       2) /* ManaRate */
     , (9399,  12,     0.5) /* Shade */
     , (9399,  13,    0.57) /* ArmorModVsSlash */
     , (9399,  14,    0.57) /* ArmorModVsPierce */
     , (9399,  15,    0.57) /* ArmorModVsBludgeon */
     , (9399,  16,    0.36) /* ArmorModVsCold */
     , (9399,  17,    0.17) /* ArmorModVsFire */
     , (9399,  18,    0.86) /* ArmorModVsAcid */
     , (9399,  19,     0.8) /* ArmorModVsElectric */
     , (9399,  31,      23) /* VisualAwarenessRange */
     , (9399,  34,       3) /* PowerupTime */
     , (9399,  36,       1) /* ChargeSpeed */
     , (9399,  64,    0.66) /* ResistSlash */
     , (9399,  65,    0.66) /* ResistPierce */
     , (9399,  66,    0.66) /* ResistBludgeon */
     , (9399,  67,    0.25) /* ResistFire */
     , (9399,  68,    0.42) /* ResistCold */
     , (9399,  69,     0.9) /* ResistAcid */
...
VALUES (9399,   1, 0x02000A0B) /* Setup */
     , (9399,   2, 0x09000006) /* MotionTable */
     , (9399,   3, 0x2000000A) /* SoundTable */
     , (9399,   4, 0x30000003) /* CombatTable */
     , (9399,   6, 0x040010C6) /* PaletteBase */
     , (9399,   7, 0x1000053B) /* ClothingBase */
     , (9399,   8, 0x06001037) /* Icon */
     , (9399,  22, 0x3400001E) /* PhysicsEffectTable */
     , (9399,  32,        321) /* WieldedTreasureType - 
                                   # Set: 1
                                   | 100.00% chance of Rock (23745)
                                   # Set: 2
...
VALUES (9399,  6, 0, 3, 0, 250, 0, 0) /* MeleeDefense        Specialized */
     , (9399,  7, 0, 3, 0, 360, 0, 0) /* MissileDefense      Specialized */
     , (9399, 15, 0, 3, 0, 230, 0, 0) /* MagicDefense        Specialized */
     , (9399, 20, 0, 2, 0,  80, 0, 0) /* Deception           Trained */
     , (9399, 22, 0, 2, 0,  80, 0, 0) /* Jump                Trained */
     , (9399, 24, 0, 2, 0,  45, 0, 0) /* Run                 Trained */
     , (9399, 45, 0, 3, 0, 200, 0, 0) /* LightWeapons        Specialized */
     , (9399, 47, 0, 3, 0, 185, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (9399,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (9399, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9399,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
