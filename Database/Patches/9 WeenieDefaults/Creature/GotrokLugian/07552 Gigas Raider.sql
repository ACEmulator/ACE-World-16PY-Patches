...
VALUES (7552, 'lugiangigasminer', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (7552,   1,       5) /* HeartbeatInterval */
     ...
     , (7552,   3,     0.7) /* HealthRate */
     , (7552,   4,       4) /* StaminaRate */
     , (7552,   5,       2) /* ManaRate */
     , (7552,  12,     0.5) /* Shade */
     , (7552,  13,    0.57) /* ArmorModVsSlash */
     , (7552,  14,    0.57) /* ArmorModVsPierce */
     , (7552,  15,    0.57) /* ArmorModVsBludgeon */
     , (7552,  16,    0.36) /* ArmorModVsCold */
     , (7552,  17,    0.17) /* ArmorModVsFire */
     , (7552,  18,    0.86) /* ArmorModVsAcid */
     , (7552,  19,     0.8) /* ArmorModVsElectric */
     , (7552,  31,      23) /* VisualAwarenessRange */
     , (7552,  34,       3) /* PowerupTime */
     , (7552,  36,       1) /* ChargeSpeed */
     , (7552,  64,    0.66) /* ResistSlash */
     , (7552,  65,    0.66) /* ResistPierce */
     , (7552,  66,    0.66) /* ResistBludgeon */
     , (7552,  67,    0.25) /* ResistFire */
     , (7552,  68,    0.42) /* ResistCold */
     , (7552,  69,     0.9) /* ResistAcid */
...
VALUES (7552,   1, 0x02000A0B) /* Setup */
     ...
     , (7552,   4, 0x30000003) /* CombatTable */
     , (7552,   6, 0x040010C6) /* PaletteBase */
     , (7552,   7, 0x100002B9) /* ClothingBase */
...
VALUES (7552,  6, 0, 3, 0, 195, 0, 0) /* MeleeDefense        Specialized */
     , (7552,  7, 0, 3, 0, 315, 0, 0) /* MissileDefense      Specialized */
     , (7552, 15, 0, 3, 0, 220, 0, 0) /* MagicDefense        Specialized */
     , (7552, 20, 0, 2, 0,  80, 0, 0) /* Deception           Trained */
     , (7552, 22, 0, 2, 0,  80, 0, 0) /* Jump                Trained */
     , (7552, 24, 0, 2, 0,  45, 0, 0) /* Run                 Trained */
     , (7552, 45, 0, 3, 0, 145, 0, 0) /* LightWeapons        Specialized */
     , (7552, 47, 0, 3, 0, 185, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7552,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7552, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7552,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
