...
VALUES (9398, 'lugiancommanderc', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (9398,   1,       5) /* HeartbeatInterval */
     ...
     , (9398,   3,     0.9) /* HealthRate */
     , (9398,   4,       4) /* StaminaRate */
     , (9398,   5,       2) /* ManaRate */
     , (9398,  12,     0.5) /* Shade */
     , (9398,  13,    0.57) /* ArmorModVsSlash */
     , (9398,  14,    0.57) /* ArmorModVsPierce */
     , (9398,  15,    0.57) /* ArmorModVsBludgeon */
     , (9398,  16,    0.36) /* ArmorModVsCold */
     , (9398,  17,    0.17) /* ArmorModVsFire */
     , (9398,  18,    0.86) /* ArmorModVsAcid */
     , (9398,  19,     0.8) /* ArmorModVsElectric */
     , (9398,  31,      23) /* VisualAwarenessRange */
     , (9398,  34,       3) /* PowerupTime */
     , (9398,  36,       1) /* ChargeSpeed */
     , (9398,  64,    0.66) /* ResistSlash */
     , (9398,  65,    0.66) /* ResistPierce */
     , (9398,  66,    0.66) /* ResistBludgeon */
     , (9398,  67,    0.25) /* ResistFire */
     , (9398,  68,    0.42) /* ResistCold */
     , (9398,  69,     0.9) /* ResistAcid */
...
VALUES (9398,   1, 0x02000A0B) /* Setup */
     ...
     , (9398,   4, 0x30000003) /* CombatTable */
     , (9398,   6, 0x040010C6) /* PaletteBase */
     , (9398,   7, 0x1000053B) /* ClothingBase */
...
VALUES (9398,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (9398, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9398,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
