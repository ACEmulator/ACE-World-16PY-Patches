...
VALUES (28649, 'fiuncrazed', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (28649,   1,         16) /* ItemType - Creature */
     , (28649,   2,         78) /* CreatureType - Fiun */
     , (28649,   3,          2) /* PaletteTemplate - Blue */
...
VALUES (28649,   1,       5) /* HeartbeatInterval */
     ...
     , (28649,   3,   0.075) /* HealthRate */
     , (28649,   4,       3) /* StaminaRate */
     , (28649,   5,       1) /* ManaRate */
     , (28649,  12,       0) /* Shade */
     , (28649,  13,     1.3) /* ArmorModVsSlash */
     , (28649,  14,       1) /* ArmorModVsPierce */
     , (28649,  15,     1.1) /* ArmorModVsBludgeon */
     , (28649,  16,     0.9) /* ArmorModVsCold */
     , (28649,  17,     0.6) /* ArmorModVsFire */
     , (28649,  18,       1) /* ArmorModVsAcid */
     , (28649,  19,     0.7) /* ArmorModVsElectric */
     , (28649,  31,      20) /* VisualAwarenessRange */
     , (28649,  34,       1) /* PowerupTime */
     , (28649,  36,       1) /* ChargeSpeed */
     , (28649,  39,     1.2) /* DefaultScale */
     , (28649,  64,     0.8) /* ResistSlash */
     , (28649,  65,    0.75) /* ResistPierce */
     , (28649,  66,    0.66) /* ResistBludgeon */
     , (28649,  67,       1) /* ResistFire */
     , (28649,  68,     0.6) /* ResistCold */
     , (28649,  69,    0.75) /* ResistAcid */
     , (28649,  70,    0.96) /* ResistElectric */
...
VALUES (28649,   1, 0x020012A2) /* Setup */
     ...
     , (28649,   4, 0x30000042) /* CombatTable */
     , (28649,   6, 0x040019D8) /* PaletteBase */
     , (28649,   7, 0x100005CE) /* ClothingBase */
     , (28649,   8, 0x060036FC) /* Icon */
     , (28649,  22, 0x340000B2) /* PhysicsEffectTable */
...
VALUES (28649,  0,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28649,  1,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28649,  2,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28649,  3,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28649,  4,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28649,  5,  4, 35,  0.5,  220,  286,  220,  242,  198,  132,  220,  154,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28649,  6,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28649,  7,  4,  0,    0,  220,  286,  220,  242,  198,  132,  220,  154,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28649,  8,  4, 35, 0.75,  220,  286,  220,  242,  198,  132,  220,  154,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (28649,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (28649, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28649,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28649,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28649,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
