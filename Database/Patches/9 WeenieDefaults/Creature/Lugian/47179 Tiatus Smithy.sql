...
VALUES (47179, 'ace47179-tiatussmithy', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (47179,  6, 0, 3, 0, 300, 0, 0) /* MeleeDefense        Specialized */
     , (47179,  7, 0, 3, 0, 220, 0, 0) /* MissileDefense      Specialized */
     , (47179, 15, 0, 3, 0, 183, 0, 0) /* MagicDefense        Specialized */
     , (47179, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (47179, 22, 0, 2, 0,  80, 0, 0) /* Jump                Trained */
     , (47179, 24, 0, 2, 0,  45, 0, 0) /* Run                 Trained */
     , (47179, 44, 0, 3, 0, 327, 0, 0) /* HeavyWeapons        Specialized */
     , (47179, 45, 0, 3, 0, 327, 0, 0) /* LightWeapons        Specialized */
     , (47179, 47, 0, 3, 0, 250, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (47179,  0,  4,  2,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (47179,  1,  4, 40,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (47179,  2,  4,  2,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (47179,  3,  4,  2,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (47179,  4,  4,  2,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (47179,  5,  4, 100, 0.75,  450,  387,  387,  387,  450,  450,  387,  162,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (47179,  6,  4,  2,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (47179,  7,  4, 25,  0.3,  450,  387,  387,  387,  450,  450,  387,  162,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (47179,  8,  4, 100, 0.75,  450,  387,  387,  387,  450,  450,  387,  162,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
