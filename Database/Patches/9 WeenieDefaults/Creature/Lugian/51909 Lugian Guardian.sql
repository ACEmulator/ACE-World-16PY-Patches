...
VALUES (51909, 'ace51909-lugianguardian', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51909,   1,       5) /* HeartbeatInterval */
     ...
     , (51909, 165,       1) /* ArmorModVsNether */
     , (51909, 166,       1) /* ResistNether */;
...
VALUES (51909,   1, 0x02000A0B) /* Setup */
     ...
     , (51909,   4, 0x30000003) /* CombatTable */
     , (51909,   6, 0x040010C6) /* PaletteBase */
     , (51909,   7, 0x100002BA) /* ClothingBase */
...
VALUES (51909,  6, 0, 2, 0, 560, 0, 0) /* MeleeDefense        Trained */
     , (51909,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense      Trained */
     , (51909, 15, 0, 2, 0, 380, 0, 0) /* MagicDefense        Trained */
     , (51909, 41, 0, 2, 0, 420, 0, 0) /* TwoHandedCombat     Trained */
     , (51909, 44, 0, 2, 0, 420, 0, 0) /* HeavyWeapons        Trained */
     , (51909, 45, 0, 2, 0, 420, 0, 0) /* LightWeapons        Trained */
     , (51909, 46, 0, 2, 0, 420, 0, 0) /* FinesseWeapons      Trained */
     , (51909, 47, 0, 2, 0, 450, 0, 0) /* MissileWeapons      Trained */
     , (51909, 52, 0, 2, 0, 420, 0, 0) /* DirtyFighting       Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51909,  0,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51909,  1,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51909,  2,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51909,  3,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51909,  4,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51909,  5,  4, 200, 0.75,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51909,  6,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51909,  7,  4, 200,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51909,  8,  4, 200, 0.75,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
