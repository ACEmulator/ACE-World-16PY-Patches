...
VALUES (72661, 'ace72661-spectralemeraldassassin', 10, '2021-09-24 10:25:27') /* Creature */;
...
VALUES (72661,   1,   33561479) /* Setup */
     , (72661,   2,  150994945) /* MotionTable */
     , (72661,   3,  536870942) /* SoundTable */
     , (72661,   4,  805306368) /* CombatTable */
     , (72661,   7,  268437544) /* ClothingBase */
     , (72661,   8,  100669124) /* Icon */
     , (72661,  22,  872415269) /* PhysicsEffectTable */
     , (72661,  35,       2105) /* DeathTreasureType - Loot Tier: 8 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72661,  0,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72661,  1,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72661,  2,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72661,  3,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72661,  4,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72661,  5,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72661,  6,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72661,  7,  4,  0,    0,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72661,  8,  4,600, 0.75,  400,  200,  200,  200,  200,  200,  200,  200,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72661,  33, 0, 2, 0, 210, 0, 0) /* LifeMagic */
     , (72661,  34, 0, 2, 0, 210, 0, 0) /* WarMagic */
     , (72661,  31, 0, 2, 0, 210, 0, 0) /* CreatureMagic */
     , (72661,  44, 0, 2, 0, 540, 0, 0) /* HeavyWeapons */
     , (72661,  45, 0, 2, 0, 540, 0, 0) /* LightWeapons */
     , (72661,  46, 0, 2, 0, 540, 0, 0) /* FinesseWeapons */
     , (72661,  51, 0, 2, 0, 530, 0, 0) /* SneakAttack */
     , (72661,  52, 0, 2, 0, 540, 0, 0) /* DirtyFighting */
     , (72661,  49, 0, 2, 0, 550, 0, 0) /* DualWield */
     , (72661,  15, 0, 2, 0, 340, 0, 0) /* MagicDefense */
     , (72661,   6, 0, 2, 0, 450, 0, 0) /* MeleeDefense */
     , (72661,   7, 0, 2, 0, 570, 0, 0) /* MissileDefense */;
