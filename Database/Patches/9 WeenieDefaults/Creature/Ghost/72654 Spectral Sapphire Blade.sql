...
VALUES (72654, 'ace72654-spectralsapphireblade', 10, '2020-10-23 23:53:25') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (72654,   1,      16) /* ItemType - Creature */
     , (72654,   2,      77) /* CreatureType - Ghost */
     , (72654,   3,       9) /* PalletteTemplate - Grey */
...
VALUES (72654,   1,       5) /* HeartbeatInterval */
     ...
     , (72654,   5,       1) /* ManaRate */
     , (72654,  12,     0.5) /* PaletteBase */
     , (72654,  13,     1.0) /* ArmorModVsSlash */
     , (72654,  14,     1.0) /* ArmorModVsPierce */
     , (72654,  15,     1.0) /* ArmorModVsBludgeon */
     , (72654,  16,     1.0) /* ArmorModVsCold */
     , (72654,  17,     1.0) /* ArmorModVsFire */
     , (72654,  18,     1.0) /* ArmorModVsAcid */
     , (72654,  19,     1.0) /* ArmorModVsElectric */
     ...
     , (72654, 166,     1.0) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72654,  1, 'Spectral Sapphire Blade') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72654,   1,   33561479) /* Setup */
     , (72654,   2,  150994945) /* MotionTable */
     , (72654,   3,  536870942) /* SoundTable */
     , (72654,   4,  805306368) /* CombatTable */
     , (72654,   6,   67108990) /* PaletteBase */
     , (72654,   7,  268437544) /* ClothingBase  */
     , (72654,   8,  100669124) /* Icon */
...
VALUES (72654,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72654,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72654,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72654,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72654,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72654,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72654,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72654,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72654,  8,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
