...
VALUES (48899, 'ace48899-ensorcelledweapon', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (48899,   1, True ) /* Stuck */
     ...
     , (48899,  29, True ) /* NoCorpse */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (48899,   1,       5) /* HeartbeatInterval */
...
VALUES (48899,   1, 0x02001BA9) /* Setup */
     ...
     , (48899,   4, 0x30000000) /* CombatTable */
...
VALUES (48899,  0,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (48899,  1,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (48899,  2,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (48899,  3,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (48899,  4,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (48899,  5,  4, 600, 0.75,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (48899,  6,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (48899,  7,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (48899,  8,  4, 600, 0.75,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
