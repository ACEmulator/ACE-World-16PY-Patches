...
VALUES (72589, 'ace72589-spectralminion', 10, '2020-10-23 23:53:25') /* Creature */;
...
VALUES (72589,   1,       5) /* HeartbeatInterval */
     ...
     , (72589,  15,     1.0) /* ArmorModVsBludgeon */
     , (72589,  16,     1.0) /* ArmorModVsCold */
     , (72589,  17,     1.0) /* ArmorModVsFire */
     , (72589,  18,    0.95) /* ArmorModVsAcid */
     , (72589,  19,     1.0) /* ArmorModVsElectric */
     ...
     , (72589, 166,     1.0) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72589,  1, 'Spectral Minion') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72589,   1,   33561495) /* Setup */
     , (72589,   2,  150994945) /* MotionTable */
     , (72589,   3,  536870942) /* SoundTable */
     , (72589,   4,  805306368) /* CombatTable */	 	 
     , (72589,   7,  268437543) /* ClothingBase */
     , (72589,   8,  100669124) /* Icon */
     , (72589,  22,  872415269) /* PhysicsEffectTable */
...
VALUES (72589,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72589,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72589,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72589,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72589,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72589,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72589,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72589,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72589,  8,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72589,  33, 0, 2, 0, 200, 0, 0) /* LifeMagic */
     , (72589,  34, 0, 2, 0, 200, 0, 0) /* WarMagic */
     , (72589,  31, 0, 2, 0, 200, 0, 0) /* CreatureMagic */
     , (72589,  44, 0, 2, 0, 407, 0, 0) /* HeavyWeapons */
     , (72589,  45, 0, 2, 0, 407, 0, 0) /* LightWeapons */
     , (72589,  41, 0, 2, 0, 407, 0, 0) /* TwoHanded */
     , (72589,  46, 0, 2, 0, 440, 0, 0) /* FinesseWeapons */
     , (72589,  15, 0, 2, 0, 379, 0, 0) /* MagicDefense */
     , (72589,   6, 0, 2, 0, 530, 0, 0) /* MeleeDefense */
     , (72589,   7, 0, 2, 0, 620, 0, 0) /* MissileDefense */
     , (72589,  49, 0, 2, 0, 407, 0, 0) /* DualWield */;
