...
VALUES (45182, 'ace45182-corrupteddread', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (45182,   1,       5) /* HeartbeatInterval */
     ...
     , (45182,   5,       2) /* ManaRate */
     , (45182,  12,     0.5) /* Shade */
     , (45182,  13,    0.64) /* ArmorModVsSlash */
     , (45182,  14,    0.96) /* ArmorModVsPierce */
     , (45182,  15,    0.96) /* ArmorModVsBludgeon */
     , (45182,  16,       1) /* ArmorModVsCold */
     , (45182,  17,    0.64) /* ArmorModVsFire */
     , (45182,  18,    0.97) /* ArmorModVsAcid */
     , (45182,  19,    0.75) /* ArmorModVsElectric */
     ...
     , (45182,  66,    0.79) /* ResistBludgeon */
     , (45182,  67,    0.89) /* ResistFire */
     , (45182,  68,    0.34) /* ResistCold */
     , (45182,  69,    0.49) /* ResistAcid */
     , (45182,  70,    0.84) /* ResistElectric */
...
VALUES (45182,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (45182,  7, 0, 3, 0, 520, 0, 0) /* MissileDefense      Specialized */
     , (45182, 14, 0, 3, 0, 263, 0, 0) /* ArcaneLore          Specialized */
     , (45182, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (45182, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (45182, 24, 0, 3, 0, 600, 0, 0) /* Run                 Specialized */
     , (45182, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (45182, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (45182, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */
     , (45182, 45, 0, 3, 0, 420, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45182,  0,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45182,  1,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45182,  2,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (45182,  3,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45182,  4,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (45182,  5,  8, 200, 0.75,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */;
...
VALUES (45182, 9, 48908,  0, 0, 0.04, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (45182, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
