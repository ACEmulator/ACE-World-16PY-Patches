...
VALUES (72557, 'ace72557-spectralminion', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (72557,   1,       5) /* HeartbeatInterval */
     ...
     , (72557,  15,       1) /* ArmorModVsBludgeon */
     , (72557,  16,       1) /* ArmorModVsCold */
...
VALUES (72557,   1, 0x02001B95) /* Setup */
     , (72557,   2, 0x09000001) /* MotionTable */
     , (72557,   3, 0x2000001E) /* SoundTable */
     , (72557,   4, 0x30000000) /* CombatTable */
     , (72557,   7, 0x10000827) /* ClothingBase */
     , (72557,   8, 0x060016C4) /* Icon */
     , (72557,  22, 0x34000025) /* PhysicsEffectTable */;
...
VALUES (72557,  6, 0, 2, 0, 400, 0, 0) /* MeleeDefense        Trained */
     , (72557,  7, 0, 2, 0, 620, 0, 0) /* MissileDefense      Trained */
     , (72557, 15, 0, 2, 0, 379, 0, 0) /* MagicDefense        Trained */
     , (72557, 41, 0, 2, 0, 507, 0, 0) /* TwoHandedCombat     Trained */
     , (72557, 44, 0, 2, 0, 507, 0, 0) /* HeavyWeapons        Trained */
     , (72557, 45, 0, 2, 0, 507, 0, 0) /* LightWeapons        Trained */
     , (72557, 46, 0, 2, 0, 540, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72557,  0,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72557,  1,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72557,  2,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72557,  3,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72557,  4,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72557,  5,  4, 600, 0.75,  400,  340,  340,  400,  400,  400,  400,  380,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72557,  6,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72557,  7,  4,  0,    0,  400,  340,  340,  400,  400,  400,  400,  380,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72557,  8,  4, 600, 0.75,  400,  340,  340,  400,  400,  400,  400,  380,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
