...
VALUES (72490, 'ace72490-vicararcher', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (72490,   1,       5) /* HeartbeatInterval */
     ...
     , (72490,   5,       1) /* ManaRate */
     , (72490,  13,       1) /* ArmorModVsSlash */
     , (72490,  14,       1) /* ArmorModVsPierce */
     , (72490,  15,       1) /* ArmorModVsBludgeon */
     , (72490,  16,       1) /* ArmorModVsCold */
     ...
     , (72490, 166,       1) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72490,   1, 'Vicar Archer') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72490,   1, 0x02001B86) /* Setup */
     , (72490,   2, 0x09000001) /* MotionTable */
     , (72490,   3, 0x2000001E) /* SoundTable */
     , (72490,   4, 0x30000000) /* CombatTable */
     , (72490,   7, 0x10000827) /* ClothingBase */
     , (72490,   8, 0x060016C4) /* Icon */
     , (72490,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (72490,  6, 0, 2, 0, 530, 0, 0) /* MeleeDefense        Trained */
     , (72490,  7, 0, 2, 0, 620, 0, 0) /* MissileDefense      Trained */
     , (72490, 15, 0, 2, 0, 379, 0, 0) /* MagicDefense        Trained */
     , (72490, 47, 0, 2, 0, 310, 0, 0) /* MissileWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (72490,  0,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72490,  1,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72490,  2,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72490,  3,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72490,  4,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72490,  5,  4, 200, 0.75,  400,  400,  400,  400,  400,  380,  400,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72490,  6,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72490,  7,  4,  0,    0,  400,  400,  400,  400,  400,  380,  400,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72490,  8,  4, 200, 0.75,  400,  400,  400,  400,  400,  380,  400,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
