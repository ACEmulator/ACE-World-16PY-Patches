...
VALUES (72655, 'ace72655-spectralsapphireclaw', 10, '2020-07-23 03:33:54') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (72655,   1,      16) /* ItemType - Creature */
     , (72655,   2,      77) /* CreatureType - Ghost */
     , (72655,   3,       9) /* PalletteTemplate - Grey */
...
VALUES (72655,   1,       5) /* HeartbeatInterval */
     ...
     , (72655,   5,       1) /* ManaRate */
     , (72655,  12,     0.5) /* PaletteBase */
     , (72655,  13,     1.0) /* ArmorModVsSlash */
     , (72655,  14,     1.0) /* ArmorModVsPierce */
     , (72655,  15,     1.0) /* ArmorModVsBludgeon */
     , (72655,  16,     1.0) /* ArmorModVsCold */
     , (72655,  17,     1.0) /* ArmorModVsFire */
     , (72655,  18,     1.0) /* ArmorModVsAcid */
     , (72655,  19,     1.0) /* ArmorModVsElectric */
     ...
     , (72655, 166,     1.0) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72655,  1, 'Spectral Sapphire Claw') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72655,  1,  33561479) /* Setup */
     , (72655,  2, 150994945) /* MotionTable */
     , (72655,  3, 536870942) /* SoundTable */
     , (72655,  4, 805306368) /* CombatTable */
     , (72655,  6,  67108990) /* PaletteBase */
     , (72655,  7, 268437544) /* ClothingBase  */
     , (72655,  8, 100669124) /* Icon */
     , (72655, 22, 872415269) /* PhysicsEffectTable */
...
VALUES (72655,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72655,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72655,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72655,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72655,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72655,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72655,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72655,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
