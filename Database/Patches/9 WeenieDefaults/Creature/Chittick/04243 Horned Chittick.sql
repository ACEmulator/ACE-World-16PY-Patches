...
VALUES (4243, 'chittickhorned', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (4243,   1,       5) /* HeartbeatInterval */
     ...
     , (4243,   3,    0.15) /* HealthRate */
     , (4243,   4,     0.5) /* StaminaRate */
     , (4243,   5,       2) /* ManaRate */
     , (4243,  13,    0.22) /* ArmorModVsSlash */
     , (4243,  14,     0.7) /* ArmorModVsPierce */
     , (4243,  15,    0.28) /* ArmorModVsBludgeon */
     , (4243,  16,     0.3) /* ArmorModVsCold */
     , (4243,  17,    0.45) /* ArmorModVsFire */
     , (4243,  18,    0.26) /* ArmorModVsAcid */
     , (4243,  19,    0.45) /* ArmorModVsElectric */
     , (4243,  31,      22) /* VisualAwarenessRange */
     , (4243,  34,     1.5) /* PowerupTime */
     , (4243,  36,       1) /* ChargeSpeed */
     , (4243,  39,     1.2) /* DefaultScale */
     , (4243,  64,    0.53) /* ResistSlash */
     , (4243,  65,       1) /* ResistPierce */
     , (4243,  66,     0.5) /* ResistBludgeon */
     , (4243,  67,     0.7) /* ResistFire */
     , (4243,  68,     0.5) /* ResistCold */
     , (4243,  69,     0.4) /* ResistAcid */
     , (4243,  70,     0.7) /* ResistElectric */
...
VALUES (4243,   1, 0x02000E66) /* Setup */
     ...
     , (4243,   4, 0x30000022) /* CombatTable */
     , (4243,   6, 0x04001442) /* PaletteBase */
     , (4243,   7, 0x10000423) /* ClothingBase */
...
VALUES (4243,  6, 0, 3, 0, 140, 0, 0) /* MeleeDefense        Specialized */
     , (4243,  7, 0, 3, 0, 236, 0, 0) /* MissileDefense      Specialized */
     , (4243, 15, 0, 3, 0, 165, 0, 0) /* MagicDefense        Specialized */
     , (4243, 20, 0, 3, 0,  20, 0, 0) /* Deception           Specialized */
     , (4243, 22, 0, 3, 0,  80, 0, 0) /* Jump                Specialized */
     , (4243, 24, 0, 3, 0,  30, 0, 0) /* Run                 Specialized */
     , (4243, 45, 0, 3, 0, 130, 0, 0) /* LightWeapons        Specialized */
     , (4243, 47, 0, 3, 0, 180, 0, 0) /* MissileWeapons      Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4243,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
