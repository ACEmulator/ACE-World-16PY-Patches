Use:
	- TurnToTarget
	- InqQuest: EmpyreanPortalspaceStabilizerHigh_Completed
		QuestSuccess:
		...
		QuestFailure:
			- InqOwnsItems: Brightly Glowing Data Crystal (43084)
				TestSuccess:
					- Tell: I can feel the data crystal's touch upon you. May I have it?
				TestFailure:
					- InqQuest: EmpyreanPortalspaceStabilizerHigh_Start
						QuestSuccess:
							- Tell: Any luck in retrieving the data at 60.0S, 98.4E?
						QuestFailure:
							...
							- Delay: 1, Tell: If you would be willing to go to 60.0S, 98.4E, dispose of 30 of these Apostate Virindi, and bring me back the data the device has collected, my Master would be grateful.
							- SetQuestCompletions: KillTaskApostateVirindiHigh_0710, 0
							- StampQuest: EmpyreanPortalspaceStabilizerHigh_Start

Refuse: Brightly Glowing Data Crystal (43084)
	- TurnToTarget
	...
	- EraseQuest: EmpyreanPortalspaceStabilizerHigh_Start
	- StampQuest: EmpyreanPortalspaceStabilizerHigh_Completed