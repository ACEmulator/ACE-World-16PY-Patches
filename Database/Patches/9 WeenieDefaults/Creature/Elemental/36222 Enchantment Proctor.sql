...
VALUES (36222, 'ace36222-enchantmentproctor', 10, '2021-06-18 01:05:22') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (36222,   1,         16) /* ItemType - Creature */
     , (36222,   2,         62) /* CreatureType - Elemental */
     , (36222,   3,          2) /* PaletteTemplate */
...
VALUES (36222,   1,   33559881) /* Setup */
     ...
     , (36222,   7,  268437114) /* ClothingBase */
     , (36222,   8,  100672514) /* Icon */
     , (36222,  22,  872415363) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (36222,  0,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (36222,  1,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (36222,  2,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (36222,  3,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (36222,  4,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (36222,  5,  8,300, 0.75,  335,  167,  167,  167,  167,  167,  167,  167,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (36222,  6,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (36222,  7,  8,  0,    0,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (36222,  8,  8,300, 0.75,  335,  167,  167,  167,  167,  167,  167,  167,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (36222, 31, 0, 2, 0, 280, 0, 0) /* CreatureMagic */
     , (36222, 33, 0, 2, 0, 280, 0, 0) /* LifeMagic */
     , (36222, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons */
     , (36222, 15, 0, 2, 0, 280, 0, 0) /* MagicDefense */
     , (36222,  6, 0, 2, 0, 310, 0, 0) /* MeleeDefense */
     , (36222,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense */
     , (36222, 34, 0, 2, 0, 280, 0, 0) /* WarMagic */;
