...
VALUES (1608, 'drudgelurker', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (1608,   1,       5) /* HeartbeatInterval */
     ...
     , (1608,   5,       1) /* ManaRate */
     , (1608,  12,     0.5) /* Shade */
     , (1608,  13,    0.84) /* ArmorModVsSlash */
     , (1608,  14,    0.64) /* ArmorModVsPierce */
     , (1608,  15,     0.9) /* ArmorModVsBludgeon */
     , (1608,  16,    0.84) /* ArmorModVsCold */
     , (1608,  17,     0.9) /* ArmorModVsFire */
     , (1608,  18,    0.84) /* ArmorModVsAcid */
     , (1608,  19,    0.26) /* ArmorModVsElectric */
     , (1608,  31,      24) /* VisualAwarenessRange */
     , (1608,  34,     1.2) /* PowerupTime */
     , (1608,  36,       1) /* ChargeSpeed */
     , (1608,  39,    0.95) /* DefaultScale */
     , (1608,  64,     0.9) /* ResistSlash */
     , (1608,  65,    0.61) /* ResistPierce */
     , (1608,  66,       1) /* ResistBludgeon */
     , (1608,  67,       1) /* ResistFire */
     , (1608,  68,     0.9) /* ResistCold */
     , (1608,  69,     0.9) /* ResistAcid */
     , (1608,  70,    0.23) /* ResistElectric */
...
VALUES (1608,   1, 0x020007DD) /* Setup */
     , (1608,   2, 0x09000008) /* MotionTable */
     , (1608,   3, 0x20000007) /* SoundTable */
     , (1608,   4, 0x30000004) /* CombatTable */
     , (1608,   6, 0x04000F6C) /* PaletteBase */
     , (1608,   7, 0x10000208) /* ClothingBase */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1608,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
