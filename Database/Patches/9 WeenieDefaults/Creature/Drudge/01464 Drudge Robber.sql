...
VALUES (1464, 'drudgerobber', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (1464,   1,       5) /* HeartbeatInterval */
     ...
     , (1464,   3,     0.2) /* HealthRate */
     , (1464,   4,       3) /* StaminaRate */
     , (1464,   5,       1) /* ManaRate */
     , (1464,  12,     0.5) /* Shade */
     , (1464,  13,     0.9) /* ArmorModVsSlash */
     , (1464,  14,       1) /* ArmorModVsPierce */
     , (1464,  15,     1.1) /* ArmorModVsBludgeon */
     , (1464,  16,     0.6) /* ArmorModVsCold */
     , (1464,  17,     0.6) /* ArmorModVsFire */
     , (1464,  18,       1) /* ArmorModVsAcid */
     , (1464,  19,     0.6) /* ArmorModVsElectric */
     , (1464,  31,      20) /* VisualAwarenessRange */
     , (1464,  34,       1) /* PowerupTime */
     , (1464,  36,       1) /* ChargeSpeed */
     , (1464,  39,     1.2) /* DefaultScale */
     , (1464,  64,    0.86) /* ResistSlash */
     , (1464,  65,    0.75) /* ResistPierce */
     , (1464,  66,    0.66) /* ResistBludgeon */
     , (1464,  67,    1.42) /* ResistFire */
     , (1464,  68,    1.42) /* ResistCold */
     , (1464,  69,    0.75) /* ResistAcid */
     , (1464,  70,    1.42) /* ResistElectric */
...
VALUES (1464,   1, 0x020007DD) /* Setup */
     , (1464,   2, 0x09000008) /* MotionTable */
     , (1464,   3, 0x20000007) /* SoundTable */
     , (1464,   4, 0x30000004) /* CombatTable */
     , (1464,   6, 0x04000F6C) /* PaletteBase */
     , (1464,   7, 0x10000204) /* ClothingBase */
     , (1464,   8, 0x06001035) /* Icon */
     , (1464,  22, 0x3400001A) /* PhysicsEffectTable */
...
VALUES (1464,  6, 0, 3, 0,  28, 0, 0) /* MeleeDefense        Specialized */
     , (1464,  7, 0, 3, 0,  20, 0, 0) /* MissileDefense      Specialized */
     , (1464, 15, 0, 3, 0,   8, 0, 0) /* MagicDefense        Specialized */
     , (1464, 20, 0, 3, 0,  15, 0, 0) /* Deception           Specialized */
     , (1464, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (1464, 44, 0, 3, 0,  28, 0, 0) /* HeavyWeapons        Specialized */
     , (1464, 45, 0, 3, 0,  28, 0, 0) /* LightWeapons        Specialized */
     , (1464, 46, 0, 3, 0,  25, 0, 0) /* FinesseWeapons      Specialized */
     , (1464, 47, 0, 3, 0,   0, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (1464,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1464, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1464,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
