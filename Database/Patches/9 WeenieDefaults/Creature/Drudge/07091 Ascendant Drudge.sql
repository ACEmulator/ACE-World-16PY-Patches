...
VALUES (7091, 'drudgeascendant', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7091,   1,       5) /* HeartbeatInterval */
     ...
     , (7091,   3,     0.9) /* HealthRate */
     , (7091,   4,       3) /* StaminaRate */
     , (7091,   5,       1) /* ManaRate */
     , (7091,  12,     0.5) /* Shade */
     , (7091,  13,    0.82) /* ArmorModVsSlash */
     , (7091,  14,    0.44) /* ArmorModVsPierce */
     , (7091,  15,    0.83) /* ArmorModVsBludgeon */
     , (7091,  16,    0.72) /* ArmorModVsCold */
     , (7091,  17,    0.83) /* ArmorModVsFire */
     , (7091,  18,    0.72) /* ArmorModVsAcid */
     , (7091,  19,     0.9) /* ArmorModVsElectric */
     , (7091,  31,      18) /* VisualAwarenessRange */
     , (7091,  34,       1) /* PowerupTime */
     , (7091,  36,       1) /* ChargeSpeed */
     , (7091,  39,     1.3) /* DefaultScale */
     , (7091,  64,     0.9) /* ResistSlash */
     , (7091,  65,    0.56) /* ResistPierce */
     , (7091,  66,    0.96) /* ResistBludgeon */
     , (7091,  67,    0.96) /* ResistFire */
     , (7091,  68,    0.85) /* ResistCold */
     , (7091,  69,    0.85) /* ResistAcid */
     , (7091,  70,    0.18) /* ResistElectric */
...
VALUES (7091,   1, 0x020007DD) /* Setup */
     ...
     , (7091,   4, 0x30000004) /* CombatTable */
     , (7091,   6, 0x04000F6C) /* PaletteBase */
     , (7091,   7, 0x10000203) /* ClothingBase */
...
VALUES (7091,  6, 0, 3, 0, 280, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (7091, 45, 0, 3, 0, 275, 0, 0) /* LightWeapons        Specialized */
...
VALUES (7091,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7091, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7091,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
