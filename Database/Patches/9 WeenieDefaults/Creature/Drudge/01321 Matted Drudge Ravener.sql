...
VALUES (1321, 'drudgeskulkersewer', 10, '2022-08-22 03:09:27') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1321,   1,         16) /* ItemType - Creature */
     , (1321,   2,          3) /* CreatureType - Drudge */
     , (1321,   3,         39) /* PaletteTemplate - Black */
...
VALUES (1321,   1,       5) /* HeartbeatInterval */
     ...
     , (1321,   3,   0.067) /* HealthRate */
     , (1321,   4,       5) /* StaminaRate */
     , (1321,   5,       1) /* ManaRate */
     , (1321,  12,       1) /* Shade */
     , (1321,  13,     0.9) /* ArmorModVsSlash */
     , (1321,  14,       1) /* ArmorModVsPierce */
     , (1321,  15,     1.1) /* ArmorModVsBludgeon */
     , (1321,  16,     0.6) /* ArmorModVsCold */
     , (1321,  17,     0.6) /* ArmorModVsFire */
     , (1321,  18,       1) /* ArmorModVsAcid */
     , (1321,  19,     0.6) /* ArmorModVsElectric */
     , (1321,  31,      25) /* VisualAwarenessRange */
     , (1321,  34,       1) /* PowerupTime */
     , (1321,  36,       1) /* ChargeSpeed */
     , (1321,  39,     1.3) /* DefaultScale */
     , (1321,  64,    0.86) /* ResistSlash */
     , (1321,  65,    0.75) /* ResistPierce */
     , (1321,  66,    0.66) /* ResistBludgeon */
     , (1321,  67,    1.42) /* ResistFire */
     , (1321,  68,    1.42) /* ResistCold */
     , (1321,  69,    0.75) /* ResistAcid */
     , (1321,  70,    1.42) /* ResistElectric */
...
VALUES (1321,   1, 0x020007DD) /* Setup */
     ...
     , (1321,   7, 0x10000209) /* ClothingBase */
...
VALUES (1321,  6, 0, 2, 0,   0, 0, 0) /* MeleeDefense        Trained */
     , (1321,  7, 0, 2, 0,   0, 0, 0) /* MissileDefense      Trained */
     , (1321, 15, 0, 2, 0,   0, 0, 0) /* MagicDefense        Trained */
     , (1321, 24, 0, 2, 0,  40, 0, 0) /* Run                 Trained */
     , (1321, 45, 0, 2, 0,   0, 0, 0) /* LightWeapons        Trained */;
...
VALUES (1321,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1321, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1321,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1321,  5 /* HeartBeat */,   0.09, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1321,  5 /* HeartBeat */,   0.19, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1321,  5 /* HeartBeat */,    0.2, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1321,  5 /* HeartBeat */,    0.1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
