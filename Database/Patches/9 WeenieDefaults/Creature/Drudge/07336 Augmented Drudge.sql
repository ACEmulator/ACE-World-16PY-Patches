...
VALUES (7336, 'drudgeaugmentedhigh', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7336,   1,       5) /* HeartbeatInterval */
     ...
     , (7336,   3,     0.8) /* HealthRate */
     , (7336,   4,       3) /* StaminaRate */
     , (7336,   5,       1) /* ManaRate */
     , (7336,  12,     0.5) /* Shade */
     , (7336,  13,    0.82) /* ArmorModVsSlash */
     , (7336,  14,    0.44) /* ArmorModVsPierce */
     , (7336,  15,    0.83) /* ArmorModVsBludgeon */
     , (7336,  16,    0.72) /* ArmorModVsCold */
     , (7336,  17,    0.83) /* ArmorModVsFire */
     , (7336,  18,    0.72) /* ArmorModVsAcid */
     , (7336,  19,    0.05) /* ArmorModVsElectric */
     , (7336,  31,      18) /* VisualAwarenessRange */
     , (7336,  34,       1) /* PowerupTime */
     , (7336,  36,       1) /* ChargeSpeed */
     , (7336,  39,     1.3) /* DefaultScale */
     , (7336,  64,     0.9) /* ResistSlash */
     , (7336,  65,    0.56) /* ResistPierce */
     , (7336,  66,    0.96) /* ResistBludgeon */
     , (7336,  67,    0.96) /* ResistFire */
     , (7336,  68,    0.85) /* ResistCold */
     , (7336,  69,    0.85) /* ResistAcid */
     , (7336,  70,    0.22) /* ResistElectric */
...
VALUES (7336,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7336, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7336,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (7336, 9, 45876,  1, 0, 0.03, False) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (7336, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (7336, 9, 45875,  1, 0, 0.01, False) /* Create Lucky Gold Letter (45875) for ContainTreasure */
