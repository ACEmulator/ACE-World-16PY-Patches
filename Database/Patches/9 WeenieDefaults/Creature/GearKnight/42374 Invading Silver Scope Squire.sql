...
VALUES (42374, 'ace42374-invadingsilverscopesquire', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (42374,   1, 0x0200190C) /* Setup */
     , (42374,   2, 0x090001A8) /* MotionTable */
     , (42374,   3, 0x200000D3) /* SoundTable */
     , (42374,   4, 0x30000000) /* CombatTable */
     , (42374,   8, 0x06002B2E) /* Icon */
     , (42374,  22, 0x34000025) /* PhysicsEffectTable */
     , (42374,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (42374,  0,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (42374,  1,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (42374,  2,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (42374,  3,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (42374,  4,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (42374,  5,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (42374,  6,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (42374,  7,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (42374,  8,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
