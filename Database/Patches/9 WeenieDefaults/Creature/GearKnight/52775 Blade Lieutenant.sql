...
VALUES (52775,   1,       5) /* HeartbeatInterval */
     ...
     , (52775,  65,     0.9) /* ResistPierce */
     , (52775,  66,     0.9) /* ResistBludgeon */
     , (52775,  67,     0.3) /* ResistFire */
     , (52775,  68,       0) /* ResistCold */
     , (52775,  69,    0.92) /* ResistAcid */
     , (52775,  70,    0.77) /* ResistElectric */
...
VALUES (52775,  6, 0, 2, 0, 477, 0, 0) /* MeleeDefense        Trained */
     , (52775,  7, 0, 2, 0, 445, 0, 0) /* MissileDefense      Trained */
     , (52775, 15, 0, 2, 0, 447, 0, 0) /* MagicDefense        Trained */
     ...
     , (52775, 41, 0, 2, 0, 460, 0, 0) /* TwoHandedCombat     Trained */
...
VALUES (52775,  0,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52775,  1,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52775,  2,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (52775,  3,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52775,  4,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (52775,  5,  4, 110,  0.4,  400,  400,  400,  400,  400,  400,  280,  300,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (52775,  6,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (52775,  7,  4,  0,    0,  400,  400,  400,  400,  400,  400,  280,  300,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
