...
VALUES (87255, 'ace87255-coppercogknight', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (87255,   1,       5) /* HeartbeatInterval */
     ...
     , (87255,  69,    0.88) /* ResistAcid */
     , (87255,  70,    0.87) /* ResistElectric */
...
VALUES (87255,   1, 0x0200190A) /* Setup */
     , (87255,   2, 0x090001A8) /* MotionTable */
     , (87255,   3, 0x200000D3) /* SoundTable */
     , (87255,   4, 0x30000000) /* CombatTable */
     , (87255,   8, 0x06002B2E) /* Icon */
     , (87255,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (87255,  0,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87255,  1,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87255,  2,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87255,  3,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87255,  4,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87255,  5,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87255,  6,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87255,  7,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87255,  8,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (87255, 10, 41240,  1, 0, 0.5, False) /* Create Gearknight Sword (41240) for WieldTreasure */
     , (87255, 10, 41244,  1, 0, 0.5, False) /* Create Gearknight Greatsword (41244) for WieldTreasure */;
