...
VALUES (41539, 'ace41539-invadingsilverscopesquire', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (41539,   1, 0x0200190C) /* Setup */
     ...
     , (41539,   4, 0x30000000) /* CombatTable */
     , (41539,   8, 0x06002B2E) /* Icon */
     , (41539,  22, 0x34000025) /* PhysicsEffectTable */
     , (41539,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (41539,  0,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41539,  1,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41539,  2,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41539,  3,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41539,  4,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41539,  5,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41539,  6,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41539,  7,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41539,  8,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  258,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41539, 2, 43132,  1, 0, 0, False) /* Create Gear Crossbow (43132) for Wield */
     ...
     , (41539, 9, 51266,  1, 0, 0.3, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (41539, 9,     0,  1, 0, 0.7, False) /* Create nothing for ContainTreasure */;
