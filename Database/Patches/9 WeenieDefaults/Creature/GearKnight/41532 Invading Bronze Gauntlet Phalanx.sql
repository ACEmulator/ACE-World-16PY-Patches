...
VALUES (41532, 'ace41532-invadingbronzegauntletphalanx', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (41532,   1, 0x02001908) /* Setup */
     ...
     , (41532,   4, 0x30000000) /* CombatTable */
...
VALUES (41532,  0,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41532,  1,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41532,  2,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41532,  3,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41532,  4,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41532,  5,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41532,  6,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41532,  7,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41532,  8,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41532, 9, 41528,  1, 0, 0.35, False) /* Create Aetherium Power Core (41528) for ContainTreasure */
     ...
     , (41532, 9, 51266,  1, 0, 0.2, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (41532, 9,     0,  1, 0, 0.8, False) /* Create nothing for ContainTreasure */
