...
VALUES (41537, 'ace41537-invadingcoppercogsquire', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (41537,   1,       5) /* HeartbeatInterval */
     ...
     , (41537,  31,      33) /* VisualAwarenessRange */
     , (41537,  34,       1) /* PowerupTime */
     , (41537,  36,       1) /* ChargeSpeed */
...
VALUES (41537,   1, 0x0200190A) /* Setup */
     ...
     , (41537,   4, 0x30000000) /* CombatTable */
     , (41537,   8, 0x06002B2E) /* Icon */
     , (41537,  22, 0x34000025) /* PhysicsEffectTable */
     , (41537,  35,       1011) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (41537,  0,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41537,  1,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41537,  2,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41537,  3,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41537,  4,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41537,  5,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41537,  6,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41537,  7,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41537,  8,  4, 190,  0.5,  430,  387,  387,  387,  602,  602,  172,  301,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41537, 9, 41528,  1, 0, 0.35, False) /* Create Aetherium Power Core (41528) for ContainTreasure */
     ...
     , (41537, 9, 51266,  1, 0, 0.3, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (41537, 9,     0,  1, 0, 0.7, False) /* Create nothing for ContainTreasure */
     , (41537, 10, 41245,  1, 0, 0.2, False) /* Create Gearknight Greatsword (41245) for WieldTreasure */
     , (41537, 10, 41237,  1, 0, 0.2, False) /* Create Gearknight Sword (41237) for WieldTreasure */
     , (41537, 10, 41246,  1, 0, 0.15, False) /* Create Acid Gearknight Sword (41246) for WieldTreasure */
     , (41537, 10, 41247,  1, 0, 0.15, False) /* Create Electric Gearknight Sword (41247) for WieldTreasure */
     , (41537, 10, 41248,  1, 0, 0.15, False) /* Create Fire Gearknight Sword (41248) for WieldTreasure */
     , (41537, 10, 41249,  1, 0, 0.15, False) /* Create Frost Gearknight Sword (41249) for WieldTreasure */;
