...
VALUES (87257, 'ace87257-ironbladeknight', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (87257,  0,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87257,  1,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87257,  2,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87257,  3,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87257,  4,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87257,  5,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87257,  6,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87257,  7,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87257,  8,  4, 80,  0.5,  450,  437,  441,  441,  446,  446,  248,  243,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (87257, 10, 41240,  1, 0, 0.5, False) /* Create Gearknight Sword (41240) for WieldTreasure */
     , (87257, 10, 41244,  1, 0, 0.5, False) /* Create Gearknight Greatsword (41244) for WieldTreasure */;
