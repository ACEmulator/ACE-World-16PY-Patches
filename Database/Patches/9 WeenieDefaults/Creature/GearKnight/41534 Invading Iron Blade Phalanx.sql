...
VALUES (41534, 'ace41534-invadingironbladephalanx', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (41534,   1,         16) /* ItemType - Creature */
     , (41534,   2,         99) /* CreatureType - GearKnight */
     , (41534,   6,         -1) /* ItemsCapacity */
     , (41534,   7,         -1) /* ContainersCapacity */
...
VALUES (41534,   1, 0x02001909) /* Setup */
     , (41534,   2, 0x090001A8) /* MotionTable */
     , (41534,   3, 0x200000D3) /* SoundTable */
     , (41534,   4, 0x30000000) /* CombatTable */
     , (41534,   8, 0x06002B2E) /* Icon */
     , (41534,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (41534,  0,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41534,  1,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41534,  2,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41534,  3,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41534,  4,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41534,  5,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41534,  6,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41534,  7,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41534,  8,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41534, 2, 43132,  1, 0, 0, False) /* Create Gear Crossbow (43132) for Wield */
     ...
     , (41534, 9, 51266,  1, 0, 0.2, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (41534, 9,     0,  1, 0, 0.8, False) /* Create nothing for ContainTreasure */;
