...
VALUES (41533, 'ace41533-invadingcoppercogphalanx', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (41533,   1, 0x0200190A) /* Setup */
     , (41533,   2, 0x090001A8) /* MotionTable */
     , (41533,   3, 0x200000D3) /* SoundTable */
     , (41533,   4, 0x30000000) /* CombatTable */
     , (41533,   8, 0x06002B2E) /* Icon */
     , (41533,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (41533,  0,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41533,  1,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41533,  2,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41533,  3,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41533,  4,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41533,  5,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41533,  6,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41533,  7,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41533,  8,  4, 180,  0.5,  400,  320,  320,  320,  520,  520,  120,  200,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41533, 9, 41528,  1, 0, 0.35, False) /* Create Aetherium Power Core (41528) for ContainTreasure */
     ...
     , (41533, 9, 51266,  1, 0, 0.2, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (41533, 9,     0,  1, 0, 0.8, False) /* Create nothing for ContainTreasure */
