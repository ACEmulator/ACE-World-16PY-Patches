...
VALUES (51611, 'ace51611-corruptsorcerer', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51611,  6, 0, 2, 0, 527, 0, 0) /* MeleeDefense        Trained */
     , (51611,  7, 0, 2, 0, 510, 0, 0) /* MissileDefense      Trained */
     , (51611, 15, 0, 2, 0, 333, 0, 0) /* MagicDefense        Trained */
     , (51611, 31, 0, 2, 0, 240, 0, 0) /* CreatureEnchantment Trained */
     , (51611, 33, 0, 2, 0, 240, 0, 0) /* LifeMagic           Trained */
     , (51611, 34, 0, 2, 0, 240, 0, 0) /* WarMagic            Trained */
     , (51611, 43, 0, 2, 0, 240, 0, 0) /* VoidMagic           Trained */
     , (51611, 45, 0, 2, 0, 537, 0, 0) /* LightWeapons        Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51611,  0, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51611,  1, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51611,  2, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51611,  3, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51611,  4, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51611,  5, 64, 200,  0.5,  400,  585,  650,  650,  650,  585,  585,  650,  650, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51611,  6, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51611,  7, 64,  0,    0,  400,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51611,  8, 64, 200,  0.5,  400,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51611,  3940,   2.15)  /* Exsanguinating Wave */
     , (51611,  3997,  2.176)  /* Heavy Lightning Ring */
