...
VALUES (238, 'virindipuppet', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (238,   1,       5) /* HeartbeatInterval */
     ...
     , (238,  16,    0.79) /* ArmorModVsCold */
     , (238,  17,       1) /* ArmorModVsFire */
     , (238,  18,       1) /* ArmorModVsAcid */
     , (238,  19,    0.79) /* ArmorModVsElectric */
...
VALUES (238,   1, 0x02000041) /* Setup */
     ...
     , (238,   4, 0x3000000D) /* CombatTable */
     , (238,   6, 0x040009B2) /* PaletteBase */
     , (238,   7, 0x100000C0) /* ClothingBase */
...
VALUES (238,  6, 0, 3, 0,  65, 0, 0) /* MeleeDefense        Specialized */
     , (238,  7, 0, 3, 0, 165, 0, 0) /* MissileDefense      Specialized */
     , (238, 14, 0, 3, 0, 200, 0, 0) /* ArcaneLore          Specialized */
     , (238, 15, 0, 3, 0,  77, 0, 0) /* MagicDefense        Specialized */
     , (238, 20, 0, 3, 0,  80, 0, 0) /* Deception           Specialized */
     , (238, 24, 0, 3, 0,  80, 0, 0) /* Run                 Specialized */
     , (238, 31, 0, 3, 0,  52, 0, 0) /* CreatureEnchantment Specialized */
     , (238, 33, 0, 3, 0,  52, 0, 0) /* LifeMagic           Specialized */
     , (238, 34, 0, 3, 0,  52, 0, 0) /* WarMagic            Specialized */
     , (238, 45, 0, 3, 0,  76, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (238,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (238, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (238,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (238, 9,  9291,  0, 0, 0.02, False) /* Create Virindi Master Key (9291) for ContainTreasure */
     , (238, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (238, 9,  7604,  0, 0, 0.0125, False) /* Create Yellow Jewel (7604) for ContainTreasure */
     , (238, 9,  3698,  0, 0, 0.0125, False) /* Create White Jewel (3698) for ContainTreasure */
     , (238, 9,  3696,  0, 0, 0.0125, False) /* Create Blue Jewel (3696) for ContainTreasure */
     , (238, 9,  3697,  0, 0, 0.0125, False) /* Create Red Jewel (3697) for ContainTreasure */
     , (238, 9, 41470,  0, 0, 0.0125, False) /* Create Purple Jewel (41470) for ContainTreasure */
     , (238, 9,     0,  0, 0, 0.9375, False) /* Create nothing for ContainTreasure */;
