...
VALUES (51726, 'ace51726-discorporaterynthidofblindrage', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51726,   1, 0x02001BCE) /* Setup */
     , (51726,   2, 0x0900021F) /* MotionTable */
     , (51726,   3, 0x20000012) /* SoundTable */
     , (51726,   4, 0x3000000D) /* CombatTable */
     , (51726,   6, 0x040009B2) /* PaletteBase */
     , (51726,   7, 0x10000854) /* ClothingBase */
     , (51726,   8, 0x06001227) /* Icon */
     , (51726,  22, 0x340000D3) /* PhysicsEffectTable */
     , (51726,  30,         84) /* PhysicsScript - BreatheFlame */
     , (51726,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51726,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (51726, 15, 0, 2, 0, 389, 0, 0) /* MagicDefense        Trained */
     , (51726, 31, 0, 2, 0, 370, 0, 0) /* CreatureEnchantment Trained */
     , (51726, 33, 0, 2, 0, 370, 0, 0) /* LifeMagic           Trained */
     , (51726, 34, 0, 2, 0, 370, 0, 0) /* WarMagic            Trained */
     , (51726, 43, 0, 2, 0, 370, 0, 0) /* VoidMagic           Trained */
     , (51726, 45, 0, 2, 0, 530, 0, 0) /* LightWeapons        Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51726,  0, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51726,  1, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51726,  2, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51726,  3, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51726,  4, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51726,  5, 16, 270,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51726,  6, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51726,  7, 16,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51726,  8, 16, 270,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
