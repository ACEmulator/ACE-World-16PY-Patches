...
VALUES (51732, 'ace51732-discorporaterynthidofconsumingtorment', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51732,   1, 0x02001BCA) /* Setup */
     ...
     , (51732,   4, 0x3000000D) /* CombatTable */
     , (51732,   6, 0x040009B2) /* PaletteBase */
     , (51732,   7, 0x10000854) /* ClothingBase */
...
VALUES (51732,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (51732, 15, 0, 2, 0, 389, 0, 0) /* MagicDefense        Trained */
     , (51732, 31, 0, 2, 0, 370, 0, 0) /* CreatureEnchantment Trained */
     , (51732, 33, 0, 2, 0, 370, 0, 0) /* LifeMagic           Trained */
     , (51732, 34, 0, 2, 0, 370, 0, 0) /* WarMagic            Trained */
     , (51732, 43, 0, 2, 0, 370, 0, 0) /* VoidMagic           Trained */
     , (51732, 45, 0, 2, 0, 530, 0, 0) /* LightWeapons        Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51732,  0, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51732,  1, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51732,  2, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51732,  3, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51732,  4, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51732,  5, 64, 270,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51732,  6, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51732,  7, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51732,  8, 64, 270,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
