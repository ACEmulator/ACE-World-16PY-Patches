...
VALUES (52716, 'ace52716-virindirival', 10, '2022-03-31 11:33:25') /* Creature */;
...
VALUES (52716,   1,       5) /* HeartbeatInterval */
     ...
     , (52716,  64,    0.75) /* ResistSlash */
     , (52716,  65,    0.55) /* ResistPierce */
     , (52716,  66,    0.45) /* ResistBludgeon */
     , (52716,  67,    0.82) /* ResistFire */
     , (52716,  68,    0.65) /* ResistCold */
     , (52716,  69,    0.55) /* ResistAcid */
     , (52716,  70,     0.8) /* ResistElectric */
...
VALUES (52716,  0,  1,  0,    0,  570,  285,  285,  285,  285,  285,  285,  285,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52716,  1,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52716,  2,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (52716,  3,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52716,  4,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (52716,  5,  1,175, 0.75,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (52716, 17,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
