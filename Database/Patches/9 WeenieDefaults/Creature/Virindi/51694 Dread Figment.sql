...
VALUES (51694, 'ace51694-dreadfigment', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51694,   1, 0x02001BCE) /* Setup */
     , (51694,   2, 0x0900021F) /* MotionTable */
     , (51694,   3, 0x200000B6) /* SoundTable */
     , (51694,   4, 0x3000000D) /* CombatTable */
     , (51694,   6, 0x040009B2) /* PaletteBase */
     , (51694,   8, 0x06001227) /* Icon */
     , (51694,  22, 0x340000D3) /* PhysicsEffectTable */;
...
VALUES (51694,  0,  1,  0,    0,  120,  120,  120,  120,  120,  120,  120,  120,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51694,  1,  1,  0,    0,  120,  120,  120,  120,  120,  120,  120,  120,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51694,  2,  1,  0,    0,  120,  120,  120,  120,  120,  120,  120,  120,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (51694,  3,  1,  0,    0,  100,  100,  100,  100,  100,  100,  100,  100,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51694,  4,  1,  0,    0,  100,  100,  100,  100,  100,  100,  100,  100,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (51694,  5,  1, 15, 0.75,  100,  100,  100,  100,  100,  100,  100,  100,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51694, 17,  1,  0,    0,  100,  100,  100,  100,  100,  100,  100,  100,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
