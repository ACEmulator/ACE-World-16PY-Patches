...
VALUES (10802,   1,       5) /* HeartbeatInterval */
     ...
     , (10802,  67,     0.2) /* ResistFire */
     , (10802,  68,       0) /* ResistCold */
     , (10802,  69,     0.3) /* ResistAcid */
...
VALUES (10802,   1, 0x02000A6A) /* Setup */
     ...
     , (10802,   4, 0x30000027) /* CombatTable */
     , (10802,   8, 0x060020D6) /* Icon */
     , (10802,  22, 0x3400008F) /* PhysicsEffectTable */
     , (10802,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (10802, 0.5, 10808, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, -1, 9, 0.819152, 0, 0, -0.573577) /* Generate Augmented Tumerok (10808) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (10802, 0.75, 10775, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, 3.4, 9, 0.965926, 0, 0, -0.258819) /* Generate Augmented Drudge (10775) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (10802, 0.85, 10778, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, -1.4, 9, 0.996195, 0, 0, -0.087156) /* Generate Unconquered Drudge (10778) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (10802, 0.9, 10818, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, -2, 9, 0.996195, 0, 0, -0.087156) /* Generate Virindi Executor (10818) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
