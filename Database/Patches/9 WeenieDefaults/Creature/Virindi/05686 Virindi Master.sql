...
VALUES (5686, 'virindimasterlethe', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (5686,   1,       5) /* HeartbeatInterval */
     ...
     , (5686,  16,    0.72) /* ArmorModVsCold */
     , (5686,  17,       1) /* ArmorModVsFire */
     , (5686,  18,       1) /* ArmorModVsAcid */
     , (5686,  19,    0.72) /* ArmorModVsElectric */
...
VALUES (5686,   1, 0x02000041) /* Setup */
     , (5686,   2, 0x09000028) /* MotionTable */
     , (5686,   3, 0x20000012) /* SoundTable */
     , (5686,   4, 0x3000000D) /* CombatTable */
     , (5686,   6, 0x040009B2) /* PaletteBase */
     , (5686,   7, 0x100000C1) /* ClothingBase */
     , (5686,   8, 0x06001227) /* Icon */
     , (5686,  22, 0x34000029) /* PhysicsEffectTable */
...
VALUES (5686,  6, 0, 2, 0, 180, 0, 436.247985454865) /* MeleeDefense        Trained */
     , (5686,  7, 0, 2, 0, 100, 0, 436.247985454865) /* MissileDefense      Trained */
     , (5686, 13, 0, 2, 0, 150, 0, 436.247985454865) /* UnarmedCombat       Trained */
     , (5686, 14, 0, 2, 0, 230, 0, 436.247985454865) /* ArcaneLore          Trained */
     , (5686, 15, 0, 2, 0, 225, 0, 436.247985454865) /* MagicDefense        Trained */
     , (5686, 20, 0, 2, 0, 130, 0, 436.247985454865) /* Deception           Trained */
     , (5686, 24, 0, 2, 0,  80, 0, 436.247985454865) /* Run                 Trained */
     , (5686, 31, 0, 2, 0, 230, 0, 436.247985454865) /* CreatureEnchantment Trained */
     , (5686, 33, 0, 2, 0, 200, 0, 436.247985454865) /* LifeMagic           Trained */
     , (5686, 34, 0, 2, 0, 250, 0, 436.247985454865) /* WarMagic            Trained */;
...
VALUES (5686,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (5686, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5686,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (5686, 1,  5680,  0, 0, 1, False) /* Create Torn Journal (5680) for Contain */
     ...
     , (5686, 9,  3696,  0, 0, 0.0125, False) /* Create Blue Jewel (3696) for ContainTreasure */
     , (5686, 9,  3697,  0, 0, 0.0125, False) /* Create Red Jewel (3697) for ContainTreasure */
     , (5686, 9, 41470,  0, 0, 0.0125, False) /* Create Purple Jewel (41470) for ContainTreasure */
