...
VALUES (51834, 'ace51834-maliciousspirit', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51834,   1, 0x02001BCC) /* Setup */
     ...
     , (51834,   4, 0x3000000D) /* CombatTable */
     , (51834,   6, 0x040009B2) /* PaletteBase */
     , (51834,   7, 0x10000854) /* ClothingBase */
...
VALUES (51834,  0, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51834,  1, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51834,  2, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51834,  3, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51834,  4, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51834,  5, 64, 200,  0.5,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51834,  6, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51834,  7, 64,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51834,  8, 64, 200,  0.5,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51834,  3885,    2.1)  /* Galvanic Ring */;
