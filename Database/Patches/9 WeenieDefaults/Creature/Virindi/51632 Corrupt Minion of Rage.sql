...
VALUES (51632, 'ace51632-corruptminionofrage', 10, '2020-10-21 21:40:21') /* Creature */;
...
VALUES (51632,   1,         16) /* ItemType - Creature */
     ...
     , (51632,  25,        240) /* Level */
     , (51632,  65,          1) /* Placement - RightHandCombat */
...
VALUES (51632,   1,       5) /* HeartbeatInterval */
     ...
     , (51632, 165,       1) /* ArmorModVsNether */
     , (51632, 166,       1) /* ResistNether */;
...
VALUES (51632,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     , (51632,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense      Trained */
     , (51632, 15, 0, 2, 0, 360, 0, 0) /* MagicDefense        Trained */
     , (51632, 16, 0, 2, 0, 405, 0, 0) /* ManaConversion      Trained */
     , (51632, 31, 0, 2, 0, 405, 0, 0) /* CreatureEnchantment Trained */
     , (51632, 33, 0, 2, 0, 405, 0, 0) /* LifeMagic           Trained */
     , (51632, 34, 0, 2, 0, 405, 0, 0) /* WarMagic            Trained */
     , (51632, 41, 0, 2, 0, 450, 0, 0) /* TwoHandedCombat     Trained */
     , (51632, 43, 0, 2, 0, 405, 0, 0) /* VoidMagic           Trained */
     , (51632, 44, 0, 2, 0, 450, 0, 0) /* HeavyWeapons        Trained */
     , (51632, 45, 0, 2, 0, 450, 0, 0) /* LightWeapons        Trained */
     , (51632, 46, 0, 2, 0, 450, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51632,  0, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51632,  1, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51632,  2, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51632,  3, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51632,  4, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51632,  5, 16, 180,  0.5,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51632,  6, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51632,  7, 16,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51632,  8, 16, 180,  0.5,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
