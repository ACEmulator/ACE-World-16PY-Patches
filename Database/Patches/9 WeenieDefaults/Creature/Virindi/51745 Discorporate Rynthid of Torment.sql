...
VALUES (51745, 'ace51745-discorporaterynthidoftorment', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51745,   1, 0x02001BCA) /* Setup */
     ...
     , (51745,   4, 0x3000000D) /* CombatTable */
     , (51745,   6, 0x040009B2) /* PaletteBase */
     , (51745,   7, 0x10000854) /* ClothingBase */
...
VALUES (51745,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (51745, 15, 0, 2, 0, 389, 0, 0) /* MagicDefense        Trained */
     , (51745, 31, 0, 2, 0, 370, 0, 0) /* CreatureEnchantment Trained */
     , (51745, 33, 0, 2, 0, 370, 0, 0) /* LifeMagic           Trained */
     , (51745, 34, 0, 2, 0, 370, 0, 0) /* WarMagic            Trained */
     , (51745, 43, 0, 2, 0, 370, 0, 0) /* VoidMagic           Trained */
     , (51745, 45, 0, 2, 0, 530, 0, 0) /* LightWeapons        Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51745,  0, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51745,  1, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51745,  2, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51745,  3, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51745,  4, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51745,  5, 64, 250,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51745,  6, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51745,  7, 64,  0,    0,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51745,  8, 64, 250,  0.5,  500,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
