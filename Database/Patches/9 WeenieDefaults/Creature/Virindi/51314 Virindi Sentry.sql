...
VALUES (51314, 'ace51314-virindisentry', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51314,  0, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51314,  1, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51314,  2, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51314,  3, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51314,  4, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51314,  5, 64, 180,  0.5,  550,  440,  550,  550,  550,  440,  550,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51314,  6, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51314,  7, 64,  0,    0,  550,  440,  550,  550,  550,  440,  550,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51314,  8, 64, 180,  0.5,  550,  440,  550,  550,  550,  440,  550,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
