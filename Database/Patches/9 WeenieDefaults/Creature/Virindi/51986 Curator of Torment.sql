...
VALUES (51986, 'ace51986-curatoroftorment', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51986,   1,         16) /* ItemType - Creature */
     , (51986,   2,         19) /* CreatureType - Virindi */
     , (51986,   3,         11) /* PaletteTemplate - Maroon */
...
VALUES (51986,   1, 0x02001C07) /* Setup */
     ...
     , (51986,   4, 0x3000000D) /* CombatTable */
     , (51986,   6, 0x040009B2) /* PaletteBase */
     , (51986,   7, 0x100007AF) /* ClothingBase */
...
VALUES (51986,  0,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51986,  1,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51986,  2,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51986,  3,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51986,  4,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51986,  5,  1, 220,  0.5,  550,  550,  550,  550,  550,  550,  550,  550,    0, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51986,  6,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51986,  7,  1,  0,    0,  550,  550,  550,  550,  550,  550,  550,  550,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51986,  8,  1, 220,  0.5,  550,  550,  550,  550,  550,  550,  550,  550,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
