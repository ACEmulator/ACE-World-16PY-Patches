...
VALUES (8538, 'grievverbaneherald', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (8538,   1,       5) /* HeartbeatInterval */
     ...
     , (8538,   3,    0.85) /* HealthRate */
     , (8538,   4,       3) /* StaminaRate */
     , (8538,   5,       1) /* ManaRate */
     , (8538,  12,     0.5) /* Shade */
     , (8538,  13,     0.6) /* ArmorModVsSlash */
     , (8538,  14,     0.7) /* ArmorModVsPierce */
     , (8538,  15,    0.94) /* ArmorModVsBludgeon */
     , (8538,  16,    0.36) /* ArmorModVsCold */
     , (8538,  17,    0.36) /* ArmorModVsFire */
     , (8538,  18,    0.36) /* ArmorModVsAcid */
     , (8538,  19,    0.36) /* ArmorModVsElectric */
     , (8538,  31,      15) /* VisualAwarenessRange */
     , (8538,  34,       1) /* PowerupTime */
     , (8538,  36,       1) /* ChargeSpeed */
     , (8538,  39,     1.5) /* DefaultScale */
     , (8538,  64,       1) /* ResistSlash */
     , (8538,  65,     0.9) /* ResistPierce */
     , (8538,  66,    0.67) /* ResistBludgeon */
...
VALUES (8538,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8538, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8538,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
