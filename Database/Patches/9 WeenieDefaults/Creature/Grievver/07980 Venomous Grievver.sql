...
VALUES (7980, 'grievvervenomous', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7980,   1,       5) /* HeartbeatInterval */
     ...
     , (7980,   3,     0.8) /* HealthRate */
     , (7980,   4,       3) /* StaminaRate */
     , (7980,   5,       1) /* ManaRate */
     , (7980,  12,     0.5) /* Shade */
     , (7980,  13,     0.6) /* ArmorModVsSlash */
     , (7980,  14,     0.7) /* ArmorModVsPierce */
     , (7980,  15,    0.92) /* ArmorModVsBludgeon */
     , (7980,  16,    0.31) /* ArmorModVsCold */
     , (7980,  17,    0.31) /* ArmorModVsFire */
     , (7980,  18,    0.31) /* ArmorModVsAcid */
     , (7980,  19,    0.31) /* ArmorModVsElectric */
     , (7980,  31,      10) /* VisualAwarenessRange */
     , (7980,  34,       1) /* PowerupTime */
     , (7980,  36,       1) /* ChargeSpeed */
     , (7980,  39,     1.2) /* DefaultScale */
     , (7980,  64,       1) /* ResistSlash */
     , (7980,  65,     0.9) /* ResistPierce */
     , (7980,  66,    0.67) /* ResistBludgeon */
...
VALUES (7980,   1, 0x020008DA) /* Setup */
     ...
     , (7980,   4, 0x3000002B) /* CombatTable */
     , (7980,   6, 0x04000FDF) /* PaletteBase */
     , (7980,   7, 0x10000246) /* ClothingBase */
     , (7980,   8, 0x06001DF0) /* Icon */
     , (7980,  19, 0x00000057) /* ActivationAnimation */
...
VALUES (7980,  6, 0, 3, 0, 172, 0, 0) /* MeleeDefense        Specialized */
     , (7980,  7, 0, 3, 0, 250, 0, 0) /* MissileDefense      Specialized */
     , (7980, 14, 0, 3, 0, 150, 0, 0) /* ArcaneLore          Specialized */
     , (7980, 15, 0, 3, 0, 230, 0, 0) /* MagicDefense        Specialized */
     , (7980, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (7980, 31, 0, 3, 0, 120, 0, 0) /* CreatureEnchantment Specialized */
     , (7980, 33, 0, 3, 0, 120, 0, 0) /* LifeMagic           Specialized */
     , (7980, 34, 0, 3, 0, 120, 0, 0) /* WarMagic            Specialized */
     , (7980, 45, 0, 3, 0, 170, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (7980,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7980, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7980,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7980,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7980,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7980,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
