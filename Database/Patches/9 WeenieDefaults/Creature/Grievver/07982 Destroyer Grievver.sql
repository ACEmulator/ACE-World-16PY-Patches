...
VALUES (7982, 'grievverdestroyer', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7982,   1,       5) /* HeartbeatInterval */
     ...
     , (7982,   3,    0.85) /* HealthRate */
     , (7982,   4,       3) /* StaminaRate */
     , (7982,   5,       1) /* ManaRate */
     , (7982,  12,     0.5) /* Shade */
     , (7982,  13,     0.6) /* ArmorModVsSlash */
     , (7982,  14,     0.7) /* ArmorModVsPierce */
     , (7982,  15,    0.93) /* ArmorModVsBludgeon */
     , (7982,  16,    0.35) /* ArmorModVsCold */
     , (7982,  17,    0.35) /* ArmorModVsFire */
     , (7982,  18,    0.35) /* ArmorModVsAcid */
     , (7982,  19,    0.35) /* ArmorModVsElectric */
     , (7982,  31,      15) /* VisualAwarenessRange */
     , (7982,  34,       1) /* PowerupTime */
     , (7982,  36,       1) /* ChargeSpeed */
     , (7982,  39,     1.4) /* DefaultScale */
     , (7982,  64,       1) /* ResistSlash */
     , (7982,  65,     0.9) /* ResistPierce */
     , (7982,  66,    0.67) /* ResistBludgeon */
...
VALUES (7982,   1, 0x020008DA) /* Setup */
     , (7982,   2, 0x0900009A) /* MotionTable */
     , (7982,   3, 0x20000061) /* SoundTable */
     , (7982,   4, 0x3000002B) /* CombatTable */
     , (7982,   6, 0x04000FDF) /* PaletteBase */
     , (7982,   7, 0x10000246) /* ClothingBase */
     , (7982,   8, 0x06001DF0) /* Icon */
     , (7982,  19, 0x00000056) /* ActivationAnimation */
     , (7982,  22, 0x34000084) /* PhysicsEffectTable */
     , (7982,  30,         87) /* PhysicsScript - BreatheLightning */
     , (7982,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (7982,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7982, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7982,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7982,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7982,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7982,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
