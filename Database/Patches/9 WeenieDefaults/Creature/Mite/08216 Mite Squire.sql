...
VALUES (8216, 'mitesquirexara', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (8216,   1,         16) /* ItemType - Creature */
     ...
     , (8216,  25,         20) /* Level */
     , (8216,  27,          0) /* ArmorType - None */
     , (8216,  40,          2) /* CombatMode - Melee */
     , (8216,  68,          5) /* TargetingTactic - Random, LastDamager */
...
VALUES (8216,   1,       5) /* HeartbeatInterval */
     ...
     , (8216,   3,     0.2) /* HealthRate */
     , (8216,   4,       5) /* StaminaRate */
     , (8216,   5,       2) /* ManaRate */
     , (8216,  12,     0.5) /* Shade */
     , (8216,  13,    0.51) /* ArmorModVsSlash */
     , (8216,  14,    0.33) /* ArmorModVsPierce */
     , (8216,  15,    0.33) /* ArmorModVsBludgeon */
     , (8216,  16,    0.51) /* ArmorModVsCold */
     , (8216,  17,     0.5) /* ArmorModVsFire */
     , (8216,  18,     0.5) /* ArmorModVsAcid */
     , (8216,  19,    0.33) /* ArmorModVsElectric */
     , (8216,  31,      18) /* VisualAwarenessRange */
     , (8216,  34,       2) /* PowerupTime */
     , (8216,  36,       1) /* ChargeSpeed */
     , (8216,  64,     0.7) /* ResistSlash */
     , (8216,  65,     0.8) /* ResistPierce */
     , (8216,  66,     0.8) /* ResistBludgeon */
     , (8216,  67,       1) /* ResistFire */
     , (8216,  68,    0.75) /* ResistCold */
     , (8216,  69,       1) /* ResistAcid */
     , (8216,  70,     0.8) /* ResistElectric */
...
VALUES (8216,   1, 0x02001080) /* Setup */
     ...
     , (8216,   4, 0x30000010) /* CombatTable */
     , (8216,   6, 0x04001881) /* PaletteBase */
     , (8216,   7, 0x10000550) /* ClothingBase */
     , (8216,   8, 0x06001038) /* Icon */
     , (8216,  22, 0x3400001F) /* PhysicsEffectTable */
     , (8216,  35,        459) /* DeathTreasureType - Loot Tier: 1 */;
...
VALUES (8216,  6, 0, 3, 0,  60, 0, 0) /* MeleeDefense        Specialized */
     , (8216,  7, 0, 3, 0,  94, 0, 0) /* MissileDefense      Specialized */
     , (8216, 15, 0, 3, 0,  61, 0, 0) /* MagicDefense        Specialized */
     , (8216, 20, 0, 3, 0,  50, 0, 0) /* Deception           Specialized */
     , (8216, 22, 0, 3, 0,  80, 0, 0) /* Jump                Specialized */
     , (8216, 24, 0, 3, 0,  80, 0, 0) /* Run                 Specialized */
     , (8216, 45, 0, 3, 0,  80, 0, 0) /* LightWeapons        Specialized */
     , (8216, 47, 0, 3, 0,   0, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (8216,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8216, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8216, 9,  8214,  0, 0, 1, False) /* Create Guard Post Key (8214) for ContainTreasure */;
