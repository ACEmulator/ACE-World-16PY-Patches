...
VALUES (9057, 'golemzirconium', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (9057,   1,       5) /* HeartbeatInterval */
     ...
     , (9057,   3,    0.15) /* HealthRate */
     , (9057,   4,       5) /* StaminaRate */
     , (9057,   5,       2) /* ManaRate */
     , (9057,  12,     0.5) /* Shade */
     , (9057,  13,    0.79) /* ArmorModVsSlash */
     , (9057,  14,    0.79) /* ArmorModVsPierce */
     , (9057,  15,    0.79) /* ArmorModVsBludgeon */
     , (9057,  16,     0.8) /* ArmorModVsCold */
     , (9057,  17,     0.7) /* ArmorModVsFire */
     , (9057,  18,    0.17) /* ArmorModVsAcid */
     , (9057,  19,    0.79) /* ArmorModVsElectric */
     , (9057,  31,      13) /* VisualAwarenessRange */
     , (9057,  34,       2) /* PowerupTime */
     , (9057,  36,       1) /* ChargeSpeed */
     , (9057,  39,     1.1) /* DefaultScale */
     , (9057,  64,    0.83) /* ResistSlash */
     , (9057,  65,    0.83) /* ResistPierce */
     , (9057,  66,    0.83) /* ResistBludgeon */
     , (9057,  67,       1) /* ResistFire */
     , (9057,  68,       1) /* ResistCold */
     , (9057,  69,    0.33) /* ResistAcid */
     , (9057,  70,    0.83) /* ResistElectric */
...
VALUES (9057,  6, 0, 3, 0,  20, 0, 0) /* MeleeDefense        Specialized */
     , (9057,  7, 0, 3, 0,  30, 0, 0) /* MissileDefense      Specialized */
     , (9057, 14, 0, 3, 0, 100, 0, 0) /* ArcaneLore          Specialized */
     , (9057, 15, 0, 3, 0,  35, 0, 0) /* MagicDefense        Specialized */
     , (9057, 20, 0, 3, 0,  80, 0, 0) /* Deception           Specialized */
     , (9057, 24, 0, 3, 0,  10, 0, 0) /* Run                 Specialized */
     , (9057, 31, 0, 3, 0,  35, 0, 0) /* CreatureEnchantment Specialized */
     , (9057, 33, 0, 3, 0,  35, 0, 0) /* LifeMagic           Specialized */
     , (9057, 34, 0, 3, 0,  35, 0, 0) /* WarMagic            Specialized */
     , (9057, 45, 0, 3, 0,   5, 0, 0) /* LightWeapons        Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9057,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
