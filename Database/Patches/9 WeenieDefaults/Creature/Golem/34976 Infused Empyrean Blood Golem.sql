...
VALUES (34976, 'ace34976-infusedempyreanbloodgolem', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (34976,  6, 0, 3, 0, 433, 0, 0) /* MeleeDefense        Specialized */
     , (34976,  7, 0, 3, 0, 385, 0, 0) /* MissileDefense      Specialized */
     , (34976, 14, 0, 2, 0, 300, 0, 0) /* ArcaneLore          Trained */
     , (34976, 15, 0, 3, 0, 365, 0, 0) /* MagicDefense        Specialized */
     , (34976, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (34976, 22, 0, 2, 0,  10, 0, 0) /* Jump                Trained */
     , (34976, 24, 0, 2, 0,  10, 0, 0) /* Run                 Trained */
     , (34976, 31, 0, 3, 0, 150, 0, 0) /* CreatureEnchantment Specialized */
     , (34976, 33, 0, 3, 0, 150, 0, 0) /* LifeMagic           Specialized */
     , (34976, 34, 0, 3, 0, 150, 0, 0) /* WarMagic            Specialized */
     , (34976, 45, 0, 3, 0, 467, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (34976,  0,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34976,  1,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34976,  2,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34976,  3,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34976,  4,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34976,  5,  4, 150, 0.55,  450,  450,  270,  450,  360,  360,  300,  540,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34976,  6,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34976,  7,  4,  0,    0,  450,  450,  270,  450,  360,  360,  300,  540,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34976,  8,  4, 150, 0.55,  450,  450,  270,  450,  360,  360,  300,  540,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
