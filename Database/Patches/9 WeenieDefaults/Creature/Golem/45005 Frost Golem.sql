...
VALUES (45005, 'ace45005-frostgolem', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (45005,   1, 0x020007D7) /* Setup */
     ...
     , (45005,   4, 0x30000008) /* CombatTable */
...
VALUES (45005,  0,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45005,  1,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45005,  2,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45005,  3,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45005,  4,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45005,  5,  4, 400, 0.75,  800,  800,  800,  536,  800,  456,  640,  536,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45005,  6,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45005,  7,  4,  0,    0,  800,  800,  800,  536,  800,  456,  640,  536,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45005,  8,  4, 400, 0.75,  800,  800,  800,  536,  800,  456,  640,  536,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45005,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45005,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
