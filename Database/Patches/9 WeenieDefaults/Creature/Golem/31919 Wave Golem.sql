...
VALUES (31919, 'ace31919-wavegolem', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31919,   1, 0x020007E6) /* Setup */
     ...
     , (31919,   4, 0x30000008) /* CombatTable */
...
VALUES (31919,  0,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31919,  1,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31919,  2,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31919,  3,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31919,  4,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31919,  5,  4, 155,  0.6,  350,   60,  133,   60,  350,  175,  277,  105,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31919,  6,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31919,  7,  4,  0,    0,  350,   60,  133,   60,  350,  175,  277,  105,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31919,  8,  4, 160,  0.6,  350,   60,  133,   60,  350,  175,  277,  105,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (31919,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31919,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (31919, 9,  6353,  0, 0, 0.04, False) /* Create Pyreal Mote (6353) for ContainTreasure */
     ...
     , (31919, 9, 24477,  1, 0, 0.03, False) /* Create Sturdy Steel Key (24477) for ContainTreasure */
     , (31919, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (31919, 9, 34277,  1, 0, 0.02, False) /* Create Ancient Falatacot Trinket (34277) for ContainTreasure */
