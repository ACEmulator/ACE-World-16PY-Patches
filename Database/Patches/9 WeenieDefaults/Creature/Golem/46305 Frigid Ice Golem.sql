...
VALUES (46305, 'ace46305-frigidicegolem', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (46305,   1, 0x020007D7) /* Setup */
     ...
     , (46305,   4, 0x30000008) /* CombatTable */
...
VALUES (46305,  0,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46305,  1,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46305,  2,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46305,  3,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46305,  4,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46305,  5,  4, 155,  0.6,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46305,  6,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46305,  7,  4,  0,    0,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46305,  8,  4, 160,  0.6,  350,  263,  263,  350, 35000,  350,  280,  312,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (46305,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46305,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
