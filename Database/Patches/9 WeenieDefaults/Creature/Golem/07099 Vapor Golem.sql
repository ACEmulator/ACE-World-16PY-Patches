...
VALUES (7099, 'golemvapor', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7099,   1,       5) /* HeartbeatInterval */
     ...
     , (7099,   3,     0.9) /* HealthRate */
     , (7099,   4,     0.5) /* StaminaRate */
     , (7099,   5,       2) /* ManaRate */
     , (7099,   6,     0.1) /* HealthUponResurrection */
     , (7099,   7,    0.25) /* StaminaUponResurrection */
     , (7099,   8,     0.3) /* ManaUponResurrection */
     , (7099,  13,    0.72) /* ArmorModVsSlash */
     , (7099,  14,    0.72) /* ArmorModVsPierce */
     , (7099,  15,    0.72) /* ArmorModVsBludgeon */
     , (7099,  16,     0.5) /* ArmorModVsCold */
     , (7099,  17,    0.84) /* ArmorModVsFire */
     , (7099,  18,    0.74) /* ArmorModVsAcid */
     , (7099,  19,    0.63) /* ArmorModVsElectric */
     , (7099,  31,      17) /* VisualAwarenessRange */
     , (7099,  34,     2.3) /* PowerupTime */
     , (7099,  64,     0.1) /* ResistSlash */
     , (7099,  65,     0.1) /* ResistPierce */
     , (7099,  66,     0.1) /* ResistBludgeon */
     , (7099,  67,     0.5) /* ResistFire */
     , (7099,  68,       1) /* ResistCold */
     , (7099,  69,     0.8) /* ResistAcid */
     , (7099,  70,    0.85) /* ResistElectric */
...
VALUES (7099,   1, 0x020008A2) /* Setup */
     ...
     , (7099,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (7099,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7099, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7099,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7099,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
