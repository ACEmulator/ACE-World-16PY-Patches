...
VALUES (53290, 'ace53290-icestorm', 10, '2022-03-31 06:02:40') /* Creature */;
...
VALUES (53290,  0,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (53290,  1,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (53290,  2,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (53290,  3,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (53290,  4,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (53290,  5,  4, 1000, 0.75,  300,  350,  350,  350,  550,  250,  350,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (53290,  6,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (53290,  7,  4,  0,    0,  300,  350,  350,  350,  550,  250,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (53290,  8,  4, 1000, 0.75,  300,  350,  350,  350,  550,  250,  350,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
