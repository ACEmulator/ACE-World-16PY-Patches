...
VALUES (41936, 'ace41936-corruptedgravefrost', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (41936,  6, 0, 3, 0, 138, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (41936, 14, 0, 2, 0, 130, 0, 0) /* ArcaneLore          Trained */
     , (41936, 15, 0, 3, 0, 152, 0, 0) /* MagicDefense        Specialized */
     , (41936, 20, 0, 2, 0, 150, 0, 0) /* Deception           Trained */
     , (41936, 24, 0, 2, 0, 100, 0, 0) /* Run                 Trained */
     , (41936, 31, 0, 3, 0,  70, 0, 0) /* CreatureEnchantment Specialized */
     , (41936, 33, 0, 3, 0,  70, 0, 0) /* LifeMagic           Specialized */
     , (41936, 34, 0, 3, 0,  70, 0, 0) /* WarMagic            Specialized */
     , (41936, 45, 0, 3, 0, 140, 0, 0) /* LightWeapons        Specialized */
     , (41936, 47, 0, 3, 0,  80, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (41936,  0,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41936,  1,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41936,  2,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41936,  3,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41936,  4,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41936,  5,  8, 200, 0.75,  120,  102,  102,  102,  102,  120,   10,  102,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41936,  6,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41936,  7,  8,  0,    0,  120,  102,  102,  102,  102,  120,   10,  102,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41936,  8,  8, 200, 0.75,  120,  102,  102,  102,  102,  120,   10,  102,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (41936,  4447,    2.2)  /* Incantation of Frost Bolt */
     , (41936,  4479,   2.25)  /* Incantation of Cold Vulnerability Other */
     , (41936,  4308,  2.333)  /* Incantation of Harm Other */
     , (41936,  3879,    2.5)  /* Glacial Strike */;
