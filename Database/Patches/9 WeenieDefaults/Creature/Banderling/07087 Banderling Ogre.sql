...
VALUES (7087, 'banderlingogre', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7087,   1,         16) /* ItemType - Creature */
     ...
     , (7087,  25,         20) /* Level */
     , (7087,  27,          0) /* ArmorType - None */
     , (7087,  40,          2) /* CombatMode - Melee */
     , (7087,  68,          3) /* TargetingTactic - Random, Focused */
     ...
     , (7087, 140,          1) /* AiOptions - CanOpenDoors */
     , (7087, 146,       3500) /* XpOverride */;
...
VALUES (7087,   1, 0x02000E08) /* Setup */
     ...
     , (7087,   4, 0x30000002) /* CombatTable */
     , (7087,   6, 0x04001425) /* PaletteBase */
     , (7087,   7, 0x10000410) /* ClothingBase */
...
VALUES (7087,  6, 0, 3, 0,  74, 0, 0) /* MeleeDefense        Specialized */
     , (7087,  7, 0, 3, 0, 120, 0, 0) /* MissileDefense      Specialized */
     , (7087, 15, 0, 3, 0,  72, 0, 0) /* MagicDefense        Specialized */
     , (7087, 20, 0, 3, 0,  40, 0, 0) /* Deception           Specialized */
     , (7087, 22, 0, 3, 0,  40, 0, 0) /* Jump                Specialized */
     , (7087, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (7087, 44, 0, 3, 0,  90, 0, 0) /* HeavyWeapons        Specialized */
     , (7087, 45, 0, 3, 0,  90, 0, 0) /* LightWeapons        Specialized */
     , (7087, 47, 0, 3, 0,  85, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7087,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7087,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7087, 9,  3693,  0, 0, 0.05, False) /* Create Banderling Scalp (3693) for ContainTreasure */
     , (7087, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */;
