...
VALUES (1462, 'banderlingbanditfire', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (1462,   1, 0x02000E08) /* Setup */
     ...
     , (1462,   4, 0x30000002) /* CombatTable */
     , (1462,   6, 0x04001425) /* PaletteBase */
     , (1462,   7, 0x10000410) /* ClothingBase */
...
VALUES (1462,  6, 0, 3, 0,  84, 0, 0) /* MeleeDefense        Specialized */
     , (1462,  7, 0, 3, 0, 185, 0, 0) /* MissileDefense      Specialized */
     , (1462, 15, 0, 3, 0, 180, 0, 0) /* MagicDefense        Specialized */
     , (1462, 22, 0, 3, 0, 100, 0, 0) /* Jump                Specialized */
     , (1462, 24, 0, 3, 0, 100, 0, 0) /* Run                 Specialized */
     , (1462, 44, 0, 3, 0, 100, 0, 0) /* HeavyWeapons        Specialized */
     , (1462, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */
     , (1462, 46, 0, 3, 0, 100, 0, 0) /* FinesseWeapons      Specialized */
     , (1462, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (1462,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1462,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
