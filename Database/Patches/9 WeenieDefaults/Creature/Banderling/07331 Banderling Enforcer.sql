...
VALUES (7331, 'banderlinghunter', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7331,   1,       5) /* HeartbeatInterval */
     ...
     , (7331,   3,     0.6) /* HealthRate */
     , (7331,   4,       5) /* StaminaRate */
     , (7331,   5,       2) /* ManaRate */
     , (7331,  12,     0.5) /* Shade */
     , (7331,  13,    0.46) /* ArmorModVsSlash */
     , (7331,  14,    0.31) /* ArmorModVsPierce */
     , (7331,  15,    0.52) /* ArmorModVsBludgeon */
     , (7331,  16,    0.46) /* ArmorModVsCold */
     , (7331,  17,    0.83) /* ArmorModVsFire */
     , (7331,  18,    0.31) /* ArmorModVsAcid */
     , (7331,  19,    1.09) /* ArmorModVsElectric */
     , (7331,  31,      22) /* VisualAwarenessRange */
     , (7331,  34,       1) /* PowerupTime */
     , (7331,  36,       1) /* ChargeSpeed */
     , (7331,  39,     1.3) /* DefaultScale */
     , (7331,  64,    0.76) /* ResistSlash */
     , (7331,  65,    0.65) /* ResistPierce */
     , (7331,  66,     0.5) /* ResistBludgeon */
     , (7331,  67,    1.08) /* ResistFire */
     , (7331,  68,    0.76) /* ResistCold */
     , (7331,  69,    0.65) /* ResistAcid */
     , (7331,  70,    1.32) /* ResistElectric */
...
VALUES (7331,   1, 0x02000E08) /* Setup */
     ...
     , (7331,   4, 0x30000002) /* CombatTable */
     , (7331,   6, 0x04001425) /* PaletteBase */
     , (7331,   7, 0x10000410) /* ClothingBase */
...
VALUES (7331,  6, 0, 3, 0, 360, 0, 0) /* MeleeDefense        Specialized */
     , (7331,  7, 0, 3, 0, 410, 0, 0) /* MissileDefense      Specialized */
     , (7331, 14, 0, 2, 0, 200, 0, 0) /* ArcaneLore          Trained */
     , (7331, 15, 0, 3, 0, 225, 0, 0) /* MagicDefense        Specialized */
     , (7331, 20, 0, 2, 0,  40, 0, 0) /* Deception           Trained */
     , (7331, 22, 0, 2, 0,  40, 0, 0) /* Jump                Trained */
     , (7331, 24, 0, 2, 0,  40, 0, 0) /* Run                 Trained */
     , (7331, 31, 0, 3, 0, 105, 0, 0) /* CreatureEnchantment Specialized */
     , (7331, 33, 0, 3, 0, 105, 0, 0) /* LifeMagic           Specialized */
     , (7331, 34, 0, 3, 0, 105, 0, 0) /* WarMagic            Specialized */
     , (7331, 45, 0, 3, 0, 300, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (7331,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7331, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7331,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
