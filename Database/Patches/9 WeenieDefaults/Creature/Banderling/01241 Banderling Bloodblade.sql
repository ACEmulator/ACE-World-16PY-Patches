...
VALUES (1241, 'banderlingyoungglenden', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (1241,   1,       5) /* HeartbeatInterval */
     ...
     , (1241,   3,    0.35) /* HealthRate */
     , (1241,   4,       5) /* StaminaRate */
     , (1241,   5,       2) /* ManaRate */
     , (1241,  12,     0.5) /* Shade */
     , (1241,  13,    0.46) /* ArmorModVsSlash */
     , (1241,  14,    0.31) /* ArmorModVsPierce */
     , (1241,  15,    0.52) /* ArmorModVsBludgeon */
     , (1241,  16,    0.46) /* ArmorModVsCold */
     , (1241,  17,    0.83) /* ArmorModVsFire */
     , (1241,  18,    0.31) /* ArmorModVsAcid */
     , (1241,  19,    1.09) /* ArmorModVsElectric */
     , (1241,  31,      22) /* VisualAwarenessRange */
     , (1241,  34,       1) /* PowerupTime */
     , (1241,  36,       1) /* ChargeSpeed */
     , (1241,  39,     1.3) /* DefaultScale */
     , (1241,  64,    0.76) /* ResistSlash */
     , (1241,  65,    0.65) /* ResistPierce */
     , (1241,  66,     0.5) /* ResistBludgeon */
     , (1241,  67,    1.08) /* ResistFire */
     , (1241,  68,    0.76) /* ResistCold */
     , (1241,  69,    0.65) /* ResistAcid */
     , (1241,  70,    1.32) /* ResistElectric */
...
VALUES (1241,   1, 0x02000E08) /* Setup */
     ...
     , (1241,   4, 0x30000002) /* CombatTable */
     , (1241,   6, 0x04001425) /* PaletteBase */
     , (1241,   7, 0x10000410) /* ClothingBase */
...
VALUES (1241,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1241, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1241,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
