...
VALUES (29363, 'knighttorturer', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (29363,   1, 0x02000001) /* Setup */
     ...
     , (29363,   4, 0x30000000) /* CombatTable */
     , (29363,   6, 0x0400007E) /* PaletteBase */
     , (29363,   8, 0x06001036) /* Icon */
     , (29363,  22, 0x34000004) /* PhysicsEffectTable */
     , (29363,  32,       2000) /* WieldedTreasureType - Loot Tier: 8 */
...
VALUES (29363,  0,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (29363,  1,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (29363,  2,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (29363,  3,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (29363,  4,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (29363,  5,  4, 25,  0.4,  125,  150,  150,  125,  125,  100,  125,  100,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (29363,  6,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (29363,  7,  4,  0,    0,  125,  150,  150,  125,  125,  100,  125,  100,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (29363,  8,  4, 25,  0.4,  125,  150,  150,  125,  125,  100,  125,  100,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29363,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29363,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
