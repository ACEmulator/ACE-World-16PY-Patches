...
VALUES (29414, 'knightdoorkeeperplatinum', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (29414,   1,       5) /* HeartbeatInterval */
     ...
     , (29414,   3,   0.067) /* HealthRate */
     , (29414,   4,       3) /* StaminaRate */
     , (29414,   5,       1) /* ManaRate */
     , (29414,  12,     0.5) /* Shade */
     , (29414,  13,     1.2) /* ArmorModVsSlash */
     , (29414,  14,     1.2) /* ArmorModVsPierce */
     , (29414,  15,       1) /* ArmorModVsBludgeon */
     , (29414,  16,       1) /* ArmorModVsCold */
     , (29414,  17,     0.8) /* ArmorModVsFire */
     , (29414,  18,       1) /* ArmorModVsAcid */
     , (29414,  19,     0.8) /* ArmorModVsElectric */
     , (29414,  31,      12) /* VisualAwarenessRange */
     , (29414,  34,       1) /* PowerupTime */
     , (29414,  36,       1) /* ChargeSpeed */
     , (29414,  39,     1.3) /* DefaultScale */
     , (29414,  64,     0.8) /* ResistSlash */
     , (29414,  65,     0.8) /* ResistPierce */
     , (29414,  66,     0.9) /* ResistBludgeon */
     , (29414,  67,     1.2) /* ResistFire */
     , (29414,  68,     0.9) /* ResistCold */
     , (29414,  69,     0.9) /* ResistAcid */
     , (29414,  70,     1.2) /* ResistElectric */
...
VALUES (29414,   1, 0x02001255) /* Setup */
     ...
     , (29414,   4, 0x30000000) /* CombatTable */
     , (29414,   6, 0x040019CC) /* PaletteBase */
     , (29414,   7, 0x100005AB) /* ClothingBase */
...
VALUES (29414,  6, 0, 3, 0, 350, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (29414, 44, 0, 3, 0, 375, 0, 0) /* HeavyWeapons        Specialized */
     , (29414, 45, 0, 3, 0, 375, 0, 0) /* LightWeapons        Specialized */
     , (29414, 46, 0, 3, 0, 375, 0, 0) /* FinesseWeapons      Specialized */
     , (29414, 47, 0, 3, 0, 215, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (29414,  0,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (29414,  1,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (29414,  2,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (29414,  3,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (29414,  4,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (29414,  5,  4, 150,  0.4,  550,  660,  660,  550,  550,  440,  550,  440,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (29414,  6,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (29414,  7,  4,  0,    0,  550,  660,  660,  550,  550,  440,  550,  440,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (29414,  8,  4, 150,  0.4,  550,  660,  660,  550,  550,  440,  550,  440,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (29414,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (29414, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29414,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29414,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29414,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29414,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29414,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
