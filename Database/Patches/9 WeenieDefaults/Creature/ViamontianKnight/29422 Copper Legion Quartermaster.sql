...
VALUES (29422, 'knightquartermastercopper', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (29422,   1,       5) /* HeartbeatInterval */
     ...
     , (29422,   3,   0.067) /* HealthRate */
     , (29422,   4,       3) /* StaminaRate */
     , (29422,   5,       1) /* ManaRate */
     , (29422,  12,     0.5) /* Shade */
     , (29422,  13,     1.2) /* ArmorModVsSlash */
     , (29422,  14,     1.2) /* ArmorModVsPierce */
     , (29422,  15,       1) /* ArmorModVsBludgeon */
     , (29422,  16,       1) /* ArmorModVsCold */
     , (29422,  17,     0.8) /* ArmorModVsFire */
     , (29422,  18,       1) /* ArmorModVsAcid */
     , (29422,  19,     0.8) /* ArmorModVsElectric */
     , (29422,  31,      12) /* VisualAwarenessRange */
     , (29422,  34,       1) /* PowerupTime */
     , (29422,  36,       1) /* ChargeSpeed */
     , (29422,  39,     1.2) /* DefaultScale */
     , (29422,  64,     0.8) /* ResistSlash */
     , (29422,  65,     0.8) /* ResistPierce */
     , (29422,  66,     0.9) /* ResistBludgeon */
     , (29422,  67,     1.2) /* ResistFire */
     , (29422,  68,     0.9) /* ResistCold */
     , (29422,  69,     0.9) /* ResistAcid */
     , (29422,  70,     1.2) /* ResistElectric */
...
VALUES (29422,   1, 0x02001255) /* Setup */
     ...
     , (29422,   4, 0x30000000) /* CombatTable */
     , (29422,   6, 0x040019CC) /* PaletteBase */
     , (29422,   7, 0x100005AB) /* ClothingBase */
...
VALUES (29422,  6, 0, 3, 0, 290, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (29422, 45, 0, 3, 0, 255, 0, 0) /* LightWeapons        Specialized */
...
VALUES (29422,  0,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (29422,  1,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (29422,  2,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (29422,  3,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (29422,  4,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (29422,  5,  4, 120,  0.4,  490,  588,  588,  490,  490,  392,  490,  392,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (29422,  6,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (29422,  7,  4,  0,    0,  490,  588,  588,  490,  490,  392,  490,  392,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (29422,  8,  4, 120,  0.4,  490,  588,  588,  490,  490,  392,  490,  392,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_event_filter` (`object_Id`, `event`)
VALUES (29422,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (29422, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29422,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29422,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29422,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29422,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29422,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
