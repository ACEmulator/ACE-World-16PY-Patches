...
VALUES (44053, 'ace44053-warreaper', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44053,   1,         16) /* ItemType - Creature */
     ...
     , (44053, 316,          5) /* CritDamageResistRating */
...
VALUES (44053,   1,       5) /* HeartbeatInterval */
     ...
     , (44053,  64,     0.7) /* ResistSlash */
     , (44053,  65,     0.8) /* ResistPierce */
...
VALUES (44053,   1, 0x02000039) /* Setup */
     ...
     , (44053,   4, 0x3000000A) /* CombatTable */
     , (44053,   6, 0x040001C1) /* PaletteBase */
     , (44053,   7, 0x10000064) /* ClothingBase */
     , (44053,   8, 0x06001223) /* Icon */
     , (44053,  22, 0x34000024) /* PhysicsEffectTable */
     , (44053,  35,       2000) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (44053,  6, 0, 3, 0, 550, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (44053, 15, 0, 3, 0, 425, 0, 0) /* MagicDefense        Specialized */
...
VALUES (44053,  0,  2, 600, 0.75,  550,  330,  275,  413,  550,  523,  523,  550,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (44053, 10,  2, 600,  0.5,  550,  330,  275,  413,  550,  523,  523,  550,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (44053, 13,  2, 600,  0.5,  550,  330,  275,  413,  550,  523,  523,  550,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (44053, 16,  4, 600,    0,  550,  330,  275,  413,  550,  523,  523,  550,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44053,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44053,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44053,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44053,  5 /* HeartBeat */,   0.15, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (44053, 9, 44240,  1, 0, 0.1, False) /* Create A'nekshay Token (44240) for ContainTreasure */
     ...
     , (44053, 9, 24847,  1, 0, 0.1, False) /* Create Reaper Reedshark Hide (24847) for ContainTreasure */
     , (44053, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */
     , (44053, 9, 48908,  1, 0, 0.03, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
