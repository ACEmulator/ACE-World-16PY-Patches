...
VALUES (88214, 'ace88214-guardiandunereaper', 10, '2021-11-29 06:19:28') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (88214,   1,         16) /* ItemType - Creature */
     , (88214,   2,         27) /* CreatureType - ShallowsShark */
     , (88214,   3,          8) /* PaletteTemplate - Green */
...
VALUES (88214,   1,       5) /* HeartbeatInterval */
     ...
     , (88214,  17,    0.95) /* ArmorModVsFire */
     , (88214,  18,    0.95) /* ArmorModVsAcid */
     ...
     , (88214,  67,     0.3) /* ResistFire */
     , (88214,  68,     0.3) /* ResistCold */
     , (88214,  69,     0.3) /* ResistAcid */
...
VALUES (88214,   1,  2755, 0, 0, 2755) /* MaxHealth */
     , (88214,   3,  3310, 0, 0, 3310) /* MaxStamina */
     , (88214,   5,   700, 0, 0, 700) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (88214,  6, 0, 3, 0, 550, 0, 0) /* MeleeDefense        Specialized */
     , (88214,  7, 0, 3, 0, 470, 0, 0) /* MissileDefense      Specialized */
     , (88214, 15, 0, 3, 0, 425, 0, 0) /* MagicDefense        Specialized */
     , (88214, 22, 0, 3, 0,  25, 0, 0) /* Jump                Specialized */
     , (88214, 24, 0, 3, 0, 450, 0, 0) /* Run                 Specialized */
     , (88214, 45, 0, 3, 0, 600, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (88214,  0,  2, 600, 0.75,  550,  275,  250,  275,  215,  275,  250,  215,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (88214, 10,  2, 600,  0.5,  550,  250,  275,  250,  215,  275,  250,  275,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (88214, 13,  2, 600,  0.5,  550,  250,  275,  250,  215,  275,  250,  275,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (88214, 16,  4, 600,    0,  550,  250,  275,  250,  215,  275,  250,  275,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;
