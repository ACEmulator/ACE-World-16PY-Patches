...
VALUES (44051, 'ace44051-tamedreaper', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (44051,   1,         16) /* ItemType - Creature */
     , (44051,   2,         27) /* CreatureType - ShallowsShark */
     , (44051,   3,         45) /* PaletteTemplate - PaleGreen */
...
VALUES (44051,   1,       5) /* HeartbeatInterval */
     ...
     , (44051,   5,       2) /* ManaRate */
     , (44051,  12,     0.5) /* Shade */
     , (44051,  13,     0.6) /* ArmorModVsSlash */
     , (44051,  14,     0.5) /* ArmorModVsPierce */
     ...
     , (44051,  64,     0.7) /* ResistSlash */
     , (44051,  65,     0.8) /* ResistPierce */
...
VALUES (44051,   1, 0x02000039) /* Setup */
     ...
     , (44051,   4, 0x3000000A) /* CombatTable */
     , (44051,   6, 0x040001C1) /* PaletteBase */
     , (44051,   7, 0x10000064) /* ClothingBase */
...
VALUES (44051,  6, 0, 3, 0, 460, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (44051, 15, 0, 3, 0, 410, 0, 0) /* MagicDefense        Specialized */
...
VALUES (44051,  0,  2, 600, 0.75,  520,  312,  260,  390,  520,  494,  494,  520,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (44051, 10,  2, 600,  0.5,  520,  312,  260,  390,  520,  494,  494,  520,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (44051, 13,  2, 600,  0.5,  520,  312,  260,  390,  520,  494,  494,  520,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (44051, 16,  4, 600,    0,  520,  312,  260,  390,  520,  494,  494,  520,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44051,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44051,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44051,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44051,  5 /* HeartBeat */,   0.15, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (44051, 9, 24847,  1, 0, 0.1, False) /* Create Reaper Reedshark Hide (24847) for ContainTreasure */
     , (44051, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */
     , (44051, 9, 48908,  1, 0, 0.03, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
