...
VALUES (31910, 'ace31910-shallowsshredder', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31910,   1, 0x02001480) /* Setup */
     ...
     , (31910,   4, 0x3000000A) /* CombatTable */
     , (31910,   6, 0x04001EA8) /* PaletteBase */
     , (31910,   7, 0x10000631) /* ClothingBase */
...
VALUES (31910,  0,  2, 110, 0.75,  300,  240,  195,  300,  195,  300,  195,  150,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (31910, 10,  2, 90,  0.6,  300,  240,  195,  300,  195,  300,  195,  150,    0, 3,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (31910, 13,  2, 10,  0.5,  300,  240,  195,  300,  195,  300,  195,  150,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (31910, 16,  4, 10,    0,  300,  240,  195,  300,  195,  300,  195,  150,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (31910, 9, 34277,  1, 0, 0.02, False) /* Create Ancient Falatacot Trinket (34277) for ContainTreasure */
     , (31910, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (31910, 9, 24477,  1, 0, 0.04, False) /* Create Sturdy Steel Key (24477) for ContainTreasure */
