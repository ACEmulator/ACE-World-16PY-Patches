Refuse: Mastery Reset Certificate (46422)
    - InqIntStat: MeleeMastery, 2 - 2
        TestSuccess:
            - DirectBroadcast: You are already a Master of Swords.
        TestFailure:
            - InqYesNo: Would you like to change your mastery to Swords?
                TestSuccess:
                ...
                TestFailure:
                    - DirectBroadcast: Give the Mastery Reset Certificate to the statue again if wish to change your mastery to Swords.
...
GotoSet: DoMasteryChange
    - SetIntStat: MeleeMastery, 2
    - DirectBroadcast: You are now a Master of Swords.
