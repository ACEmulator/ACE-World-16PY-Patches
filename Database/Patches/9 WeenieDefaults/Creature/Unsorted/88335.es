Use:
    - InqQuest: SclavusPresentStart
        QuestSuccess:        
            - InqQuestBitsOn: SclavusPresentsOpened, 0x40
                QuestSuccess:
                    - DirectBroadcast: You have already opened this present.
                QuestFailure:
                    - InqQuest: SclavusPresentFirstGuess
                        QuestSuccess:
                            - InqQuestBitsOn: SclavusPresentsOpened, 0x80
                                QuestSuccess:
                                    - Motion: On
                                    - SetQuestBitsOn: SclavusPresentsOpened, 0x40
                                    - DirectBroadcast: You matched the box!
                        ...
                        QuestFailure:
                            - Motion: On
                            - DirectBroadcast: You have found a box. Find its match.
                            - SetQuestBitsOn: SclavusPresentsOpened, 0x40
