DELETE FROM `weenie` WHERE `class_Id` = 88431;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (88431, 'ace88431-aerlinthealtar', 10, '2023-04-09 17:44:47') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (88431,   1,         16) /* ItemType - Creature */
     , (88431,   6,         -1) /* ItemsCapacity */
     , (88431,   7,         -1) /* ContainersCapacity */
     , (88431,  16,         32) /* ItemUseable - Remote */
     , (88431,  93,    6292504) /* PhysicsState - ReportCollisions, IgnoreCollisions, Gravity, ReportCollisionsAsEnvironment, EdgeSlide */
     , (88431,  95,          8) /* RadarBlipColor - Yellow */
     , (88431, 133,          4) /* ShowableOnRadar - ShowAlways */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (88431,   1, True ) /* Stuck */
     , (88431,   8, True ) /* AllowGive */
     , (88431,  19, False) /* Attackable */
     , (88431,  52, True ) /* AiImmobile */
     , (88431,  82, True ) /* DontTurnOrMoveWhenGiving */
     , (88431,  83, True ) /* NpcLooksLikeObject */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (88431,  54,       3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (88431,   1, 'Aerlinthe Altar') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (88431,   1, 0x0200096A) /* Setup */
     , (88431,   2, 0x0900013D) /* MotionTable */
     , (88431,   3, 0x20000015) /* SoundTable */
     , (88431,   8, 0x0600698C) /* Icon */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (88431,  6 /* Give */,      1, 88425 /* Head of the Aerlinthe Blight Lord */, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (@parent_id,  0,  18 /* DirectBroadcast */, 0, 1, NULL, 'You present the head of the Blight Lord to the Altar, and the device seems to absorb the foul, rotting head into itself with an unmistakable air of satisfaction. There is a flash of light, and you find that something has been dropped into your pack...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     ...
     , (@parent_id,  5,  99 /* TeleportTarget */, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0xB6E80100 /* @teleloc 0xB6E80100 [107.996002 107.996002 2.951740] 1.000000 0.000000 0.000000 0.000000 */, 107.996, 107.996, 2.95174, 1, 0, 0, 0);

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (88431,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
