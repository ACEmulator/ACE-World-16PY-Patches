                ...
                QuestFailure:
                    - InqQuest: CarenziPlagueStarted
                        QuestSuccess:
                            ...
                            - InqQuestSolves: DiseasedMangyLiver_Counter, 20
                                QuestSuccess:
                                    - DirectBroadcast: You've slain all the sick Mangy Carenzi that you needed to in order to prevent the sickness from spreading!
                                    - AwardLevelProportionalXP: 35%, 0 - 24,089,339
                                    - StampQuest: DiseasedMangyLiver_Completed
                                    - DeleteSelf
                                QuestFailure:
                                    - InqQuestSolves: DiseasedMangyLiver_Counter, 15 - 19
                                        QuestSuccess:
                                            ...
                                            - DeleteSelf
                                        QuestFailure: 
                                            - InqQuestSolves: DiseasedMangyLiver_Counter, 10 - 14
                                                QuestSuccess:
                                                    ...
                                                    - DeleteSelf
                                                QuestFailure: 
                                                    - InqQuestSolves: DiseasedMangyLiver_Counter, 1 - 9
                                                        QuestSuccess:
                                                            ...
                                                            - DeleteSelf
                        QuestFailure:
                            - InqQuestSolves: DiseasedMangyLiver_Counter, 1 - 19
                                QuestSuccess:
