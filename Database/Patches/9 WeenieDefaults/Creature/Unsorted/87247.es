Use:
    - InqQuest: GiftBoxesWait
        ...
        QuestFailure:
            - InqQuestBitsOn: GiftBoxesFound, 0x1024
                QuestSuccess:
                    - DirectBroadcast: You have already discovered this gift box.
                QuestFailure:
                    - SetQuestBitsOn: GiftBoxesFound, 0x1024
                    ...
                    - InqIntStat: Level, 1 - 49
                        TestSuccess:
                            ...
                            - AwardLevelProportionalXP: 100%, 0 - 1,500,000
                            - Goto: TitleRewards
                        TestFailure:
                            - Goto: RandomRewards
                                GotoSet: Probability: 0.125
