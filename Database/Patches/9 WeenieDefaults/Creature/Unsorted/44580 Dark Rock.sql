...
VALUES (44580, 'ace44580-darkrock', 10, '2023-02-22 07:09:25') /* Creature */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (44580, 1 /* Refuse */, 1, 72858, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (44580, -1, 72882, 0, 1, 1, 1, 4, -1, 0, 0, 0, 0, 0, 0.5, 1, 0, 0, 0) /* Generate Recording Device (72859) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
