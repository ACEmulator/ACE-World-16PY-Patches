...
VALUES (52263, 'ace52263-pillaroffire', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (52263,  0,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52263,  1,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52263,  2,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (52263,  3,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52263,  4,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (52263,  5,  4, 1000, 0.75,  300,  350,  350,  350,  250,  550,  350,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (52263,  6,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (52263,  7,  4,  0,    0,  300,  350,  350,  350,  250,  550,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (52263,  8,  4, 1000, 0.75,  300,  350,  350,  350,  250,  550,  350,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
