Use:
	- InqQuest: SclavusPresentStart
		QuestSuccess:		
			- InqQuestBitsOn: SclavusPresentsOpened, 0x4
				QuestSuccess:
					- DirectBroadcast: You have already opened this present.
				QuestFailure:
					- InqQuest: SclavusPresentFirstGuess
						QuestSuccess:
							- InqQuestBitsOn: SclavusPresentsOpened, 0x8
								QuestSuccess:
									- Motion: On
									- SetQuestBitsOn: SclavusPresentsOpened, 0x4
									- DirectBroadcast: You matched the ball!
						...
						QuestFailure:
							- Motion: On
							- DirectBroadcast: You have found a ball. Find its match.
							- SetQuestBitsOn: SclavusPresentsOpened, 0x4
