...
VALUES (7114, 'shrethrendeath', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7114,   1,       5) /* HeartbeatInterval */
     ...
     , (7114,   3,    0.35) /* HealthRate */
     , (7114,   4,       4) /* StaminaRate */
     , (7114,   5,       1) /* ManaRate */
     , (7114,  12,     0.5) /* Shade */
     , (7114,  13,    0.37) /* ArmorModVsSlash */
     , (7114,  14,    0.55) /* ArmorModVsPierce */
     , (7114,  15,     0.8) /* ArmorModVsBludgeon */
     , (7114,  16,     0.6) /* ArmorModVsCold */
     , (7114,  17,    0.61) /* ArmorModVsFire */
     , (7114,  18,    0.17) /* ArmorModVsAcid */
     , (7114,  19,    0.36) /* ArmorModVsElectric */
     , (7114,  31,      10) /* VisualAwarenessRange */
     , (7114,  34,     1.2) /* PowerupTime */
     , (7114,  36,       1) /* ChargeSpeed */
     , (7114,  39,    1.25) /* DefaultScale */
     , (7114,  64,    0.58) /* ResistSlash */
     , (7114,  65,    0.75) /* ResistPierce */
     , (7114,  66,       1) /* ResistBludgeon */
     , (7114,  67,     0.5) /* ResistFire */
     , (7114,  68,       1) /* ResistCold */
     , (7114,  69,    0.42) /* ResistAcid */
...
VALUES (7114,   1, 0x020005A7) /* Setup */
     , (7114,   2, 0x09000080) /* MotionTable */
     , (7114,   3, 0x2000004A) /* SoundTable */
     , (7114,   4, 0x3000001F) /* CombatTable */
     , (7114,   6, 0x04000DFC) /* PaletteBase */
     , (7114,   7, 0x10000490) /* ClothingBase */
     , (7114,   8, 0x06001918) /* Icon */
     , (7114,  22, 0x34000065) /* PhysicsEffectTable */
     , (7114,  35,        458) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (7114,  6, 0, 3, 0, 305, 0, 0) /* MeleeDefense        Specialized */
     , (7114,  7, 0, 3, 0, 400, 0, 0) /* MissileDefense      Specialized */
     , (7114, 15, 0, 3, 0, 280, 0, 0) /* MagicDefense        Specialized */
     , (7114, 20, 0, 2, 0,   0, 0, 0) /* Deception           Trained */
     , (7114, 22, 0, 2, 0,  10, 0, 0) /* Jump                Trained */
     , (7114, 45, 0, 3, 0, 285, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (7114,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7114, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7114,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7114, 9, 24477,  0, 0, 0.02, False) /* Create Sturdy Steel Key (24477) for ContainTreasure */
     , (7114, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
