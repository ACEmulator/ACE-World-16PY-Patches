...
VALUES (7113, 'shrethgauloth', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7113,   1,       5) /* HeartbeatInterval */
     ...
     , (7113,   3,    0.35) /* HealthRate */
     , (7113,   4,       4) /* StaminaRate */
     , (7113,   5,       1) /* ManaRate */
     , (7113,  12,     0.5) /* Shade */
     , (7113,  13,    0.37) /* ArmorModVsSlash */
     , (7113,  14,    0.55) /* ArmorModVsPierce */
     , (7113,  15,     0.8) /* ArmorModVsBludgeon */
     , (7113,  16,     0.6) /* ArmorModVsCold */
     , (7113,  17,    0.61) /* ArmorModVsFire */
     , (7113,  18,    0.17) /* ArmorModVsAcid */
     , (7113,  19,    0.36) /* ArmorModVsElectric */
     , (7113,  31,      10) /* VisualAwarenessRange */
     , (7113,  34,     1.2) /* PowerupTime */
     , (7113,  36,       1) /* ChargeSpeed */
     , (7113,  39,    1.25) /* DefaultScale */
     , (7113,  64,    0.58) /* ResistSlash */
     , (7113,  65,    0.75) /* ResistPierce */
     , (7113,  66,       1) /* ResistBludgeon */
     , (7113,  67,     0.5) /* ResistFire */
     , (7113,  68,       1) /* ResistCold */
     , (7113,  69,    0.42) /* ResistAcid */
...
VALUES (7113,   1, 0x020005A7) /* Setup */
     , (7113,   2, 0x09000080) /* MotionTable */
     , (7113,   3, 0x2000004A) /* SoundTable */
     , (7113,   4, 0x3000001F) /* CombatTable */
     , (7113,   6, 0x04000DFC) /* PaletteBase */
     , (7113,   7, 0x10000490) /* ClothingBase */
     , (7113,   8, 0x06001918) /* Icon */
     , (7113,  22, 0x34000065) /* PhysicsEffectTable */
     , (7113,  35,        454) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (7113,  6, 0, 3, 0, 270, 0, 0) /* MeleeDefense        Specialized */
     , (7113,  7, 0, 3, 0, 370, 0, 0) /* MissileDefense      Specialized */
     , (7113, 15, 0, 3, 0, 240, 0, 0) /* MagicDefense        Specialized */
     , (7113, 20, 0, 2, 0,   0, 0, 0) /* Deception           Trained */
     , (7113, 22, 0, 2, 0,  10, 0, 0) /* Jump                Trained */
     , (7113, 45, 0, 3, 0, 260, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (7113,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7113, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7113,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
