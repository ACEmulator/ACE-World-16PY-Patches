...
VALUES (7184, 'tuskersilver', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (7184,   1,       5) /* HeartbeatInterval */
     ...
     , (7184,   3,     0.8) /* HealthRate */
     , (7184,   4,       4) /* StaminaRate */
     , (7184,   5,       2) /* ManaRate */
     , (7184,  13,     0.5) /* ArmorModVsSlash */
     , (7184,  14,     0.8) /* ArmorModVsPierce */
     , (7184,  15,    0.66) /* ArmorModVsBludgeon */
     , (7184,  16,       1) /* ArmorModVsCold */
     , (7184,  17,     0.7) /* ArmorModVsFire */
...
VALUES (7184,   1, 0x02000964) /* Setup */
     ...
     , (7184,   4, 0x3000000B) /* CombatTable */
     , (7184,   6, 0x0400102F) /* PaletteBase */
     , (7184,   7, 0x10000260) /* ClothingBase */
     , (7184,   8, 0x06001033) /* Icon */
     , (7184,  22, 0x34000027) /* PhysicsEffectTable */
     , (7184,  35,        448) /* DeathTreasureType - Loot Tier: 4 */;
...
VALUES (7184,  6, 0, 3, 0, 220, 0, 0) /* MeleeDefense        Specialized */
     , (7184,  7, 0, 3, 0, 315, 0, 0) /* MissileDefense      Specialized */
     , (7184, 15, 0, 3, 0, 220, 0, 0) /* MagicDefense        Specialized */
     , (7184, 20, 0, 3, 0,  25, 0, 0) /* Deception           Specialized */
     , (7184, 22, 0, 3, 0, 120, 0, 0) /* Jump                Specialized */
     , (7184, 24, 0, 3, 0,  70, 0, 0) /* Run                 Specialized */
     , (7184, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (7184,  0,  4,  0,    0,  190,   95,  152,  125,  190,  133,  190,  190,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (7184,  1,  4,  0,    0,  175,   88,  140,  116,  175,  122,  175,  175,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
...
VALUES (7184,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7184, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,   0.15, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7184,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7184, 9, 22578,  0, 0, 0.01, False) /* Create Bunch of Nanners (22578) for ContainTreasure */
     , (7184, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */
     , (7184, 9, 45876,  1, 0, 0.03, False) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (7184, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (7184, 9, 45875,  1, 0, 0.01, False) /* Create Lucky Gold Letter (45875) for ContainTreasure */
     , (7184, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */
     , (7184, 9, 29204,  1, 0, 0.105, False) /* Create Tusker Spit (29204) for ContainTreasure */
     , (7184, 9,     0,  0, 0, 0.895, False) /* Create nothing for ContainTreasure */;
