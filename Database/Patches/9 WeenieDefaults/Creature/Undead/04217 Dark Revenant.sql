...
VALUES (4217, 'zombiedarkrevenant', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (4217,   1,       5) /* HeartbeatInterval */
     ...
     , (4217,   3,     0.8) /* HealthRate */
     , (4217,   4,     0.5) /* StaminaRate */
     , (4217,   5,       2) /* ManaRate */
     , (4217,  12,     0.5) /* Shade */
     , (4217,  13,     0.8) /* ArmorModVsSlash */
     , (4217,  14,    0.53) /* ArmorModVsPierce */
     , (4217,  15,    0.68) /* ArmorModVsBludgeon */
     , (4217,  16,    0.13) /* ArmorModVsCold */
     , (4217,  17,     0.5) /* ArmorModVsFire */
     , (4217,  18,    0.68) /* ArmorModVsAcid */
     , (4217,  19,    0.73) /* ArmorModVsElectric */
     , (4217,  31,      18) /* VisualAwarenessRange */
     , (4217,  34,       1) /* PowerupTime */
     , (4217,  36,       1) /* ChargeSpeed */
     , (4217,  39,     1.1) /* DefaultScale */
     , (4217,  64,       1) /* ResistSlash */
     , (4217,  65,    0.52) /* ResistPierce */
     , (4217,  66,    0.75) /* ResistBludgeon */
     , (4217,  67,       1) /* ResistFire */
     , (4217,  68,     0.1) /* ResistCold */
     , (4217,  69,    0.75) /* ResistAcid */
     , (4217,  70,    0.86) /* ResistElectric */
...
VALUES (4217,   1, 0x0200100D) /* Setup */
     , (4217,   2, 0x09000017) /* MotionTable */
     , (4217,   3, 0x20000016) /* SoundTable */
     , (4217,   4, 0x30000000) /* CombatTable */
     , (4217,   6, 0x040016C4) /* PaletteBase */
     , (4217,   7, 0x100004F6) /* ClothingBase */
     , (4217,   8, 0x06001226) /* Icon */
     , (4217,  22, 0x34000028) /* PhysicsEffectTable */
     ...
     , (4217,  35,        450) /* DeathTreasureType - Loot Tier: 3 */;
...
VALUES (4217,  6, 0, 3, 0, 135, 0, 0) /* MeleeDefense        Specialized */
     , (4217,  7, 0, 3, 0, 285, 0, 0) /* MissileDefense      Specialized */
     , (4217, 14, 0, 3, 0, 230, 0, 0) /* ArcaneLore          Specialized */
     , (4217, 15, 0, 3, 0, 180, 0, 0) /* MagicDefense        Specialized */
     , (4217, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (4217, 31, 0, 3, 0,  90, 0, 0) /* CreatureEnchantment Specialized */
     , (4217, 33, 0, 3, 0,  90, 0, 0) /* LifeMagic           Specialized */
     , (4217, 34, 0, 3, 0,  90, 0, 0) /* WarMagic            Specialized */
     , (4217, 44, 0, 3, 0, 195, 0, 0) /* HeavyWeapons        Specialized */
     , (4217, 45, 0, 3, 0, 195, 0, 0) /* LightWeapons        Specialized */
     , (4217, 46, 0, 3, 0, 120, 0, 0) /* FinesseWeapons      Specialized */
     , (4217, 47, 0, 3, 0, 110, 0, 0) /* MissileWeapons      Specialized */
     , (4217, 48, 0, 3, 0, 195, 0, 0) /* Shield              Specialized */;
...
VALUES (4217,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (4217, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id,  0,  17 /* LocalBroadcast */, 0, 0, NULL, 'As it collapses into a mass of bone and rot, the ancient mage mutters, "Your triumph against the Hopeslayer will be laughably short-lived. Do not grow too comfortable in this world, as it will soon be reclaimed by its true masters. His Eternal Splendor still broods in his citadel!"', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0x00000000, 0, 0, 0, 0, 0, 0, 0);
...
INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id,  0,  17 /* LocalBroadcast */, 0, 0, NULL, 'As it collapses into a mass of bone and rot, the ancient mage mutters, "Your triumph against the Hopeslayer will be laughably short-lived. Do not grow too comfortable in this world, as it will soon be reclaimed by its true masters. The Steward merely bides her time in Chalicmere!"', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0x00000000, 0, 0, 0, 0, 0, 0, 0);
...
VALUES (4217, 9,  6876,  0, 0, 0.02, False) /* Create Sturdy Iron Key (6876) for ContainTreasure */
     ...
     , (4217, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (4217, 9, 45876,  1, 0, 0.03, False) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (4217, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (4217, 9, 45875,  1, 0, 0.01, False) /* Create Lucky Gold Letter (45875) for ContainTreasure */
     , (4217, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */;
