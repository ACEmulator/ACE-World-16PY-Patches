...
Refuse: Gauntlet Guest Ticket (88051)
    ...
    - InqYesNo: This guest ticket allows you to join another fellowship in Arena One. You must already be in a fellowship and not currently have access to either of the active arenas. No refunds. Are you ready to enter Arena One?
        TestSuccess:
            - InqOwnsItems: Gauntlet Guest Ticket (88051), 1
                TestSuccess:
                    - TakeItems: Gauntlet Guest Ticket (88051), -1
                    - InqFellowQuest: IsPlayerInFellow?
                        QuestFailure:
                            - Goto: Arena1Addition
                        QuestNoFellow:
...
Refuse: Gauntlet Guest Ticket (88052)
    ...
    - InqYesNo: This guest ticket allows you to join another fellowship in Arena Two. You must already be in a fellowship and not currently have access to either of the active arenas. No refunds. Are you ready to enter Arena Two?
        TestSuccess:
            - InqOwnsItems: Gauntlet Guest Ticket (88052), 1
                TestSuccess:
                    - TakeItems: Gauntlet Guest Ticket (88052), -1
                    - InqFellowQuest: IsPlayerInFellow?
                        QuestFailure:
                            - Goto: Arena2Addition
                        QuestNoFellow:
...
Use:
    - InqFellowQuest: GauntletArena1EW
        ...
        QuestFailure:
            - InqFellowQuest: GauntletArena2EW
                QuestSuccess:
                    - Tell: Your fellowship's Arena battles still continue. I cannot reward anyone in your fellowship while they still have time left in the Gauntlet. (%fqt)
                QuestFailure:
        ...
        QuestSuccess:
            ...
            - InqQuestSolves: GauntletWinsCounter, 10 - 10
                QuestSuccess:
                    ...
                    - Give: Scroll of Eldrytch Web Recall (88053)
...
GotoSet: ErasePlayerQuestFlags
    - EraseQuest: GauntletArena1EW
    - EraseQuest: GauntletArena2EW
...
GotoSet: Arena1Addition
    - InqFellowQuest: GauntletArena1EW@Arena1Addition
        QuestSuccess:
            - Tell: Your fellowship's Arena battles still continue. I cannot start a new battle while they still have time left in the Gauntlet. (%fqt)
        QuestFailure:
            - InqFellowQuest: GauntletArena2EW@Arena1Addition
                QuestSuccess:
                    - Tell: Your fellowship's Arena battles still continue. I cannot start a new battle while they still have time left in the Gauntlet. (%fqt)
                QuestFailure:
                    - LockFellow
...
GotoSet: Arena2Addition
    - InqFellowQuest: GauntletArena1EW@Arena2Addition
        QuestSuccess:
            - Tell: Your fellowship's Arena battles still continue. I cannot start a new battle while they still have time left in the Gauntlet. (%fqt)
        QuestFailure:
            - InqFellowQuest: GauntletArena2EW@Arena2Addition
                QuestSuccess:
                    - Tell: Your fellowship's Arena battles still continue. I cannot start a new battle while they still have time left in the Gauntlet. (%fqt)
                QuestFailure:
                    - LockFellow
