...
VALUES (8122,   1,         16) /* ItemType - Creature */
     ...
     , (8122,  25,         50) /* Level */
     , (8122,  27,          0) /* ArmorType - None */
     , (8122,  40,          1) /* CombatMode - NonCombat */
     , (8122,  68,          3) /* TargetingTactic - Random, Focused */
     ...
     , (8122, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (8122,   1,       5) /* HeartbeatInterval */
     ...
     , (8122,   3,     0.3) /* HealthRate */
     , (8122,   4,     0.5) /* StaminaRate */
     , (8122,   5,       2) /* ManaRate */
     , (8122,  12,     0.5) /* Shade */
     , (8122,  13,       1) /* ArmorModVsSlash */
     , (8122,  14,     1.2) /* ArmorModVsPierce */
     , (8122,  15,     1.2) /* ArmorModVsBludgeon */
     , (8122,  16,     1.2) /* ArmorModVsCold */
     , (8122,  17,       1) /* ArmorModVsFire */
     , (8122,  18,     1.2) /* ArmorModVsAcid */
     , (8122,  19,     1.2) /* ArmorModVsElectric */
     , (8122,  31,      18) /* VisualAwarenessRange */
     , (8122,  34,       1) /* PowerupTime */
     , (8122,  36,       1) /* ChargeSpeed */
     , (8122,  39,     1.1) /* DefaultScale */
     , (8122,  64,     0.9) /* ResistSlash */
     , (8122,  65,     0.5) /* ResistPierce */
     , (8122,  66,     0.7) /* ResistBludgeon */
     , (8122,  67,     0.9) /* ResistFire */
     , (8122,  68,     0.2) /* ResistCold */
     , (8122,  69,     0.7) /* ResistAcid */
     , (8122,  70,     0.6) /* ResistElectric */
...
VALUES (8122,   1, 0x02000197) /* Setup */
     ...
     , (8122,   4, 0x30000000) /* CombatTable */
     , (8122,   6, 0x04000742) /* PaletteBase */
     , (8122,   7, 0x10000066) /* ClothingBase */
...
VALUES (8122,  6, 0, 3, 0, 132, 0, 0) /* MeleeDefense        Specialized */
     , (8122,  7, 0, 3, 0, 230, 0, 0) /* MissileDefense      Specialized */
     , (8122, 14, 0, 2, 0, 150, 0, 0) /* ArcaneLore          Trained */
     , (8122, 15, 0, 3, 0, 125, 0, 0) /* MagicDefense        Specialized */
     , (8122, 20, 0, 2, 0,  50, 0, 0) /* Deception           Trained */
     , (8122, 31, 0, 3, 0, 110, 0, 0) /* CreatureEnchantment Specialized */
     , (8122, 33, 0, 3, 0, 110, 0, 0) /* LifeMagic           Specialized */
     , (8122, 34, 0, 3, 0, 110, 0, 0) /* WarMagic            Specialized */
     , (8122, 44, 0, 3, 0, 110, 0, 0) /* HeavyWeapons        Specialized */
     , (8122, 45, 0, 3, 0, 110, 0, 0) /* LightWeapons        Specialized */
     , (8122, 46, 0, 3, 0, 110, 0, 0) /* FinesseWeapons      Specialized */
     , (8122, 47, 0, 3, 0, 117, 0, 0) /* MissileWeapons      Specialized */
     , (8122, 48, 0, 3, 0, 110, 0, 0) /* Shield              Specialized */;
