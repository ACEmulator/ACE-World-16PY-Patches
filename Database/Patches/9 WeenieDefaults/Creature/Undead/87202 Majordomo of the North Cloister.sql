...
VALUES (87202, 'ace87202-majordomoofthenorthcloister', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (87202,   1, 0x020014C0) /* Setup */
     , (87202,   2, 0x09000017) /* MotionTable */
     , (87202,   3, 0x20000016) /* SoundTable */
     , (87202,   4, 0x30000000) /* CombatTable */
     , (87202,   6, 0x0400007E) /* PaletteBase */
     , (87202,   7, 0x10000647) /* ClothingBase */
     , (87202,   8, 0x06001226) /* Icon */
     , (87202,  22, 0x34000028) /* PhysicsEffectTable */;
...
VALUES (87202,  0,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87202,  1,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87202,  2,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87202,  3,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87202,  4,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87202,  5,  4, 100, 0.75,  475,  428,  475,  333,  190,  190,  475,  285,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87202,  6,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87202,  7,  4,  0,    0,  475,  428,  475,  333,  190,  190,  475,  285,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87202,  8,  4, 100, 0.75,  475,  428,  475,  333,  190,  190,  475,  285,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
