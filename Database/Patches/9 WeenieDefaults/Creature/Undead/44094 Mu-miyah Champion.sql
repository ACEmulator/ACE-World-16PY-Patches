...
VALUES (44094, 'ace44094-mumiyahchampion', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44094,  6, 0, 2, 0, 470, 0, 0) /* MeleeDefense        Trained */
     ...
     , (44094, 15, 0, 2, 0, 320, 0, 0) /* MagicDefense        Trained */
     , (44094, 24, 0, 2, 0, 255, 0, 0) /* Run                 Trained */
     , (44094, 33, 0, 2, 0, 350, 0, 0) /* LifeMagic           Trained */
     , (44094, 34, 0, 2, 0, 350, 0, 0) /* WarMagic            Trained */
...
VALUES (44094,  0,  4,  0,    0,  460,  308,  414,  345,  460,  308,  308,  460,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44094,  1,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44094,  2,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44094,  3,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44094,  4,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44094,  5,  4, 300, 0.75,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44094,  6,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44094,  7,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44094,  8,  4, 300, 0.75,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (44094,  2074,   2.06)  /* Gossamer Flesh */
     , (44094,  2170,   2.06)  /* Inferno's Gift */
     , (44094,  4423,   2.06)  /* Incantation of Flame Arc */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (44094, 2, 44265,  1, 0, 0.1, False) /* Create Burning Sands Katar (44265) for Wield */
     ...
     , (44094, 9, 44121,  1, 0, 0.2, False) /* Create Sandstone Armor Key (44121) for ContainTreasure */
     , (44094, 9, 44122,  1, 0, 0.2, False) /* Create Sandstone Magic Key (44122) for ContainTreasure */
     , (44094, 9, 44123,  1, 0, 0.2, False) /* Create Sandstone Mixed Key (44123) for ContainTreasure */
     , (44094, 9, 44124,  1, 0, 0.2, False) /* Create Sandstone Weapon Key (44124) for ContainTreasure */
     , (44094, 9,     0,  0, 0, 0.2, False) /* Create nothing for ContainTreasure */;
