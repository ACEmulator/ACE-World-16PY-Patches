...
VALUES (44108, 'ace44108-mumiyahchanneller', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44108,   1, 0x02000001) /* Setup */
     , (44108,   2, 0x090000F5) /* MotionTable */
     , (44108,   3, 0x2000001E) /* SoundTable */
     , (44108,   4, 0x30000008) /* CombatTable */
     , (44108,   6, 0x0400007E) /* PaletteBase */
     , (44108,   7, 0x100000BD) /* ClothingBase */
     , (44108,   8, 0x060016C2) /* Icon */
     , (44108,  22, 0x34000028) /* PhysicsEffectTable */
...
VALUES (44108,  0,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44108,  1,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44108,  2,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44108,  3,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44108,  4,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44108,  5,  4,  4, 0.75,  250,  250,  250,  100,  100,  200,  168,  200,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44108,  6,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44108,  7,  4,  0,    0,  250,  250,  250,  100,  100,  200,  168,  200,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44108,  8,  4,  8, 0.75,  250,  250,  250,  100,  100,  200,  168,  200,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (44108,  5542,   2.06)  /* Burning Sands Infliction */
     , (44108,  5543,    2.5)  /* Curse of the Burning Sands */
     , (44108,  4423,    2.2)  /* Incantation of Flame Arc */
