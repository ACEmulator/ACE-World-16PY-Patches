...
VALUES (70012, 'ace70012-caravaushthechamberlain', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (70012,   1, 0x02000001) /* Setup */
     , (70012,   2, 0x09000025) /* MotionTable */
     , (70012,   3, 0x2000001E) /* SoundTable */
     , (70012,   4, 0x30000000) /* CombatTable */
     , (70012,   6, 0x0400007E) /* PaletteBase */
     , (70012,   7, 0x100000BD) /* ClothingBase */
     , (70012,   8, 0x060016C2) /* Icon */
     , (70012,  22, 0x34000028) /* PhysicsEffectTable */
...
VALUES (70012,  0,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (70012,  1,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (70012,  2,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (70012,  3,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (70012,  4,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (70012,  5,  4, 140,  0.5,  350,  207,  154,  207,   11,  140,  350,  112,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (70012,  6,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (70012,  7,  4,  0,    0,  350,  207,  154,  207,   11,  140,  350,  112,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (70012,  8,  4, 160,  0.5,  350,  207,  154,  207,   11,  140,  350,  112,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (70012,  5 /* HeartBeat */,  0.015, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (70012,  5 /* HeartBeat */,   0.04, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (70012,  5 /* HeartBeat */,  0.055, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (70012,  5 /* HeartBeat */,   0.15, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
