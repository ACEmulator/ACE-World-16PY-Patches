...
VALUES (1463, 'undeadspecial', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (1463,   1,       5) /* HeartbeatInterval */
     ...
     , (1463,   3,     0.6) /* HealthRate */
     , (1463,   4,     0.5) /* StaminaRate */
     , (1463,   5,       2) /* ManaRate */
     , (1463,  12,     0.5) /* Shade */
     , (1463,  13,     0.8) /* ArmorModVsSlash */
     , (1463,  14,    0.47) /* ArmorModVsPierce */
     , (1463,  15,    0.65) /* ArmorModVsBludgeon */
     , (1463,  16,    0.03) /* ArmorModVsCold */
     , (1463,  17,     0.5) /* ArmorModVsFire */
     , (1463,  18,    0.65) /* ArmorModVsAcid */
     , (1463,  19,    0.72) /* ArmorModVsElectric */
     , (1463,  31,      18) /* VisualAwarenessRange */
     , (1463,  34,       1) /* PowerupTime */
     , (1463,  36,       1) /* ChargeSpeed */
     , (1463,  39,     1.1) /* DefaultScale */
     , (1463,  64,       1) /* ResistSlash */
     , (1463,  65,    0.52) /* ResistPierce */
     , (1463,  66,    0.75) /* ResistBludgeon */
     , (1463,  67,       1) /* ResistFire */
     , (1463,  68,     0.1) /* ResistCold */
     , (1463,  69,    0.75) /* ResistAcid */
     , (1463,  70,    0.86) /* ResistElectric */
...
VALUES (1463,   1, 0x02000197) /* Setup */
     ...
     , (1463,   4, 0x30000000) /* CombatTable */
     , (1463,   6, 0x04000742) /* PaletteBase */
     , (1463,   7, 0x10000066) /* ClothingBase */
...
VALUES (1463,  6, 0, 3, 0, 170, 0, 0) /* MeleeDefense        Specialized */
     , (1463,  7, 0, 3, 0, 300, 0, 0) /* MissileDefense      Specialized */
     , (1463, 14, 0, 2, 0, 230, 0, 0) /* ArcaneLore          Trained */
     , (1463, 15, 0, 3, 0, 165, 0, 0) /* MagicDefense        Specialized */
     , (1463, 20, 0, 2, 0,  90, 0, 0) /* Deception           Trained */
     , (1463, 31, 0, 3, 0,  70, 0, 0) /* CreatureEnchantment Specialized */
     , (1463, 33, 0, 3, 0,  70, 0, 0) /* LifeMagic           Specialized */
     , (1463, 34, 0, 3, 0,  70, 0, 0) /* WarMagic            Specialized */
     , (1463, 44, 0, 3, 0, 200, 0, 0) /* HeavyWeapons        Specialized */
     , (1463, 45, 0, 3, 0, 200, 0, 0) /* LightWeapons        Specialized */
     , (1463, 46, 0, 3, 0, 120, 0, 0) /* FinesseWeapons      Specialized */
     , (1463, 47, 0, 3, 0, 150, 0, 0) /* MissileWeapons      Specialized */
     , (1463, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;
