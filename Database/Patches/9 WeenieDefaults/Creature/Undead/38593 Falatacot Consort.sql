...
VALUES (38593, 'ace38593-falatacotconsort', 10, '2023-06-05 00:31:03') /* Creature */;
...
VALUES (38593,  6, 0, 2, 0, 348, 0, 0) /* MeleeDefense        Trained */
     , (38593,  7, 0, 2, 0, 191, 0, 0) /* MissileDefense      Trained */
     , (38593, 15, 0, 2, 0, 320, 0, 0) /* MagicDefense        Trained */
     , (38593, 31, 0, 2, 0,  71, 0, 0) /* CreatureEnchantment Trained */
     , (38593, 33, 0, 2, 0,  71, 0, 0) /* LifeMagic           Trained */
     , (38593, 34, 0, 2, 0,  71, 0, 0) /* WarMagic            Trained */
     , (38593, 44, 0, 2, 0, 320, 0, 0) /* HeavyWeapons        Trained */
     , (38593, 45, 0, 2, 0, 320, 0, 0) /* LightWeapons        Trained */
     , (38593, 46, 0, 2, 0, 331, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (38593,  0,  4,  0,    0,  360,  360,  468,  360,  468,  360,  360,  432,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38593,  1,  4,  0,    0,  370,  370,  481,  370,  481,  370,  370,  444,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38593,  2,  4,  0,    0,  370,  370,  481,  370,  481,  370,  370,  444,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38593,  3,  4,  0,    0,  380,  380,  494,  380,  494,  380,  380,  456,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38593,  4,  4,  0,    0,  400,  400,  520,  400,  520,  400,  400,  480,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38593,  5,  4,  5, 0.75,  380,  380,  494,  380,  494,  380,  380,  456,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38593,  6,  4,  0,    0,  370,  370,  481,  370,  481,  370,  370,  444,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38593,  7,  4,  0,    0,  400,  400,  520,  400,  520,  400,  400,  480,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38593,  8,  4,  5, 0.75,  380,  380,  494,  380,  494,  380,  380,  456,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
