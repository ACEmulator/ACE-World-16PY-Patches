...
VALUES (43269, 'ace43269-undeadcommander', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (43269,   1,       5) /* HeartbeatInterval */
     ...
     , (43269,  31,      34) /* VisualAwarenessRange */
...
VALUES (43269,  6, 0, 3, 0, 350, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (43269, 45, 0, 3, 0, 290, 0, 0) /* LightWeapons        Specialized */
...
VALUES (43269,  0,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (43269,  1,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (43269,  2,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (43269,  3,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (43269,  4,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (43269,  5,  4, 500, 0.75,  390,  234,  234,  261,  390,  156,  371,  390,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (43269,  6,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (43269,  7,  4,  0,    0,  390,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (43269,  8,  4, 500, 0.75,  390,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (43269,  3878,   2.06)  /* Incendiary Strike */
     ...
     , (43269,  4643,   2.06)  /* Incantation of Drain Health Other */
...
VALUES (43269,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
