...
VALUES (39350,  6, 0, 3, 0, 340, 0, 0) /* MeleeDefense        Specialized */
     , (39350,  7, 0, 3, 0, 264, 0, 0) /* MissileDefense      Specialized */
     , (39350, 14, 0, 3, 0, 253, 0, 0) /* ArcaneLore          Specialized */
     , (39350, 15, 0, 3, 0, 251, 0, 0) /* MagicDefense        Specialized */
     , (39350, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (39350, 31, 0, 3, 0, 330, 0, 0) /* CreatureEnchantment Specialized */
     , (39350, 33, 0, 3, 0, 330, 0, 0) /* LifeMagic           Specialized */
     , (39350, 34, 0, 3, 0, 330, 0, 0) /* WarMagic            Specialized */
     , (39350, 44, 0, 3, 0, 355, 0, 0) /* HeavyWeapons        Specialized */
     , (39350, 45, 0, 3, 0, 355, 0, 0) /* LightWeapons        Specialized */
     , (39350, 46, 0, 3, 0, 340, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (39350,  0,  4,  0,    0,  500,  525,  650,  500,  650,  310,  525,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (39350,  1,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (39350,  2,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (39350,  3,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (39350,  4,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (39350,  5,  4, 200,  0.5,  500,  525,  650,  500,  650,  380,  525,  600,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (39350,  6,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (39350,  7,  4,  0,    0,  500,  525,  650,  500,  650,  380,  525,  600,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (39350,  8,  4, 250,  0.5,  500,  525,  650,  500,  650,  310,  525,  600,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
