...
VALUES (51271, 'ace51271-tressar', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (51271,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 12 /* QuestSuccess */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKillWait_0513', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 12 /* QuestSuccess */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKilltask_0513@KillTaskInProgress', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 12 /* QuestSuccess */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKilltask_0513@KillTaskCompleted', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 13 /* QuestFailure */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKillWait_0513', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 13 /* QuestFailure */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKilltask_0513@KillTaskCompleted', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (51271, 13 /* QuestFailure */,      1, NULL, NULL, NULL, 'GearknightInvasionPhalanxKilltask_0513@KillTaskInProgress', NULL, NULL, NULL);
...
VALUES (51271, 2,  2587,  0, 92, 0.5, False) /* Create Shirt (2587) for Wield */
     , (51271, 2,  2597,  0, 93, 0.5, False) /* Create Flared Pants (2597) for Wield */
