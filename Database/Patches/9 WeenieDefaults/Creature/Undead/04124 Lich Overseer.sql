...
VALUES (4124, 'zombielichoverseer', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (4124,   1,       5) /* HeartbeatInterval */
     ...
     , (4124,   3,     0.3) /* HealthRate */
     , (4124,   4,     0.5) /* StaminaRate */
     , (4124,   5,       2) /* ManaRate */
     , (4124,  12,     0.5) /* Shade */
     , (4124,  13,     0.8) /* ArmorModVsSlash */
     , (4124,  14,     0.3) /* ArmorModVsPierce */
     , (4124,  15,    0.55) /* ArmorModVsBludgeon */
     , (4124,  16,    0.18) /* ArmorModVsCold */
     , (4124,  17,     0.5) /* ArmorModVsFire */
     , (4124,  18,    0.55) /* ArmorModVsAcid */
     , (4124,  19,    0.67) /* ArmorModVsElectric */
     , (4124,  31,      20) /* VisualAwarenessRange */
     , (4124,  34,     1.1) /* PowerupTime */
     , (4124,  36,       1) /* ChargeSpeed */
     , (4124,  39,     1.3) /* DefaultScale */
     , (4124,  41,      60) /* RegenerationInterval */
     , (4124,  43,      10) /* GeneratorRadius */
     , (4124,  64,       1) /* ResistSlash */
     , (4124,  65,    0.52) /* ResistPierce */
     , (4124,  66,    0.75) /* ResistBludgeon */
     , (4124,  67,       1) /* ResistFire */
     , (4124,  68,     0.2) /* ResistCold */
     , (4124,  69,    0.75) /* ResistAcid */
     , (4124,  70,    0.86) /* ResistElectric */
...
VALUES (4124,  6, 0, 2, 0, 180, 0, 0) /* MeleeDefense        Trained */
     ...
     , (4124, 45, 0, 3, 0, 130, 0, 0) /* LightWeapons        Specialized */
...
VALUES (4124,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (4124, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,   0.14, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,   0.18, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,   0.22, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4124,  5 /* HeartBeat */,    0.3, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
