...
VALUES (1404, 'lostlightguardian', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (1404,   1,       5) /* HeartbeatInterval */
     ...
     , (1404,   3,     0.6) /* HealthRate */
     , (1404,   4,     0.5) /* StaminaRate */
     , (1404,   5,       2) /* ManaRate */
     , (1404,  12,     0.5) /* Shade */
     , (1404,  13,     0.8) /* ArmorModVsSlash */
     , (1404,  14,    0.47) /* ArmorModVsPierce */
     , (1404,  15,    0.65) /* ArmorModVsBludgeon */
     , (1404,  16,    0.03) /* ArmorModVsCold */
     , (1404,  17,     0.5) /* ArmorModVsFire */
     , (1404,  18,    0.65) /* ArmorModVsAcid */
     , (1404,  19,    0.72) /* ArmorModVsElectric */
     , (1404,  31,      18) /* VisualAwarenessRange */
     , (1404,  34,       1) /* PowerupTime */
     , (1404,  36,       1) /* ChargeSpeed */
     , (1404,  39,     1.1) /* DefaultScale */
     , (1404,  64,       1) /* ResistSlash */
     , (1404,  65,    0.52) /* ResistPierce */
     , (1404,  66,    0.75) /* ResistBludgeon */
     , (1404,  67,       1) /* ResistFire */
     , (1404,  68,     0.1) /* ResistCold */
     , (1404,  69,    0.75) /* ResistAcid */
     , (1404,  70,    0.86) /* ResistElectric */
...
VALUES (1404,  6, 0, 3, 0,  75, 0, 304.203338623047) /* MeleeDefense        Specialized */
     ...
     , (1404, 45, 0, 3, 0, 200, 0, 304.203338623047) /* LightWeapons        Specialized */
