...
VALUES (31015, 'mumiyahsentinelhighyield', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31015,   1,       5) /* HeartbeatInterval */
     ...
     , (31015,   3,     0.8) /* HealthRate */
     , (31015,   4,     0.5) /* StaminaRate */
     , (31015,   5,       2) /* ManaRate */
     , (31015,  12,     0.5) /* Shade */
     , (31015,  13,    0.85) /* ArmorModVsSlash */
     , (31015,  14,     0.9) /* ArmorModVsPierce */
     , (31015,  15,    0.65) /* ArmorModVsBludgeon */
     , (31015,  16,    0.89) /* ArmorModVsCold */
     , (31015,  17,    0.95) /* ArmorModVsFire */
     , (31015,  18,     1.2) /* ArmorModVsAcid */
     , (31015,  19,     1.1) /* ArmorModVsElectric */
     , (31015,  31,      18) /* VisualAwarenessRange */
     , (31015,  34,       1) /* PowerupTime */
     , (31015,  36,       1) /* ChargeSpeed */
     , (31015,  39,     1.1) /* DefaultScale */
     , (31015,  64,     1.1) /* ResistSlash */
     , (31015,  65,    1.15) /* ResistPierce */
     , (31015,  66,    1.33) /* ResistBludgeon */
     , (31015,  67,    0.95) /* ResistFire */
     , (31015,  68,     0.9) /* ResistCold */
     , (31015,  69,     0.4) /* ResistAcid */
     , (31015,  70,    0.85) /* ResistElectric */
...
VALUES (31015,   1, 0x02000001) /* Setup */
     ...
     , (31015,   4, 0x30000000) /* CombatTable */
     , (31015,   6, 0x0400007E) /* PaletteBase */
     , (31015,   7, 0x100000BD) /* ClothingBase */
...
VALUES (31015,  6, 0, 3, 0, 310, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (31015, 45, 0, 3, 0, 303, 0, 0) /* LightWeapons        Specialized */
...
VALUES (31015,  0,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31015,  1,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31015,  2,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31015,  3,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31015,  4,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31015,  5,  4, 185, 0.75,  450,  383,  405,  293,  401,  428,  540,  495,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31015,  6,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31015,  7,  4,  0,    0,  450,  383,  405,  293,  401,  428,  540,  495,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31015,  8,  4, 185, 0.75,  450,  383,  405,  293,  401,  428,  540,  495,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31015,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31015,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31015,  5 /* HeartBeat */,   0.15, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
