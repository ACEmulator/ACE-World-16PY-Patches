...
VALUES (7119, 'mumiyahimperial', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (7119,   1,       5) /* HeartbeatInterval */
     ...
     , (7119,   3,     0.6) /* HealthRate */
     , (7119,   4,     0.5) /* StaminaRate */
     , (7119,   5,       2) /* ManaRate */
     , (7119,  12,     0.5) /* Shade */
     , (7119,  13,    0.59) /* ArmorModVsSlash */
     , (7119,  14,    0.44) /* ArmorModVsPierce */
     , (7119,  15,    0.59) /* ArmorModVsBludgeon */
     , (7119,  16,    0.03) /* ArmorModVsCold */
     , (7119,  17,     0.4) /* ArmorModVsFire */
     , (7119,  18,       1) /* ArmorModVsAcid */
     , (7119,  19,    0.32) /* ArmorModVsElectric */
     , (7119,  31,      24) /* VisualAwarenessRange */
     , (7119,  34,       1) /* PowerupTime */
     , (7119,  36,       1) /* ChargeSpeed */
     , (7119,  39,     1.3) /* DefaultScale */
     , (7119,  64,    0.75) /* ResistSlash */
     , (7119,  65,    0.58) /* ResistPierce */
     , (7119,  66,    0.75) /* ResistBludgeon */
     , (7119,  67,       1) /* ResistFire */
     , (7119,  68,    0.25) /* ResistCold */
     , (7119,  69,       1) /* ResistAcid */
     , (7119,  70,    0.46) /* ResistElectric */
...
VALUES (7119,   1, 0x02000001) /* Setup */
     ...
     , (7119,   4, 0x30000000) /* CombatTable */
     , (7119,   6, 0x0400007E) /* PaletteBase */
     , (7119,   7, 0x100000BD) /* ClothingBase */
     , (7119,   8, 0x060016C2) /* Icon */
     , (7119,  22, 0x34000028) /* PhysicsEffectTable */
     , (7119,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (7119,  6, 0, 3, 0, 393, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (7119, 45, 0, 3, 0, 340, 0, 0) /* LightWeapons        Specialized */
...
VALUES (7119,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7119, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7119,  5 /* HeartBeat */,  0.015, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7119,  5 /* HeartBeat */,   0.04, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7119,  5 /* HeartBeat */,  0.055, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7119,  5 /* HeartBeat */,   0.15, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
