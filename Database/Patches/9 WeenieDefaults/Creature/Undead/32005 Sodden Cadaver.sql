...
VALUES (32005, 'ace32005-soddencadaver', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (32005,  6, 0, 3, 0, 203, 0, 0) /* MeleeDefense        Specialized */
     , (32005,  7, 0, 3, 0, 245, 0, 0) /* MissileDefense      Specialized */
     , (32005, 14, 0, 3, 0, 240, 0, 0) /* ArcaneLore          Specialized */
     , (32005, 15, 0, 3, 0, 232, 0, 0) /* MagicDefense        Specialized */
     , (32005, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (32005, 31, 0, 3, 0, 290, 0, 0) /* CreatureEnchantment Specialized */
     , (32005, 33, 0, 3, 0, 258, 0, 0) /* LifeMagic           Specialized */
     , (32005, 34, 0, 3, 0, 258, 0, 0) /* WarMagic            Specialized */
     , (32005, 44, 0, 3, 0, 195, 0, 0) /* HeavyWeapons        Specialized */
     , (32005, 45, 0, 3, 0, 195, 0, 0) /* LightWeapons        Specialized */
     , (32005, 46, 0, 3, 0, 208, 0, 0) /* FinesseWeapons      Specialized */
     , (32005, 47, 0, 3, 0,  10, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (32005,  0,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (32005,  1,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (32005,  2,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (32005,  3,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (32005,  4,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (32005,  5,  4, 150, 0.75,  475,  475,  475,  475,  475,  475,  475,  475,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (32005,  6,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (32005,  7,  4,  0,    0,  475,  475,  475,  475,  475,  475,  475,  475,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (32005,  8,  4, 150, 0.75,  475,  475,  475,  475,  475,  475,  475,  475,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
