...
VALUES (46815, 'ace46815-wightbladesorcerer', 10, '2025-08-05 05:31:31') /* Creature */;
...
VALUES (46815,  6, 0, 3, 0, 520, 0, 0) /* MeleeDefense        Specialized */
     , (46815,  7, 0, 3, 0, 390, 0, 0) /* MissileDefense      Specialized */
     , (46815, 15, 0, 3, 0, 375, 0, 0) /* MagicDefense        Specialized */
     , (46815, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (46815, 33, 0, 3, 0, 250, 0, 0) /* LifeMagic           Specialized */
     , (46815, 34, 0, 3, 0, 250, 0, 0) /* WarMagic            Specialized */
     , (46815, 45, 0, 3, 0, 500, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (46815,  0,  4,  0,    0,  330,  281,  314,  281,  314,  281,  297,  314,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46815,  1,  4,  0,    0,  340,  289,  323,  289,  323,  289,  306,  323,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46815,  2,  4,  0,    0,  380,  323,  361,  323,  361,  323,  342,  361,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46815,  3,  4,  0,    0,  350,  298,  333,  298,  333,  298,  315,  333,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46815,  4,  4,  0,    0,  380,  323,  361,  323,  361,  323,  342,  361,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46815,  5,  4, 400, 0.75,  360,  306,  342,  306,  342,  306,  324,  342,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46815,  6,  4,  0,    0,  340,  289,  323,  289,  323,  289,  306,  323,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46815,  7,  4,  0,    0,  380,  323,  361,  323,  361,  323,  342,  361,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46815,  8,  4, 400, 0.75,  380,  323,  361,  323,  361,  323,  342,  361,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (46815,  1786,    2.1)  /* Nuhmudira's Spines */
     , (46815,  5531,   2.11)  /* Bloodstone Bolt VII */
     , (46815,  4424,   2.12)  /* Incantation of Force Arc */
     , (46815,  4442,   2.15)  /* Incantation of Force Blast */
     , (46815,  4443,   2.17)  /* Incantation of Force Bolt */
     , (46815,  4489,    2.1)  /* Incantation of Fester Other */
     , (46815,  2166,   2.11)  /* Tusker's Gift */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46815,  3 /* Death */,    0.1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46815,  5 /* HeartBeat */,  0.012, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (46815, 9, 35105,  1, 0, 0.1, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (46815, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */
     ...
     , (46815, 9, 37260,  0, 0, 0.003, False) /* Create The Jester (37260) for ContainTreasure */
     , (46815, 9,     0,  0, 0, 0.919, False) /* Create nothing for ContainTreasure */;
