...
VALUES (39349, 'ace39349-kazykritthuunixis', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (39349,  6, 0, 3, 0, 505, 0, 0) /* MeleeDefense        Specialized */
     , (39349,  7, 0, 3, 0, 499, 0, 0) /* MissileDefense      Specialized */
     , (39349, 14, 0, 3, 0, 253, 0, 0) /* ArcaneLore          Specialized */
     , (39349, 15, 0, 3, 0, 437, 0, 0) /* MagicDefense        Specialized */
     , (39349, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (39349, 31, 0, 3, 0, 430, 0, 0) /* CreatureEnchantment Specialized */
     , (39349, 33, 0, 3, 0, 430, 0, 0) /* LifeMagic           Specialized */
     , (39349, 34, 0, 3, 0, 430, 0, 0) /* WarMagic            Specialized */
     , (39349, 44, 0, 3, 0, 455, 0, 0) /* HeavyWeapons        Specialized */
     , (39349, 45, 0, 3, 0, 455, 0, 0) /* LightWeapons        Specialized */
     , (39349, 46, 0, 3, 0, 440, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (39349,  0,  4,  0,    0,  690,  725,  897,  690,  897,  690,  725,  828,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (39349,  1,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (39349,  2,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (39349,  3,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (39349,  4,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (39349,  5,  4, 200,  0.5,  620,  651,  806,  620,  806,  620,  651,  744,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (39349,  6,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (39349,  7,  4,  0,    0,  620,  651,  806,  620,  806,  620,  651,  744,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (39349,  8,  4, 250,  0.5,  690,  725,  897,  690,  897,  690,  725,  828,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
