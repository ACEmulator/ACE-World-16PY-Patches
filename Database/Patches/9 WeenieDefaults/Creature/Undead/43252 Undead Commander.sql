...
VALUES (43252, 'ace43252-undeadcommander', 10, '2023-04-09 17:44:47') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (43252,   1,         16) /* ItemType - Creature */
     , (43252,   2,         14) /* CreatureType - Undead */
     , (43252,   3,         69) /* PaletteTemplate - YellowSlime */
...
VALUES (43252,   1,       5) /* HeartbeatInterval */
     ...
     , (43252,   3,       1) /* HealthRate */
     , (43252,   4,     0.5) /* StaminaRate */
     , (43252,   5,       2) /* ManaRate */
     , (43252,  12,       0) /* Shade */
     , (43252,  13,       1) /* ArmorModVsSlash */
     , (43252,  14,       1) /* ArmorModVsPierce */
     , (43252,  15,       1) /* ArmorModVsBludgeon */
     , (43252,  16,       1) /* ArmorModVsCold */
     , (43252,  17,       1) /* ArmorModVsFire */
     , (43252,  18,       1) /* ArmorModVsAcid */
     , (43252,  19,       1) /* ArmorModVsElectric */
     , (43252,  31,      18) /* VisualAwarenessRange */
     , (43252,  34,       1) /* PowerupTime */
     , (43252,  36,       1) /* ChargeSpeed */
     , (43252,  39,     1.3) /* DefaultScale */
     , (43252,  64,    0.65) /* ResistSlash */
     , (43252,  65,    0.65) /* ResistPierce */
     , (43252,  66,    0.65) /* ResistBludgeon */
     , (43252,  67,    0.75) /* ResistFire */
     , (43252,  68,     0.4) /* ResistCold */
     , (43252,  69,    0.65) /* ResistAcid */
     , (43252,  70,     0.4) /* ResistElectric */
...
VALUES (43252,   1, 0x0200100D) /* Setup */
     ...
     , (43252,  35,       1000) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (43252,  6, 0, 3, 0, 370, 0, 0) /* MeleeDefense        Specialized */
     , (43252,  7, 0, 3, 0, 520, 0, 0) /* MissileDefense      Specialized */
     , (43252, 15, 0, 3, 0, 290, 0, 0) /* MagicDefense        Specialized */
     , (43252, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (43252, 45, 0, 3, 0, 450, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (43252,  0,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (43252,  1,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (43252,  2,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (43252,  3,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (43252,  4,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (43252,  5,  4, 800, 0.75,  400,  234,  234,  261,  390,  156,  371,  390,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (43252,  6,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (43252,  7,  4,  0,    0,  400,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (43252,  8,  4, 800, 0.75,  400,  234,  234,  261,  390,  156,  371,  390,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (43252,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

SET @parent_id = LAST_INSERT_ID();

INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id,  0,   8 /* Say */, 1, 35, NULL, 'Enough of this.  I will deal with the interlopers myself.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
