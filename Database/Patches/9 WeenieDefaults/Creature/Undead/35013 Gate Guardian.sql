...
VALUES (35013, 'ace35013-gateguardian', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (35013,  6, 0, 3, 0, 333, 0, 0) /* MeleeDefense        Specialized */
     , (35013,  7, 0, 3, 0, 285, 0, 0) /* MissileDefense      Specialized */
     , (35013, 15, 0, 3, 0, 356, 0, 0) /* MagicDefense        Specialized */
     , (35013, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (35013, 33, 0, 3, 0, 325, 0, 0) /* LifeMagic           Specialized */
     , (35013, 34, 0, 3, 0, 325, 0, 0) /* WarMagic            Specialized */
     , (35013, 41, 0, 3, 0, 343, 0, 0) /* TwoHandedCombat     Specialized */
     , (35013, 44, 0, 3, 0, 343, 0, 0) /* HeavyWeapons        Specialized */
     , (35013, 45, 0, 3, 0, 343, 0, 0) /* LightWeapons        Specialized */
     , (35013, 46, 0, 3, 0, 343, 0, 0) /* FinesseWeapons      Specialized */
     , (35013, 47, 0, 3, 0, 298, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (35013,  0,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35013,  1,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35013,  2,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (35013,  3,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35013,  4,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (35013,  5,  4,  5, 0.75,  350,  275,  275,  275,  275,  125,  275,  275,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35013,  6,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (35013,  7,  4,  0,    0,  350,  275,  275,  275,  275,  125,  275,  275,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (35013,  8,  4,  5, 0.75,  350,  275,  275,  275,  275,  125,  275,  275,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
