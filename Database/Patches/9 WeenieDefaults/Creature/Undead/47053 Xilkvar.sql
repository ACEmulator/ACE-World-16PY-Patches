...
VALUES (47053, 'ace47053-xilkvar', 10, '2022-05-17 03:47:03') /* Creature */;
...
VALUES (47053,  6, 0, 3, 0, 395, 0, 0) /* MeleeDefense        Specialized */
     , (47053,  7, 0, 3, 0, 405, 0, 0) /* MissileDefense      Specialized */
     , (47053, 14, 0, 3, 0, 240, 0, 0) /* ArcaneLore          Specialized */
     , (47053, 15, 0, 3, 0, 380, 0, 0) /* MagicDefense        Specialized */
     , (47053, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (47053, 31, 0, 3, 0, 375, 0, 0) /* CreatureEnchantment Specialized */
     , (47053, 33, 0, 3, 0, 375, 0, 0) /* LifeMagic           Specialized */
     , (47053, 34, 0, 3, 0, 375, 0, 0) /* WarMagic            Specialized */
     , (47053, 44, 0, 3, 0, 395, 0, 0) /* HeavyWeapons        Specialized */
     , (47053, 45, 0, 3, 0, 395, 0, 0) /* LightWeapons        Specialized */
     , (47053, 46, 0, 3, 0, 395, 0, 0) /* FinesseWeapons      Specialized */
     , (47053, 47, 0, 3, 0, 175, 0, 0) /* MissileWeapons      Specialized */
     , (47053, 48, 0, 3, 0, 300, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (47053,  0,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (47053,  1,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (47053,  2,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (47053,  3,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (47053,  4,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (47053,  5,  4,  5, 0.75,  425,  595,  340,  638,  255,  404,  319,  276,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (47053,  6,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (47053,  7,  4,  0,    0,  425,  595,  340,  638,  255,  404,  319,  276,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (47053,  8,  4,  5, 0.75,  425,  595,  340,  638,  255,  404,  319,  276,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (47053, 2, 47046,  1, 0, 0.55, False) /* Create Sickle (47046) for Wield */
     , (47053, 2, 47044,  1, 0, 0.56, False) /* Create Khopesh (47044) for Wield */;
