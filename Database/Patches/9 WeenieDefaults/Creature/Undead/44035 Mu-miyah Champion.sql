...
VALUES (44035, 'ace44035-mumiyahchampion', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44035,   1, 0x02000001) /* Setup */
     ...
     , (44035,   4, 0x30000008) /* CombatTable */
     , (44035,   6, 0x0400007E) /* PaletteBase */
     , (44035,   7, 0x100000BD) /* ClothingBase */
...
VALUES (44035,  0,  4,  0,    0,  460,  308,  414,  345,  460,  308,  308,  460,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44035,  1,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44035,  2,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44035,  3,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44035,  4,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44035,  5,  4, 300, 0.75,  350,  235,  315,  263,  350,  235,  235,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44035,  6,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44035,  7,  4,  0,    0,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44035,  8,  4, 300, 0.75,  350,  235,  315,  263,  350,  235,  235,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
