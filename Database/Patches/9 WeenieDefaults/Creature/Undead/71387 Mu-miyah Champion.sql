...
VALUES (71387, 'ace71387-mumiyahchampion', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (71387,   1,       5) /* HeartbeatInterval */
     ...
     , (71387,  15,     0.6) /* ArmorModVsBludgeon */
     , (71387,  16,       1) /* ArmorModVsCold */
     , (71387,  17,     0.6) /* ArmorModVsFire */
...
VALUES (71387,   1, 0x02000001) /* Setup */
     , (71387,   2, 0x090000F5) /* MotionTable */
     , (71387,   3, 0x2000001E) /* SoundTable */
     , (71387,   4, 0x30000008) /* CombatTable */
     , (71387,   6, 0x0400007E) /* PaletteBase */
     , (71387,   7, 0x100000BD) /* ClothingBase */
     , (71387,   8, 0x060016C2) /* Icon */
     , (71387,  22, 0x34000028) /* PhysicsEffectTable */;
...
VALUES (71387,  0,  4,  0,    0,  460,  308,  414,  276,  460,  276,  308,  460,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (71387,  1,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (71387,  2,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (71387,  3,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (71387,  4,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (71387,  5,  4, 300, 0.75,  350,  235,  315,  210,  350,  210,  235,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (71387,  6,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (71387,  7,  4,  0,    0,  350,  235,  315,  210,  350,  210,  235,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (71387,  8,  4, 300, 0.75,  350,  235,  315,  210,  350,  210,  235,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (71387, 9, 71355,  1, 0, 1, False) /* Create Mu-Miyah Sacrificial Dagger (71355) for ContainTreasure */;
