...
VALUES (7124, 'zombiedarkmagus', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (7124,   1,         16) /* ItemType - Creature */
     ...
     , (7124,  25,         80) /* Level */
     , (7124,  27,          0) /* ArmorType - None */
     , (7124,  40,          1) /* CombatMode - NonCombat */
     , (7124,  68,          3) /* TargetingTactic - Random, Focused */
     ...
     , (7124, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (7124,   1,       5) /* HeartbeatInterval */
     ...
     , (7124,   3,     0.8) /* HealthRate */
     , (7124,   4,     0.5) /* StaminaRate */
     , (7124,   5,       2) /* ManaRate */
     , (7124,  12,     0.5) /* Shade */
     , (7124,  13,     0.8) /* ArmorModVsSlash */
     , (7124,  14,    0.53) /* ArmorModVsPierce */
     , (7124,  15,    0.68) /* ArmorModVsBludgeon */
     , (7124,  16,    0.13) /* ArmorModVsCold */
     , (7124,  17,     0.5) /* ArmorModVsFire */
     , (7124,  18,    0.68) /* ArmorModVsAcid */
     , (7124,  19,    0.73) /* ArmorModVsElectric */
     , (7124,  31,      18) /* VisualAwarenessRange */
     , (7124,  34,       1) /* PowerupTime */
     , (7124,  36,       1) /* ChargeSpeed */
     , (7124,  39,     1.1) /* DefaultScale */
     , (7124,  64,       1) /* ResistSlash */
     , (7124,  65,    0.52) /* ResistPierce */
     , (7124,  66,    0.75) /* ResistBludgeon */
     , (7124,  67,       1) /* ResistFire */
     , (7124,  68,     0.1) /* ResistCold */
     , (7124,  69,    0.75) /* ResistAcid */
     , (7124,  70,    0.86) /* ResistElectric */
...
VALUES (7124,   1, 0x02000197) /* Setup */
     , (7124,   2, 0x09000017) /* MotionTable */
     , (7124,   3, 0x20000016) /* SoundTable */
     , (7124,   4, 0x30000000) /* CombatTable */
     , (7124,   6, 0x04000742) /* PaletteBase */
     , (7124,   7, 0x10000066) /* ClothingBase */
...
VALUES (7124,  6, 0, 3, 0, 200, 0, 0) /* MeleeDefense        Specialized */
     , (7124,  7, 0, 3, 0, 290, 0, 0) /* MissileDefense      Specialized */
     , (7124, 14, 0, 3, 0, 240, 0, 0) /* ArcaneLore          Specialized */
     , (7124, 15, 0, 3, 0, 190, 0, 0) /* MagicDefense        Specialized */
     , (7124, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (7124, 31, 0, 3, 0,  95, 0, 0) /* CreatureEnchantment Specialized */
     , (7124, 33, 0, 3, 0,  95, 0, 0) /* LifeMagic           Specialized */
     , (7124, 34, 0, 3, 0,  95, 0, 0) /* WarMagic            Specialized */
     , (7124, 44, 0, 3, 0, 200, 0, 0) /* HeavyWeapons        Specialized */
     , (7124, 45, 0, 3, 0, 200, 0, 0) /* LightWeapons        Specialized */
     , (7124, 46, 0, 3, 0, 200, 0, 0) /* FinesseWeapons      Specialized */
     , (7124, 47, 0, 3, 0, 240, 0, 0) /* MissileWeapons      Specialized */
     , (7124, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;
...
VALUES (7124,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7124, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7124, 9,  6876,  0, 0, 0.02, False) /* Create Sturdy Iron Key (6876) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (7124, 9,  7045,  0, 0, 0.03, False) /* Create Dark Revenant Thighbone (7045) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (7124, 9,  9310,  0, 0, 0.07, False) /* Create A Large Mnemosyne (9310) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.93, False) /* Create nothing for ContainTreasure */
     , (7124, 9, 12225,  0, 0, 0.05, False) /* Create Zombie Head (12225) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (7124, 9, 45876,  1, 0, 0.03, False) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (7124, 9, 45875,  1, 0, 0.01, False) /* Create Lucky Gold Letter (45875) for ContainTreasure */
     , (7124, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */;
