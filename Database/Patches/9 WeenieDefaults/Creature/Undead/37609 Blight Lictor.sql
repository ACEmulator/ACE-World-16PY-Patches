...
VALUES (37609, 'ace37609-blightlictor', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (37609,   1, 0x0200100D) /* Setup */
     ...
     , (37609,   4, 0x30000000) /* CombatTable */
     , (37609,   6, 0x040016C4) /* PaletteBase */
     , (37609,   7, 0x100004F6) /* ClothingBase */
...
VALUES (37609,  6, 0, 3, 0, 325, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (37609, 45, 0, 3, 0, 300, 0, 0) /* LightWeapons        Specialized */
...
VALUES (37609,  0,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (37609,  1,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (37609,  2,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (37609,  3,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (37609,  4,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (37609,  5,  4, 90, 0.75,  450,  360,  212,  293,   14,  225,  293,  324,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (37609,  6,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (37609,  7,  4,  0,    0,  450,  360,  212,  293,   14,  225,  293,  324,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (37609,  8,  4, 90, 0.75,  450,  360,  212,  293,   14,  225,  293,  324,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
