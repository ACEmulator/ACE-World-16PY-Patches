...
VALUES (7117, 'mumiyahguardian', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (7117,   1,       5) /* HeartbeatInterval */
     ...
     , (7117,   3,     0.6) /* HealthRate */
     , (7117,   4,     0.5) /* StaminaRate */
     , (7117,   5,       2) /* ManaRate */
     , (7117,  12,     0.5) /* Shade */
     , (7117,  13,    0.59) /* ArmorModVsSlash */
     , (7117,  14,    0.44) /* ArmorModVsPierce */
     , (7117,  15,    0.59) /* ArmorModVsBludgeon */
     , (7117,  16,    0.03) /* ArmorModVsCold */
     , (7117,  17,     0.4) /* ArmorModVsFire */
     , (7117,  18,       1) /* ArmorModVsAcid */
     , (7117,  19,    0.32) /* ArmorModVsElectric */
     , (7117,  31,      24) /* VisualAwarenessRange */
     , (7117,  34,       1) /* PowerupTime */
     , (7117,  36,       1) /* ChargeSpeed */
     , (7117,  39,     1.3) /* DefaultScale */
     , (7117,  64,    0.75) /* ResistSlash */
     , (7117,  65,    0.58) /* ResistPierce */
     , (7117,  66,    0.75) /* ResistBludgeon */
     , (7117,  67,       1) /* ResistFire */
     , (7117,  68,    0.25) /* ResistCold */
     , (7117,  69,       1) /* ResistAcid */
     , (7117,  70,    0.46) /* ResistElectric */
...
VALUES (7117,   1, 0x02000001) /* Setup */
     , (7117,   2, 0x09000025) /* MotionTable */
     , (7117,   3, 0x2000001E) /* SoundTable */
     , (7117,   4, 0x30000000) /* CombatTable */
     , (7117,   6, 0x0400007E) /* PaletteBase */
     , (7117,   7, 0x100000BD) /* ClothingBase */
     , (7117,   8, 0x060016C2) /* Icon */
     , (7117,  22, 0x34000028) /* PhysicsEffectTable */
...
VALUES (7117,  6, 0, 3, 0, 300, 0, 0) /* MeleeDefense        Specialized */
     , (7117,  7, 0, 3, 0, 400, 0, 0) /* MissileDefense      Specialized */
     , (7117, 14, 0, 2, 0, 300, 0, 0) /* ArcaneLore          Trained */
     , (7117, 15, 0, 3, 0, 239, 0, 0) /* MagicDefense        Specialized */
     , (7117, 20, 0, 2, 0,  90, 0, 0) /* Deception           Trained */
     , (7117, 31, 0, 3, 0, 165, 0, 0) /* CreatureEnchantment Specialized */
     , (7117, 33, 0, 3, 0, 165, 0, 0) /* LifeMagic           Specialized */
     , (7117, 34, 0, 3, 0, 165, 0, 0) /* WarMagic            Specialized */
     , (7117, 44, 0, 3, 0, 240, 0, 0) /* HeavyWeapons        Specialized */
     , (7117, 45, 0, 3, 0, 240, 0, 0) /* LightWeapons        Specialized */
     , (7117, 46, 0, 3, 0, 100, 0, 0) /* FinesseWeapons      Specialized */
     , (7117, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */
     , (7117, 48, 0, 3, 0, 240, 0, 0) /* Shield              Specialized */;
...
VALUES (7117,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7117, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7117,  5 /* HeartBeat */,  0.015, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7117,  5 /* HeartBeat */,   0.04, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7117,  5 /* HeartBeat */,  0.055, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7117,  5 /* HeartBeat */,   0.15, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
