...
VALUES (44097, 'ace44097-mumiyahgrandvizier', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (44097,   1,         16) /* ItemType - Creature */
     , (44097,   2,         14) /* CreatureType - Undead */
     , (44097,   3,         77) /* PaletteTemplate - BlueGreen */
...
VALUES (44097,   1, 0x02000001) /* Setup */
     ...
     , (44097,   4, 0x30000000) /* CombatTable */
     , (44097,   6, 0x0400007E) /* PaletteBase */
     , (44097,   7, 0x100000BD) /* ClothingBase */
...
VALUES (44097,  0,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44097,  1,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44097,  2,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44097,  3,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44097,  4,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44097,  5,  4, 550, 0.75,  550,  369,  495,  413,  550,  369,  369,  550,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44097,  6,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44097,  7,  4,  0,    0,  550,  369,  495,  413,  550,  369,  369,  550,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44097,  8,  4, 550, 0.75,  550,  369,  495,  413,  550,  369,  369,  550,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (44097,  4442,   2.06)  /* Incantation of Force Blast */
     , (44097,  4424,   2.06)  /* Incantation of Force Arc */
     , (44097,  6192,   2.06)  /* Nuhmudira's Spines II */
...
VALUES (44097, 9, 44240,  3, 0, 0.1, False) /* Create A'nekshay Token (44240) for ContainTreasure */
     ...
     , (44097, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */
     , (44097, 9, 44121,  1, 0, 0.2, False) /* Create Sandstone Armor Key (44121) for ContainTreasure */
     , (44097, 9, 44122,  1, 0, 0.2, False) /* Create Sandstone Magic Key (44122) for ContainTreasure */
     , (44097, 9, 44123,  1, 0, 0.2, False) /* Create Sandstone Mixed Key (44123) for ContainTreasure */
     , (44097, 9, 44124,  1, 0, 0.2, False) /* Create Sandstone Weapon Key (44124) for ContainTreasure */
     , (44097, 9,     0,  0, 0, 0.2, False) /* Create nothing for ContainTreasure */;
