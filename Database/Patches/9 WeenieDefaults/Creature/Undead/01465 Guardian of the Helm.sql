...
VALUES (1465, 'undeadflaminghelm', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (1465,   1,       5) /* HeartbeatInterval */
     ...
     , (1465,   5,       2) /* ManaRate */
     , (1465,  12,     0.5) /* Shade */
     , (1465,  13,     0.8) /* ArmorModVsSlash */
     , (1465,  14,     0.3) /* ArmorModVsPierce */
     , (1465,  15,    0.55) /* ArmorModVsBludgeon */
     , (1465,  16,    0.18) /* ArmorModVsCold */
     , (1465,  17,     0.5) /* ArmorModVsFire */
     , (1465,  18,    0.55) /* ArmorModVsAcid */
     , (1465,  19,    0.67) /* ArmorModVsElectric */
     , (1465,  31,      18) /* VisualAwarenessRange */
     , (1465,  34,       1) /* PowerupTime */
     , (1465,  36,       1) /* ChargeSpeed */
     , (1465,  39,     1.1) /* DefaultScale */
     , (1465,  64,       1) /* ResistSlash */
     , (1465,  65,    0.52) /* ResistPierce */
     , (1465,  66,    0.75) /* ResistBludgeon */
     , (1465,  67,       1) /* ResistFire */
     , (1465,  68,     0.2) /* ResistCold */
     , (1465,  69,    0.75) /* ResistAcid */
     , (1465,  70,    0.86) /* ResistElectric */
...
VALUES (1465,   1, 0x02000197) /* Setup */
     , (1465,   2, 0x09000017) /* MotionTable */
     , (1465,   3, 0x20000016) /* SoundTable */
     , (1465,   4, 0x30000000) /* CombatTable */
     , (1465,   6, 0x04000742) /* PaletteBase */
     , (1465,   7, 0x10000066) /* ClothingBase */
...
VALUES (1465,  6, 0, 3, 0, 120, 0, 0) /* MeleeDefense        Specialized */
     , (1465,  7, 0, 2, 0, 100, 0, 0) /* MissileDefense      Trained */
     , (1465, 14, 0, 3, 0, 150, 0, 0) /* ArcaneLore          Specialized */
     , (1465, 15, 0, 3, 0, 125, 0, 0) /* MagicDefense        Specialized */
     , (1465, 20, 0, 2, 0,  55, 0, 0) /* Deception           Trained */
     , (1465, 31, 0, 2, 0, 150, 0, 0) /* CreatureEnchantment Trained */
     , (1465, 33, 0, 2, 0, 150, 0, 0) /* LifeMagic           Trained */
     , (1465, 34, 0, 2, 0, 150, 0, 0) /* WarMagic            Trained */
     , (1465, 44, 0, 3, 0, 120, 0, 0) /* HeavyWeapons        Specialized */
     , (1465, 45, 0, 3, 0, 120, 0, 0) /* LightWeapons        Specialized */
     , (1465, 46, 0, 3, 0, 120, 0, 0) /* FinesseWeapons      Specialized */
     , (1465, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */
     , (1465, 48, 0, 3, 0, 100, 0, 0) /* Shield              Specialized */;
...
VALUES (1465,  94) /* ATTACK_NOTIFICATION_EVENT */
