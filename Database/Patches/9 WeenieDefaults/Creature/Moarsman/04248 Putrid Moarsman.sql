...
VALUES (4248, 'moarsmanputrid', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (4248,   1,       5) /* HeartbeatInterval */
     ...
     , (4248,   5,       2) /* ManaRate */
     , (4248,  12,     0.5) /* Shade */
     , (4248,  13,    0.74) /* ArmorModVsSlash */
     , (4248,  14,    0.68) /* ArmorModVsPierce */
     , (4248,  15,    0.47) /* ArmorModVsBludgeon */
     , (4248,  16,    0.74) /* ArmorModVsCold */
     , (4248,  17,    0.59) /* ArmorModVsFire */
     , (4248,  18,     0.3) /* ArmorModVsAcid */
     , (4248,  19,    0.47) /* ArmorModVsElectric */
     , (4248,  31,      18) /* VisualAwarenessRange */
     , (4248,  34,       1) /* PowerupTime */
     , (4248,  36,       1) /* ChargeSpeed */
     , (4248,  39,    1.65) /* DefaultScale */
     , (4248,  55,      60) /* HomeRadius */
     , (4248,  64,    0.86) /* ResistSlash */
     , (4248,  65,    0.75) /* ResistPierce */
     , (4248,  66,    0.42) /* ResistBludgeon */
     , (4248,  67,    0.58) /* ResistFire */
     , (4248,  68,    0.86) /* ResistCold */
     , (4248,  69,    0.25) /* ResistAcid */
     , (4248,  70,    0.42) /* ResistElectric */
...
VALUES (4248,   1, 0x02000992) /* Setup */
     , (4248,   2, 0x090000A0) /* MotionTable */
     , (4248,   3, 0x2000006A) /* SoundTable */
     , (4248,   4, 0x30000023) /* CombatTable */
     , (4248,   6, 0x04000FA8) /* PaletteBase */
     , (4248,   7, 0x10000276) /* ClothingBase */
     , (4248,   8, 0x06001ED1) /* Icon */
     , (4248,  19, 0x00000054) /* ActivationAnimation */
     , (4248,  22, 0x34000069) /* PhysicsEffectTable */
     , (4248,  30,         84) /* PhysicsScript - BreatheFlame */
     , (4248,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (4248,  6, 0, 3, 0, 280, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (4248, 45, 0, 3, 0, 265, 0, 0) /* LightWeapons        Specialized */
...
VALUES (4248,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (4248, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4248,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
