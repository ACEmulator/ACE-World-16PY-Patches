...
VALUES (31913, 'ace31913-goldmoarsman', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31913,   1,       5) /* HeartbeatInterval */
     ...
     , (31913,   5,       2) /* ManaRate */
     , (31913,  12,     0.5) /* Shade */
     , (31913,  13,    0.62) /* ArmorModVsSlash */
     , (31913,  14,    0.82) /* ArmorModVsPierce */
     , (31913,  15,    0.92) /* ArmorModVsBludgeon */
     , (31913,  16,    0.72) /* ArmorModVsCold */
     , (31913,  17,    0.92) /* ArmorModVsFire */
     , (31913,  18,    0.72) /* ArmorModVsAcid */
     , (31913,  19,    0.52) /* ArmorModVsElectric */
     , (31913,  31,      18) /* VisualAwarenessRange */
     , (31913,  34,       1) /* PowerupTime */
     , (31913,  36,       1) /* ChargeSpeed */
     , (31913,  39,     1.6) /* DefaultScale */
     , (31913,  55,      60) /* HomeRadius */
     , (31913,  62,    1.55) /* WeaponOffense */
     , (31913,  64,    0.85) /* ResistSlash */
     , (31913,  65,     0.6) /* ResistPierce */
     , (31913,  66,     0.6) /* ResistBludgeon */
     , (31913,  67,     0.6) /* ResistFire */
     , (31913,  68,       1) /* ResistCold */
     , (31913,  69,       1) /* ResistAcid */
     , (31913,  70,     1.2) /* ResistElectric */
...
VALUES (31913,   1, 0x02000992) /* Setup */
     ...
     , (31913,   4, 0x30000023) /* CombatTable */
...
VALUES (31913,  0,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31913,  1,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31913,  2,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31913,  3,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31913,  4,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31913,  5, 32, 200, 0.75,  375,  233,  308,  345,  270,  345,  270,  195,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31913,  6,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31913,  7,  4, 10,    0,  375,  233,  308,  345,  270,  345,  270,  195,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31913,  8, 32, 10, 0.75,  375,  233,  308,  345,  270,  345,  270,  195,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
     , (31913, 22, 16, 550,  0.5,  375,  233,  308,  345,  270,  345,  270,  195,    0, 0,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* Breath */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (31913, 9, 31903,  0, 0, 1, False) /* Create Gold Moarsman Tooth (31903) for ContainTreasure */
     , (31913, 9,     0,  0, 0, 0, False) /* Create nothing for ContainTreasure */
     , (31913, 9, 32274,  0, 0, 0.4, False) /* Create Moarsmuck (32274) for ContainTreasure */
