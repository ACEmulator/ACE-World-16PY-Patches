...
VALUES (8866, 'moarsmanputridadja', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (8866,   1,       5) /* HeartbeatInterval */
     ...
     , (8866,   5,       2) /* ManaRate */
     , (8866,  12,     0.5) /* Shade */
     , (8866,  13,    0.74) /* ArmorModVsSlash */
     , (8866,  14,    0.68) /* ArmorModVsPierce */
     , (8866,  15,    0.47) /* ArmorModVsBludgeon */
     , (8866,  16,    0.74) /* ArmorModVsCold */
     , (8866,  17,    0.59) /* ArmorModVsFire */
     , (8866,  18,     0.3) /* ArmorModVsAcid */
     , (8866,  19,    0.47) /* ArmorModVsElectric */
     , (8866,  31,      18) /* VisualAwarenessRange */
     , (8866,  34,       1) /* PowerupTime */
     , (8866,  36,       1) /* ChargeSpeed */
     , (8866,  39,    1.65) /* DefaultScale */
     , (8866,  55,      60) /* HomeRadius */
     , (8866,  64,    0.86) /* ResistSlash */
     , (8866,  65,    0.75) /* ResistPierce */
     , (8866,  66,    0.42) /* ResistBludgeon */
     , (8866,  67,    0.58) /* ResistFire */
     , (8866,  68,    0.86) /* ResistCold */
     , (8866,  69,    0.25) /* ResistAcid */
     , (8866,  70,    0.42) /* ResistElectric */
...
VALUES (8866,   1, 0x02000992) /* Setup */
     ...
     , (8866,  19, 0x00000054) /* ActivationAnimation */
     , (8866,  22, 0x34000069) /* PhysicsEffectTable */
     , (8866,  30,         84) /* PhysicsScript - BreatheFlame */
     , (8866,  35,        460) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (8866,  6, 0, 3, 0, 280, 0, 0) /* MeleeDefense        Specialized */
     , (8866,  7, 0, 3, 0, 400, 0, 0) /* MissileDefense      Specialized */
     , (8866, 15, 0, 3, 0, 240, 0, 0) /* MagicDefense        Specialized */
     , (8866, 20, 0, 3, 0,  40, 0, 0) /* Deception           Specialized */
     , (8866, 22, 0, 3, 0,  40, 0, 0) /* Jump                Specialized */
     , (8866, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (8866, 44, 0, 3, 0, 265, 0, 0) /* HeavyWeapons        Specialized */
     , (8866, 45, 0, 3, 0, 265, 0, 0) /* LightWeapons        Specialized */
     , (8866, 47, 0, 3, 0,   0, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (8866,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (8866, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8866,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
