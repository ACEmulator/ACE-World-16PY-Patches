...
VALUES (1256, 'mosswartbarkergreenmire', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (1256,   1,       5) /* HeartbeatInterval */
     ...
     , (1256,   3,    0.15) /* HealthRate */
     , (1256,   4,       5) /* StaminaRate */
     , (1256,   5,       2) /* ManaRate */
     , (1256,  12,     0.5) /* Shade */
     , (1256,  13,    0.08) /* ArmorModVsSlash */
     , (1256,  14,    0.43) /* ArmorModVsPierce */
     , (1256,  15,    0.43) /* ArmorModVsBludgeon */
     , (1256,  16,    0.75) /* ArmorModVsCold */
     , (1256,  17,     0.4) /* ArmorModVsFire */
     , (1256,  18,    0.23) /* ArmorModVsAcid */
     , (1256,  19,     0.7) /* ArmorModVsElectric */
     , (1256,  31,      24) /* VisualAwarenessRange */
     , (1256,  34,     1.1) /* PowerupTime */
     , (1256,  36,       1) /* ChargeSpeed */
     , (1256,  64,    0.55) /* ResistSlash */
     , (1256,  65,     0.8) /* ResistPierce */
     , (1256,  66,     0.8) /* ResistBludgeon */
     , (1256,  67,       1) /* ResistFire */
     , (1256,  68,     0.8) /* ResistCold */
...
VALUES (1256,   1, 0x02000B4F) /* Setup */
     ...
     , (1256,   4, 0x30000005) /* CombatTable */
     , (1256,   6, 0x040011B8) /* PaletteBase */
     , (1256,   7, 0x10000344) /* ClothingBase */
...
VALUES (1256,  6, 0, 2, 0,  80, 0, 0) /* MeleeDefense        Trained */
     ...
     , (1256, 45, 0, 2, 0,  50, 0, 0) /* LightWeapons        Trained */;
...
VALUES (1256,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (1256, 414) /* PLAYER_DEATH_EVENT */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,   0.09, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,   0.19, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,    0.2, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1256,  5 /* HeartBeat */,    0.1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
