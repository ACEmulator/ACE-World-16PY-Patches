...
VALUES (2186, 'mosswartswampshaman', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (2186,   1,       5) /* HeartbeatInterval */
     ...
     , (2186,   3,    0.35) /* HealthRate */
     , (2186,   4,       5) /* StaminaRate */
     , (2186,   5,       2) /* ManaRate */
     , (2186,  12,     0.5) /* Shade */
     , (2186,  13,    0.23) /* ArmorModVsSlash */
     , (2186,  14,    0.33) /* ArmorModVsPierce */
     , (2186,  15,    0.33) /* ArmorModVsBludgeon */
     , (2186,  16,    0.65) /* ArmorModVsCold */
     , (2186,  17,     0.4) /* ArmorModVsFire */
     , (2186,  18,    0.28) /* ArmorModVsAcid */
     , (2186,  19,     0.7) /* ArmorModVsElectric */
     , (2186,  31,      20) /* VisualAwarenessRange */
     , (2186,  34,     1.1) /* PowerupTime */
     , (2186,  36,       1) /* ChargeSpeed */
     , (2186,  64,     0.7) /* ResistSlash */
     , (2186,  65,     0.8) /* ResistPierce */
     , (2186,  66,     0.8) /* ResistBludgeon */
     , (2186,  67,       1) /* ResistFire */
     , (2186,  68,     0.8) /* ResistCold */
     , (2186,  69,     0.6) /* ResistAcid */
...
VALUES (2186,   1, 0x02000B4F) /* Setup */
     ...
     , (2186,   4, 0x30000005) /* CombatTable */
     , (2186,   6, 0x040011B8) /* PaletteBase */
     , (2186,   7, 0x10000347) /* ClothingBase */
...
VALUES (2186,  6, 0, 2, 0,  60, 0, 0) /* MeleeDefense        Trained */
     , (2186,  7, 0, 2, 0,  65, 0, 0) /* MissileDefense      Trained */
     , (2186, 15, 0, 2, 0, 100, 0, 0) /* MagicDefense        Trained */
     , (2186, 20, 0, 2, 0,  90, 0, 0) /* Deception           Trained */
     , (2186, 24, 0, 2, 0,  40, 0, 0) /* Run                 Trained */
     , (2186, 45, 0, 2, 0,  60, 0, 0) /* LightWeapons        Trained */;
...
VALUES (2186,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (2186, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2186,  5 /* HeartBeat */,   0.09, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2186,  5 /* HeartBeat */,   0.19, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2186,  5 /* HeartBeat */,    0.2, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2186,  5 /* HeartBeat */,    0.1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
