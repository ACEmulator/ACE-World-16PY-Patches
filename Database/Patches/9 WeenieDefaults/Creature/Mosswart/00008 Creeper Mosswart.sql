...
VALUES (8, 'mosswartcreeper', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (8,   1,       5) /* HeartbeatInterval */
     ...
     , (8,   3,   0.067) /* HealthRate */
     , (8,   4,       5) /* StaminaRate */
     , (8,   5,       2) /* ManaRate */
     , (8,  12,     0.5) /* Shade */
     , (8,  13,    0.18) /* ArmorModVsSlash */
     , (8,  14,    0.02) /* ArmorModVsPierce */
     , (8,  15,    0.02) /* ArmorModVsBludgeon */
     , (8,  16,    0.34) /* ArmorModVsCold */
     , (8,  17,     0.4) /* ArmorModVsFire */
     , (8,  18,    0.58) /* ArmorModVsAcid */
     , (8,  19,     0.7) /* ArmorModVsElectric */
     , (8,  31,      24) /* VisualAwarenessRange */
     , (8,  34,       1) /* PowerupTime */
     , (8,  36,       1) /* ChargeSpeed */
     , (8,  39,     0.9) /* DefaultScale */
     , (8,  64,     0.8) /* ResistSlash */
     , (8,  65,     0.8) /* ResistPierce */
     , (8,  66,     0.8) /* ResistBludgeon */
     , (8,  67,       1) /* ResistFire */
     , (8,  68,     0.8) /* ResistCold */
     , (8,  69,     0.8) /* ResistAcid */
...
VALUES (8,   1, 0x02000B4F) /* Setup */
     , (8,   2, 0x09000009) /* MotionTable */
     , (8,   3, 0x2000002F) /* SoundTable */
     , (8,   4, 0x30000005) /* CombatTable */
     , (8,   6, 0x040011B8) /* PaletteBase */
     , (8,   7, 0x10000344) /* ClothingBase */
     , (8,   8, 0x06001039) /* Icon */
     , (8,  22, 0x34000020) /* PhysicsEffectTable */
...
VALUES (8,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
