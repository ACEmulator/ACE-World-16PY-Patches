...
VALUES (34621, 'ace34621-killagurg', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (34621,   1, 0x0200003A) /* Setup */
     ...
     , (34621,   4, 0x30000005) /* CombatTable */
...
VALUES (34621,  6, 0, 3, 0, 420, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (34621, 45, 0, 3, 0, 430, 0, 0) /* LightWeapons        Specialized */
...
VALUES (34621,  0,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34621,  1,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34621,  2,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34621,  3,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34621,  4,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34621,  5,  4, 60, 0.75,  340,  442,  170,  476,  340,  204,  442,  306,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34621,  6,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34621,  7,  4,  0,    0,  340,  442,  170,  476,  340,  204,  442,  306,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34621,  8,  4, 60, 0.75,  340,  442,  170,  476,  340,  204,  442,  306,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (34621, 2, 23721,  1, 0, 0, False) /* Create Acid Yari (23721) for Wield */
     ...
     , (34621, 9, 34456,  0, 0, 1, False) /* Create Crowley's Champion Token (34456) for ContainTreasure */
     , (34621, 9, 34456,  0, 0, 1, False) /* Create Crowley's Champion Token (34456) for ContainTreasure */
     , (34621, 9, 34456,  0, 0, 1, False) /* Create Crowley's Champion Token (34456) for ContainTreasure */
     , (34621, 9, 34456,  0, 0, 1, False) /* Create Crowley's Champion Token (34456) for ContainTreasure */
     , (34621, 9, 34456,  0, 0, 1, False) /* Create Crowley's Champion Token (34456) for ContainTreasure */
