...
VALUES (72045, 'ace72045-tormentedcharge', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (72045,   1, 0x020006AC) /* Setup */
     , (72045,   2, 0x0900008F) /* MotionTable */
     , (72045,   3, 0x2000005A) /* SoundTable */
     , (72045,   4, 0x30000000) /* CombatTable */
     , (72045,   8, 0x06001C75) /* Icon */
     , (72045,  22, 0x34000075) /* PhysicsEffectTable */
...
VALUES (72045,  0, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72045,  1, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72045,  2, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72045,  3, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72045,  4, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72045,  5, 64, 180, 0.75,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72045,  6, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72045,  7, 64,  0,    0,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72045,  8, 64, 180, 0.75,  320,  266,  266,  266,  275,  237,  320, 32000,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
