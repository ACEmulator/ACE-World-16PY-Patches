...
VALUES (6382, 'lightningelementalstatic', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (6382,   1,       5) /* HeartbeatInterval */
     ...
     , (6382,   3,     0.6) /* HealthRate */
     , (6382,   4,     0.5) /* StaminaRate */
     , (6382,   5,       2) /* ManaRate */
     , (6382,  13,    0.67) /* ArmorModVsSlash */
     , (6382,  14,     0.9) /* ArmorModVsPierce */
     , (6382,  15,     0.9) /* ArmorModVsBludgeon */
     , (6382,  16,    0.98) /* ArmorModVsCold */
     , (6382,  17,    2.15) /* ArmorModVsFire */
     , (6382,  18,       1) /* ArmorModVsAcid */
     , (6382,  19,     100) /* ArmorModVsElectric */
     , (6382,  31,      15) /* VisualAwarenessRange */
     , (6382,  39,     0.5) /* DefaultScale */
     , (6382,  64,    0.65) /* ResistSlash */
     , (6382,  65,    0.65) /* ResistPierce */
     , (6382,  66,    0.65) /* ResistBludgeon */
     , (6382,  67,    0.65) /* ResistFire */
     , (6382,  68,    0.65) /* ResistCold */
     , (6382,  69,     1.1) /* ResistAcid */
...
VALUES (6382,  6, 0, 3, 0,  10, 0, 0) /* MeleeDefense        Specialized */
     , (6382,  7, 0, 3, 0,  25, 0, 0) /* MissileDefense      Specialized */
     , (6382, 14, 0, 3, 0,  20, 0, 0) /* ArcaneLore          Specialized */
     , (6382, 15, 0, 3, 0,  12, 0, 0) /* MagicDefense        Specialized */
     , (6382, 20, 0, 3, 0,  20, 0, 0) /* Deception           Specialized */
     , (6382, 24, 0, 3, 0,  50, 0, 0) /* Run                 Specialized */
     , (6382, 31, 0, 3, 0,  20, 0, 0) /* CreatureEnchantment Specialized */
     , (6382, 33, 0, 3, 0,  20, 0, 0) /* LifeMagic           Specialized */
     , (6382, 34, 0, 3, 0,  20, 0, 0) /* WarMagic            Specialized */
     , (6382, 45, 0, 3, 0,  20, 0, 0) /* LightWeapons        Specialized */;
