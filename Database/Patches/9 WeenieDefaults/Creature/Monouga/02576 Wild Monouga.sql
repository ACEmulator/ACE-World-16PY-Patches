...
VALUES (2576, 'monougawild', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (2576,   1,       5) /* HeartbeatInterval */
     ...
     , (2576,  14,    0.81) /* ArmorModVsPierce */
     , (2576,  15,    0.41) /* ArmorModVsBludgeon */
     , (2576,  16,     0.6) /* ArmorModVsCold */
     , (2576,  17,    0.41) /* ArmorModVsFire */
     , (2576,  18,    0.53) /* ArmorModVsAcid */
     , (2576,  19,    0.17) /* ArmorModVsElectric */
     , (2576,  31,      24) /* VisualAwarenessRange */
     , (2576,  34,     0.6) /* PowerupTime */
     , (2576,  36,       1) /* ChargeSpeed */
     , (2576,  39,     1.5) /* DefaultScale */
     , (2576,  64,    0.52) /* ResistSlash */
     , (2576,  65,     0.9) /* ResistPierce */
     , (2576,  66,    0.45) /* ResistBludgeon */
     , (2576,  67,    0.45) /* ResistFire */
     , (2576,  68,       1) /* ResistCold */
     , (2576,  69,    0.75) /* ResistAcid */
     , (2576,  70,    0.46) /* ResistElectric */
...
VALUES (2576,   1, 0x020002FF) /* Setup */
     , (2576,   2, 0x09000027) /* MotionTable */
     , (2576,   3, 0x20000032) /* SoundTable */
     , (2576,   4, 0x30000016) /* CombatTable */
     , (2576,   6, 0x04000986) /* PaletteBase */
     , (2576,   7, 0x1000010E) /* ClothingBase */
     , (2576,   8, 0x060016BD) /* Icon */
     , (2576,  22, 0x34000019) /* PhysicsEffectTable */
...
VALUES (2576,  6, 0, 3, 0,  70, 0, 0) /* MeleeDefense        Specialized */
     , (2576,  7, 0, 3, 0,  70, 0, 0) /* MissileDefense      Specialized */
     , (2576, 15, 0, 3, 0,  42, 0, 0) /* MagicDefense        Specialized */
     , (2576, 20, 0, 2, 0,  70, 0, 0) /* Deception           Trained */
     , (2576, 22, 0, 2, 0,  40, 0, 0) /* Jump                Trained */
     , (2576, 24, 0, 2, 0,  50, 0, 0) /* Run                 Trained */
     , (2576, 44, 0, 3, 0,  60, 0, 0) /* HeavyWeapons        Specialized */
     , (2576, 45, 0, 3, 0,  60, 0, 0) /* LightWeapons        Specialized */
     , (2576, 46, 0, 3, 0,   0, 0, 0) /* FinesseWeapons      Specialized */
     , (2576, 47, 0, 3, 0,  20, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (2576,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (2576, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2576,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2576,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2576,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2576,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
