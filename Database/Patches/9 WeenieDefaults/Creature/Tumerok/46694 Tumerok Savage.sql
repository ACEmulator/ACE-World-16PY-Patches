...
VALUES (46694,   1,      10) /* HeartbeatInterval */
     ...
     , (46694,  64,    0.84) /* ResistSlash */
     , (46694,  65,    0.65) /* ResistPierce */
...
VALUES (46694,  6, 0, 3, 0, 325, 0, 0) /* MeleeDefense        Specialized */
     , (46694,  7, 0, 3, 0, 265, 0, 0) /* MissileDefense      Specialized */
     , (46694, 15, 0, 3, 0, 225, 0, 0) /* MagicDefense        Specialized */
     ...
     , (46694, 44, 0, 3, 0, 327, 0, 0) /* HeavyWeapons        Specialized */
     , (46694, 45, 0, 3, 0, 333, 0, 0) /* LightWeapons        Specialized */
     , (46694, 46, 0, 3, 0, 325, 0, 0) /* FinesseWeapons      Specialized */
     , (46694, 48, 0, 3, 0, 440, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (46694,  0,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46694,  1,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46694,  2,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46694,  3,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46694,  4,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46694,  5,  4,  2, 0.75,  430,  340,  430,  430,  430,  430,  430,  330,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46694,  6,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46694,  7,  4,  0,    0,  430,  340,  430,  430,  430,  430,  430,  330,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46694,  8,  4,  3, 0.75,  430,  340,  430,  430,  430,  430,  430,  330,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
