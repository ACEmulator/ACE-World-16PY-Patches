...
VALUES (2564, 'armoredillofreshwater', 10, '2022-08-22 03:09:27') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2564,   1,         16) /* ItemType - Creature */
     , (2564,   2,         17) /* CreatureType - Armoredillo */
     , (2564,   3,          3) /* PaletteTemplate - BluePurple */
...
VALUES (2564,   1,       5) /* HeartbeatInterval */
     ...
     , (2564,   3,     0.3) /* HealthRate */
     , (2564,   4,     0.5) /* StaminaRate */
     , (2564,   5,       2) /* ManaRate */
     , (2564,  12,     0.5) /* Shade */
     , (2564,  13,    0.22) /* ArmorModVsSlash */
     , (2564,  14,     0.7) /* ArmorModVsPierce */
     , (2564,  15,    0.25) /* ArmorModVsBludgeon */
     , (2564,  16,     0.3) /* ArmorModVsCold */
     , (2564,  17,    0.43) /* ArmorModVsFire */
     , (2564,  18,    0.55) /* ArmorModVsAcid */
     , (2564,  19,    0.43) /* ArmorModVsElectric */
     , (2564,  31,      22) /* VisualAwarenessRange */
     , (2564,  34,       5) /* PowerupTime */
     , (2564,  36,       1) /* ChargeSpeed */
     , (2564,  39,     0.8) /* DefaultScale */
     , (2564,  64,    0.53) /* ResistSlash */
     , (2564,  65,       1) /* ResistPierce */
     , (2564,  66,     0.5) /* ResistBludgeon */
     , (2564,  67,     0.7) /* ResistFire */
     , (2564,  68,     0.5) /* ResistCold */
     , (2564,  69,     0.5) /* ResistAcid */
     , (2564,  70,     0.7) /* ResistElectric */
...
VALUES (2564,  6, 0, 3, 0,  75, 0, 0) /* MeleeDefense        Specialized */
     , (2564,  7, 0, 3, 0, 105, 0, 0) /* MissileDefense      Specialized */
     , (2564, 15, 0, 3, 0,  74, 0, 0) /* MagicDefense        Specialized */
     , (2564, 20, 0, 3, 0,  20, 0, 0) /* Deception           Specialized */
     , (2564, 22, 0, 3, 0,  20, 0, 0) /* Jump                Specialized */
     , (2564, 24, 0, 3, 0,  25, 0, 0) /* Run                 Specialized */
     , (2564, 45, 0, 3, 0,  30, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (2564,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2564,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2564,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2564,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
