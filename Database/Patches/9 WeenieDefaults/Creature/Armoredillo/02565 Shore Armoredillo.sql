...
VALUES (2565, 'armoredilloshore', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (2565,   1,       5) /* HeartbeatInterval */
     ...
     , (2565,   3,     0.3) /* HealthRate */
     , (2565,   4,     0.5) /* StaminaRate */
     , (2565,   5,       2) /* ManaRate */
     , (2565,  12,     0.5) /* Shade */
     , (2565,  13,    0.22) /* ArmorModVsSlash */
     , (2565,  14,     0.7) /* ArmorModVsPierce */
     , (2565,  15,    0.25) /* ArmorModVsBludgeon */
     , (2565,  16,     0.3) /* ArmorModVsCold */
     , (2565,  17,    0.43) /* ArmorModVsFire */
     , (2565,  18,    0.26) /* ArmorModVsAcid */
     , (2565,  19,    0.43) /* ArmorModVsElectric */
     , (2565,  31,      22) /* VisualAwarenessRange */
     , (2565,  34,       4) /* PowerupTime */
     , (2565,  36,       1) /* ChargeSpeed */
     , (2565,  39,     0.8) /* DefaultScale */
     , (2565,  64,    0.53) /* ResistSlash */
     , (2565,  65,       1) /* ResistPierce */
     , (2565,  66,     0.5) /* ResistBludgeon */
     , (2565,  67,     0.7) /* ResistFire */
     , (2565,  68,     0.5) /* ResistCold */
     , (2565,  69,     0.4) /* ResistAcid */
     , (2565,  70,     0.7) /* ResistElectric */
...
VALUES (2565,   1, 0x02000004) /* Setup */
     ...
     , (2565,   4, 0x3000000E) /* CombatTable */
     , (2565,   6, 0x040001B5) /* PaletteBase */
     , (2565,   7, 0x1000005B) /* ClothingBase */
...
VALUES (2565,  6, 0, 3, 0,  79, 0, 0) /* MeleeDefense        Specialized */
     , (2565,  7, 0, 3, 0, 120, 0, 0) /* MissileDefense      Specialized */
     , (2565, 15, 0, 3, 0,  95, 0, 0) /* MagicDefense        Specialized */
     , (2565, 20, 0, 3, 0,  20, 0, 0) /* Deception           Specialized */
     , (2565, 22, 0, 3, 0,  25, 0, 0) /* Jump                Specialized */
     , (2565, 24, 0, 3, 0,  20, 0, 0) /* Run                 Specialized */
     , (2565, 45, 0, 3, 0,  45, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (2565,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2565,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2565,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (2565,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
