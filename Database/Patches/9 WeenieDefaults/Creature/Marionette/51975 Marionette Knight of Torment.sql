...
VALUES (51975, 'ace51975-marionetteknightoftorment', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51975,   1, 0x02001A8E) /* Setup */
     ...
     , (51975,   4, 0x3000002A) /* CombatTable */
     , (51975,   6, 0x040016C4) /* PaletteBase */
     , (51975,   7, 0x100004F6) /* ClothingBase */
...
VALUES (51975,  0,  4, 160, 0.75,  700,  630,  560,  525,  525,  665,  665,  700,  700, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (51975, 16,  4, 160,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (51975, 21,  4,  0,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (51975, 24,  4, 160,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (51975, 25,  4, 160, 0.75,  700,  630,  560,  525,  525,  665,  665,  700,  700, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;
