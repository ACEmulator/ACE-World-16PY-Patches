...
VALUES (51976, 'ace51976-tormentedmarionette', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51976,   1, 0x02001A8D) /* Setup */
     , (51976,   2, 0x0900009B) /* MotionTable */
     , (51976,   3, 0x20000070) /* SoundTable */
     , (51976,   4, 0x3000002A) /* CombatTable */
     , (51976,   8, 0x06001FBC) /* Icon */
     , (51976,  22, 0x3400008C) /* PhysicsEffectTable */
...
VALUES (51976,  0,  4, 180, 0.75,  700,  630,  560,  525,  525,  665,  665,  700,  700, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (51976, 16,  4, 180,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (51976, 21,  4,  0,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (51976, 24,  4, 180,    0,  700,  630,  560,  525,  525,  665,  665,  700,  700, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (51976, 25,  4, 180, 0.75,  700,  630,  560,  525,  525,  665,  665,  700,  700, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;
