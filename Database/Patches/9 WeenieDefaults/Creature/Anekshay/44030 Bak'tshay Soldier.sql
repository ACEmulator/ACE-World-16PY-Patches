...
VALUES (44030, 'ace44030-baktshaysoldier', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44030,   1, 0x02001AA3) /* Setup */
     , (44030,   2, 0x09000001) /* MotionTable */
     , (44030,   3, 0x20000015) /* SoundTable */
     , (44030,   4, 0x30000000) /* CombatTable */
     , (44030,   6, 0x0400007E) /* PaletteBase */
     , (44030,   7, 0x100007D0) /* ClothingBase */
     , (44030,   8, 0x06001B42) /* Icon */
     , (44030,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (44030,  6, 0, 2, 0, 425, 0, 0) /* MeleeDefense        Trained */
     ...
     , (44030, 45, 0, 3, 0, 460, 0, 0) /* LightWeapons        Specialized */
     , (44030, 46, 0, 3, 0, 460, 0, 0) /* FinesseWeapons      Specialized */
     , (44030, 48, 0, 2, 0,  60, 0, 0) /* Shield              Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (44030,  0,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44030,  1,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44030,  2,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44030,  3,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44030,  4,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44030,  5,  4, 450, 0.75,  450,  450,  405,  338,  450,  450,  302,  450,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44030,  6,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44030,  7,  4,  0,    0,  450,  450,  405,  338,  450,  450,  302,  450,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44030,  8,  4, 450, 0.75,  450,  450,  405,  338,  450,  450,  302,  450,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (44030,  1785,   2.06)  /* Cassius' Ring of Fire */
     , (44030,  1841,   2.06)  /* Slithering Flames */
     , (44030,  2053,   2.06)  /* Executor's Blessing */
     , (44030,  2074,   2.06)  /* Gossamer Flesh */
     , (44030,  2128,   2.06)  /* Ilservian's Flame */
     , (44030,  2155,   2.06)  /* Icy Blessing */
