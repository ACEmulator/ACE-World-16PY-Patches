...
VALUES (44090, 'ace44090-baktshayguard', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (44090,   1,         16) /* ItemType - Creature */
     , (44090,   2,        101) /* CreatureType - Anekshay */
     , (44090,   3,          9) /* PaletteTemplate - Grey */
...
VALUES (44090,   1, 0x02001AA4) /* Setup */
     ...
     , (44090,   4, 0x30000000) /* CombatTable */
     , (44090,   6, 0x0400007E) /* PaletteBase */
     , (44090,   7, 0x100007D0) /* ClothingBase */
...
VALUES (44090,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (44090, 15, 0, 2, 0, 250, 0, 0) /* MagicDefense        Trained */
     , (44090, 24, 0, 2, 0, 200, 0, 0) /* Run                 Trained */
     , (44090, 33, 0, 2, 0, 300, 0, 0) /* LifeMagic           Trained */
     , (44090, 34, 0, 2, 0, 300, 0, 0) /* WarMagic            Trained */
     , (44090, 45, 0, 3, 0, 440, 0, 0) /* LightWeapons        Specialized */
     , (44090, 46, 0, 3, 0, 440, 0, 0) /* FinesseWeapons      Specialized */
     , (44090, 48, 0, 2, 0,  60, 0, 0) /* Shield              Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (44090,  0,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44090,  1,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44090,  2,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44090,  3,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44090,  4,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44090,  5,  4, 250, 0.75,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44090,  6,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44090,  7,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44090,  8,  4, 250, 0.75,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (44090, 9, 44267,  1, 0, 0.2, False) /* Create Engraved A'nekshay Bracers (44267) for ContainTreasure */
     ...
     , (44090, 9, 44121,  1, 0, 0.2, False) /* Create Sandstone Armor Key (44121) for ContainTreasure */
     , (44090, 9, 44122,  1, 0, 0.2, False) /* Create Sandstone Magic Key (44122) for ContainTreasure */
     , (44090, 9, 44123,  1, 0, 0.2, False) /* Create Sandstone Mixed Key (44123) for ContainTreasure */
     , (44090, 9, 44124,  1, 0, 0.2, False) /* Create Sandstone Weapon Key (44124) for ContainTreasure */
     , (44090, 9,     0,  0, 0, 0.2, False) /* Create nothing for ContainTreasure */;
