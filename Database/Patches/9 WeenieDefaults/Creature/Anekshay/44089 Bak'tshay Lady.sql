...
VALUES (44089, 'ace44089-baktshaylady', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (44089,   1, 0x02001AA4) /* Setup */
     , (44089,   2, 0x09000001) /* MotionTable */
     , (44089,   3, 0x20000015) /* SoundTable */
     , (44089,   4, 0x30000000) /* CombatTable */
     , (44089,   6, 0x0400007E) /* PaletteBase */
     , (44089,   7, 0x100007D0) /* ClothingBase */
     , (44089,   8, 0x06001B42) /* Icon */
     , (44089,  22, 0x34000025) /* PhysicsEffectTable */
...
VALUES (44089,  0,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44089,  1,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44089,  2,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44089,  3,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44089,  4,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44089,  5,  4, 600, 0.75,  800,  800,  720,  600,  800,  800,  536,  800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44089,  6,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44089,  7,  4,  0,    0,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44089,  8,  4, 600, 0.75,  800,  800,  720,  600,  800,  800,  536,  800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (44089, 9, 44240,  1, 0, 0.1, False) /* Create A'nekshay Token (44240) for ContainTreasure */
     ...
     , (44089, 9, 44121,  1, 0, 0.2, False) /* Create Sandstone Armor Key (44121) for ContainTreasure */
     , (44089, 9, 44122,  1, 0, 0.2, False) /* Create Sandstone Magic Key (44122) for ContainTreasure */
     , (44089, 9, 44123,  1, 0, 0.2, False) /* Create Sandstone Mixed Key (44123) for ContainTreasure */
     , (44089, 9, 44124,  1, 0, 0.2, False) /* Create Sandstone Weapon Key (44124) for ContainTreasure */
     , (44089, 9,     0,  0, 0, 0.2, False) /* Create nothing for ContainTreasure */;
