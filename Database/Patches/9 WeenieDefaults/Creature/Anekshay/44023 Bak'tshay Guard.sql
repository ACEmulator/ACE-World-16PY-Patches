...
VALUES (44023, 'ace44023-baktshayguard', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (44023,   1,         16) /* ItemType - Creature */
     , (44023,   2,        101) /* CreatureType - Anekshay */
     , (44023,   3,          9) /* PaletteTemplate - Grey */
...
VALUES (44023,   1, 0x02001AA4) /* Setup */
     ...
     , (44023,   4, 0x30000000) /* CombatTable */
     , (44023,   6, 0x0400007E) /* PaletteBase */
     , (44023,   7, 0x100007D0) /* ClothingBase */
...
VALUES (44023,  0,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44023,  1,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44023,  2,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44023,  3,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44023,  4,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44023,  5,  4, 250, 0.75,  350,  350,  315,  263,  350,  350,  235,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44023,  6,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44023,  7,  4,  0,    0,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44023,  8,  4, 250, 0.75,  350,  350,  315,  263,  350,  350,  235,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
