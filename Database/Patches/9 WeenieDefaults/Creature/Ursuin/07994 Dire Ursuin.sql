...
VALUES (7994, 'ursuindire', 10, '2022-08-22 03:09:27') /* Creature */;
...
VALUES (7994,   1,       5) /* HeartbeatInterval */
     ...
     , (7994,   3,     0.1) /* HealthRate */
     , (7994,   4,       3) /* StaminaRate */
     , (7994,   5,       1) /* ManaRate */
     , (7994,  12,     0.5) /* Shade */
     , (7994,  13,    0.56) /* ArmorModVsSlash */
     , (7994,  14,     0.8) /* ArmorModVsPierce */
     , (7994,  15,    0.56) /* ArmorModVsBludgeon */
     , (7994,  16,    0.56) /* ArmorModVsCold */
     , (7994,  17,    0.73) /* ArmorModVsFire */
     , (7994,  18,    0.56) /* ArmorModVsAcid */
     , (7994,  19,    0.56) /* ArmorModVsElectric */
     , (7994,  31,      24) /* VisualAwarenessRange */
     , (7994,  34,       1) /* PowerupTime */
     , (7994,  36,       1) /* ChargeSpeed */
     , (7994,  39,     1.3) /* DefaultScale */
     , (7994,  64,    0.58) /* ResistSlash */
     , (7994,  65,       1) /* ResistPierce */
     , (7994,  66,    0.58) /* ResistBludgeon */
     , (7994,  67,    0.86) /* ResistFire */
     , (7994,  68,    0.58) /* ResistCold */
     , (7994,  69,    0.58) /* ResistAcid */
     , (7994,  70,    0.58) /* ResistElectric */
...
VALUES (7994,   1, 0x02000925) /* Setup */
     , (7994,   2, 0x0900009C) /* MotionTable */
     , (7994,   3, 0x20000063) /* SoundTable */
     , (7994,   4, 0x30000029) /* CombatTable */
     , (7994,   6, 0x04000FF0) /* PaletteBase */
     , (7994,   7, 0x10000248) /* ClothingBase */
     , (7994,   8, 0x06001DEF) /* Icon */
     , (7994,  22, 0x34000086) /* PhysicsEffectTable */
...
VALUES (7994,  6, 0, 3, 0, 140, 0, 563.111633300781) /* MeleeDefense        Specialized */
     ...
     , (7994, 45, 0, 3, 0, 130, 0, 563.111633300781) /* LightWeapons        Specialized */;
...
VALUES (7994,  94) /* ATTACK_NOTIFICATION_EVENT */
     , (7994, 414) /* PLAYER_DEATH_EVENT */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7994,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7994,  5 /* HeartBeat */,   0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7994,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7994,  5 /* HeartBeat */,   0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
