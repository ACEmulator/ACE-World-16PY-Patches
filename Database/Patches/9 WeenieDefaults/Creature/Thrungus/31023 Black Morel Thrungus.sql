...
VALUES (31023, 'thrungusblackmorel', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31023,   1, 0x02001253) /* Setup */
     ...
     , (31023,   4, 0x30000041) /* CombatTable */
     , (31023,   6, 0x04001D4D) /* PaletteBase */
     , (31023,   7, 0x1000059A) /* ClothingBase */
...
VALUES (31023,  0,  4, 192,  0.3,  554,  499,  499,  609,  332,  443,  554,  443,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31023,  1,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31023,  2,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31023,  3,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31023,  4,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31023,  5,  1, 240,  0.4,  554,  499,  499,  609,  332,  443,  554,  443,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31023,  6,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31023,  7,  4,  0,    0,  554,  499,  499,  609,  332,  443,  554,  443,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31023,  8,  4, 240,  0.4,  554,  499,  499,  609,  332,  443,  554,  443,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
     , (31023, 22, 32, 174,  0.3,  554,  499,  499,  609,  332,  443,  554,  443,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Breath */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31023,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31023,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
