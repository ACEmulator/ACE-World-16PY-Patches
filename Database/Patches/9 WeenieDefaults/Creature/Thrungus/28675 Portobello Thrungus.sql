...
VALUES (28675, 'thrungusportobello', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (28675,   1, 0x02001253) /* Setup */
     ...
     , (28675,   4, 0x30000041) /* CombatTable */
     , (28675,   6, 0x04001D4D) /* PaletteBase */
     , (28675,   7, 0x1000059A) /* ClothingBase */
...
VALUES (28675,  0,  4, 24,  0.3,  132,  119,   79,  145,  106,   79,  132,  106,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28675,  1,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28675,  2,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28675,  3,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28675,  4,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28675,  5,  4, 30,  0.4,  132,  119,   79,  145,  106,   79,  132,  106,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28675,  6,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28675,  7,  4,  0,    0,  132,  119,   79,  145,  106,   79,  132,  106,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28675,  8,  4, 30,  0.4,  132,  119,   79,  145,  106,   79,  132,  106,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
     , (28675, 22, 32, 22,  0.4,  132,  119,   79,  145,  106,   79,  132,  106,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Breath */;
...
VALUES (28675,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28675,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
