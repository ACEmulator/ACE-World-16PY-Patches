...
VALUES (28678, 'thrungusbeefsteak', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (28678,   1, 0x02001253) /* Setup */
     ...
     , (28678,   4, 0x30000041) /* CombatTable */
     , (28678,   6, 0x04001D4D) /* PaletteBase */
     , (28678,   7, 0x1000059A) /* ClothingBase */
...
VALUES (28678,  0,  4, 32,  0.3,  231,  208,  208,  254,  185,  185,  231,  185,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28678,  1,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28678,  2,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28678,  3,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28678,  4,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28678,  5,  4, 40,  0.4,  231,  208,  208,  254,  185,  185,  231,  185,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28678,  6,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28678,  7,  4,  0,    0,  231,  208,  208,  254,  185,  185,  231,  185,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28678,  8,  4, 40,  0.4,  231,  208,  208,  254,  185,  185,  231,  185,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
     , (28678, 22, 32, 29,  0.4,  231,  208,  208,  254,  185,  185,  231,  185,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Breath */;
...
VALUES (28678,  5 /* HeartBeat */,  0.085, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (28678,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
