...
VALUES (2584, 'sclavusaste', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (2584,   1,       5) /* HeartbeatInterval */
     ...
     , (2584,   3,     0.3) /* HealthRate */
     , (2584,   4,       3) /* StaminaRate */
     , (2584,   5,       1) /* ManaRate */
     , (2584,  13,     0.8) /* ArmorModVsSlash */
     , (2584,  14,    0.58) /* ArmorModVsPierce */
     , (2584,  15,    0.28) /* ArmorModVsBludgeon */
     , (2584,  16,     0.7) /* ArmorModVsCold */
     , (2584,  17,    0.58) /* ArmorModVsFire */
     , (2584,  18,    0.38) /* ArmorModVsAcid */
     , (2584,  19,    0.38) /* ArmorModVsElectric */
     , (2584,  31,      24) /* VisualAwarenessRange */
     , (2584,  34,     1.5) /* PowerupTime */
     , (2584,  36,       1) /* ChargeSpeed */
     , (2584,  39,    1.02) /* DefaultScale */
     , (2584,  64,       1) /* ResistSlash */
     , (2584,  65,    0.75) /* ResistPierce */
     , (2584,  66,    0.46) /* ResistBludgeon */
     , (2584,  67,    0.75) /* ResistFire */
     , (2584,  68,       1) /* ResistCold */
     , (2584,  69,     0.4) /* ResistAcid */
     , (2584,  70,     0.4) /* ResistElectric */
...
VALUES (2584,  6, 0, 3, 0,  63, 0, 0) /* MeleeDefense        Specialized */
     , (2584,  7, 0, 3, 0, 106, 0, 0) /* MissileDefense      Specialized */
     , (2584, 14, 0, 3, 0, 110, 0, 0) /* ArcaneLore          Specialized */
     , (2584, 15, 0, 3, 0,  63, 0, 0) /* MagicDefense        Specialized */
     , (2584, 20, 0, 3, 0,  70, 0, 0) /* Deception           Specialized */
     , (2584, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (2584, 31, 0, 3, 0,  14, 0, 0) /* CreatureEnchantment Specialized */
     , (2584, 33, 0, 3, 0,  14, 0, 0) /* LifeMagic           Specialized */
     , (2584, 34, 0, 3, 0,  14, 0, 0) /* WarMagic            Specialized */
     , (2584, 44, 0, 3, 0,  70, 0, 0) /* HeavyWeapons        Specialized */
     , (2584, 45, 0, 3, 0,  70, 0, 0) /* LightWeapons        Specialized */
     , (2584, 46, 0, 3, 0,  70, 0, 0) /* FinesseWeapons      Specialized */
     , (2584, 47, 0, 3, 0,  90, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (2584,  94) /* ATTACK_NOTIFICATION_EVENT */
