...
VALUES (71111, 'ace71111-kathirik', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (71111,   1, 0x02001879) /* Setup */
     , (71111,   2, 0x09000068) /* MotionTable */
     , (71111,   3, 0x20000041) /* SoundTable */
     , (71111,   4, 0x30000019) /* CombatTable */
     , (71111,   6, 0x04000C00) /* PaletteBase */
     , (71111,   7, 0x1000010F) /* ClothingBase */
     , (71111,   8, 0x060016C0) /* Icon */
     , (71111,  22, 0x34000030) /* PhysicsEffectTable */
...
VALUES (71111,  6, 0, 3, 0, 260, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (71111, 45, 0, 3, 0, 400, 0, 0) /* LightWeapons        Specialized */
...
VALUES (71111,  0,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (71111,  1,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (71111,  2,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (71111,  3,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (71111,  4,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (71111,  5,  4, 350, 0.75,  600,  480,  402,  282,  264,  402,  450,  450,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (71111,  6,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (71111,  7,  4,  0,    0,  600,  480,  402,  282,  264,  402,  450,  450,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (71111,  8,  4, 350, 0.75,  600,  480,  402,  282,  264,  402,  450,  450,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (71111, 9, 71110,  0, 0, 1, False) /* Create Ancient Falatacot Tome of Light (71110) for ContainTreasure */;
