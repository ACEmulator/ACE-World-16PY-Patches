...
VALUES (34043, 'ace34043-afessesclavus', 10, '2021-11-01 00:00:00') /* Creature */;
...
VALUES (34043,   1,       5) /* HeartbeatInterval */
     ...
     , (34043,  64,    0.55) /* ResistSlash */
     , (34043,  65,    0.65) /* ResistPierce */
     , (34043,  66,    0.46) /* ResistBludgeon */
     , (34043,  67,    0.75) /* ResistFire */
     , (34043,  68,    0.79) /* ResistCold */
...
VALUES (34043,   1, 0x02000498) /* Setup */
     ...
     , (34043,   4, 0x30000019) /* CombatTable */
     , (34043,   6, 0x04000C00) /* PaletteBase */
     , (34043,   7, 0x1000010F) /* ClothingBase */
...
VALUES (34043,  0,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34043,  1,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34043,  2,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34043,  3,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34043,  4,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34043,  5,  4, 75, 0.75,  310,  248,  211,  155,   90,  111,  211,  211,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34043,  6,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34043,  7,  4,  0,    0,  310,  248,  211,  155,   90,  111,  211,  211,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34043,  8,  4, 75, 0.75,  310,  248,  211,  155,   90,  111,  211,  211,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
