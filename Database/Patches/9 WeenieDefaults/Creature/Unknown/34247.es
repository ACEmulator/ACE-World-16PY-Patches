			...
			- InqQuest: DiseasedCarnivorousLiver_Completed
				...
				QuestFailure:
					- InqQuest: CarenziPlagueStarted
						QuestSuccess:
							- IncrementQuest: DiseasedCarnivorousLiver_Counter, 1
							- InqQuestSolves: DiseasedCarnivorousLiver_Counter, 15
								QuestSuccess:
									- DirectBroadcast: You've slain all the sick Carnivorous Stalkers that you needed to in order to prevent the sickness from spreading!
									- AwardLevelProportionalXP: 40%, 0 - 11,876,314
									- StampQuest: DiseasedCarnivorousLiver_Completed
									- DeleteSelf
								QuestFailure:
									- InqQuestSolves: DiseasedCarnivorousLiver_Counter, 11 - 14
										QuestSuccess:
											...
											- DeleteSelf
										QuestFailure: 
											- InqQuestSolves: DiseasedCarnivorousLiver_Counter, 7 - 10
												QuestSuccess:
													...
													- DeleteSelf
												QuestFailure: 
													- InqQuestSolves: DiseasedCarnivorousLiver_Counter, 1 - 6
														QuestSuccess:
															...
															- DeleteSelf
						QuestFailure:
							- InqQuestSolves: DiseasedCarnivorousLiver_Counter, 1 - 14
								QuestSuccess:
