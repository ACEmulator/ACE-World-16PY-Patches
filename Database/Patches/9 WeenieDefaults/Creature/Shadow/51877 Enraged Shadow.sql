...
VALUES (51877, 'ace51877-enragedshadow', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51877,   1,       5) /* HeartbeatInterval */
     ...
     , (51877,  31,      28) /* VisualAwarenessRange */
...
VALUES (51877,   1, 0x02001BFC) /* Setup */
     ...
     , (51877,   4, 0x30000000) /* CombatTable */
     , (51877,   7, 0x100000B0) /* ClothingBase */
...
VALUES (51877,   1, 240, 0, 0) /* Strength */
     , (51877,   2, 260, 0, 0) /* Endurance */
     , (51877,   3, 310, 0, 0) /* Quickness */
     , (51877,   4, 290, 0, 0) /* Coordination */
     , (51877,   5, 270, 0, 0) /* Focus */
     , (51877,   6, 190, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (51877,   1,  2250, 0, 0, 2380) /* MaxHealth */
     , (51877,   3,  2000, 0, 0, 2260) /* MaxStamina */
     , (51877,   5,  2000, 0, 0, 2190) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (51877,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     , (51877,  7, 0, 2, 0, 325, 0, 0) /* MissileDefense      Trained */
     , (51877, 15, 0, 2, 0, 354, 0, 0) /* MagicDefense        Trained */
     , (51877, 31, 0, 2, 0, 315, 0, 0) /* CreatureEnchantment Trained */
     , (51877, 33, 0, 2, 0, 315, 0, 0) /* LifeMagic           Trained */
     , (51877, 34, 0, 2, 0, 315, 0, 0) /* WarMagic            Trained */
     , (51877, 43, 0, 2, 0, 315, 0, 0) /* VoidMagic           Trained */
     , (51877, 45, 0, 2, 0, 588, 0, 0) /* LightWeapons        Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51877,  0,  4,  0,    0,  360,  256,  288,  288,  320,  256,  320,  320,  320, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51877,  1,  4,  0,    0,  290,  256,  288,  288,  320,  256,  320,  320,  320, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51877,  2,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51877,  3,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51877,  4,  4,  0,    0,  300,  256,  288,  288,  320,  256,  320,  320,  320, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51877,  5,  4, 250, 0.75,  330,  256,  288,  288,  320,  256,  320,  320,  320, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51877,  6,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51877,  7,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51877,  8,  4, 250, 0.75,  400,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51877,  2282,   2.08)  /* Futility */
     ...
     , (51877,  2281,  2.093)  /* Aura of Resistance */
