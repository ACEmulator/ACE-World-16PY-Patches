...
VALUES (46702,   1,       5) /* HeartbeatInterval */
     ...
     , (46702,  14,    0.91) /* ArmorModVsPierce */
     , (46702,  15,    0.91) /* ArmorModVsBludgeon */
     , (46702,  16,       1) /* ArmorModVsCold */
     , (46702,  17,    0.84) /* ArmorModVsFire */
     , (46702,  18,     0.9) /* ArmorModVsAcid */
     , (46702,  19,     0.9) /* ArmorModVsElectric */
...
VALUES (46702,  6, 0, 3, 0, 385, 0, 0) /* MeleeDefense        Specialized */
     , (46702,  7, 0, 3, 0, 275, 0, 0) /* MissileDefense      Specialized */
     ...
     , (46702, 34, 0, 3, 0, 385, 0, 0) /* WarMagic            Specialized */
     , (46702, 44, 0, 3, 0, 397, 0, 0) /* HeavyWeapons        Specialized */
     , (46702, 45, 0, 3, 0, 395, 0, 0) /* LightWeapons        Specialized */
     , (46702, 46, 0, 3, 0, 333, 0, 0) /* FinesseWeapons      Specialized */
     , (46702, 47, 0, 3, 0, 299, 0, 0) /* MissileWeapons      Specialized */
     , (46702, 48, 0, 3, 0, 365, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (46702,  0,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46702,  1,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46702,  2,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46702,  3,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46702,  4,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46702,  5,  4, 400, 0.75,  380,  355,  355,  355,  590,  210,  590,  590,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46702,  6,  4,  0,    0,  380,  355,  355,  355,  590,  210,  590,  590,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
