...
VALUES (51880, 'ace51880-tormentedshadow', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51880,  0,  4,  0,    0,  360,  256,  288,  288,  320,  256,  320,  320,  320, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51880,  1,  4,  0,    0,  290,  256,  288,  288,  320,  256,  320,  320,  320, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51880,  2,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51880,  3,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51880,  4,  4,  0,    0,  300,  256,  288,  288,  320,  256,  320,  320,  320, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51880,  5,  4, 250, 0.75,  330,  256,  288,  288,  320,  256,  320,  320,  320, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51880,  6,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51880,  7,  4,  0,    0,  330,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51880,  8,  4, 250, 0.75,  400,  256,  288,  288,  320,  256,  320,  320,  320, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
