...
VALUES (33010, 'ace33010-kaihoataithemonitor', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (33010,   1,       5) /* HeartbeatInterval */
     ...
     , (33010,   3,     0.7) /* HealthRate */
     , (33010,   4,     2.5) /* StaminaRate */
     , (33010,   5,       1) /* ManaRate */
     , (33010,  12,     0.5) /* Shade */
     , (33010,  13,       1) /* ArmorModVsSlash */
     , (33010,  14,     0.8) /* ArmorModVsPierce */
     , (33010,  15,    0.85) /* ArmorModVsBludgeon */
     , (33010,  16,     0.6) /* ArmorModVsCold */
     , (33010,  17,     1.1) /* ArmorModVsFire */
     , (33010,  18,     0.7) /* ArmorModVsAcid */
     , (33010,  19,    0.75) /* ArmorModVsElectric */
     , (33010,  31,      25) /* VisualAwarenessRange */
     , (33010,  34,     1.1) /* PowerupTime */
     , (33010,  36,       1) /* ChargeSpeed */
     , (33010,  39,     1.1) /* DefaultScale */
     , (33010,  64,    0.92) /* ResistSlash */
     , (33010,  65,     0.5) /* ResistPierce */
     , (33010,  66,     0.7) /* ResistBludgeon */
     , (33010,  67,    0.95) /* ResistFire */
     , (33010,  68,     0.1) /* ResistCold */
     , (33010,  69,     0.2) /* ResistAcid */
...
VALUES (33010,   1, 0x020013F1) /* Setup */
     ...
     , (33010,   4, 0x30000028) /* CombatTable */
...
VALUES (33010,  0,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (33010,  1,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (33010,  2,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (33010,  3,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (33010,  4,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (33010,  5,  4, 50, 0.75,  450,  450,  360,  383,  270,  495,  315,  338,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (33010,  6,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (33010,  7,  4,  0,    0,  450,  450,  360,  383,  270,  495,  315,  338,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (33010,  8,  4, 60, 0.75,  450,  450,  360,  383,  270,  495,  315,  338,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
