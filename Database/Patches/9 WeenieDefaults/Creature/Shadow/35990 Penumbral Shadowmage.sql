...
VALUES (35990, 'ace35990-penumbralshadowmage', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (35990,  6, 0, 3, 0, 267, 0, 0) /* MeleeDefense        Specialized */
     , (35990,  7, 0, 3, 0, 205, 0, 0) /* MissileDefense      Specialized */
     , (35990, 15, 0, 3, 0, 167, 0, 0) /* MagicDefense        Specialized */
     , (35990, 31, 0, 3, 0, 255, 0, 0) /* CreatureEnchantment Specialized */
     , (35990, 33, 0, 3, 0, 255, 0, 0) /* LifeMagic           Specialized */
     , (35990, 34, 0, 3, 0, 255, 0, 0) /* WarMagic            Specialized */
     , (35990, 45, 0, 3, 0, 273, 0, 0) /* LightWeapons        Specialized */
     , (35990, 46, 0, 3, 0, 299, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (35990,  0,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (35990,  1,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (35990,  2,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (35990,  3,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (35990,  4,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (35990,  5,  4, 60, 0.75,  190,  190,  190,  190,  190,  190,  190,  190,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (35990,  6,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (35990,  7,  4,  0,    0,  190,  190,  190,  190,  190,  190,  190,  190,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (35990,  8,  4, 60, 0.75,  190,  190,  190,  190,  190,  190,  190,  190,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (35990,  2074,   2.02)  /* Gossamer Flesh */
     , (35990,  2318,   2.02)  /* Gravity Well */
     , (35990,  2228,   2.02)  /* Broadside of a Barn */
     , (35990,  2128,   2.01)  /* Ilservian's Flame */
     , (35990,  2140,   2.02)  /* Alset's Coil */
     , (35990,  2132,   2.02)  /* The Spike */
     , (35990,  2146,   2.02)  /* Evisceration */
     , (35990,  2166,   2.02)  /* Tusker's Gift */
     , (35990,  2139,   2.04)  /* Luminous Wrath */
     , (35990,  2745,   2.04)  /* Flame Arc VII */
     , (35990,  2131,   2.04)  /* Stinging Needles */
     , (35990,  2320,   2.04)  /* Wrath of the Hieromancer */
     , (35990,  2172,   2.04)  /* Astyrrian's Gift */
     , (35990,  2329,   2.01)  /* Essence Void */
