...
VALUES (43898, 'ace43898-void', 10, '2022-12-30 05:49:23') /* Creature */;
...
VALUES (43898,  0,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (43898,  1,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (43898,  2,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (43898,  3,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (43898,  4,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (43898,  5,  4, 400, 0.75,  580,  580,  812,  783,  812,  476,  986,  783,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (43898,  6,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (43898,  7,  4,  0,    0,  580,  580,  812,  783,  812,  476,  986,  783,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (43898,  8,  4, 400, 0.75,  580,  580,  812,  783,  812,  476,  986,  783,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
