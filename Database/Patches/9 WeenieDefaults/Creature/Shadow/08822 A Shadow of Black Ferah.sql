...
VALUES (8822, 'blackferahkillable', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (8822,   1,       5) /* HeartbeatInterval */
     ...
     , (8822,   5,       1) /* ManaRate */
     , (8822,  12,     0.5) /* Shade */
     , (8822,  13,     1.1) /* ArmorModVsSlash */
     , (8822,  14,    1.05) /* ArmorModVsPierce */
     , (8822,  15,       1) /* ArmorModVsBludgeon */
     , (8822,  16,       1) /* ArmorModVsCold */
     , (8822,  17,     1.1) /* ArmorModVsFire */
     , (8822,  18,       1) /* ArmorModVsAcid */
     , (8822,  19,       1) /* ArmorModVsElectric */
     , (8822,  31,      28) /* VisualAwarenessRange */
     , (8822,  34,     1.1) /* PowerupTime */
     , (8822,  36,       1) /* ChargeSpeed */
     , (8822,  39,     0.8) /* DefaultScale */
     , (8822,  64,    0.45) /* ResistSlash */
     , (8822,  65,     0.4) /* ResistPierce */
     , (8822,  66,     0.3) /* ResistBludgeon */
     , (8822,  67,    0.45) /* ResistFire */
     , (8822,  68,     0.1) /* ResistCold */
     , (8822,  69,     0.2) /* ResistAcid */
...
VALUES (8822,  6, 0, 3, 0, 335, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (8822, 45, 0, 3, 0, 313, 0, 0) /* LightWeapons        Specialized */
...
VALUES (8822,  0,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (8822,  1,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (8822,  2,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (8822,  3,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (8822,  4,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (8822,  5,  4, 165, 0.75,  430,  473,  452,  430,  430,  473,  430,  430,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (8822,  6,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (8822,  7,  4,  0,    0,  430,  473,  452,  430,  430,  473,  430,  430,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (8822,  8,  4, 165, 0.75,  430,  473,  452,  430,  430,  473,  430,  430,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
