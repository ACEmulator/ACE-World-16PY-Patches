HeartBeat: Style: NonCombat, Substyle: Ready, Probability: 0.08
    - InqEvent: RBGauntletArena1Event
        EventSuccess:
            - InqEvent: RBGauntletArena2Event
                EventSuccess:
                    - Motion: Ready
                EventFailure:
...
Refuse: Gauntlet Guest Ticket (87869)
    ...
    - InqYesNo: This guest ticket allows you to join another fellowship in Arena One. You must already be in a fellowship and not currently have access to either of the active arenas. No refunds. Are you ready to enter Arena One?
        TestSuccess:
            - InqOwnsItems: Gauntlet Guest Ticket (87869), 1
                TestSuccess:
                    - TakeItems: Gauntlet Guest Ticket (87869), -1
                    - InqFellowQuest: IsPlayerInFellow?
                        QuestFailure:
                            - Goto: Arena1Addition
                        QuestNoFellow:
...
Refuse: Gauntlet Guest Ticket (87870)
    ...
    - InqYesNo: This guest ticket allows you to join another fellowship in Arena Two. You must already be in a fellowship and not currently have access to either of the active arenas. No refunds. Are you ready to enter Arena Two?
        TestSuccess:
            - InqOwnsItems: Gauntlet Guest Ticket (87870), 1
                TestSuccess:
...
GotoSet: ErasePlayerQuestFlags
    - EraseQuest: GauntletArena1RB
    - EraseQuest: GauntletArena2RB
...
GotoSet: IsPlayerInMyFaction
    - InqQuest: RadiantBloodMember
        ...
        QuestFailure:
            ...
            - Tell: Your ticket is no good here, unless you are a member of the Radiant Blood.
            - Tell: Begone fool, and do not try to fool the Radiant Blood!
    ...
    - InqFellowQuest: GauntletArena1RB@Arena1Addition
        ...
        QuestFailure:
            - InqFellowQuest: GauntletArena2RB@Arena1Addition
                ...
                QuestFailure:
                    - LockFellow
                    - StampFellowQuest: GauntletArena1RB
    ...
    - InqFellowQuest: GauntletArena1RB@Arena1Addition
        ...
        QuestFailure:
            - InqFellowQuest: GauntletArena2RB@Arena1Addition
                ...
                QuestFailure:
                    - LockFellow
                    - StampFellowQuest: GauntletArena2RB
                    #- Give: Gauntlet Ticket Stub (52795)
        ...
        EventFailure:
            - InqMyQuest: GauntletArenaOneWait
                ...
                QuestFailure:
                    ...
                    - LockFellow
                    - LocalSignal: ActivateRBArenaOne
                    - StampFellowQuest: GauntletArena1RB
                    - Give: Gauntlet Ticket Stub (52795)
                    - Delay 2, TellFellow: Your fellowship will be battling in Arena One.
                    - Delay 1, TellFellow: Use the portal to enter your Arena.
                    ...
                    - Give: Gauntlet Guest Ticket (87869)
        ...
        EventFailure:
            - InqMyQuest: GauntletArenaTwoWait
                ...
                QuestFailure:
                    ...
                    - LockFellow
                    - LocalSignal: ActivateRBArenaTwo
                    - StampFellowQuest: GauntletArena2RB
                    - Give: Gauntlet Ticket Stub (52795)
                    - Delay 2, TellFellow: Your fellowship will be battling in Arena Two.
                    - Delay 1, TellFellow: Use the portal to enter your Arena.
                    ...
                    - Give: Gauntlet Guest Ticket (87870)
                    - Tell: If you wish to have another fellowship join you in battle, you may give the leader this guest ticket and have them hand it back to me so that they may enter the Arena with you.
