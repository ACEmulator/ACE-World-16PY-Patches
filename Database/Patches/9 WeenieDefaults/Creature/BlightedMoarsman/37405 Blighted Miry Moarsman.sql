...
VALUES (37405, 'ace37405-blightedmirymoarsman', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (37405,   1,       5) /* HeartbeatInterval */
     ...
     , (37405,   5,       2) /* ManaRate */
     , (37405,  12,     0.5) /* Shade */
     , (37405,  13,    0.82) /* ArmorModVsSlash */
     , (37405,  14,    0.44) /* ArmorModVsPierce */
     , (37405,  15,    0.83) /* ArmorModVsBludgeon */
     , (37405,  16,    0.72) /* ArmorModVsCold */
     , (37405,  17,    0.83) /* ArmorModVsFire */
     , (37405,  18,    0.72) /* ArmorModVsAcid */
     , (37405,  19,     0.9) /* ArmorModVsElectric */
     ...
     , (37405,  64,     0.9) /* ResistSlash */
     , (37405,  65,    0.56) /* ResistPierce */
     , (37405,  66,    0.96) /* ResistBludgeon */
     , (37405,  67,    0.96) /* ResistFire */
     , (37405,  68,    0.85) /* ResistCold */
     , (37405,  69,    0.85) /* ResistAcid */
...
VALUES (37405,   1, 0x02000992) /* Setup */
     ...
     , (37405,   4, 0x30000023) /* CombatTable */
     , (37405,   6, 0x04000FA8) /* PaletteBase */
     , (37405,   7, 0x10000276) /* ClothingBase */
...
VALUES (37405,  0,  4,  0,    0,  250,  205,  110,  208,  180,  208,  180,  225,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (37405,  1,  4,  0,    0,  250,  205,  110,  208,  180,  208,  180,  225,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (37405,  2,  4,  0,    0,  250,  205,  110,  208,  180,  208,  180,  225,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (37405,  3,  4,  0,    0,  260,  213,  114,  216,  187,  216,  187,  234,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (37405,  4,  4,  0,    0,  250,  205,  110,  208,  180,  208,  180,  225,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (37405,  5, 32, 100, 0.75,  250,  205,  110,  208,  180,  208,  180,  225,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (37405,  6,  4,  0,    0,  255,  209,  112,  212,  184,  212,  184,  230,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
...
VALUES (37405,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37405,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
