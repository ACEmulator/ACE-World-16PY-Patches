...
VALUES (43800, 'ace43800-bloodstoneshard', 10, '2022-11-05 05:26:30') /* Creature */;
...
VALUES (43800,  6, 0, 3, 0, 360, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (43800, 15, 0, 3, 0, 395, 0, 0) /* MagicDefense        Specialized */
     , (43800, 20, 0, 3, 0, 420, 0, 0) /* Deception           Specialized */
     , (43800, 33, 0, 3, 0, 220, 0, 0) /* LifeMagic           Specialized */
     , (43800, 34, 0, 3, 0, 240, 0, 0) /* WarMagic            Specialized */
     , (43800, 45, 0, 3, 0, 395, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (43800,  0,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (43800,  1,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (43800,  2,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (43800,  3,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (43800,  4,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (43800,  5,  4, 500, 0.75,  375,  300,  188,  150,  300,  300,  300,  300,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (43800,  6,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (43800,  7,  4, 500,    0,  375,  300,  188,  150,  300,  300,  300,  300,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (43800,  8,  4, 500, 0.75,  375,  300,  188,  150,  300,  300,  300,  300,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
