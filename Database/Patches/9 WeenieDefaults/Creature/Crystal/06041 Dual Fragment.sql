...
VALUES (6041, 'crystaldualfragment', 10, '2021-11-29 06:19:28') /* Creature */;
...
VALUES (6041,   1,       5) /* HeartbeatInterval */
     ...
     , (6041,  16,    1.19) /* ArmorModVsCold */
     , (6041,  17,     100) /* ArmorModVsFire */
     , (6041,  18,    2.78) /* ArmorModVsAcid */
     ...
     , (6041,  68,    0.65) /* ResistCold */
     , (6041,  69,     0.3) /* ResistAcid */
...
VALUES (6041,   1, 0x02000702) /* Setup */
     , (6041,   2, 0x09000099) /* MotionTable */
     , (6041,   3, 0x20000059) /* SoundTable */
     , (6041,   4, 0x30000027) /* CombatTable */
     , (6041,   6, 0x04000BEF) /* PaletteBase */
     , (6041,   7, 0x1000019D) /* ClothingBase */
     , (6041,   8, 0x06001BBB) /* Icon */
     , (6041,  22, 0x34000074) /* PhysicsEffectTable */
     , (6041,  35,        462) /* DeathTreasureType - Loot Tier: 3 */;
...
VALUES (6041,  6, 0, 3, 0, 150, 0, 0) /* MeleeDefense        Specialized */
     , (6041,  7, 0, 3, 0, 250, 0, 0) /* MissileDefense      Specialized */
     , (6041, 15, 0, 3, 0, 192, 0, 0) /* MagicDefense        Specialized */
     , (6041, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (6041, 24, 0, 3, 0,  10, 0, 0) /* Run                 Specialized */
     , (6041, 31, 0, 3, 0, 207, 0, 0) /* CreatureEnchantment Specialized */
     , (6041, 33, 0, 3, 0, 207, 0, 0) /* LifeMagic           Specialized */
     , (6041, 34, 0, 3, 0, 207, 0, 0) /* WarMagic            Specialized */
     , (6041, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (6041, 9,  6056,  0, 0, 0.02, False) /* Create Small Shard (6056) for ContainTreasure */
     , (6041, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (6041, 9, 45876,  1, 0, 0.03, False) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (6041, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (6041, 9, 45875,  1, 0, 0.01, False) /* Create Lucky Gold Letter (45875) for ContainTreasure */
