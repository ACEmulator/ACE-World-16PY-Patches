...
VALUES (31669, 'ace31669-pillaroftheeternalharvester', 10, '2023-04-09 17:44:47') /* Creature */;
...
VALUES (31669,   1,       5) /* HeartbeatInterval */
     ...
     , (31669,   5,       2) /* ManaRate */
     , (31669,  13,     1.1) /* ArmorModVsSlash */
     , (31669,  14,     1.1) /* ArmorModVsPierce */
     , (31669,  15,     0.5) /* ArmorModVsBludgeon */
     , (31669,  16,     1.1) /* ArmorModVsCold */
     , (31669,  17,     1.1) /* ArmorModVsFire */
     , (31669,  18,    0.58) /* ArmorModVsAcid */
     , (31669,  19,     1.1) /* ArmorModVsElectric */
     , (31669,  31,     0.3) /* VisualAwarenessRange */
...
VALUES (31669,   1, 0x02001413) /* Setup */
     , (31669,   2, 0x09000229) /* MotionTable */
     , (31669,   3, 0x2000005F) /* SoundTable */
     , (31669,   4, 0x30000004) /* CombatTable */
     , (31669,   8, 0x060022C4) /* Icon */
     , (31669,  22, 0x3400006B) /* PhysicsEffectTable */;
...
VALUES (31669,  0,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31669,  1,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31669,  2,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31669,  3,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31669,  4,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31669,  5,  4,  0, 0.75,  200,  220,  220,  100,  220,  220,  116,  220,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31669,  6,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31669,  7,  4,  0,    0,  200,  220,  220,  100,  220,  220,  116,  220,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31669,  8,  4,  0, 0.75,  200,  220,  220,  100,  220,  220,  116,  220,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
