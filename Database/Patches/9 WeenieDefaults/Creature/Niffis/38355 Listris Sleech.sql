...
VALUES (38355, 'ace38355-listrissleech', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (38355,   1, 0x020014A0) /* Setup */
     ...
     , (38355,   4, 0x3000002A) /* CombatTable */
     , (38355,   6, 0x04001EDC) /* PaletteBase */
     , (38355,   7, 0x10000639) /* ClothingBase */
...
VALUES (38355,  0,  4, 200, 0.75,  650,  650,  618,  618,  650,  650,  650,  650,    0, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (38355, 16,  4,  0,    0,  650,  650,  618,  618,  650,  650,  650,  650,    0, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (38355, 21,  4,  0,    0,  650,  650,  618,  618,  650,  650,  650,  650,    0, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (38355, 24,  4,  0,    0,  650,  650,  618,  618,  650,  650,  650,  650,    0, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (38355, 25,  4, 200,  0.5,  650,  650,  618,  618,  650,  650,  650,  650,    0, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (38355,  2074,    2.1)  /* Gossamer Flesh */
     , (38355,  2122,    2.1)  /* Disintegration */
     , (38355,  4347,   2.05)  /* Incantation of Nullify Life Magic Other */
     , (38355,  2162,    2.1)  /* Olthoi's Gift */;
