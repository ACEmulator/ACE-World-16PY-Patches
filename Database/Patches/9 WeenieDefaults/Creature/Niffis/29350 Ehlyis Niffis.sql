...
VALUES (29350, 'niffisehlyis', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (29350,  6, 0, 3, 0, 155, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (29350, 45, 0, 3, 0, 120, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (29350,  0,  4, 20, 0.75,  210,  210,  181,  181,  206,  181,  206,  181,    0, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (29350, 16,  4,  0,    0,  210,  210,  181,  181,  206,  181,  206,  181,    0, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (29350, 21,  4,  0,    0,  210,  210,  181,  181,  206,  181,  206,  181,    0, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (29350, 24,  4,  0,    0,  210,  210,  181,  181,  206,  181,  206,  181,    0, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (29350, 25,  4, 20, 0.75,  210,  210,  181,  181,  206,  181,  206,  181,    0, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;
