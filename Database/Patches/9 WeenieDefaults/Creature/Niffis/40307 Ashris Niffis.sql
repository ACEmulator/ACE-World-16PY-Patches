...
VALUES (40307, 'ace40307-ashrisniffis', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (40307,   1, 0x02000926) /* Setup */
     ...
     , (40307,   4, 0x3000002A) /* CombatTable */
     , (40307,   6, 0x04000FE9) /* PaletteBase */
     , (40307,   7, 0x10000247) /* ClothingBase */
...
VALUES (40307,  6, 0, 2, 0, 433, 0, 0) /* MeleeDefense        Trained */
     , (40307,  7, 0, 2, 0, 350, 0, 0) /* MissileDefense      Trained */
     , (40307, 15, 0, 2, 0, 356, 0, 0) /* MagicDefense        Trained */
     , (40307, 16, 0, 2, 0, 150, 0, 0) /* ManaConversion      Trained */
     , (40307, 31, 0, 2, 0, 150, 0, 0) /* CreatureEnchantment Trained */
     , (40307, 33, 0, 2, 0, 150, 0, 0) /* LifeMagic           Trained */
     , (40307, 34, 0, 2, 0, 150, 0, 0) /* WarMagic            Trained */
     , (40307, 41, 0, 2, 0, 483, 0, 0) /* TwoHandedCombat     Trained */
     , (40307, 43, 0, 2, 0, 150, 0, 0) /* VoidMagic           Trained */
     , (40307, 44, 0, 2, 0, 483, 0, 0) /* HeavyWeapons        Trained */
     , (40307, 45, 0, 2, 0, 483, 0, 0) /* LightWeapons        Trained */
     , (40307, 46, 0, 2, 0, 483, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (40307,  0,  4, 215, 0.75,  350,  350,  298,  298,  333,  298,  333,  298,    0, 1, 0.44,  0.3,    0,  0.4,  0.1,    0, 0.44,  0.3,    0,  0.4,  0.1,    0) /* Head */
     , (40307, 16,  4,  0,    0,  350,  350,  298,  298,  333,  298,  333,  298,    0, 2,  0.5, 0.48,  0.1,  0.5,  0.6,  0.1,  0.5, 0.48,  0.1,  0.5,  0.6, 0.22) /* Torso */
     , (40307, 21,  4,  0,    0,  350,  350,  298,  298,  333,  298,  333,  298,    0, 2,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0, 0.28) /* Wings */
     , (40307, 24,  4,  0,    0,  350,  350,  298,  298,  333,  298,  333,  298,    0, 2, 0.06, 0.22,  0.3,  0.1,  0.2,  0.3, 0.06, 0.22,  0.3,  0.1,  0.2, 0.22) /* UpperTentacle */
     , (40307, 25,  4, 215, 0.75,  350,  350,  298,  298,  333,  298,  333,  298,    0, 3,    0,    0,  0.3,    0,  0.1,  0.3,    0,    0,  0.3,    0,  0.1, 0.28) /* LowerTentacle */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (40307,  2162,    2.5)  /* Olthoi's Gift */
     , (40307,  2122,   2.25)  /* Disintegration */
     , (40307,  2074,   2.02)  /* Gossamer Flesh */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (40307,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
