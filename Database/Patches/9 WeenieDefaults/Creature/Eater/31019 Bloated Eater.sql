...
VALUES (31019, 'eaterbloated', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (31019,   1,       5) /* HeartbeatInterval */
     ...
     , (31019,   3,     0.1) /* HealthRate */
     , (31019,   4,       3) /* StaminaRate */
     , (31019,   5,       1) /* ManaRate */
     , (31019,  12,       0) /* Shade */
     , (31019,  13,     0.9) /* ArmorModVsSlash */
     ...
     , (31019,  64,     1.1) /* ResistSlash */
     , (31019,  65,     0.8) /* ResistPierce */
     , (31019,  66,     0.8) /* ResistBludgeon */
     , (31019,  67,     0.8) /* ResistFire */
     , (31019,  68,     0.8) /* ResistCold */
     , (31019,  69,     0.8) /* ResistAcid */
     , (31019,  70,     0.8) /* ResistElectric */
     ...
     , (31019, 125,     0.6) /* ResistHealthDrain */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (31019,   1, 'Bloated Eater') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (31019,   1, 0x02001251) /* Setup */
     , (31019,   2, 0x0900017A) /* MotionTable */
     , (31019,   3, 0x200000B9) /* SoundTable */
     , (31019,   4, 0x3000003F) /* CombatTable */
     , (31019,   6, 0x0400197B) /* PaletteBase */
     , (31019,   7, 0x10000598) /* ClothingBase */
     , (31019,   8, 0x060036F5) /* Icon */
     , (31019,  22, 0x340000B1) /* PhysicsEffectTable */
     , (31019,  35,        454) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (31019,  0,  2, 180,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31019,  1,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31019,  2,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31019,  3,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31019,  4,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31019,  5,  1, 180,  0.4,  570,  513,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31019,  6,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31019,  7,  2,  0,    0,  570,  513,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31019,  8,  4, 180,  0.4,  570,  513,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */
...
VALUES (31019,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31019,  5 /* HeartBeat */,   0.07, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31019,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31019,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31019,  5 /* HeartBeat */,   0.07, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31019,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
