...
VALUES (42372, 'ace42372-invadingcoppercogsquire', 10, '2020-08-02 19:56:42') /* Creature */;
...
VALUES (42372,   1,   33560842) /* Setup */
     ...
     , (42372,   4,  805306368) /* CombatTable */
     , (42372,   8,  100674350) /* Icon */
     , (42372,  22,  872415269) /* PhysicsEffectTable */
     , (42372,  35,       1011) /* DeathTreasureType */;
...
VALUES (42372,  0,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (42372,  1,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (42372,  2,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (42372,  3,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (42372,  4,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (42372,  5,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (42372,  6,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (42372,  7,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (42372,  8,  4, 190,  0.5,  430,  390,  390,  390,  390,  390,  190,  290,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (42372, 9, 41528,  1, 0, 0.35, True) /* Create  (41528) for ContainTreasure */
     , (42372, 9,     0,  1, 0, 0.65, False) /* Create nothing for ContainTreasure */
     , (42372, 9, 42114,  1, 0, 0.05, True) /* Create Aetherium-infused Gear (42114) for ContainTreasure */
     , (42372, 9,     0,  1, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (42372, 9, 41979,  1, 0, 0.05, True) /* Create Shattered Mana Forge Key (41979) for ContainTreasure */
     , (42372, 9,     0,  1, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (42372, 9, 34277,  1, 0, 0.02, True) /* Create Ancient Falatacot Trinket (34277) for ContainTreasure */
     , (42372, 9,     0,  1, 0, 0.98, False) /* Create nothing for ContainTreasure */
     , (42372, 9, 51266,  1, 0, 0.30, False) /* Create Pile of Gearknight Parts (51266) for ContainTreasure */
     , (42372, 9,     0,  1, 0, 0.70, False) /* Create nothing for ContainTreasure */
     , (42372, 10, 41245,  1, 0, 0.2, True) /* Create  (41245) for WieldTreasure */
     , (42372, 10, 41237,  1, 0, 0.2, True) /* Create  (41237) for WieldTreasure */
     , (42372, 10, 41246,  1, 0, 0.15, True) /* Create  (41246) for WieldTreasure */
     , (42372, 10, 41247,  1, 0, 0.15, True) /* Create  (41247) for WieldTreasure */
     , (42372, 10, 41248,  1, 0, 0.15, True) /* Create  (41248) for WieldTreasure */
     , (42372, 10, 41249,  1, 0, 0.15, True) /* Create  (41249) for WieldTreasure */;
