...
VALUES (41584, 'ace41584-goldgearlesserlord', 10, '2020-04-25 17:25:06') /* Creature */;
...
VALUES (41584,   1,   33560843) /* Setup */
     ...
     , (41584,   4,  805306368) /* CombatTable */
     , (41584,   8,  100674350) /* Icon */
     , (41584,  22,  872415269) /* PhysicsEffectTable */
     , (41584,  31,      41606) /* LinkedPortalOne - Gearknight Lord's Tower */
     , (41584,  35,        450) /* DeathTreasureType - Loot Tier: 3 */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (41584, 12, 2287009796, 11.9728, 84.1704, 61.517403, 0, 0, 0, -1) /* PortalSummonLoc */
/* @teleloc 0x88510004 [11.972800 84.170403 61.517403] 0.000000 0.000000 0.000000 -1.000000 */;
...
VALUES (41584,  0,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41584,  1,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41584,  2,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (41584,  3,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41584,  4,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (41584,  5,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (41584,  6,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (41584,  7,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (41584,  8,  4, 80,  0.5,  250,  200,  200,  200,  200,  200,  100,  150,    0, 2,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (41584,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (41584, 1, 41564,  1, 0, 1, True) /* Create Gold Aetherium Core Fragment (41564) for Contain */
     , (41584, 9, 41563,  1, 0, 0.35, True) /* Create Gear Knight Core Fragment (41563) for ContainTreasure */
     , (41584, 9,     0,  1, 0, 0.65, False) /* Create nothing for ContainTreasure */
     , (41584, 9, 42113,  1, 0, 0.1, True) /* Create Scratched Gear (42113) for ContainTreasure */
     , (41584, 9,     0,  1, 0, 0.9, False) /* Create nothing for ContainTreasure */
     , (41584, 9, 45876,  1, 0, 0.05, True) /* Create Scarlet Red Letter (45876) for ContainTreasure */
     , (41584, 9,     0,  1, 0, 0.95, False) /* Create nothing for ContainTreasure */
     , (41584, 9, 45875,  1, 0, 0.03, True) /* Create Lucky Gold Letter (45875) for ContainTreasure */
     , (41584, 9,     0,  1, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (41584, 10, 41240,  1, 0, 0.5, True) /* Create Gearknight Sword (41240) for WieldTreasure */
     , (41584, 10, 41244,  1, 0, 0.5, True) /* Create Gearknight Greatsword (41244) for WieldTreasure */;
