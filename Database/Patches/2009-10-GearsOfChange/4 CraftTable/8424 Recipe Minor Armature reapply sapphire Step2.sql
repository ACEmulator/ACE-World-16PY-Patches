DELETE FROM `recipe` WHERE `id` = 8424;
...
VALUES (8424, 0, 18 /* ItemTinkering */, 0, 1, 0, 0, 'You apply the Sapphire.', 0, 0, 'You apply the Sapphire, but in the process you destroy the target.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 1, 1, NULL, 0, '2020-02-28 10:00:00');

INSERT INTO `recipe_requirements_int` (`recipe_Id`, `index`, `stat`, `value`, `enum`, `message`)
VALUES (8424, 1,  92, 100, 2, 'The material is not complete!') /* Source.Structure LessThan 100 */
	 , (8424, 0,  92, 100, 6, 'The armature has already been completed!') /* Target.Structure Equal to 100 */;

INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8424, True, 0, 0, 0, False, 939524161, 0, 0);
...
INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8424, True, 0, 0, 0, False, 0, 0, 0);
...
INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8424, True, 0, 0, 0, False, 939524158, 0, 0);
...
DELETE FROM `cook_book` WHERE `recipe_Id` = 8424;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (8424, 21074 /*  Salvaged Sapphire */,  71427 /* Minor Item Tinkering Armature */, '2020-02-28 10:00:00')
     , (8385, 70736 /*  Salvaged Sapphire */,  71427 /* Minor Item Tinkering Armature */, '2020-03-31 00:00:00');
