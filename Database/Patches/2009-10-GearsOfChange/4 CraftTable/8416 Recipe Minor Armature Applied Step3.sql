...
VALUES (8416, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* Target.ItemWorkmanship LessThan 1 */
     ...
     , (8416, 0, 304, 1, 3, 'The target item has been imbued already!') /* Target.ImbuedEffect - 8192 - Spellbook_ImbuedEffectType */
...
VALUES (8416, True, 0, 0, 0, False, 939524161, 0, 0);

SET @parent_id = LAST_INSERT_ID();

INSERT INTO `recipe_mods_int` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 0, 5138, -1, 7, 0) /* On Player.SuccessTarget AddSpell Augmented Damage I to Target */
     , (@parent_id, 0, 304, 8192, 1, 0) /* On Player.SuccessTarget Add ImbuedEffect 303 8192 Spellbook_ImbuedEffectType to Target */;
