...
VALUES (8420, 0, 18 /* Item Tinkering */, 0, 0, 41493 /* Salvaged Ruby */, 1, 'You prepare the Armature with trace amounts of Ruby.', 0, 0, 'You fail to prepare the Armature.', 0, 0, '', 1, 1, '', 0, 0, '', 0, 0, '', 0, '2020-02-28 21:42:55');

DELETE FROM `cook_book` WHERE `recipe_Id` = 8420;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (8420, 21072 /*  Salvaged Ruby */,  41509 /* Major Item Tinkering Armature */, '2020-02-28 21:42:55')
     , (8420, 70741 /*  Salvaged Ruby */,  41509 /* Major Item Tinkering Armature */, '2020-03-31 00:00:00');
