...
VALUES (8372, 0, 18 /* ItemTinkering */, 0, 2, 0, 0, 'You apply the Ruby.', 0, 0, 'You apply the Ruby, but in the process you destroy the target.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 1, 1, NULL, 0, '2020-02-28 10:00:00');
...
VALUES (8372, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* Target.ItemWorkmanship LessThan 1 */
     ...
     , (8372, 0, 179, 1, 3, 'The target item has been imbued already!') /* Target.ImbuedEffect - 8192 - Spellbook_ImbuedEffectType */
...
VALUES (8372, True, 0, 0, 0, False, 939524161, 0, 0);
...
VALUES (@parent_id, 0, 109, 25, 2, 0) /* On Player.SuccessTarget Add ItemDifficulty 25 to Target */
     ...
     , (@parent_id, 0, 5146, -1, 7, 0) /* On Player.SuccessTarget AddSpell AugmentedHealthThree to Target */
