...
VALUES (8388, 0, 18 /* Item Tinkering */, 0, 0, 71422 /* Salvaged Amber Moderate Item Tinkering Armature*/, 1, 'You prepare the Armature with trace amounts of Amber.', 0, 0, 'You fail to prepare the Armature.', 0, 0, '', 1, 1, '', 0, 0, '', 0, 0, '', 0, '2020-02-28 21:42:55');

DELETE FROM `cook_book` WHERE `recipe_Id` = 8388;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (8388, 21035 /*  Salvaged Amber */,  41507 /* Moderate Item Tinkering Armature */, '2020-02-28 21:42:55')
     , (8388, 70737 /*  Salvaged Amber */,  41507 /* Moderate Item Tinkering Armature */, '2020-03-31 00:00:00');
