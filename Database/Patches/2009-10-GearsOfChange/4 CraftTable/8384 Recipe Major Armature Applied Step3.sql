...
VALUES (8384, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* Target.ItemWorkmanship LessThan 1 */
     , (8384, 0, 171, 3, 3, 'The target item has been tinkered too many times already!') /* Target.NumTimesTinkered GreaterThanEqual 3 */
     , (8384, 0, 179, 1, 3, 'The target item has been imbued already!') /* Target.ImbuedEffect - 8192 - Spellbook_ImbuedEffectType */
...
VALUES (8384, True, 0, 0, 0, False, 939524161, 0, 0);
...
VALUES (@parent_id, 0, 109, 25, 2, 0) /* On Player.SuccessTarget Add ItemDifficulty 25 to Target */
     ...
     , (@parent_id, 0, 5137, -1, 7, 0) /* On Player.SuccessTarget AddSpell Augmented Understanding III to Target */
...
INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8384, True, 0, 0, 0, False, 939524158, 0, 0);
