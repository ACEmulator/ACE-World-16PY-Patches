...
VALUES (8422, 0, 105, 1, 2, 'The target item cannot be tinkered!') /* Target.ItemWorkmanship LessThan 1 */
     ...
     , (8422, 0, 304, 1, 3, 'The target item has been imbued already!') /* Target.ImbuedEffect - 8192 - Spellbook_ImbuedEffectType */
...
VALUES (8422, True, 0, 0, 0, False, 939524161, 0, 0);

SET @parent_id = LAST_INSERT_ID();

INSERT INTO `recipe_mods_int` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 0, 5144, -1, 7, 0) /* On Player.SuccessTarget AddSpell AugmentedHealthThree to Target */
     , (@parent_id, 0, 304, 8192, 1, 0) /* On Player.SuccessTarget Add ImbuedEffect 304 Augmented Health I to Target */;
...
VALUES (8422, 41493 /* Minor Item Tinkering Armature */,   41483 /* Compass */, '2020-02-28 10:00:00')
     , (8422, 41493 /* Minor Item Tinkering Armature */,   41484 /* Goggles */, '2020-02-28 10:00:00')
     , (8422, 41493 /* Minor Item Tinkering Armature */,   41485 /* Pocket Watch */, '2020-02-28 10:00:00')
     , (8422, 41493 /* Minor Item Tinkering Armature */,   41486 /* Puzzle Box */, '2020-02-28 10:00:00')
     , (8422, 41493 /* Minor Item Tinkering Armature */,   41487 /* Mechanical Scarab */, '2020-02-28 10:00:00')
     , (8422, 41493 /* Minor Item Tinkering Armature */,   41488 /* Top */, '2020-02-28 10:00:00');
