...
VALUES (72166, 'ace72166-lightningcloud', 10, '2020-07-23 03:33:58') /* Creature */;
...
VALUES (72166,   1,   33560373) /* Setup */
     , (72166,   2,  150995290) /* MotionTable */
     , (72166,   3,  536871001) /* SoundTable */
     , (72166,   4,  805306368) /* CombatTable */
     , (72166,   8,  100670581) /* Icon */
     , (72166,  22,  872415389) /* PhysicsEffectTable */;
...
VALUES (72166,  0, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72166,  1, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72166,  2, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72166,  3, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72166,  4, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72166,  5, 64, 75, 0.75,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72166,  6, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72166,  7, 64,  0,    0,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72166,  8, 64, 75, 0.75,  320,  283,  283,  283,  289,  263,  220, 22000,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72166,  4453,   3.0)  /* Incantation of Lightning Volley */;
