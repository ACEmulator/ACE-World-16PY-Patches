...
VALUES (51375, 'ace51375-hollowservitor', 10, '2020-10-21 21:40:20') /* Creature */;
...
VALUES (51375,   1,    5) /* HeartbeatInterval */
     ...
     , (51375,  15,  1.0) /* ArmorModVsBludgeon */
     , (51375,  16,  0.8) /* ArmorModVsCold */
     , (51375,  17,  1.0) /* ArmorModVsFire */
     , (51375,  18,  1.0) /* ArmorModVsAcid */
     , (51375,  19,  1.0) /* ArmorModVsElectric */
     ...
     , (51375, 165,  1.0) /* ArmorModVsNether */
     , (51375, 166,  1.0) /* ResistNether */;
...
VALUES (51375,   1,   33556792) /* Setup */
     ...
     , (51375,   7,  268436617) /* ClothingBase */
...
VALUES (51375, 8040, 1483866494, 132.978, -190.456, 0.00274992, -0.209224, 0, 0, -0.977868) /* PCAPRecordedLocation */
...
VALUES (51375,  0,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51375,  1,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51375,  2,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (51375,  3,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51375,  4,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (51375,  5,  4, 40, 0.75,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51375, 17,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (51375, 9, 72160,  0, 0,   1, False) /* Create Private Chamber Key (72160) for Contain */;
