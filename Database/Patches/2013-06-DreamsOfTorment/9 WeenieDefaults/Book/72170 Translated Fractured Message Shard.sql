...
VALUES (72170, 'ace72170-translatedmessageshard', 8, '2021-01-17 05:55:18') /* Book */;
...
VALUES (72170,   1,   33554773) /* Setup */
     , (72170,   3,  536870932) /* SoundTable */
     , (72170,   8,  100668176) /* Icon */
     , (72170,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (72170, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (72170, 0, 4294967295, 'Diyas al-Yat', 'prewritten', False, 'Specimen: Gear Knight
