DELETE FROM `spell` WHERE `id` = 4458;
...
VALUES (4458, 'Incantation of Whirling Blade Streak', 94, 1 /* Slash */, 47, 47, 7268 /* Whirling Blade */, 1, 1, 1, 1, 1, 1, 1, '2019-03-18 09:00:00');
