...
VALUES (49025, 'ace49025-zombie', 71, '2021-07-12 02:37:58') /* CombatPet */;
...
VALUES (49025,  0,  8,  0,    0,  400,  400,  400,  400,  400,  400,  400,  400,  400, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49025,  5,  8, 141, 0.75,  400,  400,  400,  400,  400,  400,  400,  400,  400, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49025,  8,  8, 141, 0.75,  400,  400,  400,  400,  400,  400,  400,  400,  400, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (49025, 2, 48994,  1, 1, 0, False) /* Create Frost Hatchet (48994) for Wield */
     , (49025, 2,  2596,  1, 9, 0.1, False) /* Create Doublet (2596) for Wield */
     , (49025, 2, 87371,  1, 91, 0.3091, False) /* Create Haebrean Breastplate (87371) for Wield */
     , (49025, 2, 87372,  1, 91, 0.2545, False) /* Create Haebrean Girth (87372) for Wield */;
