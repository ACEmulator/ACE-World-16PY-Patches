...
VALUES (49016, 'ace49016-zombie', 71, '2021-07-12 02:37:47') /* CombatPet */;
...
VALUES (49016,   1, 0x02001A96) /* Setup */
     , (49016,   2, 0x09000001) /* MotionTable */
     , (49016,   3, 0x20000016) /* SoundTable */
     , (49016,   4, 0x30000000) /* CombatTable */
     , (49016,   6, 0x0400007E) /* PaletteBase */
     , (49016,   8, 0x06001226) /* Icon */
     , (49016,  22, 0x34000028) /* PhysicsEffectTable */;
...
VALUES (49016,   1,   350, 0, 0, 430) /* MaxHealth */
...
VALUES (49016,  0, 16,  0,    0,  310,  310,  310,  310,  310,  310,  310,  310,  310, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49016,  5, 16, 81, 0.75,  310,  310,  310,  310,  310,  310,  310,  310,  310, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49016,  8, 16, 81, 0.75,  310,  310,  310,  310,  310,  310,  310,  310,  310, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (49016, 2, 48985,  1, 1, 0, False) /* Create Flaming Hatchet (48985) for Wield */;
