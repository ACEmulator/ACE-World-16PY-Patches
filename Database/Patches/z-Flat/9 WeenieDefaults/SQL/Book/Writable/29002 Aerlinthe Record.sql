DELETE FROM `weenie` WHERE `class_Id` = 29002;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (29002, 'bookroads3', 8, '2005-02-09 10:00:00') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29002,   1,       8192) /* ItemType - Writable */
     , (29002,   5,        160) /* EncumbranceVal */
     , (29002,   8,        200) /* Mass */
     , (29002,   9,          0) /* ValidLocations - None */
     , (29002,  16,          8) /* ItemUseable - Contained */
     , (29002,  19,         90) /* Value */
     , (29002,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29002,  22, False) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29002,  39,    1.22) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29002,   1, 'Aerlinthe Record') /* Name */
     , (29002,  15, 'A translation of an Empyrean text.') /* ShortDesc */
     , (29002,  16, 'A translation of an Empyrean text found on Aerlinthe Island.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29002,   1,   33554771) /* Setup */
     , (29002,   3,  536870932) /* SoundTable */
     , (29002,   8,  100668117) /* Icon */
     , (29002,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29002, 32, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (29002, 0, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 1, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 2, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (29002, 3, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 4, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 5, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 6, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 9, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 10, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 11, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 12, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 13, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 14, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 15, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 16, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (29002, 17, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 18, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 19, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 20, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (29002, 21, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 22, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (29002, 23, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 25, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (29002, 26, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (29002, 27, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (29002, 28, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 29, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (29002, 30, 4294967295, 'Tale of Years', 'prewritten', False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (29002, 31, 4294967295, 'Tale of Years', 'prewritten', False, '
