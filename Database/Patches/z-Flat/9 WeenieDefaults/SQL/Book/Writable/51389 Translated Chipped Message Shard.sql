...
VALUES (51389, 'ace51389-translatedmessageshard', 8, '2021-01-07 11:38:04') /* Book */;
...
VALUES (51389,   1,   33554773) /* Setup */
     , (51389,   3,  536870932) /* SoundTable */
     , (51389,   8,  100668176) /* Icon */
     , (51389,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (51389, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (51389, 0, 4294967295, 'Diyas al-Yat', 'prewritten', False, 'Specimen: Lugian
