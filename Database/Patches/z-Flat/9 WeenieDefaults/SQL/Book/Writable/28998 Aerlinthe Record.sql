DELETE FROM `weenie` WHERE `class_Id` = 28998;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (28998, 'bookroads1', 8, '2005-02-09 10:00:00') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (28998,   1,       8192) /* ItemType - Writable */
     , (28998,   5,        160) /* EncumbranceVal */
     , (28998,   8,        200) /* Mass */
     , (28998,   9,          0) /* ValidLocations - None */
     , (28998,  16,          8) /* ItemUseable - Contained */
     , (28998,  19,         90) /* Value */
     , (28998,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (28998,  22, False) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (28998,  39,    1.22) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (28998,   1, 'Aerlinthe Record') /* Name */
     , (28998,  15, 'A translation of an Empyrean text.') /* ShortDesc */
     , (28998,  16, 'A translation of an Empyrean text found on Aerlinthe Island.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (28998,   1,   33554771) /* Setup */
     , (28998,   3,  536870932) /* SoundTable */
     , (28998,   8,  100668117) /* Icon */
     , (28998,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (28998, 32, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (28998, 0, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 1, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 2, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 222: Loritane sends sixteen great ocean-galleons and two skyships to the island, carrying the supplies necessary to build a mining outpost. Lord Loritane and Lady Raina accompany the vessels in Tinoriel.
...
')
     , (28998, 3, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 4, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 5, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 6, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 9, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 10, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 11, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 12, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 13, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 14, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 15, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 16, 4294967295, 'Tale of Years', 'prewritten', False, 'RE 895: Aurlanaa leaves her aerie on the peak of Cunara. She meets several other gromnatross south of Aerlinthe, and they ascend, disappearing into the heavens. No gromnatross are seen on Auberean for twenty-two years.
...
')
     , (28998, 17, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 18, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 19, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 20, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 11: A daughter, Alhallie, is born to Caerlin and Clari. A Festival Year is declared in Elancia and Aerlinthe.
...
')
     , (28998, 21, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 22, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 275: The legendary traveling entertainer Surinna Thrasyl stops at Aerlinthe.
...
')
     , (28998, 23, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 25, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 450: After the census, Emperor Caerlin announces that Tentael has a population of over one million, most under the age of 400. Aerlinthe''s population is less than 100, but nearly 1000 golems work the forges at any time.
...
')
     , (28998, 26, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 464: The new forges are completed. Due to the distance between them and the magma flows, production is less than half of that before the collapse.
...
')
     , (28998, 27, 4294967295, 'Tale of Years', 'prewritten', False, 'TE 513: The Great Northern Tempest. Mages hold off the worst of the storm for three days. The Naarcaerel Reef is ripped apart by storm-tides.
...
')
     , (28998, 28, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 29, 4294967295, 'Tale of Years', 'prewritten', False, '
...
')
     , (28998, 30, 4294967295, 'Tale of Years', 'prewritten', False, 'HE 239: The Nali relocates from Aventin to Tentael at the invitation of Emperor Kellin.
...
')
     , (28998, 31, 4294967295, 'Tale of Years', 'prewritten', False, '
