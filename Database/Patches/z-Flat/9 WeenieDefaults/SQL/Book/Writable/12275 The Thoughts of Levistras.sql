...
VALUES (12275, 'notelevistrastranslated', 8, '2005-02-09 10:00:00') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (12275,   1,       8192) /* ItemType - Writable */
     , (12275,   5,          5) /* EncumbranceVal */
     , (12275,   8,          5) /* Mass */
     , (12275,   9,          0) /* ValidLocations - None */
     , (12275,  16,          8) /* ItemUseable - Contained */
     , (12275,  19,         20) /* Value */
     , (12275,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (12275,  22, False) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12275,  39,    1.22) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12275,   1, 'The Thoughts of Levistras') /* Name */
     , (12275,  14, 'Use this item to read it.') /* Use */
     , (12275,  15, 'A note translated by Diyas al-Yat of Zaikhal.') /* ShortDesc */
     , (12275,  16, 'A note translated by Diyas al-Yat of Zaikhal.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (12275,   1,   33554773) /* Setup */
     , (12275,   3,  536870932) /* SoundTable */
     , (12275,   8,  100668176) /* Icon */
     , (12275,  22,  872415275) /* PhysicsEffectTable */;
