DELETE FROM `weenie` WHERE `class_Id` = 28135;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (28135, 'scrollfellowshipmeleedefense5null', 8, '2005-02-09 10:00:00') /* Book */;
...
VALUES (28135,   1,       8192) /* ItemType - Writable */
     ...
     , (28135,  19,          0) /* Value */
     , (28135,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;
