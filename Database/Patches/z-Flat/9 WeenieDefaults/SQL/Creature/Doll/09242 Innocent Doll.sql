...
VALUES (9242, 'dollinnocent', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (9242,   1,       5) /* HeartbeatInterval */
     ...
     , (9242,  16,    0.79) /* ArmorModVsCold */
     , (9242,  17,       1) /* ArmorModVsFire */
     , (9242,  18,       1) /* ArmorModVsAcid */
     , (9242,  19,    0.79) /* ArmorModVsElectric */
...
VALUES (9242,   1, 0x02000A04) /* Setup */
     ...
     , (9242,   4, 0x30000030) /* CombatTable */
     , (9242,   6, 0x040010BE) /* PaletteBase */
     , (9242,   7, 0x100002B4) /* ClothingBase */
     , (9242,   8, 0x06001FBD) /* Icon */
     , (9242,  19, 0x00000057) /* ActivationAnimation */
     , (9242,  22, 0x3400008D) /* PhysicsEffectTable */
     , (9242,  30,         87) /* PhysicsScript - BreatheLightning */
     , (9242,  35,        463) /* DeathTreasureType - Loot Tier: 2 */;
...
VALUES (9242,  6, 0, 3, 0, 163, 0, 0) /* MeleeDefense        Specialized */
     , (9242,  7, 0, 3, 0, 274, 0, 0) /* MissileDefense      Specialized */
     , (9242, 14, 0, 3, 0, 200, 0, 0) /* ArcaneLore          Specialized */
     , (9242, 15, 0, 3, 0, 115, 0, 0) /* MagicDefense        Specialized */
     , (9242, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (9242, 24, 0, 2, 0,  80, 0, 0) /* Run                 Trained */
     , (9242, 31, 0, 3, 0, 100, 0, 0) /* CreatureEnchantment Specialized */
     , (9242, 33, 0, 3, 0, 100, 0, 0) /* LifeMagic           Specialized */
     , (9242, 34, 0, 3, 0, 100, 0, 0) /* WarMagic            Specialized */
     , (9242, 45, 0, 3, 0, 113, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (9242,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9242,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (9242, 9,  9225,  0, 0, 0.03, False) /* Create Obsidian Shard (9225) for ContainTreasure */
     , (9242, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */;
