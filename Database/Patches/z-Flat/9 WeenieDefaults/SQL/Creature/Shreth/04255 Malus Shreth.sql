...
VALUES (4255, 'shrethmalus', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (4255,   1,         16) /* ItemType - Creature */
     ...
     , (4255,  25,         80) /* Level */
     , (4255,  27,          0) /* ArmorType - None */
     , (4255,  40,          2) /* CombatMode - Melee */
     , (4255,  68,          9) /* TargetingTactic - Random, TopDamager */
...
VALUES (4255,   1,       5) /* HeartbeatInterval */
     ...
     , (4255,   5,       1) /* ManaRate */
     , (4255,  12,     0.5) /* Shade */
     , (4255,  13,    0.56) /* ArmorModVsSlash */
     , (4255,  14,    0.66) /* ArmorModVsPierce */
     , (4255,  15,     0.8) /* ArmorModVsBludgeon */
     , (4255,  16,    0.99) /* ArmorModVsCold */
     , (4255,  17,    0.24) /* ArmorModVsFire */
     , (4255,  18,    0.42) /* ArmorModVsAcid */
     , (4255,  19,    0.42) /* ArmorModVsElectric */
     , (4255,  31,      10) /* VisualAwarenessRange */
     , (4255,  34,     1.2) /* PowerupTime */
     , (4255,  36,       1) /* ChargeSpeed */
     , (4255,  39,    1.45) /* DefaultScale */
     , (4255,  64,    0.58) /* ResistSlash */
     , (4255,  65,    0.75) /* ResistPierce */
     , (4255,  66,       1) /* ResistBludgeon */
     , (4255,  67,    0.25) /* ResistFire */
     , (4255,  68,    1.42) /* ResistCold */
     , (4255,  69,    0.42) /* ResistAcid */
     , (4255,  70,    0.42) /* ResistElectric */
...
VALUES (4255,   1, 0x020005A7) /* Setup */
     , (4255,   2, 0x09000080) /* MotionTable */
     , (4255,   3, 0x2000004A) /* SoundTable */
     , (4255,   4, 0x3000001F) /* CombatTable */
     , (4255,   6, 0x04000DFC) /* PaletteBase */
     , (4255,   7, 0x10000160) /* ClothingBase */
     , (4255,   8, 0x06001918) /* Icon */
     , (4255,  22, 0x34000065) /* PhysicsEffectTable */
...
VALUES (4255,  6, 0, 3, 0, 175, 0, 0) /* MeleeDefense        Specialized */
     , (4255,  7, 0, 3, 0, 265, 0, 0) /* MissileDefense      Specialized */
     , (4255, 14, 0, 2, 0,  70, 0, 0) /* ArcaneLore          Trained */
     , (4255, 15, 0, 3, 0, 155, 0, 0) /* MagicDefense        Specialized */
     , (4255, 20, 0, 2, 0,   0, 0, 0) /* Deception           Trained */
     , (4255, 22, 0, 2, 0,  10, 0, 0) /* Jump                Trained */
     , (4255, 31, 0, 3, 0,   0, 0, 0) /* CreatureEnchantment Specialized */
     , (4255, 33, 0, 3, 0,   0, 0, 0) /* LifeMagic           Specialized */
     , (4255, 34, 0, 3, 0,   0, 0, 0) /* WarMagic            Specialized */
     , (4255, 45, 0, 3, 0, 115, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (4255,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4255,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4255,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4255,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4255,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (4255,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (4255, 9,  6876,  0, 0, 0.01, False) /* Create Sturdy Iron Key (6876) for ContainTreasure */
     , (4255, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */
