...
VALUES (45707, 'ace45707-geraine', 10, '2021-06-07 08:09:45') /* Creature */;
...
VALUES (45707,   1,   33554433) /* Setup */
     ...
     , (45707,   7,  268437422) /* ClothingBase */
...
VALUES (45707,  0,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45707,  1,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45707,  2,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45707,  3,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45707,  4,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45707,  5,  4, 800, 0.75,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45707,  6,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45707,  7,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45707,  8,  4, 800, 0.75,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (45707,  3879,  2.167)  /* Glacial Strike */
     , (45707,  3884,    2.1)  /* Glacial Ring */
...
VALUES (45707, -1, 72349, 180, 1, 1, 1, 4, 0, 0, 0, 1466958361, 45.0424, -115.241, 24.055, 1, 0, 0, 0) /* Generate Frozen Refuge Guards Gen (72349) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
