...
VALUES (38148,   1,       5) /* HeartbeatInterval */
     ...
     , (38148,   3, 0.100000001490116) /* HealthRate */
     , (38148,   4,       3) /* StaminaRate */
     , (38148,   5,       1) /* ManaRate */
     , (38148,  12,     0.5) /* Shade */
     , (38148,  13,    1.75) /* ArmorModVsSlash */
     , (38148,  14,    1.75) /* ArmorModVsPierce */
     , (38148,  15, 1.60000002384186) /* ArmorModVsBludgeon */
     , (38148,  16, 1.35000002384186) /* ArmorModVsCold */
     , (38148,  17, 1.35000002384186) /* ArmorModVsFire */
     , (38148,  18, 1.35000002384186) /* ArmorModVsAcid */
     , (38148,  19, 1.20000004768372) /* ArmorModVsElectric */
     , (38148,  31,      12) /* VisualAwarenessRange */
     , (38148,  34,       1) /* PowerupTime */
     , (38148,  36,       1) /* ChargeSpeed */
     , (38148,  54,       3) /* UseRadius */
     , (38148,  64, 0.400000005960464) /* ResistSlash */
     , (38148,  65, 0.400000005960464) /* ResistPierce */
     , (38148,  66,     0.5) /* ResistBludgeon */
     , (38148,  67,     0.5) /* ResistFire */
     , (38148,  68, 0.600000023841858) /* ResistCold */
     , (38148,  69, 0.600000023841858) /* ResistAcid */
     , (38148,  70, 0.860000023841858) /* ResistElectric */
...
VALUES (38148,   1,   33554433) /* Setup */
     ...
     , (38148,   7,  268437297) /* ClothingBase */
...
VALUES (38148,  0,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38148,  1,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38148,  2,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38148,  3,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38148,  4,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38148,  5,  4, 95,  0.4,  395,  452,  452,  395,  395,  299,  395,  299,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38148,  6,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38148,  7,  4,  0,    0,  395,  452,  452,  395,  395,  299,  395,  299,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38148,  8,  4, 95,  0.4,  395,  452,  452,  395,  395,  299,  395,  299,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38148,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38148,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38148,  5 /* HeartBeat */,   0.05, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38148,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (38148,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
