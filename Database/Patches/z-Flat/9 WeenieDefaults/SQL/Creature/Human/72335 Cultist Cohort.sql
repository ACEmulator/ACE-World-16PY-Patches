...
VALUES (72335, 'ace72335-cultistcohort', 10, '2021-05-30 01:23:31') /* Creature */;
...
VALUES (72335,   1,   33554433) /* Setup */
     , (72335,   2,  150994945) /* MotionTable */
     , (72335,   3,  536870913) /* SoundTable */
     , (72335,   4,  805306368) /* CombatTable */
     , (72335,   6,   67108990) /* PaletteBase */
     , (72335,   8,  100667446) /* Icon */
     , (72335,  22,  872415236) /* PhysicsEffectTable */
...
VALUES (72335,  0,  4,  0,    0,  370,  235,  235,  235,  235,  235,  235,  235,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72335,  1,  4,  0,    0,  360,  230,  230,  230,  230,  230,  230,  230,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72335,  2,  4,  0,    0,  360,  230,  230,  230,  230,  230,  230,  230,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72335,  3,  4,  0,    0,  350,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72335,  4,  4,  0,    0,  350,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72335,  5,  4, 200, 0.75,  350,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72335,  6,  4,  0,    0,  350,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72335,  7,  4,  0,    0,  350,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72335,  8,  4, 200, 0.75,  350,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72335,  2053,      2)  /* Executor's Blessing */
     , (72335,  2070,   2.04)  /* Heart Rend */
     , (72335,  2074,    2.1)  /* Gossamer Flesh */
     , (72335,  2122,   2.09)  /* Disintegration */
