...
VALUES (45699, 'ace45699-geraine', 10, '2021-06-07 08:12:03') /* Creature */;
...
VALUES (45699,   1,   33554433) /* Setup */
     ...
     , (45699,   7,  268437422) /* ClothingBase */
...
VALUES (45699,  0,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45699,  1,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45699,  2,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45699,  3,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45699,  4,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45699,  5,  4, 800, 0.75,  980,  490,  490,  490,  490,  490,  490,  490,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45699,  6,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45699,  7,  4,  0,    0,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45699,  8,  4, 800, 0.75,  980,  490,  490,  490,  490,  490,  490,  490,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (45699,  2121,  2.211)  /* Corrosive Flash */
     , (45699,  3877,  2.148)  /* Corrosive Strike */
     , (45699,  3881,  2.174)  /* Corrosive Ring */
     , (45699,  3904,  2.073)  /* Essence's Fury */
...
VALUES (45699, -1, 72350, 180, 1, 1, 1, 4, 0, 0, 0, 1466695936, 20.0748, -113.667, -29.945, 0, 0, 0, -1) /* Generate Acidic Refuge Guards Gen (72350) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
