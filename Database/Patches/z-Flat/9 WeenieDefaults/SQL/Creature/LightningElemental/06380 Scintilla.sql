...
VALUES (6380, 'lightningelementalscintilla', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (6380,   1,       5) /* HeartbeatInterval */
     ...
     , (6380,   3,     0.7) /* HealthRate */
     , (6380,   4,     0.5) /* StaminaRate */
     , (6380,   5,       2) /* ManaRate */
     , (6380,  13,    0.73) /* ArmorModVsSlash */
     , (6380,  14,    0.73) /* ArmorModVsPierce */
     , (6380,  15,    0.73) /* ArmorModVsBludgeon */
     , (6380,  16,    0.78) /* ArmorModVsCold */
     , (6380,  17,     0.6) /* ArmorModVsFire */
     , (6380,  18,       1) /* ArmorModVsAcid */
     , (6380,  19,     100) /* ArmorModVsElectric */
     , (6380,  31,      20) /* VisualAwarenessRange */
     , (6380,  39,     1.3) /* DefaultScale */
     , (6380,  41,     300) /* RegenerationInterval */
     , (6380,  43,      10) /* GeneratorRadius */
     , (6380,  64,    0.45) /* ResistSlash */
     , (6380,  65,    0.45) /* ResistPierce */
     , (6380,  66,    0.45) /* ResistBludgeon */
     , (6380,  67,     0.3) /* ResistFire */
     , (6380,  68,     0.3) /* ResistCold */
     , (6380,  69,    0.65) /* ResistAcid */
...
VALUES (6380,   1, 0x020006AC) /* Setup */
     , (6380,   2, 0x0900008F) /* MotionTable */
     , (6380,   3, 0x20000056) /* SoundTable */
     , (6380,   4, 0x30000000) /* CombatTable */
     , (6380,   8, 0x06001C75) /* Icon */
     , (6380,  22, 0x34000075) /* PhysicsEffectTable */
...
VALUES (6380,  6, 0, 3, 0, 144, 0, 0) /* MeleeDefense        Specialized */
     , (6380,  7, 0, 3, 0, 290, 0, 0) /* MissileDefense      Specialized */
     , (6380, 14, 0, 2, 0, 130, 0, 0) /* ArcaneLore          Trained */
     , (6380, 15, 0, 3, 0, 158, 0, 0) /* MagicDefense        Specialized */
     , (6380, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (6380, 24, 0, 2, 0,  80, 0, 0) /* Run                 Trained */
     , (6380, 31, 0, 3, 0,  90, 0, 0) /* CreatureEnchantment Specialized */
     , (6380, 33, 0, 3, 0,  90, 0, 0) /* LifeMagic           Specialized */
     , (6380, 34, 0, 3, 0,  90, 0, 0) /* WarMagic            Specialized */
     , (6380, 45, 0, 3, 0, 150, 0, 0) /* LightWeapons        Specialized */;
