...
VALUES (26692, 'ursuinbabyslasher', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (26692,   1,   33556773) /* Setup */
     , (26692,   2,  150995284) /* MotionTable */
     , (26692,   3,  536871011) /* SoundTable */
     , (26692,   4,  805306409) /* CombatTable */
     , (26692,   8,  100670959) /* Icon */
     , (26692,  22,  872415366) /* PhysicsEffectTable */
...
VALUES (26692,  6, 0, 3, 0,  90, 0, 1805.15807042367) /* MeleeDefense        Specialized */
     , (26692,  7, 0, 3, 0,  75, 0, 1805.15807042367) /* MissileDefense      Specialized */
     , (26692, 13, 0, 3, 0,  65, 0, 1805.15807042367) /* UnarmedCombat       Specialized */
     , (26692, 15, 0, 3, 0,  95, 0, 1805.15807042367) /* MagicDefense        Specialized */;
...
VALUES (26692,  0,  2, 25, 0.75,  160,   85,  128,   85,   85,  115,   85,   85,    0, 1,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     ...
     , (26692, 16,  4,  0,    0,  150,   79,  120,   79,   79,  108,   79,   79,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;
...
VALUES (26692,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (26692,  5 /* HeartBeat */,   0.03, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (26692,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (26692,  5 /* HeartBeat */,   0.03, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
