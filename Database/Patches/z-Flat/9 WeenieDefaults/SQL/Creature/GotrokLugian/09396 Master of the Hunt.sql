...
VALUES (9396, 'lugiancommandera', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (9396,   1,   33557003) /* Setup */
     , (9396,   2,  150994950) /* MotionTable */
     , (9396,   3,  536870922) /* SoundTable */
     , (9396,   4,  805306371) /* CombatTable */
     , (9396,   6,   67113158) /* PaletteBase */
     , (9396,   7,  268436175) /* ClothingBase */
     , (9396,   8,  100667447) /* Icon */
     , (9396,  22,  872415262) /* PhysicsEffectTable */
...
VALUES (9396,  1, 0, 3, 0, 200, 0, 639.348502305668) /* Axe                 Specialized */
     , (9396,  5, 0, 3, 0, 200, 0, 639.348502305668) /* Mace                Specialized */
     , (9396,  6, 0, 3, 0, 250, 0, 639.348502305668) /* MeleeDefense        Specialized */
     , (9396,  7, 0, 3, 0, 360, 0, 639.348502305668) /* MissileDefense      Specialized */
     , (9396, 12, 0, 3, 0, 185, 0, 639.348502305668) /* ThrownWeapon        Specialized */
     , (9396, 13, 0, 3, 0, 200, 0, 639.348502305668) /* UnarmedCombat       Specialized */
     , (9396, 15, 0, 3, 0, 230, 0, 639.348502305668) /* MagicDefense        Specialized */
     , (9396, 20, 0, 2, 0,  80, 0, 639.348502305668) /* Deception           Trained */
     , (9396, 22, 0, 2, 0,  80, 0, 639.348502305668) /* Jump                Trained */
     , (9396, 24, 0, 2, 0,  45, 0, 639.348502305668) /* Run                 Trained */;
...
VALUES (9396,  0,  4,  2,  0.3,  145,   83,   83,   83,   52,   25,  125,  116,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (9396,  6,  4,  2,  0.3,  150,   86,   86,   86,   54,   26,  129,  120,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (9396,  7,  4, 25,  0.3,  150,   86,   86,   86,   54,   26,  129,  120,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
...
VALUES (9396,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,  0.125, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,  0.025, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9396,  5 /* HeartBeat */,  0.125, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
