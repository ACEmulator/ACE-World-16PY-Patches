...
VALUES (9465, 'lugianlieutenantc', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (9465,   1,       5) /* HeartbeatInterval */
     ...
     , (9465,   3,     0.9) /* HealthRate */
     , (9465,   4,       4) /* StaminaRate */
     , (9465,   5,       2) /* ManaRate */
     , (9465,  12,     0.5) /* Shade */
     , (9465,  13,    0.57) /* ArmorModVsSlash */
     , (9465,  14,    0.57) /* ArmorModVsPierce */
     , (9465,  15,    0.57) /* ArmorModVsBludgeon */
     , (9465,  16,    0.36) /* ArmorModVsCold */
     , (9465,  17,    0.17) /* ArmorModVsFire */
     , (9465,  18,    0.86) /* ArmorModVsAcid */
     , (9465,  19,     0.8) /* ArmorModVsElectric */
     , (9465,  31,      23) /* VisualAwarenessRange */
     , (9465,  34,       3) /* PowerupTime */
     , (9465,  36,       1) /* ChargeSpeed */
     , (9465,  64,    0.66) /* ResistSlash */
     , (9465,  65,    0.66) /* ResistPierce */
     , (9465,  66,    0.66) /* ResistBludgeon */
     , (9465,  67,    0.25) /* ResistFire */
     , (9465,  68,    0.42) /* ResistCold */
     , (9465,  69,     0.9) /* ResistAcid */
...
VALUES (9465,   1, 0x02000A0B) /* Setup */
     , (9465,   2, 0x09000006) /* MotionTable */
     , (9465,   3, 0x2000000A) /* SoundTable */
     , (9465,   4, 0x30000003) /* CombatTable */
     , (9465,   6, 0x040010C6) /* PaletteBase */
     , (9465,   7, 0x1000053B) /* ClothingBase */
     , (9465,   8, 0x06001037) /* Icon */
     , (9465,  22, 0x3400001E) /* PhysicsEffectTable */
...
VALUES (9465,  6, 0, 3, 0, 230, 0, 0) /* MeleeDefense        Specialized */
     , (9465,  7, 0, 3, 0, 330, 0, 0) /* MissileDefense      Specialized */
     , (9465, 15, 0, 3, 0, 230, 0, 0) /* MagicDefense        Specialized */
     , (9465, 20, 0, 2, 0,  80, 0, 0) /* Deception           Trained */
     , (9465, 22, 0, 2, 0,  80, 0, 0) /* Jump                Trained */
     , (9465, 24, 0, 2, 0,  45, 0, 0) /* Run                 Trained */
     , (9465, 45, 0, 3, 0, 200, 0, 0) /* LightWeapons        Specialized */
     , (9465, 47, 0, 3, 0, 190, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (9465,  5 /* HeartBeat */,  0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,  0.025, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9465,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
