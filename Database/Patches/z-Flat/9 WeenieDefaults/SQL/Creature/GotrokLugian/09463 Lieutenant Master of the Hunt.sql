...
VALUES (9463,   1,   33557003) /* Setup */
     , (9463,   2,  150994950) /* MotionTable */
     , (9463,   3,  536870922) /* SoundTable */
     , (9463,   4,  805306371) /* CombatTable */
     , (9463,   6,   67113158) /* PaletteBase */
     , (9463,   7,  268436795) /* ClothingBase */
     , (9463,   8,  100667447) /* Icon */
     , (9463,  22,  872415262) /* PhysicsEffectTable */
...
VALUES (9463,  1, 0, 3, 0, 200, 0, 642.211529658439) /* Axe                 Specialized */
     , (9463,  5, 0, 3, 0, 200, 0, 642.211529658439) /* Mace                Specialized */
     , (9463,  6, 0, 3, 0, 230, 0, 642.211529658439) /* MeleeDefense        Specialized */
     , (9463,  7, 0, 3, 0, 330, 0, 642.211529658439) /* MissileDefense      Specialized */
     , (9463, 12, 0, 3, 0, 190, 0, 642.211529658439) /* ThrownWeapon        Specialized */
     , (9463, 13, 0, 3, 0, 200, 0, 642.211529658439) /* UnarmedCombat       Specialized */
     , (9463, 15, 0, 3, 0, 230, 0, 642.211529658439) /* MagicDefense        Specialized */
     , (9463, 20, 0, 2, 0,  80, 0, 642.211529658439) /* Deception           Trained */
     , (9463, 22, 0, 2, 0,  80, 0, 642.211529658439) /* Jump                Trained */
     , (9463, 24, 0, 2, 0,  45, 0, 642.211529658439) /* Run                 Trained */;
...
VALUES (9463,  0,  4,  2,  0.3,  145,   83,   83,   83,   52,   25,  125,  116,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (9463,  6,  4,  2,  0.3,  150,   86,   86,   86,   54,   26,  129,  120,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (9463,  7,  4, 25,  0.3,  150,   86,   86,   86,   54,   26,  129,  120,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
...
VALUES (9463,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,  0.125, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,  0.025, NULL, 2147483710 /* SwordCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9463,  5 /* HeartBeat */,  0.125, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
