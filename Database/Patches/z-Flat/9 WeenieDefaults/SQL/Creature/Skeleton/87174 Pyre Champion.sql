...
VALUES (87174, 'ace87174-pyrechampion', 10, '2019-08-22 00:00:00') /* Creature */;
...
VALUES (87174,   1,       5) /* HeartbeatInterval */
     ...
     , (87174, 166,    0.82) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (87174,   1, 'Pyre Champion') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (87174,   1,   33560229) /* Setup */
     , (87174,   2,  150994981) /* MotionTable */
     , (87174,   3,  536870942) /* SoundTable */
     , (87174,   4,  805306368) /* CombatTable */
     , (87174,   6,   67116522) /* PaletteBase */
...
VALUES (87174,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (87174,  7, 0, 3, 0, 397, 0, 0) /* MissileDefense      Specialized */
     , (87174, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (87174, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (87174, 33, 0, 3, 0, 280, 0, 0) /* LifeMagic           Specialized */
     , (87174, 34, 0, 3, 0, 280, 0, 0) /* WarMagic            Specialized */
     , (87174, 44, 0, 3, 0, 565, 0, 0) /* HeavyWeapons        Specialized */
     , (87174, 45, 0, 3, 0, 565, 0, 0) /* LightWeapons        Specialized */
     , (87174, 46, 0, 3, 0, 565, 0, 0) /* FinesseWeapons      Specialized */
     , (87174, 47, 0, 3, 0, 565, 0, 0) /* MissileWeapons      Specialized */
     , (87174, 48, 0, 3, 0, 200, 0, 0) /* Shield              Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (87174,  0,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87174,  1,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87174,  2,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87174,  3,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87174,  4,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87174,  5,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87174,  6,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87174,  7,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87174,  8,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (87174,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
