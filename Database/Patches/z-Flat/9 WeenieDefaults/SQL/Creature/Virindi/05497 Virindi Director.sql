...
VALUES (5497, 'virindidirector', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (5497,   1,         16) /* ItemType - Creature */
     ...
     , (5497,  25,         50) /* Level */
     , (5497,  27,          0) /* ArmorType - None */
     , (5497,  68,          3) /* TargetingTactic - Random, Focused */
     , (5497,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (5497, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (5497, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (5497,   1,       5) /* HeartbeatInterval */
     ...
     , (5497,  16,    0.72) /* ArmorModVsCold */
     , (5497,  17,       1) /* ArmorModVsFire */
     , (5497,  18,       1) /* ArmorModVsAcid */
     , (5497,  19,    0.72) /* ArmorModVsElectric */
...
VALUES (5497,   1, 0x02000041) /* Setup */
     , (5497,   2, 0x09000028) /* MotionTable */
     , (5497,   3, 0x20000012) /* SoundTable */
     , (5497,   4, 0x3000000D) /* CombatTable */
     , (5497,   6, 0x040009B2) /* PaletteBase */
     , (5497,   7, 0x100000C1) /* ClothingBase */
     , (5497,   8, 0x06001227) /* Icon */
     , (5497,  22, 0x34000029) /* PhysicsEffectTable */
     , (5497,  35,        463) /* DeathTreasureType - Loot Tier: 2 */;
...
VALUES (5497,  6, 0, 3, 0, 105, 0, 0) /* MeleeDefense        Specialized */
     , (5497,  7, 0, 3, 0, 200, 0, 0) /* MissileDefense      Specialized */
     , (5497, 14, 0, 2, 0, 230, 0, 0) /* ArcaneLore          Trained */
     , (5497, 15, 0, 3, 0, 120, 0, 0) /* MagicDefense        Specialized */
     , (5497, 20, 0, 2, 0, 130, 0, 0) /* Deception           Trained */
     , (5497, 24, 0, 2, 0,  80, 0, 0) /* Run                 Trained */
     , (5497, 31, 0, 3, 0, 100, 0, 0) /* CreatureEnchantment Specialized */
     , (5497, 33, 0, 3, 0, 100, 0, 0) /* LifeMagic           Specialized */
     , (5497, 34, 0, 3, 0, 100, 0, 0) /* WarMagic            Specialized */
     , (5497, 45, 0, 3, 0, 150, 0, 0) /* LightWeapons        Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5497,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (5497, 9,  8154,  0, 0, 0.1, False) /* Create Broken Virindi Mask (8154) for ContainTreasure */
     ...
     , (5497, 9,  3696,  0, 0, 0.0125, False) /* Create Blue Jewel (3696) for ContainTreasure */
     , (5497, 9,  3697,  0, 0, 0.0125, False) /* Create Red Jewel (3697) for ContainTreasure */
     , (5497, 9, 41470,  0, 0, 0.0125, False) /* Create Purple Jewel (41470) for ContainTreasure */
