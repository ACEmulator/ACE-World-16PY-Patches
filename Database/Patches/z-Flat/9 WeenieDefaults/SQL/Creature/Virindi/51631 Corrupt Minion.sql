...
VALUES (51631, 'ace51631-corruptminion', 10, '2020-10-21 21:40:21') /* Creature */;
...
VALUES (51631,   1,         16) /* ItemType - Creature */
     ...
     , (51631,  25,        240) /* Level */
     , (51631,  65,          1) /* Placement - RightHandCombat */
...
VALUES (51631,   1,       5) /* HeartbeatInterval */
     ...
     , (51631, 165,       1) /* ArmorModVsNether */
     , (51631, 166,       1) /* ResistNether */;
...
VALUES (51631,   1,   33561544) /* Setup */
     ...
     , (51631,   4,  805306381) /* CombatTable */
     , (51631,   6,   67111346) /* PaletteBase */
     , (51631,   7,  268437588) /* ClothingBase */
...
VALUES (51631,  6, 0, 2, 0, 350, 0, 0) /* MeleeDefense        Trained */
     , (51631,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense      Trained */
     , (51631, 15, 0, 2, 0, 360, 0, 0) /* MagicDefense        Trained */
     , (51631, 16, 0, 2, 0, 405, 0, 0) /* ManaConversion      Trained */
     , (51631, 31, 0, 2, 0, 405, 0, 0) /* CreatureEnchantment Trained */
     , (51631, 33, 0, 2, 0, 405, 0, 0) /* LifeMagic           Trained */
     , (51631, 34, 0, 2, 0, 405, 0, 0) /* WarMagic            Trained */
     , (51631, 41, 0, 2, 0, 450, 0, 0) /* TwoHandedCombat     Trained */
     , (51631, 43, 0, 2, 0, 405, 0, 0) /* VoidMagic           Trained */
     , (51631, 44, 0, 2, 0, 450, 0, 0) /* HeavyWeapons        Trained */
     , (51631, 45, 0, 2, 0, 450, 0, 0) /* LightWeapons        Trained */
     , (51631, 46, 0, 2, 0, 450, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51631,  0, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51631,  1, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51631,  2, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51631,  3, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51631,  4, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51631,  5, 64, 180,  0.5,  650,  520,  520,  520,  520,  520,  520,  520,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51631,  6, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51631,  7, 64,  0,    0,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51631,  8, 64, 180,  0.5,  650,  520,  520,  520,  520,  520,  520,  520,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
