...
VALUES (235, 'tuskergoldenback', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (235,   1,       5) /* HeartbeatInterval */
     ...
     , (235,  14,     0.8) /* ArmorModVsPierce */
     , (235,  15,     0.6) /* ArmorModVsBludgeon */
     , (235,  16,       1) /* ArmorModVsCold */
     , (235,  17,     0.7) /* ArmorModVsFire */
...
VALUES (235,   1, 0x02000964) /* Setup */
     ...
     , (235,   4, 0x3000000B) /* CombatTable */
     , (235,   6, 0x040001C3) /* PaletteBase */
     , (235,   7, 0x1000025D) /* ClothingBase */
     , (235,   8, 0x06001033) /* Icon */
     , (235,  22, 0x34000027) /* PhysicsEffectTable */
     , (235,  35,        457) /* DeathTreasureType - Loot Tier: 2 */;
...
VALUES (235,  6, 0, 3, 0,  60, 0, 0) /* MeleeDefense        Specialized */
     , (235,  7, 0, 3, 0,  70, 0, 0) /* MissileDefense      Specialized */
     , (235, 15, 0, 3, 0,  97, 0, 0) /* MagicDefense        Specialized */
     , (235, 20, 0, 2, 0,  25, 0, 0) /* Deception           Trained */
     , (235, 22, 0, 2, 0, 120, 0, 0) /* Jump                Trained */
     , (235, 24, 0, 2, 0,  70, 0, 0) /* Run                 Trained */
     , (235, 45, 0, 3, 0, 120, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (235,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,   0.15, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (235,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (235, 9, 22578,  0, 0, 0.01, False) /* Create Bunch of Nanners (22578) for ContainTreasure */
     , (235, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */
     , (235, 9, 29204,  1, 0, 0.15, False) /* Create Tusker Spit (29204) for ContainTreasure */
     , (235, 9,     0,  0, 0, 0.85, False) /* Create nothing for ContainTreasure */;
