...
VALUES (72216, 'ace72216-shadeoflordrytheran', 10, '2021-04-24 09:55:58') /* Creature */;
...
VALUES (72216,   1,   33560277) /* Setup */
     , (72216,   2,  150994945) /* MotionTable */
     , (72216,   3,  536870934) /* SoundTable */
     , (72216,   4,  805306368) /* CombatTable */
     , (72216,   6,   67108990) /* PaletteBase */
     , (72216,   7,  268437294) /* ClothingBase */
     , (72216,   8,  100667942) /* Icon */
     , (72216,  22,  872415272) /* PhysicsEffectTable */;
...
VALUES (72216,  0,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72216,  1,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72216,  2,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72216,  3,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72216,  4,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72216,  5,  4, 150, 0.75,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72216,  6,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72216,  7,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72216,  8,  4, 155, 0.75,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (72216,  2074,  2.333)  /* Gossamer Flesh */
     , (72216,  3876,      3)  /* Curse of the Blades */
     , (72216,  3947,    2.5)  /* Blade Wave */
     , (72216,  4422,  2.167)  /* Incantation of Blade Arc */
