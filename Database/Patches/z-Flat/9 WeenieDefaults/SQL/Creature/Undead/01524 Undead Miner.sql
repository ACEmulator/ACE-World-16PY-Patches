...
VALUES (1524, 'undeadminer', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (1524,   1,       5) /* HeartbeatInterval */
     ...
     , (1524,   3,     0.2) /* HealthRate */
     , (1524,   4,       5) /* StaminaRate */
     , (1524,   5,       2) /* ManaRate */
     , (1524,  12,     0.5) /* Shade */
     , (1524,  13,     0.8) /* ArmorModVsSlash */
     , (1524,  14,    0.12) /* ArmorModVsPierce */
     , (1524,  15,    0.23) /* ArmorModVsBludgeon */
     , (1524,  16,    0.35) /* ArmorModVsCold */
     , (1524,  17,     0.5) /* ArmorModVsFire */
     , (1524,  18,    0.23) /* ArmorModVsAcid */
     , (1524,  19,    0.49) /* ArmorModVsElectric */
     , (1524,  31,      20) /* VisualAwarenessRange */
     , (1524,  34,       2) /* PowerupTime */
     , (1524,  36,       1) /* ChargeSpeed */
     , (1524,  64,       1) /* ResistSlash */
     , (1524,  65,    0.65) /* ResistPierce */
     , (1524,  66,    0.75) /* ResistBludgeon */
     , (1524,  67,       1) /* ResistFire */
     , (1524,  68,     0.4) /* ResistCold */
     , (1524,  69,    0.75) /* ResistAcid */
     , (1524,  70,    0.86) /* ResistElectric */
...
VALUES (1524,  6, 0, 2, 0,  70, 0, 0) /* MeleeDefense        Trained */
     , (1524,  7, 0, 2, 0,  70, 0, 0) /* MissileDefense      Trained */
     , (1524, 14, 0, 3, 0,  80, 0, 0) /* ArcaneLore          Specialized */
     , (1524, 15, 0, 2, 0,  75, 0, 0) /* MagicDefense        Trained */
     , (1524, 20, 0, 2, 0,  50, 0, 0) /* Deception           Trained */
     , (1524, 31, 0, 2, 0,  70, 0, 0) /* CreatureEnchantment Trained */
     , (1524, 33, 0, 2, 0,  70, 0, 0) /* LifeMagic           Trained */
     , (1524, 34, 0, 3, 0,  80, 0, 0) /* WarMagic            Specialized */
     , (1524, 44, 0, 2, 0,  80, 0, 0) /* HeavyWeapons        Trained */
     , (1524, 45, 0, 2, 0,  70, 0, 0) /* LightWeapons        Trained */;
...
INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id,  0,   5 /* Motion */, 0, 1, 0x13000083 /* Nod */, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0x00000000, 0, 0, 0, 0, 0, 0, 0);
