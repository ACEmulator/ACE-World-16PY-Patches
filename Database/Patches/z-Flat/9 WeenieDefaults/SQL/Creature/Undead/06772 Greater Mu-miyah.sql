...
VALUES (6772, 'mumiyahgreatercrimsonruby3', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (6772,   1,       5) /* HeartbeatInterval */
     ...
     , (6772,   3,    0.35) /* HealthRate */
     , (6772,   4,     0.5) /* StaminaRate */
     , (6772,   5,       2) /* ManaRate */
     , (6772,  12,     0.5) /* Shade */
     , (6772,  13,    0.53) /* ArmorModVsSlash */
     , (6772,  14,    0.33) /* ArmorModVsPierce */
     , (6772,  15,    0.53) /* ArmorModVsBludgeon */
     , (6772,  16,    0.26) /* ArmorModVsCold */
     , (6772,  17,     0.4) /* ArmorModVsFire */
     , (6772,  18,       1) /* ArmorModVsAcid */
     , (6772,  19,    0.17) /* ArmorModVsElectric */
     , (6772,  31,      24) /* VisualAwarenessRange */
     , (6772,  34,       1) /* PowerupTime */
     , (6772,  36,       1) /* ChargeSpeed */
     , (6772,  39,     1.2) /* DefaultScale */
     , (6772,  64,    0.75) /* ResistSlash */
     , (6772,  65,    0.58) /* ResistPierce */
     , (6772,  66,    0.75) /* ResistBludgeon */
     , (6772,  67,       1) /* ResistFire */
     , (6772,  68,     0.4) /* ResistCold */
     , (6772,  69,       1) /* ResistAcid */
     , (6772,  70,    0.46) /* ResistElectric */
...
VALUES (6772,  6, 0, 2, 0, 100, 0, 0) /* MeleeDefense        Trained */
     , (6772,  7, 0, 2, 0,  50, 0, 0) /* MissileDefense      Trained */
     , (6772, 14, 0, 2, 0, 250, 0, 0) /* ArcaneLore          Trained */
     , (6772, 15, 0, 2, 0, 100, 0, 0) /* MagicDefense        Trained */
     , (6772, 20, 0, 2, 0,  90, 0, 0) /* Deception           Trained */
     , (6772, 31, 0, 2, 0, 250, 0, 0) /* CreatureEnchantment Trained */
     , (6772, 33, 0, 2, 0, 250, 0, 0) /* LifeMagic           Trained */
     , (6772, 34, 0, 2, 0, 250, 0, 0) /* WarMagic            Trained */
     , (6772, 44, 0, 3, 0, 110, 0, 0) /* HeavyWeapons        Specialized */
     , (6772, 45, 0, 3, 0, 110, 0, 0) /* LightWeapons        Specialized */
     , (6772, 46, 0, 3, 0, 110, 0, 0) /* FinesseWeapons      Specialized */;
...
VALUES (6772,  5 /* HeartBeat */,  0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (6772,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (6772,  5 /* HeartBeat */,   0.15, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
