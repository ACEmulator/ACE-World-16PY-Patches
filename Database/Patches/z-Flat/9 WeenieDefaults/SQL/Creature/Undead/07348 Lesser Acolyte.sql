...
VALUES (7348, 'zombiesoulfearingacolytearea1', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (7348,   1,       5) /* HeartbeatInterval */
     ...
     , (7348,   3,     0.3) /* HealthRate */
     , (7348,   4,     0.5) /* StaminaRate */
     , (7348,   5,       2) /* ManaRate */
     , (7348,  12,     0.5) /* Shade */
     , (7348,  13,     0.8) /* ArmorModVsSlash */
     , (7348,  14,     0.3) /* ArmorModVsPierce */
     , (7348,  15,    0.55) /* ArmorModVsBludgeon */
     , (7348,  16,    0.18) /* ArmorModVsCold */
     , (7348,  17,     0.5) /* ArmorModVsFire */
     , (7348,  18,    0.55) /* ArmorModVsAcid */
     , (7348,  19,    0.67) /* ArmorModVsElectric */
     , (7348,  31,       4) /* VisualAwarenessRange */
     , (7348,  34,     0.8) /* PowerupTime */
     , (7348,  36,       1) /* ChargeSpeed */
     , (7348,  39,     1.2) /* DefaultScale */
     , (7348,  64,       1) /* ResistSlash */
     , (7348,  65,    0.52) /* ResistPierce */
     , (7348,  66,    0.75) /* ResistBludgeon */
     , (7348,  67,       1) /* ResistFire */
     , (7348,  68,     0.2) /* ResistCold */
     , (7348,  69,    0.75) /* ResistAcid */
     , (7348,  70,    0.86) /* ResistElectric */
...
VALUES (7348,  6, 0, 3, 0, 125, 0, 0) /* MeleeDefense        Specialized */
     , (7348,  7, 0, 3, 0, 240, 0, 0) /* MissileDefense      Specialized */
     , (7348, 14, 0, 2, 0, 150, 0, 0) /* ArcaneLore          Trained */
     , (7348, 15, 0, 3, 0, 136, 0, 0) /* MagicDefense        Specialized */
     , (7348, 20, 0, 2, 0,  50, 0, 0) /* Deception           Trained */
     , (7348, 31, 0, 3, 0,  80, 0, 0) /* CreatureEnchantment Specialized */
     , (7348, 33, 0, 3, 0,  80, 0, 0) /* LifeMagic           Specialized */
     , (7348, 34, 0, 3, 0,  80, 0, 0) /* WarMagic            Specialized */
     , (7348, 44, 0, 3, 0, 125, 0, 0) /* HeavyWeapons        Specialized */
     , (7348, 45, 0, 3, 0, 125, 0, 0) /* LightWeapons        Specialized */
     , (7348, 46, 0, 3, 0, 125, 0, 0) /* FinesseWeapons      Specialized */
     , (7348, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */
     , (7348, 48, 0, 3, 0, 125, 0, 0) /* Shield              Specialized */;
