...
VALUES (45751, 'ace45751-geraine', 10, '2021-06-01 05:55:55') /* Creature */;
...
VALUES (45751,   1,   33554433) /* Setup */
     ...
     , (45751,   4,  805306368) /* CombatTable */
     , (45751,   6,   67108990) /* PaletteBase */
     , (45751,   7,  268437422) /* ClothingBase */
...
VALUES (45751,  0,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45751,  1,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45751,  2,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45751,  3,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45751,  4,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45751,  5,  4, 800, 0.75,  980,  780,  780,  780,  780,  780,  780,  780,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45751,  6,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45751,  7,  4,  0,    0,  980,  780,  780,  780,  780,  780,  780,  780,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45751,  8,  4, 800, 0.75,  980,  780,  780,  780,  780,  780,  780,  780,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45751, -1, 72375, 180, 1, 1, 1, 4, 0, 0, 0, 1466892847, 30, -90, 12.5, 1, 0, 0, 0) /* Generate Twisted Refuge Guards Gen (72375) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (45751, -1, 72375, 180, 1, 1, 1, 4, 0, 0, 0, 1466892729, 40, -90, -5.5, 1, 0, 0, 0) /* Generate Twisted Refuge Guards Gen (72375) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (45751, -1, 72375, 180, 1, 1, 1, 4, 0, 0, 0, 1466892777, 30, -80, 0.5, 1, 0, 0, 0) /* Generate Twisted Refuge Guards Gen (72375) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (45751, -1, 72375, 180, 1, 1, 1, 4, 0, 0, 0, 1466892830, 40, -80, 6.5, 1, 0, 0, 0) /* Generate Twisted Refuge Guards Gen (72375) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
