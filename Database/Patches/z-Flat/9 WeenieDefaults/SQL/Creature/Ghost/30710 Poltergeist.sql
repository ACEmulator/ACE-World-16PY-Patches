...
VALUES (30710,  6, 0, 3, 0, 263, 0, 2291.9721956262) /* MeleeDefense        Specialized */
     , (30710,  7, 0, 3, 0, 389, 0, 2291.9721956262) /* MissileDefense      Specialized */
     , (30710, 13, 0, 3, 0, 287, 0, 2291.9721956262) /* UnarmedCombat       Specialized */
     , (30710, 14, 0, 3, 0, 300, 0, 2291.9721956262) /* ArcaneLore          Specialized */
     , (30710, 15, 0, 3, 0, 239, 0, 2291.9721956262) /* MagicDefense        Specialized */
     , (30710, 20, 0, 3, 0, 250, 0, 2291.9721956262) /* Deception           Specialized */
     , (30710, 24, 0, 3, 0,  90, 0, 2291.9721956262) /* Run                 Specialized */
     , (30710, 31, 0, 3, 0, 190, 0, 2291.9721956262) /* CreatureEnchantment Specialized */
     , (30710, 33, 0, 3, 0, 190, 0, 2291.9721956262) /* LifeMagic           Specialized */
     , (30710, 34, 0, 3, 0, 190, 0, 2291.9721956262) /* WarMagic            Specialized */;
...
VALUES (30710,    97,   2.05)  /* Whirling Blade VI */
     , (30710,   126,   2.05)  /* Blade Blast VI */
     , (30710,   154,   2.05)  /* Blade Volley VI */
     , (30710,   897,   2.02)  /* Healing Ineptitude Other VI */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30710,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
