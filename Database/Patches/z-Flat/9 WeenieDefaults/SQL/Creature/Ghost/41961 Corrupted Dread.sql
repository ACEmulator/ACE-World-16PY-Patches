...
VALUES (41961,   1,       5) /* HeartbeatInterval */
     ...
     , (41961,   5,       2) /* ManaRate */
     , (41961,  12,     0.5) /* Shade */
     , (41961,  13,    0.64) /* ArmorModVsSlash */
     , (41961,  14,    0.96) /* ArmorModVsPierce */
     , (41961,  15,    0.96) /* ArmorModVsBludgeon */
     , (41961,  16,       1) /* ArmorModVsCold */
     , (41961,  17,    0.64) /* ArmorModVsFire */
     , (41961,  18,    0.97) /* ArmorModVsAcid */
     , (41961,  19,    0.75) /* ArmorModVsElectric */
     ...
     , (41961,  67,    0.89) /* ResistFire */
     , (41961,  68,    0.34) /* ResistCold */
     , (41961,  69,    0.49) /* ResistAcid */
     , (41961,  70,    0.84) /* ResistElectric */
...
VALUES (41961,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (41961,  7, 0, 3, 0, 520, 0, 0) /* MissileDefense      Specialized */
     , (41961, 14, 0, 3, 0, 263, 0, 0) /* ArcaneLore          Specialized */
     , (41961, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (41961, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (41961, 24, 0, 3, 0, 600, 0, 0) /* Run                 Specialized */
     , (41961, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (41961, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (41961, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */
     , (41961, 45, 0, 3, 0, 420, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (41961,  0,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (41961,  1,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (41961,  2,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (41961,  3,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (41961,  4,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (41961,  5,  8, 200, 0.75,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */;
...
VALUES (41961, 9, 48908,  0, 0, 0.04, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (41961, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */;
