...
VALUES (37454, 'ace37454-spectraldread', 10, '2020-11-06 00:00:00') /* Creature */;
...
VALUES (37454,   1,       5) /* HeartbeatInterval */
     ...
     , (37454,  19,    0.75) /* ArmorModVsElectric */
...
VALUES (37454,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (37454, 14, 0, 3, 0, 263, 0, 0) /* ArcaneLore          Specialized */
     , (37454, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (37454, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (37454, 24, 0, 3, 0, 600, 0, 0) /* Run                 Specialized */
     , (37454, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (37454, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (37454, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */
     , (37454, 45, 0, 3, 0, 420, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (37454,  0,  1,  0,    0,  500,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (37454,  1,  1,  0,    0,  500,  200,  250,  250,  250,  250,  250,  200,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (37454,  2,  1,  0,    0,  500,  200,  250,  250,  250,  250,  250,  200,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (37454,  3,  1,  0,    0,  500,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (37454,  4,  1,  0,    0,  500,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (37454,  5,  9, 230, 0.55,  500,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (37454,  5 /* HeartBeat */,  0.032, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (37454, 9, 48908,  0, 0, 0.04, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (37454, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */;
