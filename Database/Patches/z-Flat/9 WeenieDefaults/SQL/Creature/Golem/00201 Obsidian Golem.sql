...
VALUES (201, 'golemobsidian', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (201,   1,       5) /* HeartbeatInterval */
     ...
     , (201,   3,     0.6) /* HealthRate */
     , (201,   4,     0.5) /* StaminaRate */
     , (201,   5,       2) /* ManaRate */
     , (201,   6,     0.1) /* HealthUponResurrection */
     , (201,   7,    0.25) /* StaminaUponResurrection */
     , (201,   8,     0.3) /* ManaUponResurrection */
     , (201,  13,    1.41) /* ArmorModVsSlash */
     , (201,  14,    1.76) /* ArmorModVsPierce */
     , (201,  15,     1.2) /* ArmorModVsBludgeon */
     , (201,  16,    0.63) /* ArmorModVsCold */
     , (201,  17,    1.75) /* ArmorModVsFire */
     , (201,  18,    0.67) /* ArmorModVsAcid */
     , (201,  19,    1.75) /* ArmorModVsElectric */
     , (201,  31,      25) /* VisualAwarenessRange */
     , (201,  34,     3.6) /* PowerupTime */
     , (201,  64,    0.53) /* ResistSlash */
     , (201,  65,     0.9) /* ResistPierce */
     , (201,  66,       1) /* ResistBludgeon */
     , (201,  67,     0.4) /* ResistFire */
     , (201,  68,     0.1) /* ResistCold */
     , (201,  69,     0.2) /* ResistAcid */
     , (201,  70,     0.4) /* ResistElectric */
...
VALUES (201,   1, 0x020007D8) /* Setup */
     , (201,   2, 0x09000081) /* MotionTable */
     , (201,   3, 0x20000015) /* SoundTable */
     , (201,   4, 0x30000008) /* CombatTable */
     , (201,   8, 0x06001224) /* Icon */
     , (201,  22, 0x3400005F) /* PhysicsEffectTable */
...
VALUES (201,  6, 0, 3, 0, 215, 0, 0) /* MeleeDefense        Specialized */
     , (201,  7, 0, 3, 0, 320, 0, 0) /* MissileDefense      Specialized */
     , (201, 14, 0, 2, 0, 200, 0, 0) /* ArcaneLore          Trained */
     , (201, 15, 0, 3, 0, 157, 0, 0) /* MagicDefense        Specialized */
     , (201, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (201, 22, 0, 2, 0,  10, 0, 0) /* Jump                Trained */
     , (201, 24, 0, 2, 0,  10, 0, 0) /* Run                 Trained */
     , (201, 31, 0, 3, 0, 110, 0, 0) /* CreatureEnchantment Specialized */
     , (201, 33, 0, 3, 0, 110, 0, 0) /* LifeMagic           Specialized */
     , (201, 34, 0, 3, 0, 110, 0, 0) /* WarMagic            Specialized */
     , (201, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (201,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (201,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
