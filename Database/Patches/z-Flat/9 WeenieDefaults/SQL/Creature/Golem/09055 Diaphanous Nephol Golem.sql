...
VALUES (9055, 'golemnepholmed_nostone', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (9055,   1,       5) /* HeartbeatInterval */
     ...
     , (9055,   3,     0.6) /* HealthRate */
     , (9055,   4,     0.5) /* StaminaRate */
     , (9055,   5,       2) /* ManaRate */
     , (9055,  13,    0.72) /* ArmorModVsSlash */
     , (9055,  14,    0.72) /* ArmorModVsPierce */
     , (9055,  15,    0.72) /* ArmorModVsBludgeon */
     , (9055,  16,     0.5) /* ArmorModVsCold */
     , (9055,  17,    0.84) /* ArmorModVsFire */
     , (9055,  18,    0.74) /* ArmorModVsAcid */
     , (9055,  19,    0.63) /* ArmorModVsElectric */
     , (9055,  31,      25) /* VisualAwarenessRange */
     , (9055,  34,     2.3) /* PowerupTime */
     , (9055,  64,     0.1) /* ResistSlash */
     , (9055,  65,     0.1) /* ResistPierce */
     , (9055,  66,     0.1) /* ResistBludgeon */
     , (9055,  67,     0.5) /* ResistFire */
     , (9055,  68,       1) /* ResistCold */
     , (9055,  69,     0.8) /* ResistAcid */
     , (9055,  70,    0.85) /* ResistElectric */
...
VALUES (9055,   1, 0x020008A2) /* Setup */
     , (9055,   2, 0x09000081) /* MotionTable */
     , (9055,   3, 0x2000009A) /* SoundTable */
     , (9055,   4, 0x30000008) /* CombatTable */
     , (9055,   8, 0x06001224) /* Icon */
     , (9055,  22, 0x3400005A) /* PhysicsEffectTable */;
...
VALUES (9055,  6, 0, 3, 0, 150, 0, 0) /* MeleeDefense        Specialized */
     , (9055,  7, 0, 3, 0, 150, 0, 0) /* MissileDefense      Specialized */
     , (9055, 14, 0, 3, 0, 200, 0, 0) /* ArcaneLore          Specialized */
     , (9055, 15, 0, 3, 0, 197, 0, 0) /* MagicDefense        Specialized */
     , (9055, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (9055, 22, 0, 3, 0,  10, 0, 0) /* Jump                Specialized */
     , (9055, 24, 0, 3, 0,  10, 0, 0) /* Run                 Specialized */
     , (9055, 31, 0, 3, 0, 220, 0, 0) /* CreatureEnchantment Specialized */
     , (9055, 33, 0, 3, 0, 220, 0, 0) /* LifeMagic           Specialized */
     , (9055, 34, 0, 3, 0, 240, 0, 0) /* WarMagic            Specialized */
     , (9055, 45, 0, 3, 0, 100, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (9055,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9055,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
