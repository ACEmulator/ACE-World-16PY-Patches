...
VALUES (9052, 'golemnephollow', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (9052,   1,       5) /* HeartbeatInterval */
     ...
     , (9052,   3,    0.35) /* HealthRate */
     , (9052,   4,       5) /* StaminaRate */
     , (9052,   5,       2) /* ManaRate */
     , (9052,  13,    0.72) /* ArmorModVsSlash */
     , (9052,  14,    0.72) /* ArmorModVsPierce */
     , (9052,  15,    0.72) /* ArmorModVsBludgeon */
     , (9052,  16,     0.5) /* ArmorModVsCold */
     , (9052,  17,    0.84) /* ArmorModVsFire */
     , (9052,  18,    0.74) /* ArmorModVsAcid */
     , (9052,  19,    0.63) /* ArmorModVsElectric */
     , (9052,  31,      13) /* VisualAwarenessRange */
     , (9052,  34,     2.3) /* PowerupTime */
     , (9052,  64,     0.1) /* ResistSlash */
     , (9052,  65,     0.1) /* ResistPierce */
     , (9052,  66,     0.1) /* ResistBludgeon */
     , (9052,  67,     0.5) /* ResistFire */
     , (9052,  68,       1) /* ResistCold */
     , (9052,  69,     0.8) /* ResistAcid */
     , (9052,  70,    0.85) /* ResistElectric */
...
VALUES (9052,  6, 0, 3, 0,  50, 0, 0) /* MeleeDefense        Specialized */
     , (9052,  7, 0, 3, 0,  40, 0, 0) /* MissileDefense      Specialized */
     , (9052, 14, 0, 3, 0, 190, 0, 0) /* ArcaneLore          Specialized */
     , (9052, 15, 0, 3, 0, 115, 0, 0) /* MagicDefense        Specialized */
     , (9052, 20, 0, 3, 0,  80, 0, 0) /* Deception           Specialized */
     , (9052, 22, 0, 3, 0,  10, 0, 0) /* Jump                Specialized */
     , (9052, 24, 0, 3, 0,  10, 0, 0) /* Run                 Specialized */
     , (9052, 31, 0, 3, 0, 120, 0, 0) /* CreatureEnchantment Specialized */
     , (9052, 33, 0, 3, 0, 120, 0, 0) /* LifeMagic           Specialized */
     , (9052, 34, 0, 3, 0, 200, 0, 0) /* WarMagic            Specialized */
     , (9052, 45, 0, 3, 0,  90, 0, 0) /* LightWeapons        Specialized */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9052,  5 /* HeartBeat */,      1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
