...
VALUES (52626,  6, 0, 2, 0, 530, 0, 0) /* MeleeDefense        Trained */
     , (52626,  7, 0, 2, 0, 550, 0, 0) /* MissileDefense      Trained */
     , (52626, 15, 0, 2, 0, 360, 0, 0) /* MagicDefense        Trained */
...
VALUES (52626,  0,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52626,  1,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52626,  2,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (52626,  3,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52626,  4,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (52626,  5,  4, 700, 0.75,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (52626,  6,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (52626,  7,  4,  0,    0,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (52626,  8,  4, 700, 0.75,  430,  383,  383,  383,  389,  363,  320, 22000,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (52626,  4312,   2.08)  /* Incantation of Imperil Other */
     , (52626,  4477,  2.087)  /* Incantation of Bludgeoning Vulnerability Other */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (52626, 14 /* Taunt */,    0.1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
