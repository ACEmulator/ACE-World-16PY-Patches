...
VALUES (1669,   1,       5) /* HeartbeatInterval */
     ...
     , (1669,   3,    0.35) /* HealthRate */
     , (1669,   4,       5) /* StaminaRate */
     , (1669,   5,       2) /* ManaRate */
     , (1669,  12,     0.5) /* Shade */
     , (1669,  13,    0.53) /* ArmorModVsSlash */
     , (1669,  14,    0.42) /* ArmorModVsPierce */
     , (1669,  15,    0.67) /* ArmorModVsBludgeon */
     , (1669,  16,    0.53) /* ArmorModVsCold */
     , (1669,  17,     0.7) /* ArmorModVsFire */
     , (1669,  18,    0.42) /* ArmorModVsAcid */
     , (1669,  19,     0.6) /* ArmorModVsElectric */
     , (1669,  31,      22) /* VisualAwarenessRange */
     , (1669,  34,       1) /* PowerupTime */
     , (1669,  36,       1) /* ChargeSpeed */
     , (1669,  39,     1.3) /* DefaultScale */
     , (1669,  64,    0.76) /* ResistSlash */
     , (1669,  65,    0.65) /* ResistPierce */
     , (1669,  66,     0.5) /* ResistBludgeon */
     , (1669,  67,       1) /* ResistFire */
     , (1669,  68,    0.76) /* ResistCold */
     , (1669,  69,    0.65) /* ResistAcid */
...
VALUES (1669,   1, 0x02000E08) /* Setup */
     , (1669,   2, 0x09000007) /* MotionTable */
     , (1669,   3, 0x20000005) /* SoundTable */
     , (1669,   4, 0x30000002) /* CombatTable */
     , (1669,   6, 0x04001425) /* PaletteBase */
     , (1669,   7, 0x10000411) /* ClothingBase */
...
VALUES (1669,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1669,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
