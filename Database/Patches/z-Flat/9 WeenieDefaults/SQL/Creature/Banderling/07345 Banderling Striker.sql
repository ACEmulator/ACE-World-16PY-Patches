...
VALUES (7345, 'banderlingstriker', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (7345,   1,       5) /* HeartbeatInterval */
     ...
     , (7345,   3,     0.4) /* HealthRate */
     , (7345,   4,       5) /* StaminaRate */
     , (7345,   5,       2) /* ManaRate */
     , (7345,  12,     0.5) /* Shade */
     , (7345,  13,    0.46) /* ArmorModVsSlash */
     , (7345,  14,    0.31) /* ArmorModVsPierce */
     , (7345,  15,    0.52) /* ArmorModVsBludgeon */
     , (7345,  16,    0.46) /* ArmorModVsCold */
     , (7345,  17,    0.83) /* ArmorModVsFire */
     , (7345,  18,    0.31) /* ArmorModVsAcid */
     , (7345,  19,    1.09) /* ArmorModVsElectric */
     , (7345,  31,      22) /* VisualAwarenessRange */
     , (7345,  34,       1) /* PowerupTime */
     , (7345,  36,       1) /* ChargeSpeed */
     , (7345,  39,    1.25) /* DefaultScale */
     , (7345,  64,    0.76) /* ResistSlash */
     , (7345,  65,    0.65) /* ResistPierce */
     , (7345,  66,     0.5) /* ResistBludgeon */
     , (7345,  67,    1.08) /* ResistFire */
     , (7345,  68,    0.76) /* ResistCold */
     , (7345,  69,    0.65) /* ResistAcid */
     , (7345,  70,    1.32) /* ResistElectric */
...
VALUES (7345,  6, 0, 3, 0, 162, 0, 0) /* MeleeDefense        Specialized */
     , (7345,  7, 0, 3, 0, 260, 0, 0) /* MissileDefense      Specialized */
     , (7345, 14, 0, 2, 0, 150, 0, 0) /* ArcaneLore          Trained */
     , (7345, 15, 0, 3, 0, 105, 0, 0) /* MagicDefense        Specialized */
     , (7345, 20, 0, 2, 0,  40, 0, 0) /* Deception           Trained */
     , (7345, 22, 0, 2, 0,  40, 0, 0) /* Jump                Trained */
     , (7345, 24, 0, 2, 0,  40, 0, 0) /* Run                 Trained */
     , (7345, 31, 0, 3, 0,   5, 0, 0) /* CreatureEnchantment Specialized */
     , (7345, 33, 0, 3, 0,   5, 0, 0) /* LifeMagic           Specialized */
     , (7345, 34, 0, 3, 0,   5, 0, 0) /* WarMagic            Specialized */
     , (7345, 45, 0, 3, 0,  90, 0, 0) /* LightWeapons        Specialized */
     , (7345, 47, 0, 3, 0,  85, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7345,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7345,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (7345, 9,  3693,  0, 0, 0.05, False) /* Create Banderling Scalp (3693) for ContainTreasure */
     , (7345, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     ...
     , (7345, 9, 15762,  0, 0, 0.02, False) /* Create Ruined Amulet of Missile Weapons (15762) for ContainTreasure */
