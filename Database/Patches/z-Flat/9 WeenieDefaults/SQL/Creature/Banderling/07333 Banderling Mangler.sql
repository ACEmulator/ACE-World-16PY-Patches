...
VALUES (7333, 'banderlingmangler', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (7333,   1,         16) /* ItemType - Creature */
     ...
     , (7333,  25,        100) /* Level */
     , (7333,  27,          0) /* ArmorType - None */
     , (7333,  40,          2) /* CombatMode - Melee */
     , (7333,  68,          3) /* TargetingTactic - Random, Focused */
     ...
     , (7333, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (7333,   1, 0x02000E08) /* Setup */
     , (7333,   2, 0x09000007) /* MotionTable */
     , (7333,   3, 0x20000005) /* SoundTable */
     , (7333,   4, 0x30000002) /* CombatTable */
     , (7333,   6, 0x04001425) /* PaletteBase */
     , (7333,   7, 0x10000412) /* ClothingBase */
     , (7333,   8, 0x0600103D) /* Icon */
     , (7333,  22, 0x34000017) /* PhysicsEffectTable */
...
VALUES (7333,  6, 0, 3, 0, 175, 0, 0) /* MeleeDefense        Specialized */
     , (7333,  7, 0, 3, 0, 290, 0, 0) /* MissileDefense      Specialized */
     , (7333, 14, 0, 2, 0, 200, 0, 0) /* ArcaneLore          Trained */
     , (7333, 15, 0, 3, 0, 225, 0, 0) /* MagicDefense        Specialized */
     , (7333, 20, 0, 2, 0, 150, 0, 0) /* Deception           Trained */
     , (7333, 22, 0, 3, 0,  40, 0, 0) /* Jump                Specialized */
     , (7333, 24, 0, 3, 0,  40, 0, 0) /* Run                 Specialized */
     , (7333, 31, 0, 3, 0, 120, 0, 0) /* CreatureEnchantment Specialized */
     , (7333, 33, 0, 3, 0, 120, 0, 0) /* LifeMagic           Specialized */
     , (7333, 34, 0, 3, 0, 120, 0, 0) /* WarMagic            Specialized */
     , (7333, 44, 0, 3, 0, 160, 0, 0) /* HeavyWeapons        Specialized */
     , (7333, 45, 0, 3, 0, 160, 0, 0) /* LightWeapons        Specialized */
     , (7333, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7333,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7333,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
