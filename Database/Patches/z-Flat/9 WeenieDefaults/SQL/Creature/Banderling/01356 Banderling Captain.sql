...
VALUES (1356, 'alfrethbanderlingcaptain', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (1356,   1,         16) /* ItemType - Creature */
     ...
     , (1356,  25,         15) /* Level */
     , (1356,  27,          0) /* ArmorType - None */
     , (1356,  40,          2) /* CombatMode - Melee */
     , (1356,  68,          3) /* TargetingTactic - Random, Focused */
...
VALUES (1356,   1,       5) /* HeartbeatInterval */
     ...
     , (1356,   3,     0.2) /* HealthRate */
     , (1356,   4,       5) /* StaminaRate */
     , (1356,   5,       2) /* ManaRate */
     , (1356,  12,     0.5) /* Shade */
     , (1356,  13,     0.5) /* ArmorModVsSlash */
     , (1356,  14,    0.38) /* ArmorModVsPierce */
     , (1356,  15,    0.61) /* ArmorModVsBludgeon */
     , (1356,  16,     0.5) /* ArmorModVsCold */
     , (1356,  17,     0.7) /* ArmorModVsFire */
     , (1356,  18,    0.38) /* ArmorModVsAcid */
     , (1356,  19,     0.6) /* ArmorModVsElectric */
     , (1356,  31,      30) /* VisualAwarenessRange */
     , (1356,  34,     2.2) /* PowerupTime */
     , (1356,  36,       1) /* ChargeSpeed */
     , (1356,  39,     1.7) /* DefaultScale */
     , (1356,  64,    0.76) /* ResistSlash */
     , (1356,  65,    0.65) /* ResistPierce */
     , (1356,  66,     0.5) /* ResistBludgeon */
     , (1356,  67,       1) /* ResistFire */
     , (1356,  68,    0.76) /* ResistCold */
     , (1356,  69,    0.65) /* ResistAcid */
...
VALUES (1356,   1, 0x02000E08) /* Setup */
     ...
     , (1356,   4, 0x30000002) /* CombatTable */
     , (1356,   6, 0x04001425) /* PaletteBase */
     , (1356,   7, 0x10000412) /* ClothingBase */
...
VALUES (1356,  6, 0, 2, 0,  50, 0, 0) /* MeleeDefense        Trained */
     , (1356,  7, 0, 2, 0,  60, 0, 0) /* MissileDefense      Trained */
     , (1356, 14, 0, 2, 0,  50, 0, 0) /* ArcaneLore          Trained */
     , (1356, 15, 0, 2, 0,  40, 0, 0) /* MagicDefense        Trained */
     , (1356, 20, 0, 2, 0,  40, 0, 0) /* Deception           Trained */
     , (1356, 22, 0, 3, 0,  80, 0, 0) /* Jump                Specialized */
     , (1356, 24, 0, 2, 0,  60, 0, 0) /* Run                 Trained */
     , (1356, 31, 0, 2, 0,  50, 0, 0) /* CreatureEnchantment Trained */
     , (1356, 33, 0, 2, 0,  50, 0, 0) /* LifeMagic           Trained */
     , (1356, 34, 0, 2, 0,  50, 0, 0) /* WarMagic            Trained */
     , (1356, 44, 0, 2, 0,  60, 0, 0) /* HeavyWeapons        Trained */
     , (1356, 45, 0, 2, 0,  60, 0, 0) /* LightWeapons        Trained */
     , (1356, 47, 0, 2, 0,  20, 0, 0) /* MissileWeapons      Trained */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,   0.19, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,    0.2, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1356,  5 /* HeartBeat */,    0.1, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1356, 8,  1358,  0, 0, 1, False) /* Create Worn Key (1358) for Treasure */;
