...
VALUES (7330, 'banderlingbasher', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (7330,   1,       5) /* HeartbeatInterval */
     ...
     , (7330,   3,     0.4) /* HealthRate */
     , (7330,   4,       5) /* StaminaRate */
     , (7330,   5,       2) /* ManaRate */
     , (7330,  12,     0.5) /* Shade */
     , (7330,  13,    0.46) /* ArmorModVsSlash */
     , (7330,  14,    0.31) /* ArmorModVsPierce */
     , (7330,  15,    0.52) /* ArmorModVsBludgeon */
     , (7330,  16,    0.46) /* ArmorModVsCold */
     , (7330,  17,    0.83) /* ArmorModVsFire */
     , (7330,  18,    0.31) /* ArmorModVsAcid */
     , (7330,  19,    1.09) /* ArmorModVsElectric */
     , (7330,  31,      22) /* VisualAwarenessRange */
     , (7330,  34,       1) /* PowerupTime */
     , (7330,  36,       1) /* ChargeSpeed */
     , (7330,  39,     1.3) /* DefaultScale */
     , (7330,  64,    0.76) /* ResistSlash */
     , (7330,  65,    0.65) /* ResistPierce */
     , (7330,  66,     0.5) /* ResistBludgeon */
     , (7330,  67,    1.08) /* ResistFire */
     , (7330,  68,    0.76) /* ResistCold */
     , (7330,  69,    0.65) /* ResistAcid */
     , (7330,  70,    1.32) /* ResistElectric */
...
VALUES (7330,   1, 0x02000E08) /* Setup */
     , (7330,   2, 0x09000007) /* MotionTable */
     , (7330,   3, 0x20000005) /* SoundTable */
     , (7330,   4, 0x30000002) /* CombatTable */
     , (7330,   6, 0x04001425) /* PaletteBase */
     , (7330,   7, 0x10000410) /* ClothingBase */
     , (7330,   8, 0x0600103D) /* Icon */
     , (7330,  22, 0x34000017) /* PhysicsEffectTable */
...
VALUES (7330,  6, 0, 3, 0, 140, 0, 0) /* MeleeDefense        Specialized */
     , (7330,  7, 0, 3, 0, 260, 0, 0) /* MissileDefense      Specialized */
     , (7330, 14, 0, 2, 0, 150, 0, 0) /* ArcaneLore          Trained */
     , (7330, 15, 0, 3, 0, 170, 0, 0) /* MagicDefense        Specialized */
     , (7330, 20, 0, 2, 0,  40, 0, 0) /* Deception           Trained */
     , (7330, 22, 0, 2, 0,  40, 0, 0) /* Jump                Trained */
     , (7330, 24, 0, 2, 0,  40, 0, 0) /* Run                 Trained */
     , (7330, 31, 0, 3, 0, 150, 0, 0) /* CreatureEnchantment Specialized */
     , (7330, 33, 0, 3, 0, 150, 0, 0) /* LifeMagic           Specialized */
     , (7330, 34, 0, 3, 0, 150, 0, 0) /* WarMagic            Specialized */
     , (7330, 45, 0, 3, 0,  90, 0, 0) /* LightWeapons        Specialized */
     , (7330, 47, 0, 3, 0,  85, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (7330,  3 /* Death */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,   0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7330,  9 /* Generation */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
