...
VALUES (8272, 'scarecrowsuspicious', 10, '2005-02-09 10:00:00') /* Creature */;
...
VALUES (8272,   1,   33556868) /* Setup */
     , (8272,   2,  150995101) /* MotionTable */
     , (8272,   3,  536871014) /* SoundTable */
     , (8272,   4,  805306412) /* CombatTable */
     , (8272,   6,   67112967) /* PaletteBase */
     , (8272,   7,  268436084) /* ClothingBase */
     , (8272,   8,  100671141) /* Icon */
     , (8272,  22,  872415368) /* PhysicsEffectTable */
...
VALUES (8272,  6, 0, 3, 0,  34, 0, 578.279734316694) /* MeleeDefense        Specialized */
     , (8272,  7, 0, 3, 0,  34, 0, 578.279734316694) /* MissileDefense      Specialized */
     , (8272, 13, 0, 3, 0,  35, 0, 578.279734316694) /* UnarmedCombat       Specialized */
     , (8272, 14, 0, 3, 0,  60, 0, 578.279734316694) /* ArcaneLore          Specialized */
     , (8272, 15, 0, 3, 0,  34, 0, 578.279734316694) /* MagicDefense        Specialized */
     , (8272, 20, 0, 3, 0,  30, 0, 578.279734316694) /* Deception           Specialized */
     , (8272, 24, 0, 3, 0,  90, 0, 578.279734316694) /* Run                 Specialized */
     , (8272, 31, 0, 3, 0,  22, 0, 578.279734316694) /* CreatureEnchantment Specialized */
     , (8272, 33, 0, 3, 0,  22, 0, 578.279734316694) /* LifeMagic           Specialized */
     , (8272, 34, 0, 3, 0,  22, 0, 578.279734316694) /* WarMagic            Specialized */;
...
VALUES (8272,  0,  4,  0,    0,   45,   30,    5,    5,    5,   32,    5,   30,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (8272,  3,  4,  0,    0,   45,   30,    5,    5,    5,   32,    5,   30,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (8272,  4,  4,  0,    0,   45,   30,    5,    5,    5,   32,    5,   30,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (8272,  5,  4,  7, 0.75,   45,   30,    5,    5,    5,   32,    5,   30,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (8272,  6,  4,  0,    0,   45,   30,    5,    5,    5,   32,    5,   30,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (8272,  7,  4,  0,    0,   45,   30,    5,    5,    5,   32,    5,   30,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
...
VALUES (8272,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8272,  5 /* HeartBeat */,      1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
