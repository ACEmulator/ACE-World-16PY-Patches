...
VALUES (1616, 'gromnieswamp', 10, '2019-09-13 00:00:00') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1616,   1,         16) /* ItemType - Creature */
     , (1616,   2,         15) /* CreatureType - Gromnie */
     , (1616,   3,         17) /* PaletteTemplate - Yellow */
...
VALUES (1616,   1, 0x02000037) /* Setup */
     ...
     , (1616,   4, 0x30000012) /* CombatTable */
     , (1616,   6, 0x040001BB) /* PaletteBase */
     , (1616,   7, 0x100000AF) /* ClothingBase */
     , (1616,   8, 0x06001222) /* Icon */
     , (1616,  19, 0x00000056) /* ActivationAnimation */
...
VALUES (1616,  6, 0, 3, 0,  64, 0, 0) /* MeleeDefense        Specialized */
     , (1616,  7, 0, 3, 0,  70, 0, 0) /* MissileDefense      Specialized */
     , (1616, 15, 0, 3, 0,  34, 0, 0) /* MagicDefense        Specialized */
     , (1616, 20, 0, 3, 0,  30, 0, 0) /* Deception           Specialized */
     , (1616, 22, 0, 3, 0,  35, 0, 0) /* Jump                Specialized */
     , (1616, 24, 0, 3, 0,  35, 0, 0) /* Run                 Specialized */
     , (1616, 45, 0, 3, 0,  80, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (1616,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1616,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1616,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1616,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
