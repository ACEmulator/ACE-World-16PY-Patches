...
VALUES (5687, 'reedsharkalfrega', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (5687,   1,       5) /* HeartbeatInterval */
     ...
     , (5687,   3,   0.067) /* HealthRate */
     , (5687,   4,       5) /* StaminaRate */
     , (5687,   5,       2) /* ManaRate */
     , (5687,  13,    0.42) /* ArmorModVsSlash */
     , (5687,  14,    0.49) /* ArmorModVsPierce */
     , (5687,  15,     0.7) /* ArmorModVsBludgeon */
     , (5687,  16,    0.37) /* ArmorModVsCold */
     , (5687,  17,     0.7) /* ArmorModVsFire */
     , (5687,  18,     0.6) /* ArmorModVsAcid */
     , (5687,  19,    0.49) /* ArmorModVsElectric */
     , (5687,  31,      24) /* VisualAwarenessRange */
     , (5687,  34,       1) /* PowerupTime */
     , (5687,  36,       1) /* ChargeSpeed */
     , (5687,  39,     1.4) /* DefaultScale */
     , (5687,  64,     0.6) /* ResistSlash */
     , (5687,  65,    0.75) /* ResistPierce */
     , (5687,  66,       1) /* ResistBludgeon */
     , (5687,  67,       1) /* ResistFire */
     , (5687,  68,    0.66) /* ResistCold */
...
VALUES (5687,  6, 0, 2, 0,  30, 0, 436.304138183594) /* MeleeDefense        Trained */
     ...
     , (5687, 45, 0, 2, 0,  35, 0, 436.304138183594) /* LightWeapons        Trained */;
...
VALUES (5687,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,  0.075, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,  0.125, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,   0.15, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,  0.075, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,  0.125, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5687,  5 /* HeartBeat */,   0.15, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
