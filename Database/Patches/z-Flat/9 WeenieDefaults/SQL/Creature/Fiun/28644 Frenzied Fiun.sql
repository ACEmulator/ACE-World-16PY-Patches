...
VALUES (28644, 'fiunfrenzied', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (28644,  6, 0, 3, 0, 240, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (28644, 45, 0, 3, 0, 315, 0, 0) /* LightWeapons        Specialized */;
...
VALUES (28644,  0,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28644,  1,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28644,  2,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28644,  3,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28644,  4,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28644,  5,  4, 35,  0.4,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28644,  6,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28644,  7,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28644,  8,  4, 35,  0.4,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
