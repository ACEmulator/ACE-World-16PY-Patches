...
VALUES (51356, 'ace51356-experimentalbloodstonefragment', 10, '2020-10-15 00:00:00') /* Creature */;
...
VALUES (51356,  6, 0, 3, 0, 360, 0, 0) /* MeleeDefense        Specialized */
     , (51356,  7, 0, 3, 0, 367, 0, 0) /* MissileDefense      Specialized */
     , (51356, 15, 0, 3, 0, 395, 0, 0) /* MagicDefense        Specialized */
     , (51356, 20, 0, 3, 0, 420, 0, 0) /* Deception           Specialized */
     , (51356, 33, 0, 3, 0, 460, 0, 0) /* LifeMagic           Specialized */
     , (51356, 34, 0, 3, 0, 395, 0, 0) /* WarMagic            Specialized */
     , (51356, 41, 0, 3, 0, 445, 0, 0) /* TwoHandedCombat     Specialized */
     , (51356, 44, 0, 3, 0, 445, 0, 0) /* HeavyWeapons        Specialized */
     , (51356, 45, 0, 3, 0, 445, 0, 0) /* LightWeapons        Specialized */
     , (51356, 46, 0, 3, 0, 445, 0, 0) /* FinesseWeapons      Specialized */
     , (51356, 47, 0, 3, 0, 445, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51356,  0,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51356,  1,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51356,  2,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51356,  3,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51356,  4,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51356,  5,  4, 400, 0.75,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51356,  6,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51356,  7,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51356,  8,  4, 400, 0.75,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51356,  2136,    2.1)  /* Icy Torment */
     , (51356,  2138,    2.1)  /* Blizzard */
     , (51356,  6193,    2.1)  /* Halo of Frost II */;
