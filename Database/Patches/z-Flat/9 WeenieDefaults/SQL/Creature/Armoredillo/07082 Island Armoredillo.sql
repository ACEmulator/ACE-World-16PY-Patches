...
VALUES (7082,   1,         16) /* ItemType - Creature */
     ...
     , (7082,   3,          5) /* PaletteTemplate - DarkBlue */
...
VALUES (7082,   1,       5) /* HeartbeatInterval */
     ...
     , (7082,   3,     0.3) /* HealthRate */
     , (7082,   4,     0.4) /* StaminaRate */
     , (7082,   5,       2) /* ManaRate */
     , (7082,  12,     0.5) /* Shade */
     , (7082,  13,    0.49) /* ArmorModVsSlash */
     , (7082,  14,     0.7) /* ArmorModVsPierce */
     , (7082,  15,    0.54) /* ArmorModVsBludgeon */
     , (7082,  16,    0.59) /* ArmorModVsCold */
     , (7082,  17,     0.6) /* ArmorModVsFire */
     , (7082,  18,    0.59) /* ArmorModVsAcid */
     , (7082,  19,     0.6) /* ArmorModVsElectric */
     , (7082,  31,      22) /* VisualAwarenessRange */
     , (7082,  34,       1) /* PowerupTime */
     , (7082,  36,       1) /* ChargeSpeed */
     , (7082,  39,     1.2) /* DefaultScale */
     , (7082,  64,    0.53) /* ResistSlash */
     , (7082,  65,       1) /* ResistPierce */
     , (7082,  66,     0.5) /* ResistBludgeon */
     , (7082,  67,     0.5) /* ResistFire */
     , (7082,  68,     0.5) /* ResistCold */
     , (7082,  69,     0.4) /* ResistAcid */
     , (7082,  70,     0.7) /* ResistElectric */
...
VALUES (7082,  5 /* HeartBeat */,   0.05, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7082,  5 /* HeartBeat */,    0.1, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7082,  5 /* HeartBeat */,   0.05, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7082,  5 /* HeartBeat */,    0.1, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
