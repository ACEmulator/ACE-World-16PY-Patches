...
VALUES (9253, 'monougawily', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (9253,   1,       5) /* HeartbeatInterval */
     ...
     , (9253,   5,       2) /* ManaRate */
     , (9253,  12,     0.5) /* Shade */
     , (9253,  13,     0.3) /* ArmorModVsSlash */
     , (9253,  14,    0.74) /* ArmorModVsPierce */
     , (9253,  15,    0.04) /* ArmorModVsBludgeon */
     , (9253,  16,     0.6) /* ArmorModVsCold */
     , (9253,  17,    0.04) /* ArmorModVsFire */
     , (9253,  18,    0.36) /* ArmorModVsAcid */
     , (9253,  19,    0.07) /* ArmorModVsElectric */
     , (9253,  31,      21) /* VisualAwarenessRange */
     , (9253,  34,     0.6) /* PowerupTime */
     , (9253,  36,       1) /* ChargeSpeed */
     , (9253,  39,     1.8) /* DefaultScale */
     , (9253,  64,     0.6) /* ResistSlash */
     , (9253,  65,     0.9) /* ResistPierce */
     , (9253,  66,    0.45) /* ResistBludgeon */
     , (9253,  67,    0.45) /* ResistFire */
     , (9253,  68,       1) /* ResistCold */
     , (9253,  69,    0.75) /* ResistAcid */
     , (9253,  70,    0.55) /* ResistElectric */
...
VALUES (9253,  6, 0, 3, 0, 190, 0, 0) /* MeleeDefense        Specialized */
     , (9253,  7, 0, 3, 0, 300, 0, 0) /* MissileDefense      Specialized */
     , (9253, 15, 0, 3, 0, 134, 0, 0) /* MagicDefense        Specialized */
     , (9253, 20, 0, 2, 0,  80, 0, 0) /* Deception           Trained */
     , (9253, 22, 0, 2, 0,  40, 0, 0) /* Jump                Trained */
     , (9253, 24, 0, 2, 0,  60, 0, 0) /* Run                 Trained */
     , (9253, 31, 0, 3, 0,  65, 0, 0) /* CreatureEnchantment Specialized */
     , (9253, 33, 0, 3, 0,  65, 0, 0) /* LifeMagic           Specialized */
     , (9253, 44, 0, 3, 0, 160, 0, 0) /* HeavyWeapons        Specialized */
     , (9253, 45, 0, 3, 0, 160, 0, 0) /* LightWeapons        Specialized */
     , (9253, 47, 0, 3, 0, 100, 0, 0) /* MissileWeapons      Specialized */;
...
VALUES (9253,  5 /* HeartBeat */,  0.045, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9253,  5 /* HeartBeat */,  0.095, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9253,  5 /* HeartBeat */,  0.045, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (9253,  5 /* HeartBeat */,  0.095, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
