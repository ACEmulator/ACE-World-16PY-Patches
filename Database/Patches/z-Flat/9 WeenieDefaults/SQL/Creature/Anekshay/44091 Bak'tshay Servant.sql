...
VALUES (44091,   1, 0x02001AA4) /* Setup */
     ...
     , (44091,   4, 0x30000000) /* CombatTable */
     , (44091,   6, 0x0400007E) /* PaletteBase */
     , (44091,   7, 0x100007D0) /* ClothingBase */
     , (44091,   8, 0x06001B42) /* Icon */
     , (44091,  22, 0x34000025) /* PhysicsEffectTable */
     , (44091,  32,       3001) /* WieldedTreasureType - 
...
VALUES (44091,  6, 0, 2, 0, 425, 0, 0) /* MeleeDefense        Trained */
     ...
     , (44091, 15, 0, 2, 0, 350, 0, 0) /* MagicDefense        Trained */
     , (44091, 24, 0, 2, 0, 200, 0, 0) /* Run                 Trained */
     , (44091, 33, 0, 2, 0, 350, 0, 0) /* LifeMagic           Trained */
     , (44091, 34, 0, 2, 0, 350, 0, 0) /* WarMagic            Trained */
     , (44091, 45, 0, 3, 0, 460, 0, 0) /* LightWeapons        Specialized */
     , (44091, 46, 0, 3, 0, 460, 0, 0) /* FinesseWeapons      Specialized */
     , (44091, 48, 0, 2, 0, 200, 0, 0) /* Shield              Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (44091,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44091,  1,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44091,  2,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44091,  3,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44091,  4,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44091,  5,  4, 300, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44091,  6,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44091,  7,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44091,  8,  4, 300, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (44091,  1785,   2.06)  /* Cassius' Ring of Fire */
     , (44091,  1841,   2.06)  /* Slithering Flames */
     , (44091,  2053,   2.06)  /* Executor's Blessing */
     , (44091,  2074,   2.06)  /* Gossamer Flesh */
     , (44091,  2128,   2.06)  /* Ilservian's Flame */
     , (44091,  2155,   2.06)  /* Icy Blessing */
...
VALUES (44091, 9, 48908,  1, 0, 0.03, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (44091, 9, 44121,  1, 0, 0.2, False) /* Create Sandstone Armor Key (44121) for ContainTreasure */
     , (44091, 9, 44122,  1, 0, 0.2, False) /* Create Sandstone Magic Key (44122) for ContainTreasure */
     , (44091, 9, 44123,  1, 0, 0.2, False) /* Create Sandstone Mixed Key (44123) for ContainTreasure */
     , (44091, 9, 44124,  1, 0, 0.2, False) /* Create Sandstone Weapon Key (44124) for ContainTreasure */
     , (44091, 9,     0,  0, 0, 0.2, False) /* Create nothing for ContainTreasure */;
