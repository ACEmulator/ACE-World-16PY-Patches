...
VALUES (2768, 'scrollacidlure3', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2768,   1,       8192) /* ItemType - Writable */
     , (2768,   5,         30) /* EncumbranceVal */
     , (2768,   8,         90) /* Mass */
     , (2768,   9,          0) /* ValidLocations - None */
...
VALUES (2768,   1, 'Scroll of Acid Lure III') /* Name */
     , (2768,  15, 'A magic scroll.') /* ShortDesc */
     , (2768,  16, 'When learned, this spell decreases a shield or piece of armor''s resistance to acid damage by 50%.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2768,   1,   33554826) /* Setup */
     , (2768,   8,  100676663) /* Icon */
     , (2768,  22,  872415275) /* PhysicsEffectTable */
     , (2768,  28,       1501) /* Spell - Acid Lure III */;
