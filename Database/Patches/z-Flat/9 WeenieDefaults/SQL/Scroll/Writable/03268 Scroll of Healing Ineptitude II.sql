...
VALUES (3268, 'scrollhealingineptitude2', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (3268,   1,       8192) /* ItemType - Writable */
     , (3268,   5,         30) /* EncumbranceVal */
     , (3268,   8,         90) /* Mass */
     , (3268,   9,          0) /* ValidLocations - None */
...
VALUES (3268,   1, 'Scroll of Healing Ineptitude II') /* Name */
     , (3268,  15, 'A magic scroll.') /* ShortDesc */
     , (3268,  16, 'When learned, this spell decreases the target''s Healing skill by 20%.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (3268,   1,   33554826) /* Setup */
     , (3268,   8,  100676459) /* Icon */
     , (3268,  22,  872415275) /* PhysicsEffectTable */
     , (3268,  28,        893) /* Spell - Healing Ineptitude Other II */;
