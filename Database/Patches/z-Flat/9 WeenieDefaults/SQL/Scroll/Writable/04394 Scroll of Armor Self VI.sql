...
VALUES (4394, 'scrollarmorself6', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4394,   1,       8192) /* ItemType - Writable */
     , (4394,   5,         30) /* EncumbranceVal */
     , (4394,   8,         90) /* Mass */
     , (4394,   9,          0) /* ValidLocations - None */
...
VALUES (4394,   1, 'Scroll of Armor Self VI') /* Name */
     , (4394,  15, 'A magic scroll.') /* ShortDesc */
     , (4394,  16, 'When learned, this spell increases the caster''s natural armor by 200 points.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4394,   1,   33554826) /* Setup */
     , (4394,   8,  100676928) /* Icon */
     , (4394,  22,  872415275) /* PhysicsEffectTable */
     , (4394,  28,       1312) /* Spell - Armor Self VI */;
