...
VALUES (20470, 'scrollbladevulnerabilityother7', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (20470,   1,       8192) /* ItemType - Writable */
     , (20470,   5,         30) /* EncumbranceVal */
     , (20470,   8,         90) /* Mass */
     , (20470,   9,          0) /* ValidLocations - None */
...
VALUES (20470,   1, 'Scroll of Swordsman''s Gift') /* Name */
     , (20470,  15, 'When learned, this spell increases damage the target takes from Slashing by 185%.') /* ShortDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (20470,   1,   33554826) /* Setup */
     , (20470,   8,  100676954) /* Icon */
     , (20470,  22,  872415275) /* PhysicsEffectTable */
     , (20470,  28,       2164) /* Spell - Swordsman's Gift */;
