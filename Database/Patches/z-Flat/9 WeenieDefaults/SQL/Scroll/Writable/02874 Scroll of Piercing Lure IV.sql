...
VALUES (2874, 'scrollpiercinglure4', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2874,   1,       8192) /* ItemType - Writable */
     , (2874,   5,         30) /* EncumbranceVal */
     , (2874,   8,         90) /* Mass */
     , (2874,   9,          0) /* ValidLocations - None */
...
VALUES (2874,   1, 'Scroll of Piercing Lure IV') /* Name */
     , (2874,  15, 'A magic scroll.') /* ShortDesc */
     , (2874,  16, 'When learned, this spell decreases a shield or piece of armor''s resistance to piercing damage by 75%.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2874,   1,   33554826) /* Setup */
     , (2874,   8,  100676669) /* Icon */
     , (2874,  22,  872415275) /* PhysicsEffectTable */
     , (2874,  28,       1566) /* Spell - Piercing Lure IV */;
