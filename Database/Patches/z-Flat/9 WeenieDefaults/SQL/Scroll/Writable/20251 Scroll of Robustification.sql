...
VALUES (20251, 'scrollrevitalizeself7', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (20251,   1,       8192) /* ItemType - Writable */
     , (20251,   5,         30) /* EncumbranceVal */
     , (20251,   8,         90) /* Mass */
     , (20251,   9,          0) /* ValidLocations - None */
...
VALUES (20251,   1, 'Scroll of Robustification') /* Name */
     , (20251,  15, 'When learned, this spell restores 100-175 points of the caster''s Stamina.') /* ShortDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (20251,   1,   33554826) /* Setup */
     , (20251,   8,  100676930) /* Icon */
     , (20251,  22,  872415275) /* PhysicsEffectTable */
     , (20251,  28,       2083) /* Spell - Robustification */;
