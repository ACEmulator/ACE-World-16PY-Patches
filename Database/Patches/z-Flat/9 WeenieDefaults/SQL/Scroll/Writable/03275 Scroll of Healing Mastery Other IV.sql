...
VALUES (3275,   1, 'Scroll of Healing Mastery Other IV') /* Name */
     , (3275,  15, 'A magic scroll.') /* ShortDesc */
     , (3275,  16, 'When learned, this spell increases the target''s Healing skill by 75%.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (3275,   1,   33554826) /* Setup */
     , (3275,   8,  100676459) /* Icon */
     , (3275,  22,  872415275) /* PhysicsEffectTable */
     , (3275,  28,        883) /* Spell - Healing Mastery Other IV */;
