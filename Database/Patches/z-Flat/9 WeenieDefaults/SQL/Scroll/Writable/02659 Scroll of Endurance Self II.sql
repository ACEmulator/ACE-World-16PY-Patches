...
VALUES (2659, 'scrollenduranceself2', 34, '2005-02-09 10:00:00') /* Scroll */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2659,   1,       8192) /* ItemType - Writable */
     , (2659,   5,         30) /* EncumbranceVal */
     , (2659,   8,         90) /* Mass */
     , (2659,   9,          0) /* ValidLocations - None */
...
VALUES (2659,   1, 'Scroll of Endurance Self II') /* Name */
     , (2659,  15, 'A magic scroll.') /* ShortDesc */
     , (2659,  16, 'When learned, this spell increases the caster''s Endurance by 20 points.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2659,   1,   33554826) /* Setup */
     , (2659,   8,  100676456) /* Icon */
     , (2659,  22,  872415275) /* PhysicsEffectTable */
     , (2659,  28,       1350) /* Spell - Endurance Self II */;
