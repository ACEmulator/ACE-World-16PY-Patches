...
VALUES (87028, 'ace-87028ThorstenGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87028,   1,   33555051) /* Setup */
     , (87028,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87028, -1, 36797, 1, 1, 1, 1, 4, 0, 0, 0, 3583639609, 173.503, 1.05272, 373.8, 0.707107, 0, 0, -0.707107) /* Generate Thorsten Cragstone (36797) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
