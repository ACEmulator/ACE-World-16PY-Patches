...
VALUES (87158, 'ace-87158-MFKerthumptheEarTakerGenerator', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87158,   1,   33555051) /* Setup */
     , (87158,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87158, -1, 38953, 1, 1, 1, 1, 4, 0, 0, 0, 869924901, 108, 101, 60.0049, 1, 0, 0, 0) /* Generate Kerthump the Ear Taker (38953) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
