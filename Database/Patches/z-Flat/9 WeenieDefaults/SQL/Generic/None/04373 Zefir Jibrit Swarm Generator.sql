...
VALUES (4373, 'zefirjibritswarmgen', 1, '2005-02-09 10:00:00') /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4373,  81,          3) /* MaxGeneratedObjects */
     , (4373,  82,          3) /* InitGeneratedObjects */
     , (4373,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;
...
VALUES (4373, 0.1, 5779, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 1, 1, 0, 0.953717, 0, 0, -0.300706) /* Generate Strange Stick (5779) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4373, 0.6, 2608, 2400, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, 2.4, 0, 0.92388, 0, 0, -0.382683) /* Generate Jibrit Zefir (2608) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
