...
VALUES (4356, 0.2, 2581, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 1, 5, 0, 0.92388, 0, 0, -0.382683) /* Generate Snowy Mattekar (2581) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4356, 0.8, 2580, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 0, -5, 0, -0.0871558, 0, 0, -0.996195) /* Generate White Mattekar (2580) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
