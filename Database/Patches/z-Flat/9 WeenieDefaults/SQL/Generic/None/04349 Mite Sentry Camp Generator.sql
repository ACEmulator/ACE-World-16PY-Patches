...
VALUES (4349, 0.2, 945, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 6, 0, 0, 0.887011, 0, 0, -0.461749) /* Generate Mite Sentry (945) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     ...
     , (4349, 0.95, 209, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, -1.2, 0, 0.92388, 0, 0, -0.382683) /* Generate Mite Squib (209) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (4349, 1, 6118, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 0, 0, 0, 0.999048, 0, 0, -0.0436194) /* Generate Pile of Short Sticks (6118) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
