...
VALUES (44503,   1,       2048) /* ItemType - Gem */
     ...
     , (44503, 349,         88) /* UseCreatesContractId - Contract_88_Soc__Phyntos_Queen */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44503,  22, True ) /* Inscribable */
     , (44503,  69, False) /* IsSellable */;
...
VALUES (44503,   1, 'Contract for Phyntos Queen') /* Name */
     , (44503,  14, 'Recommended Level: 180') /* Use */
     , (44503,  16, 'Kill the Phyntos Queen and collect her abdomen.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (44503,   1,   33557625) /* Setup */
     , (44503,   3,  536870932) /* SoundTable */
     , (44503,   8,  100691930) /* Icon */
     , (44503,  22,  872415275) /* PhysicsEffectTable */;
