DELETE FROM `weenie` WHERE `class_Id` = 14379;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (14379, 'portaljumpshaft8x2', 7, '2005-02-09 10:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (14379,   1,      65536) /* ItemType - Portal */
     , (14379,  16,         32) /* ItemUseable - Remote */
     , (14379,  93,       3084) /* PhysicsState - Ethereal, ReportCollisions, Gravity, LightingOn */
     , (14379, 111,         49) /* PortalBitmask - Unrestricted, NoSummon, NoRecall */
