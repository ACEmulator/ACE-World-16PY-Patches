...
VALUES (9004, 'portaldesertmarchexit', 7, '2019-02-04 06:52:23') /* Portal */;
...
VALUES (9004,  54,    -0.1) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (9004,   1, 'Surface Portal') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (9004,   1, 0x020001B3) /* Setup */
     , (9004,   2, 0x09000003) /* MotionTable */
     , (9004,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (9004, 2, 0x7A870024, 106.4, 79.3, 16.5, -0.594823, 0, 0, -0.803857) /* Destination */
/* @teleloc 0x7A870024 [106.400002 79.300003 16.500000] -0.594823 0.000000 0.000000 -0.803857 */;
