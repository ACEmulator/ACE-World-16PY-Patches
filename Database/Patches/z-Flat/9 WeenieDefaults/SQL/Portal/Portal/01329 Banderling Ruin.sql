...
VALUES (1329,  54,    -0.1) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (1329,   1, 'Banderling Ruin') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (1329,   1, 0x020001B3) /* Setup */
     , (1329,   2, 0x09000003) /* MotionTable */
     , (1329,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (1329, 2, 0x01E00121, 13.0085, -27.0157, 6.005, -0, 0, 0, -1) /* Destination */
/* @teleloc 0x01E00121 [13.008500 -27.015699 6.005000] -0.000000 0.000000 0.000000 -1.000000 */;
