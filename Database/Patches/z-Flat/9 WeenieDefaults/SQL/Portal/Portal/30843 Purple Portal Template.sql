DELETE FROM `weenie` WHERE `class_Id` = 30843;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (30843, 'portalshadowlugianstrongholdexit', 7, '2005-02-09 10:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (30843,   1,      65536) /* ItemType - Portal */
     , (30843,  16,         32) /* ItemUseable - Remote */
     , (30843,  93,       3084) /* PhysicsState - Ethereal, ReportCollisions, Gravity, LightingOn */
...
VALUES (30843, 2, 27787606, 40, -10, 0, 0.00420624, 0, 0, -0.999991) /* Destination */
