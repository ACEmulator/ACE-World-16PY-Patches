DELETE FROM `weenie` WHERE `class_Id` = 7526;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (7526, 'portalpkarenanpk', 7, '2005-02-09 10:00:00') /* Portal */;
...
VALUES (7526, 2, 2926641179, 73, 55, 20, -0.866025, 0, 0, -0.5) /* Destination */
