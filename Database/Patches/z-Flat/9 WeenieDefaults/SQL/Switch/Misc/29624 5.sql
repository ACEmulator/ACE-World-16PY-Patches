...
VALUES (29624, 'lever-number05-toj', 26, '2005-02-09 10:00:00') /* Switch */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29624,   1,        128) /* ItemType - Misc */
     , (29624,  16,         48) /* ItemUseable - ViewedRemote */
     , (29624,  83,       2048) /* ActivationResponse - Emote */
     , (29624,  93,         20) /* PhysicsState - Ethereal, IgnoreCollisions */
     , (29624, 119,          1) /* Active */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (29624,   1, True ) /* Stuck */
     , (29624,  14, False) /* GravityStatus */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29624,  54,       2) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (29624,   1, '5') /* Name */
