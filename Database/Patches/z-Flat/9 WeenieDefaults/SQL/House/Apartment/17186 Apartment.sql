DELETE FROM `weenie` WHERE `class_Id` = 17186;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (17186, 'houseapartment4314', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (17186,   1,   33557058) /* Setup */
     ...
     , (17186,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
