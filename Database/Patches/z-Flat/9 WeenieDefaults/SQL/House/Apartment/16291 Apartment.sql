DELETE FROM `weenie` WHERE `class_Id` = 16291;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16291, 'houseapartment3251', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16291,   1,   33557058) /* Setup */
     ...
     , (16291,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
