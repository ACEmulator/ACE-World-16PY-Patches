DELETE FROM `weenie` WHERE `class_Id` = 17616;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (17616, 'houseapartment4744', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (17616,   1,   33557058) /* Setup */
     ...
     , (17616,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
