DELETE FROM `weenie` WHERE `class_Id` = 18410;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (18410, 'houseapartment5537', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (18410,   1,   33557058) /* Setup */
     ...
     , (18410,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
