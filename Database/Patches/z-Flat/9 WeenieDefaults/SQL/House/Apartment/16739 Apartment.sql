DELETE FROM `weenie` WHERE `class_Id` = 16739;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16739, 'houseapartment3699', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16739,   1,   33557058) /* Setup */
     ...
     , (16739,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
