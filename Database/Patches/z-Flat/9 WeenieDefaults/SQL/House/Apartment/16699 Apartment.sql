DELETE FROM `weenie` WHERE `class_Id` = 16699;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16699, 'houseapartment3659', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16699,   1,   33557058) /* Setup */
     ...
     , (16699,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
