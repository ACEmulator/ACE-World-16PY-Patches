DELETE FROM `weenie` WHERE `class_Id` = 16721;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16721, 'houseapartment3681', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16721,   1,   33557058) /* Setup */
     ...
     , (16721,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
