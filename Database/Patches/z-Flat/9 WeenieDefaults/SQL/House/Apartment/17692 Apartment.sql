DELETE FROM `weenie` WHERE `class_Id` = 17692;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (17692, 'houseapartment4820', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (17692,   1,   33557058) /* Setup */
     ...
     , (17692,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
