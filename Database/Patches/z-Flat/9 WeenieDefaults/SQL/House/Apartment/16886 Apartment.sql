DELETE FROM `weenie` WHERE `class_Id` = 16886;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16886, 'houseapartment3846', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16886,   1,        128) /* ItemType - Misc */
     ...
     , (16886,  19,          0) /* Value */
     , (16886,  93,         52) /* PhysicsState - Ethereal, IgnoreCollisions, NoDraw */
...
VALUES (16886,   1,   33557058) /* Setup */
     ...
     , (16886,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
