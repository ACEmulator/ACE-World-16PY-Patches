DELETE FROM `weenie` WHERE `class_Id` = 16682;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16682, 'houseapartment3642', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16682,   1,   33557058) /* Setup */
     ...
     , (16682,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
