DELETE FROM `weenie` WHERE `class_Id` = 17608;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (17608, 'houseapartment4736', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (17608,   1,   33557058) /* Setup */
     ...
     , (17608,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
