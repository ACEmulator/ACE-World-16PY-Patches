DELETE FROM `weenie` WHERE `class_Id` = 16565;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16565, 'houseapartment3525', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16565,   1,   33557058) /* Setup */
     ...
     , (16565,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
