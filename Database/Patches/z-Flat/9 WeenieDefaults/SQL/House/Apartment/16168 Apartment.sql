DELETE FROM `weenie` WHERE `class_Id` = 16168;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16168, 'houseapartment3128', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16168,   1,        128) /* ItemType - Misc */
     ...
     , (16168,  19,          0) /* Value */
     , (16168,  93,         52) /* PhysicsState - Ethereal, IgnoreCollisions, NoDraw */
...
VALUES (16168,   1,   33557058) /* Setup */
     ...
     , (16168,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
