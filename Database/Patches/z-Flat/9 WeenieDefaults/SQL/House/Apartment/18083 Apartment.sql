DELETE FROM `weenie` WHERE `class_Id` = 18083;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (18083, 'houseapartment5211', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (18083,   1,   33557058) /* Setup */
     ...
     , (18083,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
