DELETE FROM `weenie` WHERE `class_Id` = 16264;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16264, 'houseapartment3224', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16264,   1,        128) /* ItemType - Misc */
     ...
     , (16264,  19,          0) /* Value */
     , (16264,  93,         52) /* PhysicsState - Ethereal, IgnoreCollisions, NoDraw */
...
VALUES (16264,   1,   33557058) /* Setup */
     ...
     , (16264,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
