DELETE FROM `weenie` WHERE `class_Id` = 16158;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16158, 'houseapartment3118', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16158,   1,   33557058) /* Setup */
     ...
     , (16158,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
