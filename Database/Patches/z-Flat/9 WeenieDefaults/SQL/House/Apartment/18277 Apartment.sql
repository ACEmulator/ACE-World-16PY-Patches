DELETE FROM `weenie` WHERE `class_Id` = 18277;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (18277, 'houseapartment5404', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (18277,   1,   33557058) /* Setup */
     ...
     , (18277,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
