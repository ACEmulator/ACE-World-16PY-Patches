DELETE FROM `weenie` WHERE `class_Id` = 16023;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16023, 'houseapartment2983', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16023,   1,   33557058) /* Setup */
     ...
     , (16023,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
