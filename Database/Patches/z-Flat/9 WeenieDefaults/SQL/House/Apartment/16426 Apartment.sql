DELETE FROM `weenie` WHERE `class_Id` = 16426;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (16426, 'houseapartment3386', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (16426,   1,   33557058) /* Setup */
     ...
     , (16426,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
