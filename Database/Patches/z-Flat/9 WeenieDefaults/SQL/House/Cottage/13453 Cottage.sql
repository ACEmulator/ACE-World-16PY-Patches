DELETE FROM `weenie` WHERE `class_Id` = 13453;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (13453, 'housecottage1661', 53, '2005-02-09 10:00:00') /* House */;
...
VALUES (13453,   1,        128) /* ItemType - Misc */
     ...
     , (13453,  19,          0) /* Value */
     , (13453,  93,         52) /* PhysicsState - Ethereal, IgnoreCollisions, NoDraw */
...
VALUES (13453,   1,   33557058) /* Setup */
     ...
     , (13453,  44,        152) /* RestrictionEffect - RestrictionEffectBlue */;
