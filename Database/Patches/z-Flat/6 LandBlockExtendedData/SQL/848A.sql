...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7848A009,  9251, 0x848A0119, 159.166, 131.832, 300.005, -0.678248, 0, 0, -0.734833,  True, '2005-02-09 10:00:00'); /* Brutish Monouga */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7848A00D,  9251, 0x848A0000, 161.413, 121.686, 300.005, 0.433081, 0, 0, 0.901355,  True, '2005-02-09 10:00:00'); /* Brutish Monouga */
/* @teleloc 0x848A0000 [161.412994 121.685997 300.005005] 0.433081 0.000000 0.000000 0.901355 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7848A00E,  9251, 0x848A0000, 150.574, 121.502, 300.005, 0.125998, 0, 0, -0.992031,  True, '2005-02-09 10:00:00'); /* Brutish Monouga */
/* @teleloc 0x848A0000 [150.574005 121.501999 300.005005] 0.125998 0.000000 0.000000 -0.992031 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7848A00F,  1762, 0x848A0000, 149.24, 138.493, 300.005, 0.926725, 0, 0, 0.37574,  True, '2005-02-09 10:00:00'); /* Skeleton Lord */
/* @teleloc 0x848A0000 [149.240005 138.492996 300.005005] 0.926725 0.000000 0.000000 0.375740 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7848A010,  8673, 0x848A0000, 160.808, 139.639, 300.008, 0.99106, 0, 0, -0.133414,  True, '2005-02-09 10:00:00'); /* Risen Knight */
