...
VALUES (0x7A8AC000,  2082, 0xA8AC0000, 36.0269, 16.3946, 84.005, 1, 0, 0, 0, False, '2005-02-09 10:00:00'); /* Hunter's Leap */
/* @teleloc 0xA8AC0000 [36.026901 16.394600 84.004997] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A8AC007,  1625, 0xA8AC0102, 60.5426, 48.9019, 75.667, 0.822468, 0, 0, -0.568811,  True, '2005-02-09 10:00:00'); /* Mountain Rat */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A8AC009,  1625, 0xA8AC0102, 61.5363, 54.3989, 75.667, 0.491545, 0, 0, 0.870852,  True, '2005-02-09 10:00:00'); /* Mountain Rat */
/* @teleloc 0xA8AC0102 [61.536301 54.398899 75.667000] 0.491545 0.000000 0.000000 0.870852 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A8AC00A,  7923, 0xA8AC0102, 54.8578, 41.388, 75.66, 1, 0, 0, 0, False, '2005-02-09 10:00:00'); /* Linkable Monster Generator ( 3 Min.) */
