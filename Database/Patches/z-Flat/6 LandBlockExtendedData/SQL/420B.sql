...
VALUES (0x7420B001,  1154, 0x420B000F, 40.4589, 162.463, 0.928493, 0.510482, 0, 0, -0.859888, False, '2021-10-03 02:50:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7420B002, 38259, 0x420B002F, 132, 156, 2.94674, -0.577523, 0, 0, -0.816375,  True, '2021-10-03 02:50:00'); /* Shrine of the Skull of Mishfain */
