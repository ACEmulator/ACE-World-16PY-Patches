...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78B6800B,  1922, 0x8B680102, 9.12793, 96.256, 4.805, -0.796952, 0, 0, -0.604042, False, '2005-02-09 10:00:00'); /* Chest */
/* @teleloc 0x8B680102 [9.127930 96.255997 4.805000] -0.796952 0.000000 0.000000 -0.604042 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78B6800C,   204, 0x8B680103, 14.563, 85.284, 10.056, -0.182356, 0, 0, -0.983233,  True, '2005-02-09 10:00:00'); /* Lich */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78B6800E,   204, 0x8B680103, 11.2522, 82.3632, 10.0203, -0.190358, 0, 0, 0.981715,  True, '2005-02-09 10:00:00'); /* Lich */
/* @teleloc 0x8B680103 [11.252200 82.363197 10.020300] -0.190358 0.000000 0.000000 0.981715 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78B6800F,  7923, 0x8B680103, 14.0914, 83.2593, 10.031, -0.190358, 0, 0, 0.981715, False, '2005-02-09 10:00:00'); /* Linkable Monster Generator ( 3 Min.) */
