...
VALUES (8701, 0, 265, 138, 3, 'The target is already imbued with the magics of the Paragon!') /* Target.EquipmentSetId - ParagonMissile GreaterThanEqual 138 */
     , (8701, 0, 265, 0, 8, 'The target cannot be imbued with the magics of the Paragon!') /* Target.EquipmentSetId - Invalid Exist 0 */;

INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8701, True, 0, 0, 0, False, 956301312, 0, 0);
