...
VALUES (@parent_id, 0,   7, 268436741, 1, 1) /* On Source.SuccessTarget SetValue ClothingBase to Target */;
...
INSERT INTO `recipe_mods_d_i_d` (`recipe_Mod_Id`, `index`, `stat`, `value`, `enum`, `source`)
VALUES (@parent_id, 4,   7, 268436741, 1, 1) /* On Source.FailureTarget SetValue ClothingBase to Target */;
