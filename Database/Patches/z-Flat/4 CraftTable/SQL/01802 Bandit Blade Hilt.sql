DELETE FROM `recipe` WHERE `id` = 1802;
...
VALUES (1802, 0, 171, 0, 4, 'You can''t hilt a weapon that has been tinkered.') /* Target.NumTimesTinkered NotEqual 0 */
     , (1802, 0,  47, 32, 3, 'This weapon has already been hilted!') /* Target.AttackType - DoubleSlash GreaterThanEqual 32 */;
...
VALUES (@parent_id, 0,   1, 'Acid Bandit Dagger', 1, 1) /* On Source.SuccessTarget SetValue Name to Target */;

DELETE FROM `cook_book` WHERE `recipe_Id` = 1802;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (1802, 8899 /* Bandit Blade Hilt */,  3778 /* Acid Dagger */, '2005-02-09 10:00:00');
