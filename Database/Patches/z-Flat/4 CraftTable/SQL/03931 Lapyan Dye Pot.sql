DELETE FROM `recipe` WHERE `id` = 3931;
...
VALUES (@parent_id, 0,  50, 100673653, 1, 1) /* On Source.SuccessTarget SetValue IconOverlay to Target */
...
DELETE FROM `cook_book` WHERE `recipe_Id` = 3931;
