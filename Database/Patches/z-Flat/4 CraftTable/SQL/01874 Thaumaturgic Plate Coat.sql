...
DELETE FROM `cook_book` WHERE `recipe_Id` = 1874;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (1874, 9078 /* Silver Kindling Stone */,  9094 /* Unkindled Thaumaturgic Plate Coat */, '2005-02-09 10:00:00');
