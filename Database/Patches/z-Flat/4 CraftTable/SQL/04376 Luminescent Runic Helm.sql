...
VALUES (4376, True, 0, 0, 0, False, 0, 0, 0);
...
DELETE FROM `cook_book` WHERE `recipe_Id` = 4376;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (4376, 23977 /* Infused Helm of Knorr */, 23959 /* Forge of Knorr */, '2005-02-09 10:00:00');
