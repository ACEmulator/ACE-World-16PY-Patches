...
VALUES (6815, 0, 0, 0, 0, 0, 1, 'You attach the Fetish of the Dark Idols to the Slingshot.', 0, 1, '', 1, 1, '', 0, 0, '', 1, 1, '', 0, 0, '', 0, '2019-04-10 06:55:37');

INSERT INTO `recipe_requirements_int` (`recipe_Id`, `stat`, `value`, `enum`, `message`)
VALUES (6815, 179, 536870912, 3, 'This weapon has already been empowered with the Fetish of the Dark Idols!') /* ImbuedEffect - IgnoreSomeMagicProjectileDamage */;
...
VALUES (@parent_id,   1, 'Dark Acid Slingshot', 1, 1) /* Name */;

DELETE FROM `cook_book` WHERE `recipe_Id` = 6815;

INSERT INTO `cook_book` (`recipe_Id`, `source_W_C_I_D`, `target_W_C_I_D`, `last_Modified`)
VALUES (6815, 27795 /* Fetish of the Dark Idols */, 31813 /* Acid Slingshot */, '2019-04-10 06:55:37');
