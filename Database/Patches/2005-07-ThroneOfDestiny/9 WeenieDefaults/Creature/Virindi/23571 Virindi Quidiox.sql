...
VALUES (23571, 'virindiquidiox', 10, '2020-05-09 15:09:43') /* Creature */;
...
VALUES (23571,   1,       5) /* HeartbeatInterval */
     ...
     , (23571,   3, 0.6000000238418579) /* HealthRate */
     ...
     , (23571,  16, 0.7200000286102295) /* ArmorModVsCold */
     , (23571,  17,       1) /* ArmorModVsFire */
     , (23571,  18,       1) /* ArmorModVsAcid */
     , (23571,  19, 0.7200000286102295) /* ArmorModVsElectric */
...
VALUES (23571,  6, 0, 3, 0, 300, 0, 1458.2816162109375) /* MeleeDefense        Specialized */
     , (23571,  7, 0, 3, 0, 420, 0, 1458.2816162109375) /* MissileDefense      Specialized */
     , (23571, 13, 0, 3, 0, 300, 0, 1458.2816162109375) /* UnarmedCombat       Specialized */
     , (23571, 14, 0, 3, 0, 300, 0, 1458.2816162109375) /* ArcaneLore          Specialized */
     , (23571, 15, 0, 3, 0, 295, 0, 1458.2816162109375) /* MagicDefense        Specialized */
     , (23571, 20, 0, 3, 0, 250, 0, 1458.2816162109375) /* Deception           Specialized */
     , (23571, 24, 0, 3, 0,  90, 0, 1458.2816162109375) /* Run                 Specialized */
     , (23571, 31, 0, 3, 0, 210, 0, 1458.2816162109375) /* CreatureEnchantment Specialized */
     , (23571, 33, 0, 3, 0, 210, 0, 1458.2816162109375) /* LifeMagic           Specialized */
     , (23571, 34, 0, 3, 0, 210, 0, 1458.2816162109375) /* WarMagic            Specialized */;
...
VALUES (23571, 9,  9292,  0, 0, 0.06, False) /* Create Virindi Singularity Key (9292) for ContainTreasure */
     ...
     , (23571, 9,  3696,  0, 0, 0.0125, False) /* Create Blue Gem (3696) for ContainTreasure */
     , (23571, 9,  3697,  0, 0, 0.0125, False) /* Create Red Jewel (3697) for ContainTreasure */
     , (23571, 9, 41470,  0, 0, 0.0125, False) /* Create  (41470) for ContainTreasure */
     , (23571, 9,     0,  0, 0, 0.9375, False) /* Create nothing for ContainTreasure */;

/* Lifestoned Changelog:
{
  "LastModified": "2020-05-09T14:56:30.9141289+00:00",
  "ModifiedBy": "Relyc",
  "Changelog": [
    {
    ...
    },
    {
      "created": "0001-01-01T00:00:00",
      "author": "Zarto",
      "comment": "Removed 7604 with prob 0.0500000007450581 and accompanying EMPTY entry (0) with prob 0.949999988079071\r\n    Added Yellow Jewel(7604) with prob 0.0125\r\n    Added White Jewel (3698) with prob 0.0125\r\n    Added Blue Jewel (3696) with prob 0.0125\r\n    Added Red Jewel (3697) with prob 0.0125\r\n    Added Purple Jewel (41470) with prob 0.0125\r\n    Added EMPTY(0) with prob 0.9375\r\n"
    }
  ],
  "UserChangeSummary": "Removed 7604 with prob 0.0500000007450581 and accompanying EMPTY entry (0) with prob 0.949999988079071\r\n    Added Yellow Jewel(7604) with prob 0.0125\r\n    Added White Jewel (3698) with prob 0.0125\r\n    Added Blue Jewel (3696) with prob 0.0125\r\n    Added Red Jewel (3697) with prob 0.0125\r\n    Added Purple Jewel (41470) with prob 0.0125\r\n    Added EMPTY(0) with prob 0.9375\r\n",
  "IsDone": true
}
*/
