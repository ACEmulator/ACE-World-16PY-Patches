...
VALUES (28643, 'fiunderanged', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (28643,   1,         16) /* ItemType - Creature */
     ...
     , (28643,  25,        100) /* Level */
     , (28643,  27,          0) /* ArmorType - None */
     , (28643,  40,          2) /* CombatMode - Melee */
     , (28643,  68,          9) /* TargetingTactic - Random, TopDamager */
     ...
     , (28643, 140,          1) /* AiOptions - CanOpenDoors */
...
VALUES (28643,   1,   33559202) /* Setup */
     ...
     , (28643,  35,        452) /* DeathTreasureType - Loot Tier: 5 */;
...
VALUES (28643,  6, 0, 3, 0, 340, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (28643, 45, 0, 3, 0, 315, 0, 0) /* LightWeapons        Specialized */
...
VALUES (28643,  0,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28643,  1,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28643,  2,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28643,  3,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28643,  4,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28643,  5,  4, 35,  0.4,  285,  330,  350,  350,  350,  270,  350,  280,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28643,  6,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28643,  7,  4,  0,    0,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28643,  8,  4, 35,  0.4,  285,  330,  350,  350,  350,  270,  350,  280,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
