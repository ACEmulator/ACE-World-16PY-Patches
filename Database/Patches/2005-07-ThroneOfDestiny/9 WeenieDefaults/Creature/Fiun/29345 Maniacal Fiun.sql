...
VALUES (29345, 'fiunmaniacal', 10, '2019-09-13 00:00:00') /* Creature */;
...
VALUES (29345,  6, 0, 3, 0, 225, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (29345, 45, 0, 3, 0, 210, 0, 0) /* LightWeapons        Specialized */
...
VALUES (29345,  0,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (29345,  1,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (29345,  2,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (29345,  3,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (29345,  4,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (29345,  5,  4, 45,  0.4,  300,  350,  360,  360,  360,  285,  360,  300,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (29345,  6,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (29345,  7,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (29345,  8,  4, 45,  0.4,  300,  350,  360,  360,  360,  280,  360,  300,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
