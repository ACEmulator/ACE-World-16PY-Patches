...
VALUES (29404, 'knightcaptainbalanchi1', 10, '2021-05-06 02:16:28') /* Creature */;
...
VALUES (29404,   1,       5) /* HeartbeatInterval */
     ...
     , (29404,   3,   0.072) /* HealthRate */
     , (29404,   4,       3) /* StaminaRate */
     , (29404,   5,       1) /* ManaRate */
     , (29404,  12,     0.5) /* Shade */
     , (29404,  13,     1.2) /* ArmorModVsSlash */
     , (29404,  14,     1.2) /* ArmorModVsPierce */
     , (29404,  15,       1) /* ArmorModVsBludgeon */
     , (29404,  16,       1) /* ArmorModVsCold */
     , (29404,  17,     0.8) /* ArmorModVsFire */
     , (29404,  18,       1) /* ArmorModVsAcid */
     , (29404,  19,     0.8) /* ArmorModVsElectric */
     , (29404,  31,      12) /* VisualAwarenessRange */
     , (29404,  34,       1) /* PowerupTime */
     , (29404,  36,       1) /* ChargeSpeed */
     , (29404,  39,     1.3) /* DefaultScale */
     , (29404,  64,     0.8) /* ResistSlash */
     , (29404,  65,     0.8) /* ResistPierce */
     , (29404,  66,     0.9) /* ResistBludgeon */
     , (29404,  67,     1.2) /* ResistFire */
     , (29404,  68,     0.9) /* ResistCold */
     , (29404,  69,     0.9) /* ResistAcid */
     , (29404,  70,     1.2) /* ResistElectric */
...
VALUES (29404,   1,   33559125) /* Setup */
     , (29404,   2,  150995334) /* MotionTable */
     , (29404,   3,  536871102) /* SoundTable */
...
VALUES (29404,  0,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (29404,  1,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (29404,  2,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (29404,  3,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (29404,  4,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (29404,  5,  4,153,  0.4,  558,  279,  279,  279,  279,  279,  279,  279,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (29404,  6,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (29404,  7,  4,  0,    0,  558,  279,  279,  279,  279,  279,  279,  279,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (29404,  8,  4,153,  0.4,  558,  279,  279,  279,  279,  279,  279,  279,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (29404,  6, 0, 3, 0, 358, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (29404, 45, 0, 3, 0, 385, 0, 0) /* LightWeapons        Specialized */
...
VALUES (29404, 5 /* HeartBeat */, 0.025, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29404, 5 /* HeartBeat */, 0.03, NULL, 0x8000003C /* HandCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29404, 5 /* HeartBeat */, 0.05, NULL, 0x8000003E /* SwordCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29404, 5 /* HeartBeat */, 0.025, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (29404, 5 /* HeartBeat */, 0.03, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
