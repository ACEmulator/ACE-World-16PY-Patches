...
VALUES (8270, 'hollowminionsotiris', 10, '2019-02-04 06:52:23') /* Creature */;
...
VALUES (8270,   1,       5) /* HeartbeatInterval */
     ...
     , (8270,   3, 0.699999988079071) /* HealthRate */
     , (8270,   4,     0.5) /* StaminaRate */
     , (8270,   5,       2) /* ManaRate */
     , (8270,  13, 0.759999990463257) /* ArmorModVsSlash */
     , (8270,  14, 0.759999990463257) /* ArmorModVsPierce */
     , (8270,  15, 0.680000007152557) /* ArmorModVsBludgeon */
     , (8270,  16, 0.839999973773956) /* ArmorModVsCold */
     , (8270,  17, 0.639999985694885) /* ArmorModVsFire */
     , (8270,  18, 0.759999990463257) /* ArmorModVsAcid */
     , (8270,  19, 0.639999985694885) /* ArmorModVsElectric */
     , (8270,  31,      12) /* VisualAwarenessRange */
     , (8270,  34,       1) /* PowerupTime */
     , (8270,  36,       1) /* ChargeSpeed */
     , (8270,  64,     0.5) /* ResistSlash */
     , (8270,  65,     0.5) /* ResistPierce */
     , (8270,  66, 0.330000013113022) /* ResistBludgeon */
     , (8270,  67,    0.25) /* ResistFire */
     , (8270,  68, 0.670000016689301) /* ResistCold */
...
VALUES (8270,  6, 0, 3, 0, 140, 0, 578.062683105469) /* MeleeDefense        Specialized */
     , (8270,  7, 0, 3, 0, 240, 0, 578.062683105469) /* MissileDefense      Specialized */
     , (8270, 13, 0, 3, 0, 105, 0, 578.062683105469) /* UnarmedCombat       Specialized */
     , (8270, 15, 0, 3, 0, 155, 0, 578.062683105469) /* MagicDefense        Specialized */
     , (8270, 20, 0, 3, 0, 150, 0, 578.062683105469) /* Deception           Specialized */
     , (8270, 24, 0, 3, 0, 150, 0, 578.062683105469) /* Run                 Specialized */;
...
VALUES (8270,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (8270,  5 /* HeartBeat */,      1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (8270, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
     ...
     , (8270, 9, 45875,  1, 0, 0.01, False) /* Create  (45875) for ContainTreasure */
     , (8270, 9, 45876,  1, 0, 0.03, False) /* Create  (45876) for ContainTreasure */;
