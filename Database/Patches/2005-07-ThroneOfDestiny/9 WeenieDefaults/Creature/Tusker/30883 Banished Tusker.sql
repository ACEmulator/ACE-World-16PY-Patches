...
VALUES (30883, 'tuskerbossmid0205', 10, '2019-02-04 06:52:23') /* Creature */;
...
VALUES (30883,   1,       5) /* HeartbeatInterval */
     ...
     , (30883,   3, 0.800000011920929) /* HealthRate */
     , (30883,   4,       4) /* StaminaRate */
     , (30883,   5,       2) /* ManaRate */
     , (30883,  13,     0.5) /* ArmorModVsSlash */
     , (30883,  14, 0.800000011920929) /* ArmorModVsPierce */
     , (30883,  15, 0.660000026226044) /* ArmorModVsBludgeon */
     , (30883,  16,       1) /* ArmorModVsCold */
     , (30883,  17, 0.699999988079071) /* ArmorModVsFire */
     , (30883,  18,       1) /* ArmorModVsAcid */
     , (30883,  19,       1) /* ArmorModVsElectric */
     , (30883,  31,      25) /* VisualAwarenessRange */
     , (30883,  34, 2.59999990463257) /* PowerupTime */
...
VALUES (30883,  6, 0, 3, 0, 230, 0, 2313.12353515625) /* MeleeDefense        Specialized */
     , (30883,  7, 0, 3, 0, 325, 0, 2313.12353515625) /* MissileDefense      Specialized */
     , (30883, 13, 0, 3, 0, 175, 0, 2313.12353515625) /* UnarmedCombat       Specialized */
     , (30883, 15, 0, 3, 0, 225, 0, 2313.12353515625) /* MagicDefense        Specialized */
     , (30883, 20, 0, 2, 0,  50, 0, 2313.12353515625) /* Deception           Trained */
     , (30883, 22, 0, 2, 0, 115, 0, 2313.12353515625) /* Jump                Trained */
     , (30883, 24, 0, 2, 0,  50, 0, 2313.12353515625) /* Run                 Trained */;
...
VALUES (30883,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,  0.125, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,   0.15, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,  0.125, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30883,  5 /* HeartBeat */,   0.15, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (30883, 9,     0,  0, 0, 0.95, False) /* Create nothing for ContainTreasure */
