DELETE FROM `spell` WHERE `id` = 2491;
...
VALUES (2491, 'Free Ride to the Holtburg West Outpost', 2780037171, 158.08, 66.886, 48.5, 0.8637739, 0, 0, -0.5038795, '2019-04-10 07:20:28');
