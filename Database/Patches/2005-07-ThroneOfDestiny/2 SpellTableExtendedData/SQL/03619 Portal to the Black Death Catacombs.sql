DELETE FROM `spell` WHERE `id` = 3619;
...
VALUES (3619, 'Portal to the Black Death Catacombs', 3637116948, 58.339, 92.125, 275.1, -0.9099612, 0, 0, -0.4146934, '2019-04-10 07:20:28');
