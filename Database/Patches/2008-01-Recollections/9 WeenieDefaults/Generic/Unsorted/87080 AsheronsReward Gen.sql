...
VALUES (87080, 'ace-87080AsheronsRewardGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87080,   1,   33555051) /* Setup */
     , (87080,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87080, -1, 36767, 1, 1, 1, 1, 4, 0, 0, 0, 14025876, 60, -53.798, 83.985, 1, 0, 0, 0) /* Generate Asheron (36767) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
