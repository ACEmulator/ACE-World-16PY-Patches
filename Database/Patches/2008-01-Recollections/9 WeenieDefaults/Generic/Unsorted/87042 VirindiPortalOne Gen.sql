...
VALUES (87042, 'ace-87042VirindiPortalOneGen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87042,   1,   33555051) /* Setup */
     , (87042,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87042, -1, 36759, 1, 1, 1, 1, 4, 0, 0, 0, 14025869, 52.7257, -23.6488, 85.25, 0.5, 0, 0, -0.866025) /* Generate Virindi Portal (36759) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
