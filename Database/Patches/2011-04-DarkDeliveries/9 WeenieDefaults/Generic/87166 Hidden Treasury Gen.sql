...
VALUES (87166,   1,   33555051) /* Setup */
     , (87166,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87166, -1, 87167, 1, 1, 1, 1, 4, 0, 0, 0, 1448214807, 80.0707, -104.14, -101.995, 0.999907, 0, 0, 0.013629) /* Generate Hidden Treasury (87167) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
