...
VALUES (72040, 'ace72040-tormentedwatcher', 10, '2020-10-21 21:40:19') /* Creature */;
...
VALUES (72040,   1,         16) /* ItemType - Creature */
     ...
     , (72040,  25,        220) /* Level */
     , (72040,  65,          1) /* Placement - RightHandCombat */
...
VALUES (72040,   1,       5) /* HeartbeatInterval */
     ...
     , (72040, 165,     1.0) /* ArmorModVsNether */
     , (72040, 166,     1.0) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (72040,   1, 'Tormented Watcher') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (72040,   1,   33556792) /* Setup */
     , (72040,   2,  150995101) /* MotionTable */
     , (72040,   3,  536871013) /* SoundTable */
     , (72040,   4,  805306413) /* CombatTable */
     , (72040,   6,   67112967) /* PaletteBase */
     , (72040,   7,  268436617) /* ClothingBase */
     , (72040,   8,  100671140) /* Icon */
     , (72040,  22,  872415367) /* PhysicsEffectTable */
     , (72040,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (72040,  0,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72040,  1,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72040,  2,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (72040,  3,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72040,  4,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
     , (72040,  5,  4, 40, 0.75,  290,  220,  220,  197,  244,  186,  220,  186,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72040, 17,  4,  0,    0,  290,  220,  220,  197,  244,  186,  220,  186,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail */;
