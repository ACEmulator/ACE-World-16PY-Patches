...
VALUES (51992, 'ace51992-curatoroftorment', 10, '2021-01-14 08:54:12') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51992,   1,         16) /* ItemType - Creature */
     , (51992,   2,         19) /* CreatureType - Virindi */
     , (51992,   3,         11) /* PaletteTemplate */
...
VALUES (51992,   1,   33561607) /* Setup */
     ...
     , (51992,   7,  268437423) /* ClothingBase */
     , (51992,   8,  100667943) /* Icon */
     , (51992,  22,  872415273) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51992,  0,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51992,  1,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51992,  2,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51992,  3,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51992,  4,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51992,  5,  1,220,  0.5,  550,  275,  275,  275,  275,  275,  275,  275,    0, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51992,  6,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51992,  7,  1,  0,    0,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51992,  8,  1,220,  0.5,  550,  275,  275,  275,  275,  275,  275,  275,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
     , (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
     , (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
     , (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
     , (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
     , (51992, 9, 52008,  0, 0,    1, False) /* Create (52008) for Contain */
