...
VALUES (8699, 0, 265, 138, 3, 'The target is already imbued with the magics of the Paragon!') /* Target.EquipmentSetId GreaterThanEqual 138 */
     , (8699, 0, 265, 0, 8, 'The target cannot be imbued with the magics of the Paragon!') /* Target.EquipmentSetId Exist 0 */;
