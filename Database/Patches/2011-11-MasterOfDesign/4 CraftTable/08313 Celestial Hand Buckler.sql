DELETE FROM `recipe` WHERE `id` = 8313;

INSERT INTO `recipe` (`id`, `unknown_1`, `skill`, `difficulty`, `salvage_Type`, `success_W_C_I_D`, `success_Amount`, `success_Message`, `fail_W_C_I_D`, `fail_Amount`, `fail_Message`, `success_Destroy_Source_Chance`, `success_Destroy_Source_Amount`, `success_Destroy_Source_Message`, `success_Destroy_Target_Chance`, `success_Destroy_Target_Amount`, `success_Destroy_Target_Message`, `fail_Destroy_Source_Chance`, `fail_Destroy_Source_Amount`, `fail_Destroy_Source_Message`, `fail_Destroy_Target_Chance`, `fail_Destroy_Target_Amount`, `fail_Destroy_Target_Message`, `data_Id`, `last_Modified`)
VALUES (8313, 0, 0, 0, 0, 0, 0, 'You tailor the heraldry of the Celestial Hand onto the shield.', 0, 0, 'You fail! Impossible.', 1, 1, NULL, 0, 0, NULL, 1, 1, NULL, 0, 0, NULL, 0, '2020-07-25 10:00:00');

INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8313, True, 0, 0, 0, True, 0, 0, 0);
...
VALUES (8313, 44588 /* Celestial Hand Buckler Cover */, 44 /* Buckler */, '2020-07-25 10:00:00')
     , (8313, 44588 /* Celestial Hand Buckler Cover */, 91 /* Kite Shield */, '2020-07-25 10:00:00')
     , (8313, 44588 /* Celestial Hand Buckler Cover */, 92 /* Large Kite Shield */, '2020-07-25 10:00:00')
     , (8313, 44588 /* Celestial Hand Buckler Cover */, 93 /* Round Shield */, '2020-07-25 10:00:00')
     , (8313, 44588 /* Celestial Hand Buckler Cover */, 94 /* Large Round Shield */, '2020-07-25 10:00:00')
     , (8313, 44588 /* Celestial Hand Buckler Cover */, 95 /* Tower Shield */, '2020-07-25 10:00:00');
