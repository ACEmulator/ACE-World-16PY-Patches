...
VALUES (31830,   1,       5) /* HeartbeatInterval */
     ...
     , (31830,  64,  0.4449) /* ResistSlash */
     , (31830,  65,  0.5559) /* ResistPierce */
     , (31830,  66,  0.5559) /* ResistBludgeon */
     , (31830,  67,       0) /* ResistFire */
     , (31830,  68,       1) /* ResistCold */
     , (31830,  69, 0.67777) /* ResistAcid */
     , (31830,  70, 0.66777) /* ResistElectric */
...
VALUES (31830,   1,   33559684) /* Setup */
     ...
     , (31830,   7,  268437043) /* ClothingBase */
...
VALUES (31830,  0, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31830,  1, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31830,  2, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31830,  3, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31830,  4, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31830,  5, 16, 45, 0.75,  390,  390,  390,  390,  290,  520,  390,  390,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31830,  6, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31830,  7, 16,  0,    0,  390,  390,  390,  390,  290,  520,  390,  390,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31830,  8, 16, 45, 0.75,  390,  390,  390,  390,  290,  520,  390,  390,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
