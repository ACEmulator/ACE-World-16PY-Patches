...
VALUES (33142,   1,  2860, 0, 0, 3000) /* MaxHealth */
     , (33142,   3,  3720, 0, 0, 4000) /* MaxStamina */
     , (33142,   5,  2800, 0, 0, 3000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (33142,  6, 0, 2, 0, 300, 0, 0) /* MeleeDefense        Trained */
     , (33142,  7, 0, 2, 0, 220, 0, 0) /* MissileDefense      Trained */
     , (33142, 15, 0, 2, 0, 206, 0, 0) /* MagicDefense        Trained */
     , (33142, 24, 0, 2, 0,  25, 0, 0) /* Run                 Trained */
     , (33142, 31, 0, 2, 0, 250, 0, 0) /* CreatureEnchantment Trained */
     , (33142, 33, 0, 2, 0, 250, 0, 0) /* LifeMagic           Trained */
     , (33142, 34, 0, 2, 0, 250, 0, 0) /* WarMagic            Trained */
     , (33142, 44, 0, 3, 0, 300, 0, 0) /* HeavyWeapons        Specialized */
     , (33142, 45, 0, 3, 0, 300, 0, 0) /* LightWeapons        Specialized */
     , (33142, 46, 0, 3, 0, 287, 0, 0) /* FinesseWeapons      Specialized */
     , (33142, 47, 0, 2, 0, 270, 0, 0) /* MissileWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (33142,  0,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (33142,  1,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (33142,  2,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (33142,  3,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (33142,  4,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (33142,  5,  4,  4, 0.75,  350,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (33142,  6,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (33142,  7,  4,  0,    0,  350,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (33142,  8,  4,  8, 0.75,  350,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
