...
VALUES (33145,   1, True ) /* Stuck */
     , (33145,  11, True ) /* IgnoreCollisions */
     , (33145,  12, True ) /* ReportCollisions */
     , (33145,  13, False) /* Ethereal */
     , (33145,  14, True ) /* GravityStatus */
     , (33145,  41, True ) /* ReportCollisionsAsEnvironment */
     , (33145,  42, True ) /* AllowEdgeSlide */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (33145,   1,       5) /* HeartbeatInterval */
     , (33145,   2,       0) /* HeartbeatTimestamp */
     , (33145,   3, 0.699999988079071) /* HealthRate */
     , (33145,   4,     2.5) /* StaminaRate */
     , (33145,   5,       1) /* ManaRate */
     , (33145,  12,       1) /* Shade */
     , (33145,  13,       1) /* ArmorModVsSlash */
     , (33145,  14, 0.800000011920929) /* ArmorModVsPierce */
     , (33145,  15, 0.8500000238418579) /* ArmorModVsBludgeon */
     , (33145,  16, 0.6000000238418579) /* ArmorModVsCold */
     , (33145,  17, 1.100000023841858) /* ArmorModVsFire */
     , (33145,  18, 0.699999988079071) /* ArmorModVsAcid */
     , (33145,  19,    0.75) /* ArmorModVsElectric */
     , (33145,  31,      28) /* VisualAwarenessRange */
     , (33145,  34, 1.100000023841858) /* PowerupTime */
     , (33145,  36,       1) /* ChargeSpeed */
     , (33145,  39,     1.1) /* DefaultScale */
     , (33145,  64,       1) /* ResistSlash */
     , (33145,  65,     0.5) /* ResistPierce */
     , (33145,  66, 0.699999988079071) /* ResistBludgeon */
     , (33145,  67,       1) /* ResistFire */
     , (33145,  68, 0.10000000149011612) /* ResistCold */
     , (33145,  69, 0.20000000298023224) /* ResistAcid */
...
VALUES (33145,  0,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (33145,  1,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (33145,  2,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (33145,  3,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (33145,  4,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (33145,  5,  4, 40, 0.75,  390,  305,  433,  431,  431,  273,  473,  392,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (33145,  6,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (33145,  7,  4,  0,    0,  390,  305,  433,  431,  431,  273,  473,  392,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (33145,  8,  4, 80, 0.75,  390,  305,  433,  431,  431,  273,  473,  392,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (33145, 2, 21159,  1, 93, 0, False) /* Create Covenant Tassets (21159) for Wield */
     ...
     , (33145, 2,  2597,  1, 92, 0, False) /* Create Pants (2597) for Wield */
     , (33145, 2,  2588,  1, 14, 0, False) /* Create Shirt (2588) for Wield */
