...
VALUES (33168,  6, 0, 3, 0, 335, 0, 0) /* MeleeDefense        Specialized */
     , (33168,  7, 0, 3, 0, 430, 0, 0) /* MissileDefense      Specialized */
...
VALUES (33168,  0,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (33168,  1,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (33168,  2,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (33168,  3,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (33168,  4,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (33168,  5,  4, 60, 0.75,  480,  480,  384,  408,  288,  528,  336,  480,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (33168,  6,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (33168,  7,  4,  0,    0,  480,  480,  384,  408,  288,  528,  336,  480,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (33168,  8,  4, 70, 0.75,  480,  480,  384,  408,  288,  528,  336,  480,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (33168, 2, 21159,  1, 93, 0, False) /* Create Covenant Tassets (21159) for Wield */
     ...
     , (33168, 2, 87038,  1, 93, 0, False) /* Create Helm of Isin Dule Mob (87038) for Wield */
     , (33168, 2,  2597,  1, 92, 0, False) /* Create Pants (2597) for Wield */
     , (33168, 2,  2588,  1, 14, 0, False) /* Create Shirt (2588) for Wield */;
