...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7302F1EF, 87062, 0x302F000B, 24.191177, 56.477283, 146.00499, -0.69286686, 0, 0, -0.7210656,  True, '2020-12-01 07:12:12'); /* AerbaxPortal Controller */
/* @teleloc 0x302F000B [24.191177 56.477283 146.004990] -0.692867 0.000000 0.000000 -0.721066 */
