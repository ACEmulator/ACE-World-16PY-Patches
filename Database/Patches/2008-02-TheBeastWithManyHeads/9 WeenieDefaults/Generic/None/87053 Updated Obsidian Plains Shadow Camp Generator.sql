...
VALUES (87053, 'ace87053updatedobsidianplainsshadowcampgen', 1, '2005-02-09 10:00:00') /* Generic */;
...
VALUES (87053,   1,   33555051) /* Setup */
     , (87053,   8,  100667494) /* Icon */;
...
VALUES (87053, 0.3, 36852, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, -1, 0, 0.819152, 0, 0, -0.573577) /* Generate Shadow Spectre (36852) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (87053, 0.6, 33309, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, 3.4, 0, 0.965926, 0, 0, -0.258819) /* Generate  (33309) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (87053, 0.7, 36848, 1800, 1, 1, 1, 4, -1, 0, 0, 0, 2.4, -1.4, 0, 0.996195, 0, 0, -0.0871557) /* Generate Pandemonium Shadow (36848) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (87053, 0.8, 36851, 1800, 1, 1, 1, 4, -1, 0, 0, 0, -2, -2, 0, 0.996195, 0, 0, -0.0871557) /* Generate Sinister Shadow (36851) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
