...
VALUES (87060, 'ace-87060AerbaxsShadow5Gen', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87060,   1,   33555051) /* Setup */
     , (87060,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87060, -1, 37380, 1, 1, 1, 1, 4, 0, 0, 0, 791543850, 132, 36, 125.576, 0.999958, 0, 0, -0.00913665) /* Generate Aerbax's Shadow (37380) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
