...
VALUES (51749,   1,       5) /* HeartbeatInterval */
     ...
     , (51749,   5,       2) /* ManaRate */
     , (51749,  12,       0) /* Shade */
     , (51749,  13,     0.7) /* ArmorModVsSlash */
     , (51749,  14,       1) /* ArmorModVsPierce */
     , (51749,  15,       1) /* ArmorModVsBludgeon */
     , (51749,  16,     1.4) /* ArmorModVsCold */
     , (51749,  17,     0.7) /* ArmorModVsFire */
     , (51749,  18,       1) /* ArmorModVsAcid */
     , (51749,  19,     1.4) /* ArmorModVsElectric */
     , (51749,  31,      18) /* VisualAwarenessRange */
     , (51749,  34,       1) /* PowerupTime */
     , (51749,  36,       1) /* ChargeSpeed */
     , (51749,  64,     1.1) /* ResistSlash */
     , (51749,  65,     0.8) /* ResistPierce */
     , (51749,  66,     0.8) /* ResistBludgeon */
     , (51749,  67,     1.1) /* ResistFire */
     ...
     , (51749, 165,       1) /* ArmorModVsNether */
     , (51749, 166,       1) /* ResistNether */;
...
VALUES (51749,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51749,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51749,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51749,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51749,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51749,  5, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51749,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51749,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51749,  8, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51749,  2074,   2.05)  /* Gossamer Flesh */
     , (51749,  2172,   2.05)  /* Astyrrian's Gift */
     , (51749,  3989,   2.08)  /* Dark Lightning */;
