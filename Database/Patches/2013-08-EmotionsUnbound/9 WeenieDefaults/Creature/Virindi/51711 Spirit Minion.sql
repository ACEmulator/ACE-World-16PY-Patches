...
VALUES (51711,   1,       5) /* HeartbeatInterval */
     ...
     , (51711,   5,       2) /* ManaRate */
     , (51711,  12,       0) /* Shade */
     , (51711,  13,     0.7) /* ArmorModVsSlash */
     , (51711,  14,       1) /* ArmorModVsPierce */
     , (51711,  15,       1) /* ArmorModVsBludgeon */
     , (51711,  16,     1.4) /* ArmorModVsCold */
     , (51711,  17,     0.7) /* ArmorModVsFire */
     , (51711,  18,       1) /* ArmorModVsAcid */
     , (51711,  19,     1.4) /* ArmorModVsElectric */
     , (51711,  31,      18) /* VisualAwarenessRange */
     , (51711,  34,       1) /* PowerupTime */
     , (51711,  36,       1) /* ChargeSpeed */
     , (51711,  64,     1.1) /* ResistSlash */
     , (51711,  65,     0.8) /* ResistPierce */
     , (51711,  66,     0.8) /* ResistBludgeon */
     , (51711,  67,     1.1) /* ResistFire */
...
VALUES (51711,   1,   33561544) /* Setup */
     ...
     , (51711,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51711,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51711,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51711,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51711,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51711,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51711,  5, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51711,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51711,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51711,  8, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51711,  3989,   2.10)  /* Dark Lightning */
     , (51711,  4483,   2.05)  /* Incantation of Lightning Vulnerability Other */;
