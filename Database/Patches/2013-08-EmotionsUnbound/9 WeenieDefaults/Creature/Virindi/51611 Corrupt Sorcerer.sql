...
VALUES (51611,   1,       5) /* HeartbeatInterval */
     ...
     , (51611,   5,       2) /* ManaRate */
     , (51611,  12,       0) /* Shade */
     , (51611,  13,     0.7) /* ArmorModVsSlash */
     , (51611,  14,       1) /* ArmorModVsPierce */
     , (51611,  15,       1) /* ArmorModVsBludgeon */
     , (51611,  16,     1.4) /* ArmorModVsCold */
     , (51611,  17,     0.7) /* ArmorModVsFire */
     , (51611,  18,       1) /* ArmorModVsAcid */
     , (51611,  19,     1.4) /* ArmorModVsElectric */
     , (51611,  31,      18) /* VisualAwarenessRange */
     , (51611,  34,       1) /* PowerupTime */
     , (51611,  36,       1) /* ChargeSpeed */
     , (51611,  64,     1.1) /* ResistSlash */
     , (51611,  65,     0.8) /* ResistPierce */
     , (51611,  66,     0.8) /* ResistBludgeon */
     , (51611,  67,     1.1) /* ResistFire */
     ...
     , (51611, 165,       1) /* ArmorModVsNether */
     , (51611, 166,     1.5) /* ResistNether */;
...
VALUES (51611,   1,   33561548) /* Setup */
     ...
     , (51611,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51611,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51611,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51611,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51611,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51611,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51611,  5, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51611,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51611,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51611,  8, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51611,  3882,   2.05)  /* Incendiary Ring */
     , (51611,  3940,   2.05)  /* Exsanguinating Wave */
     , (51611,  3941,   2.05)  /* Heavy Lightning Ring */
     , (51611,  3989,   2.15)  /* Dark Lightning */
     , (51611,  4312,   2.08)  /* Incantation of Imperil Other */
     , (51611,  4439,   2.15)  /* Incantation of Flame Bolt */
     , (51611,  4481,   2.08)  /* Incantation of Fire Vulnerability Other */
     , (51611,  4483,   2.08)  /* Incantation of Lightning Vulnerability Other */;
