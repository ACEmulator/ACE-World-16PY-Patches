...
VALUES (51726,   1, True ) /* Stuck */
     ...
     , (51726,  65, True ) /* IgnoreMagicResist */
     , (51726,  66, True ) /* IgnoreMagicArmor */
...
VALUES (51726,   1,       5) /* HeartbeatInterval */
     ...
     , (51726,   5,       2) /* ManaRate */
     , (51726,  12,       0) /* Shade */
     , (51726,  13,     0.7) /* ArmorModVsSlash */
     , (51726,  14,       1) /* ArmorModVsPierce */
     , (51726,  15,       1) /* ArmorModVsBludgeon */
     , (51726,  16,     1.4) /* ArmorModVsCold */
     , (51726,  17,     0.7) /* ArmorModVsFire */
     , (51726,  18,       1) /* ArmorModVsAcid */
     , (51726,  19,     1.4) /* ArmorModVsElectric */
     , (51726,  31,      18) /* VisualAwarenessRange */
     , (51726,  34,       1) /* PowerupTime */
     , (51726,  36,       1) /* ChargeSpeed */
     , (51726,  64,     1.1) /* ResistSlash */
     , (51726,  65,     0.8) /* ResistPierce */
     , (51726,  66,     0.8) /* ResistBludgeon */
     , (51726,  67,     1.1) /* ResistFire */
     ...
     , (51726, 165,       1) /* ArmorModVsNether */
     , (51726, 166,       1) /* ResistNether */;
...
VALUES (51726,  0, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51726,  1, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51726,  2, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51726,  3, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51726,  4, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51726,  5, 16, 50, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51726,  6, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51726,  7, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51726,  8, 16, 50, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
	 
INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51726,  4312,   2.05)  /* Incantation of Imperil Other */
     , (51726,  4481,   2.05)  /* Incantation of Fire Vulnerability Other */;
