...
VALUES (51714,   1,       5) /* HeartbeatInterval */
     ...
     , (51714,   5,       2) /* ManaRate */
     , (51714,  12,       0) /* Shade */
     , (51714,  13,     0.7) /* ArmorModVsSlash */
     , (51714,  14,       1) /* ArmorModVsPierce */
     , (51714,  15,       1) /* ArmorModVsBludgeon */
     , (51714,  16,     1.4) /* ArmorModVsCold */
     , (51714,  17,     0.7) /* ArmorModVsFire */
     , (51714,  18,       1) /* ArmorModVsAcid */
     , (51714,  19,     1.4) /* ArmorModVsElectric */
     , (51714,  31,      18) /* VisualAwarenessRange */
     , (51714,  34,       1) /* PowerupTime */
     , (51714,  36,       1) /* ChargeSpeed */
     , (51714,  64,     1.1) /* ResistSlash */
     , (51714,  65,     0.8) /* ResistPierce */
     , (51714,  66,     0.8) /* ResistBludgeon */
     , (51714,  67,     1.1) /* ResistFire */
     , (51714,  68,     0.4) /* ResistCold */
     , (51714,  69,       1) /* ResistAcid */
     ...
     , (51714, 165,       1) /* ArmorModVsNether */
     , (51714, 166,     1.5) /* ResistNether */;
...
VALUES (51714,   1,   33561548) /* Setup */
     ...
     , (51714,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51714,  0, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51714,  1, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51714,  2, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51714,  3, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51714,  4, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51714,  5, 80, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51714,  6, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51714,  7, 80,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51714,  8, 80, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51714,  3941,   2.05)  /* Heavy Lightning Ring */
     , (51714,  3989,   2.15)  /* Dark Lightning */
     , (51714,  4312,   2.08)  /* Incantation of Imperil Other */
     , (51714,  4483,   2.08)  /* Incantation of Lightning Vulnerability Other */
     , (51714,  4597,   2.08)  /* Incantation of Magic Yield Other */
     , (51714,  4633,   2.08)  /* Incantation of Vulnerability Other */
     , (51714,  5378,   2.08)  /* Incantation of Festering Curse */
     , (51714,  5386,   2.08)  /* Incantation of Weakening Curse */;
