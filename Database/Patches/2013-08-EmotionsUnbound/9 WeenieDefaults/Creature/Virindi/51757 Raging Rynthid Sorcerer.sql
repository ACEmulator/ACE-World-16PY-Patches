...
VALUES (51757,   1,       5) /* HeartbeatInterval */
     ...
     , (51757,   5,       2) /* ManaRate */
     , (51757,  12,       0) /* Shade */
     , (51757,  13,     0.7) /* ArmorModVsSlash */
     , (51757,  14,       1) /* ArmorModVsPierce */
     , (51757,  15,       1) /* ArmorModVsBludgeon */
     , (51757,  16,     1.4) /* ArmorModVsCold */
     , (51757,  17,     0.7) /* ArmorModVsFire */
     , (51757,  18,       1) /* ArmorModVsAcid */
     , (51757,  19,     1.4) /* ArmorModVsElectric */
     , (51757,  31,      18) /* VisualAwarenessRange */
     , (51757,  34,       1) /* PowerupTime */
     , (51757,  36,       1) /* ChargeSpeed */
     , (51757,  64,     1.1) /* ResistSlash */
     , (51757,  65,     0.8) /* ResistPierce */
     , (51757,  66,     0.8) /* ResistBludgeon */
     , (51757,  67,     1.1) /* ResistFire */
...
VALUES (51757,  0, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51757,  1, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51757,  2, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51757,  3, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51757,  4, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51757,  5, 16, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51757,  6, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51757,  7, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51757,  8, 16, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51757,  3882,   2.05)  /* Incendiary Ring */
     , (51757,  3940,   2.05)  /* Exsanguinating Wave */
     , (51757,  4312,   2.05)  /* Incantation of Imperil Other */
     , (51757,  4439,   2.15)  /* Incantation of Flame Bolt */
     , (51757,  4481,   2.08)  /* Incantation of Fire Vulnerability Other */
	 , (51757,  4491,   2.02)  /* Incantation of Mana Depletion Other */
	 , (51757,  4468,   2.02)  /* Incantation of Fire Protection Self */
	 , (51757,  4302,   2.05)  /* Incantation of Feeblemind Other */
	 , (51757,  4452,   2.10)  /* Incantation of Lightning Streak */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (51757, 8, 51859,  1, 0, 0.03, False) /* Mask for Treasure */
