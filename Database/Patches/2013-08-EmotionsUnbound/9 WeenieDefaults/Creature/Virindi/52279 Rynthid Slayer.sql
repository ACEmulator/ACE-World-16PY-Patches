...
VALUES (52279,   1,       5) /* HeartbeatInterval */
     ...
     , (52279,   5,       2) /* ManaRate */
     , (52279,  12,       0) /* Shade */
     , (52279,  13,     0.7) /* ArmorModVsSlash */
     , (52279,  14,       1) /* ArmorModVsPierce */
     , (52279,  15,       1) /* ArmorModVsBludgeon */
     , (52279,  16,     1.4) /* ArmorModVsCold */
     , (52279,  17,     0.7) /* ArmorModVsFire */
     , (52279,  18,       1) /* ArmorModVsAcid */
     , (52279,  19,     1.4) /* ArmorModVsElectric */
     , (52279,  31,      18) /* VisualAwarenessRange */
     , (52279,  34,       1) /* PowerupTime */
     , (52279,  36,       1) /* ChargeSpeed */
     , (52279,  64,     1.1) /* ResistSlash */
     , (52279,  65,     0.8) /* ResistPierce */
     , (52279,  66,     0.8) /* ResistBludgeon */
     , (52279,  67,     1.1) /* ResistFire */
...
VALUES (52279,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52279,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52279,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (52279,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52279,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (52279,  5, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (52279,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (52279,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (52279,  8, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (52279,  3941,  2.02)  /* Heavy Lightning Ring */
     , (52279,  3989,  2.10)  /* Dark Lightning */
	 , (52279,  4441,  2.02)  /* Incantation of Flame Volley */
     , (52279,  4483,  2.05)  /* Incantation of Lightning Vulnerability Other */;
