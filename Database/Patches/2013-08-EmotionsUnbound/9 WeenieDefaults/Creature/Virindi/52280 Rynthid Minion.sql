...
VALUES (52280,   1,       5) /* HeartbeatInterval */
     ...
     , (52280,   5,       2) /* ManaRate */
     , (52280,  12,       0) /* Shade */
     , (52280,  13,     0.7) /* ArmorModVsSlash */
     , (52280,  14,       1) /* ArmorModVsPierce */
     , (52280,  15,       1) /* ArmorModVsBludgeon */
     , (52280,  16,     1.4) /* ArmorModVsCold */
     , (52280,  17,     0.7) /* ArmorModVsFire */
     , (52280,  18,       1) /* ArmorModVsAcid */
     , (52280,  19,     1.4) /* ArmorModVsElectric */
     , (52280,  31,      18) /* VisualAwarenessRange */
     , (52280,  34,       1) /* PowerupTime */
     , (52280,  36,       1) /* ChargeSpeed */
     , (52280,  64,     1.1) /* ResistSlash */
     , (52280,  65,     0.8) /* ResistPierce */
     , (52280,  66,     0.8) /* ResistBludgeon */
     , (52280,  67,     1.1) /* ResistFire */
     ...
     , (52280, 165,       1) /* ArmorModVsNether */
     , (52280, 166,       1) /* ResistNether */;
...
VALUES (52280,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (52280,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (52280,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (52280,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (52280,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (52280,  5, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (52280,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (52280,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (52280,  8, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (52280,  2074,   2.05)  /* Gossamer Flesh */
     , (52280,  2172,   2.05)  /* Astyrrian's Gift */
     , (52280,  3989,   2.08)  /* Dark Lightning */;
