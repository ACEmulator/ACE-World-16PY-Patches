...
VALUES (51608,   1,       5) /* HeartbeatInterval */
     ...
     , (51608,   5,       2) /* ManaRate */
     , (51608,  12,       0) /* Shade */
     , (51608,  13,     0.7) /* ArmorModVsSlash */
     , (51608,  14,       1) /* ArmorModVsPierce */
     , (51608,  15,       1) /* ArmorModVsBludgeon */
     , (51608,  16,     1.4) /* ArmorModVsCold */
     , (51608,  17,     0.7) /* ArmorModVsFire */
     , (51608,  18,       1) /* ArmorModVsAcid */
     , (51608,  19,     1.4) /* ArmorModVsElectric */
     , (51608,  31,      18) /* VisualAwarenessRange */
     , (51608,  34,       1) /* PowerupTime */
     , (51608,  36,       1) /* ChargeSpeed */
     , (51608,  64,     1.1) /* ResistSlash */
     , (51608,  65,     0.8) /* ResistPierce */
     , (51608,  66,     0.8) /* ResistBludgeon */
     , (51608,  67,     1.1) /* ResistFire */
     ...
     , (51608, 165,       1) /* ArmorModVsNether */
     , (51608, 166,     1.5) /* ResistNether */;
...
VALUES (51608,   1,   33561561) /* Setup */
     ...
     , (51608,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51608,  0, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51608,  1, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51608,  2, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51608,  3, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51608,  4, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51608,  5, 16, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51608,  6, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51608,  7, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51608,  8, 16, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51608,  2074,   2.05)  /* Gossamer Flesh */
     , (51608,  2128,    2.1)  /* Ilservian's Flame */
     , (51608,  2170,   2.05)  /* Inferno's Gift */
	 , (51608,  2282,   2.05)  /* Futility */;
