...
VALUES (51759,   1,       5) /* HeartbeatInterval */
     ...
     , (51759,   5,       2) /* ManaRate */
     , (51759,  12,       0) /* Shade */
     , (51759,  13,     0.7) /* ArmorModVsSlash */
     , (51759,  14,       1) /* ArmorModVsPierce */
     , (51759,  15,       1) /* ArmorModVsBludgeon */
     , (51759,  16,     1.4) /* ArmorModVsCold */
     , (51759,  17,     0.7) /* ArmorModVsFire */
     , (51759,  18,       1) /* ArmorModVsAcid */
     , (51759,  19,     1.4) /* ArmorModVsElectric */
     , (51759,  31,      18) /* VisualAwarenessRange */
     , (51759,  34,       1) /* PowerupTime */
     , (51759,  36,       1) /* ChargeSpeed */
     , (51759,  64,     1.1) /* ResistSlash */
     , (51759,  65,     0.8) /* ResistPierce */
     , (51759,  66,     0.8) /* ResistBludgeon */
     , (51759,  67,     1.1) /* ResistFire */
...
VALUES (51759,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51759,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51759,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51759,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51759,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51759,  5, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51759,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51759,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51759,  8, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51759,  3882,   2.05)  /* Incendiary Ring */
     , (51759,  3940,   2.05)  /* Exsanguinating Wave */
     , (51759,  3941,   2.05)  /* Heavy Lightning Ring */
     , (51759,  3989,   2.15)  /* Dark Lightning */
     , (51759,  4312,   2.08)  /* Incantation of Imperil Other */
     , (51759,  4439,   2.15)  /* Incantation of Flame Bolt */
     , (51759,  4481,   2.08)  /* Incantation of Fire Vulnerability Other */
     , (51759,  4483,   2.08)  /* Incantation of Lightning Vulnerability Other */;
