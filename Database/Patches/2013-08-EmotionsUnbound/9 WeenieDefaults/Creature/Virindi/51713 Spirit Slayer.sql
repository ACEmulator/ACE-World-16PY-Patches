...
VALUES (51713,   1,       5) /* HeartbeatInterval */
     ...
     , (51713,   5,       2) /* ManaRate */
     , (51713,  12,       0) /* Shade */
     , (51713,  13,     0.7) /* ArmorModVsSlash */
     , (51713,  14,       1) /* ArmorModVsPierce */
     , (51713,  15,       1) /* ArmorModVsBludgeon */
     , (51713,  16,     1.4) /* ArmorModVsCold */
     , (51713,  17,     0.7) /* ArmorModVsFire */
     , (51713,  18,       1) /* ArmorModVsAcid */
     , (51713,  19,     1.4) /* ArmorModVsElectric */
     , (51713,  31,      18) /* VisualAwarenessRange */
     , (51713,  34,       1) /* PowerupTime */
     , (51713,  36,       1) /* ChargeSpeed */
     , (51713,  64,     1.1) /* ResistSlash */
     , (51713,  65,     0.8) /* ResistPierce */
     , (51713,  66,     0.8) /* ResistBludgeon */
     , (51713,  67,     1.1) /* ResistFire */
...
VALUES (51713,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51713,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51713,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51713,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51713,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51713,  5, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51713,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51713,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51713,  8, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51713,  4439,   2.10)  /* Incantation of Flame Bolt */
     , (51713,  4481,   2.05)  /* Incantation of Fire Vulnerability */;
