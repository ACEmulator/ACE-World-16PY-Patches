...
VALUES (51609,   1,       5) /* HeartbeatInterval */
     ...
     , (51609,   5,       2) /* ManaRate */
     , (51609,  12,       0) /* Shade */
     , (51609,  13,     0.7) /* ArmorModVsSlash */
     , (51609,  14,       1) /* ArmorModVsPierce */
     , (51609,  15,       1) /* ArmorModVsBludgeon */
     , (51609,  16,     1.4) /* ArmorModVsCold */
     , (51609,  17,     0.7) /* ArmorModVsFire */
     , (51609,  18,       1) /* ArmorModVsAcid */
     , (51609,  19,     1.4) /* ArmorModVsElectric */
     , (51609,  31,      18) /* VisualAwarenessRange */
     , (51609,  34,       1) /* PowerupTime */
     , (51609,  36,       1) /* ChargeSpeed */
     , (51609,  64,     1.1) /* ResistSlash */
     , (51609,  65,     0.8) /* ResistPierce */
     , (51609,  66,     0.8) /* ResistBludgeon */
     , (51609,  67,     1.1) /* ResistFire */
...
VALUES (51609,   1,   33561547) /* Setup */
     ...
     , (51609,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51609,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51609,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51609,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51609,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51609,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51609,  5, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51609,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51609,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51609,  8, 64, 200, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51609,  3941,  2.05)  /* Heavy Lightning Ring */
     , (51609,  3989,  2.10)  /* Dark Lightning */
	 , (51609,  4441,  2.05)  /* Incantation of Flame Volley */
     , (51609,  4483,  2.05)  /* Incantation of Lightning Vulnerability Other */;
