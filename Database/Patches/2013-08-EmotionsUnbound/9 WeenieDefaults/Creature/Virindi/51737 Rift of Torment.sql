...
VALUES (51737, 'ace51737-riftoftorment', 10, '2020-10-21 21:40:20') /* Creature */;
...
VALUES (51737,   1,         16) /* ItemType - Creature */
     ...
     , (51737,  25,        250) /* Level */
     , (51737,  65,          1) /* Placement - RightHandCombat */
...
/* @teleloc 0x2D310027 [111.669998 154.048996 126.862000] 0.428539 0.000000 0.000000 -0.903523 */;
...
VALUES (51737,  6, 0, 2, 0, 530, 0, 0) /* MeleeDefense        Trained */
     ...
     , (51737, 33, 0, 2, 0, 400, 0, 0) /* LifeMagic           Trained */
     , (51737, 34, 0, 2, 0, 400, 0, 0) /* WarMagic            Trained */
     , (51737, 41, 0, 2, 0, 450, 0, 0) /* TwoHandedCombat     Trained */
     , (51737, 43, 0, 2, 0, 400, 0, 0) /* VoidMagic           Trained */
     , (51737, 44, 0, 2, 0, 450, 0, 0) /* HeavyWeapons        Trained */
     , (51737, 45, 0, 2, 0, 450, 0, 0) /* LightWeapons        Trained */
     , (51737, 46, 0, 2, 0, 450, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51737,  0, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51737,  1, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51737,  2, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51737,  3, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51737,  4, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51737,  5, 64, 200, 0.5, 350, 220, 220, 220, 220, 220, 220, 220,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51737,  6, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51737,  7, 64,  0,    0, 350, 220, 220, 220, 220, 220, 220, 220,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
