...
VALUES (51712,   1,       5) /* HeartbeatInterval */
     ...
     , (51712,   5,       2) /* ManaRate */
     , (51712,  12,       0) /* Shade */
     , (51712,  13,     0.7) /* ArmorModVsSlash */
     , (51712,  14,       1) /* ArmorModVsPierce */
     , (51712,  15,       1) /* ArmorModVsBludgeon */
     , (51712,  16,     1.4) /* ArmorModVsCold */
     , (51712,  17,     0.7) /* ArmorModVsFire */
     , (51712,  18,       1) /* ArmorModVsAcid */
     , (51712,  19,     1.4) /* ArmorModVsElectric */
     , (51712,  31,      18) /* VisualAwarenessRange */
     , (51712,  34,       1) /* PowerupTime */
     , (51712,  36,       1) /* ChargeSpeed */
     , (51712,  64,     1.1) /* ResistSlash */
     , (51712,  65,     0.8) /* ResistPierce */
     , (51712,  66,     0.8) /* ResistBludgeon */
     , (51712,  67,     1.1) /* ResistFire */
...
VALUES (51712,   1,   33561547) /* Setup */
     ...
     , (51712,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51712,  0, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51712,  1, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51712,  2, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51712,  3, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51712,  4, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51712,  5, 16, 220, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51712,  6, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51712,  7, 16,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51712,  8, 16, 220, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
