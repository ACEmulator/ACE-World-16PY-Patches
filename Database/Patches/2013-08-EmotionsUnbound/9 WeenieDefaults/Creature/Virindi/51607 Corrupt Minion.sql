...
VALUES (51607,   1,       5) /* HeartbeatInterval */
     ...
     , (51607,   5,       2) /* ManaRate */
     , (51607,  12,       0) /* Shade */
     , (51607,  13,     0.7) /* ArmorModVsSlash */
     , (51607,  14,       1) /* ArmorModVsPierce */
     , (51607,  15,       1) /* ArmorModVsBludgeon */
     , (51607,  16,     1.4) /* ArmorModVsCold */
     , (51607,  17,     0.7) /* ArmorModVsFire */
     , (51607,  18,       1) /* ArmorModVsAcid */
     , (51607,  19,     1.4) /* ArmorModVsElectric */
     , (51607,  31,      18) /* VisualAwarenessRange */
     , (51607,  34,       1) /* PowerupTime */
     , (51607,  36,       1) /* ChargeSpeed */
     , (51607,  64,     1.1) /* ResistSlash */
     , (51607,  65,     0.8) /* ResistPierce */
     , (51607,  66,     0.8) /* ResistBludgeon */
     , (51607,  67,     1.1) /* ResistFire */
...
VALUES (51607,   1,   33561544) /* Setup */
     ...
     , (51607,  35,       2110) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (51607,  0, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51607,  1, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51607,  2, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51607,  3, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51607,  4, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51607,  5, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51607,  6, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51607,  7, 64,  0,    0, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51607,  8, 64, 180, 0.5, 350, 120, 120, 120, 120, 120, 120, 120,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (51607,  2074,   2.05)  /* Gossamer Flesh */
     , (51607,  2128,    2.1)  /* Ilservian's Flame */
     , (51607,  2170,   2.05)  /* Inferno's Gift */
     , (51607,  2172,   2.05)  /* Astyrrian's Gift */
     , (51607,  3989,    2.1)  /* Dark Lightning */;
