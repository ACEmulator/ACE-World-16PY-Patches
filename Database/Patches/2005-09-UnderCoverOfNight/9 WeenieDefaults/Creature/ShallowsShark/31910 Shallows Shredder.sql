...
VALUES (31910, 'ace31910-shallowsshredder', 10, '2019-07-26 06:01:15') /* Creature */;
...
VALUES (31910,   1,         16) /* ItemType - Creature */
     ...
     , (31910,  25,        160) /* Level */
     , (31910,  40,          2) /* CombatMode - Melee */
     , (31910,  68,          3) /* TargetingTactic - Random, Focused */
...
VALUES (31910,   1, True ) /* Stuck */
     , (31910,  11, False) /* IgnoreCollisions */
...
VALUES (31910,  0,  2, 10, 0.75,  480,  220,  250,  300,  220,  300,  220,  180,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (31910, 10,  2, 280,  0.4,  480,  220,  250,  300,  220,  300,  220,  180,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (31910, 13,  2, 10,  0.5,  480,  220,  250,  300,  220,  300,  220,  180,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (31910, 16,  4, 10,    0,  480,  220,  250,  300,  220,  300,  220,  180,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;
