...
VALUES (31920, 'ace31920-aqueousgolem', 10, '2019-06-30 00:00:00') /* Creature */;
...
VALUES (31920,   1,         16) /* ItemType - Creature */
     ...
     , (31920,  68,          5) /* TargetingTactic - Random, LastDamager */
...
VALUES (31920,   1, 320, 0, 0) /* Strength */
     ...
     , (31920,   3, 230, 0, 0) /* Quickness */
     , (31920,   4, 220, 0, 0) /* Coordination */
...
VALUES (31920,  6, 0, 3, 0, 180, 0, 0) /* MeleeDefense        Specialized */
     , (31920,  7, 0, 3, 0, 230, 0, 0) /* MissileDefense      Specialized */
     , (31920, 45, 0, 3, 0, 178, 0, 0) /* Light Weapons       Specialized */
     , (31920, 15, 0, 3, 0, 230, 0, 0) /* MagicDefense        Specialized */
     , (31920, 20, 0, 2, 0, 100, 0, 0) /* Deception           Trained */
     , (31920, 24, 0, 2, 0, 200, 0, 0) /* Run                 Trained */
     , (31920, 31, 0, 3, 0, 175, 0, 0) /* CreatureEnchantment Specialized */
     , (31920, 33, 0, 3, 0, 175, 0, 0) /* LifeMagic           Specialized */
     , (31920, 34, 0, 3, 0, 175, 0, 0) /* WarMagic            Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (31920,  0,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (31920,  1,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (31920,  2,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (31920,  3,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (31920,  4,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (31920,  5, 12, 120, 0.75,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (31920,  6,  4,  0,    0,  350,  350,  350,  350,  350, 20000,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (31920,  7,  4,  0,    0,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (31920,  8, 20, 150, 0.75,  350,  300,  350,  350,  350, 20000,  350,  350,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (31920,  2074,   2.15)  /* Gossamer Flesh */
     , (31920,  2136,   2.18)  /* Icy Torment */
     , (31920,  2138,   2.15)  /* Blizzard */
     , (31920,  2168,   2.15)  /* Gelidite's Gift */
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (31920,  5 /* HeartBeat */,      1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (31920, 9,  6353,  0, 0, 0.04, False) /* Create Pyreal Mote (6353) for ContainTreasure */
     ...
     , (31920, 9, 24477,  1, 0, 0.03, True) /* Create Sturdy Steel Key (24477) for ContainTreasure */
     , (31920, 9,     0,  0, 0, 0.97, False) /* Create nothing for ContainTreasure */
     , (31920, 9, 34277,  1, 0, 0.02, True) /* Create Ancient Falatacot Trinket (34277) for ContainTreasure */
