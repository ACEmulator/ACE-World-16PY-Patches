...
VALUES (87155, 'ace-87155-MonsterFightsAnnouncerGenerator', 1, '2020-05-22 10:00:00') /* Generic */;
...
VALUES (87155,   1,   33555051) /* Setup */
     , (87155,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87155, -1, 38990, 1, 1, 1, 1, 4, 0, 0, 0, 869924893, 92.4851, 99.2742, 60.005, 0.47699, 0, 0, -0.878909) /* Generate Monster Fights Announcer (38990) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
