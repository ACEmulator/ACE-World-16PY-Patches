...
VALUES (44024, 'ace44024-baktshayguard', 10, '2020-04-22 00:00:00') /* Creature */;
...
VALUES (44024,   1, True ) /* Stuck */
     ...
     , (44024,   7, True ) /* AiUseHumanMagicAnimations */
     , (44024,  10, True ) /* AttackerAi */
...
VALUES (44024,   1,       5) /* HeartbeatInterval */
     ...
     , (44024,  31,      24) /* VisualAwarenessRange */
...
VALUES (44024,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (44024, 15, 0, 2, 0, 380, 0, 0) /* MagicDefense        Trained */
     , (44024, 24, 0, 2, 0, 200, 0, 0) /* Run                 Trained */
     , (44024, 33, 0, 2, 0, 380, 0, 0) /* LifeMagic           Trained */
     , (44024, 34, 0, 2, 0, 380, 0, 0) /* WarMagic            Trained */
...
VALUES (44024,  0,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (44024,  1,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (44024,  2,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (44024,  3,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (44024,  4,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (44024,  5,  4, 600, 0.75,  800,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (44024,  6,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (44024,  7,  4,  0,    0,  800,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (44024,  8,  4, 600, 0.75,  800,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
