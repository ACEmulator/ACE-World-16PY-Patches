...
VALUES (71388, 'ace71388-mumiyahvizier', 10, '2019-08-16 00:00:00') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (71388,   1,         16) /* ItemType - Creature */
     , (71388,   2,         14) /* CreatureType - Undead */
     , (71388,   3,         77) /* PaletteTemplate - Blue Green */
...
VALUES (71388,   1, True ) /* Stuck */
     ...
     , (71388,   7, True ) /* AiUseHumanMagicAnimations */
     , (71388,  10, True ) /* AttackerAi */
     , (71388,  11, False) /* IgnoreCollisions */
     , (71388,  12, True ) /* ReportCollisions */
     , (71388,  13, False) /* Ethereal */
     , (71388,  58, True ) /* SpellQueueActive */;
...
VALUES (71388,  0,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (71388,  1,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (71388,  2,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (71388,  3,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (71388,  4,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (71388,  5,  4,  450, 0.75,  460,  250,  150,  275,  250,  100,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (71388,  6,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (71388,  7,  4,  0,    0,  460,  250,  150,  275,  250,  100,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (71388,  8,  4,  400, 0.75,  460,  250,  150,  275,  250,  100,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
