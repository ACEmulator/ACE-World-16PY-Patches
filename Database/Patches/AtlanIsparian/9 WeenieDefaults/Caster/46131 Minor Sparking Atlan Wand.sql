...
/* Weenie - Casters - Minor Sparking Atlan Wand (46125) */
DELETE FROM weenie WHERE class_Id = 46125;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46125, 'minorsparkingatlanwand', 35) /* Caster */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46125,   1,      32768) /* ItemType - Caster */
     , (46125,   3,         13) /* PaletteTemplate - Purple */
     ...
     , (46125, 263,         64) /* ResistanceModifierType - Electric */;
