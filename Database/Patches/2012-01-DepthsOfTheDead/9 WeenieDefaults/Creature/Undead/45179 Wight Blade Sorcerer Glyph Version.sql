...
VALUES (45179, 'ace45179-wightbladesorcerer', 10, '2021-04-23 03:08:32') /* Creature */;
...
VALUES (45179,   1,   33560225) /* Setup */
     ...
     , (45179,   7,  268435558) /* ClothingBase */
...
VALUES (45179,  0,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45179,  1,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45179,  2,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45179,  3,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45179,  4,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45179,  5,  4,400, 0.75,  225,  112,  112,  112,  112,  112,  112,  112,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45179,  6,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45179,  7,  4,  0,    0,  225,  112,  112,  112,  112,  112,  112,  112,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45179,  8,  4,400, 0.75,  225,  112,  112,  112,  112,  112,  112,  112,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45179,  6, 0, 3, 0, 360, 0, 0) /* MeleeDefense        Specialized */
     , (45179,  7, 0, 3, 0, 367, 0, 0) /* MissileDefense      Specialized */
     , (45179, 15, 0, 3, 0, 395, 0, 0) /* MagicDefense        Specialized */
     , (45179, 20, 0, 3, 0, 420, 0, 0) /* Deception           Specialized */
     , (45179, 33, 0, 3, 0, 460, 0, 0) /* LifeMagic           Specialized */
     , (45179, 34, 0, 3, 0, 395, 0, 0) /* WarMagic            Specialized */
     , (45179, 45, 0, 3, 0, 445, 0, 0) /* LightWeapons        Specialized */
     , (45179, 46, 0, 3, 0, 445, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (45179,  1786,   2.143) /* Nuhmudira's Spines */
     , (45179,  5531,   2.167) /* Bloodstone Bolt VII */
     , (45179,  4424,     2.2) /* Incantation of Force Arc */
     , (45179,  4442,    2.25) /* Incantation of Force Blast */
     , (45179,  4443,   2.334) /* Incantation of Force Bolt */
     , (45179,  4489,   2.501) /* Incantation of Fester Other */
     , (45179,  2166,   3.002) /* Tusker's Gift */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (45179, 9, 35105,  1, 0, 0.10, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (45179, 9,     0,  0, 0, 0.90, False) /* Create nothing for ContainTreasure */
     ...
     , (45179, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
     , (45179, 9, 45151,  0, 0,  0.8, False) /* Create Mhoire Oubliette Portal Glyph (45151) for Contain Treasure */
     , (45179, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */
     , (45179, 9, 45151,  0, 0,  0.8, False) /* Create Mhoire Oubliette Portal Glyph (45151) for Contain Treasure */
     , (45179, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */
     , (45179, 9, 45151,  0, 0,  0.8, False) /* Create Mhoire Oubliette Portal Glyph (45151) for Contain Treasure */
     , (45179, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */
     , (45179, 9, 45193,  0, 0, 0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45179, 9,     0,  0, 0, 0.2, False) /* Create nothing for Contain Treasure */;
