...
VALUES (45161, 'ace45161-wightbladesorcerer', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (45161,  1,  33560225) /* Setup */
     ...
     , (45161,  4, 805306368) /* CombatTable */
     , (45161,  6,  67110722) /* PaletteBase */
     , (45161,  7, 268435558) /* ClothingBase */
...
VALUES (45161,  6, 0, 3, 0, 360, 0, 0) /* MeleeDefense        Specialized */
     , (45161,  7, 0, 3, 0, 367, 0, 0) /* MissileDefense      Specialized */
     , (45161, 15, 0, 3, 0, 395, 0, 0) /* MagicDefense        Specialized */
     , (45161, 20, 0, 3, 0, 420, 0, 0) /* Deception           Specialized */
     , (45161, 33, 0, 3, 0, 460, 0, 0) /* LifeMagic           Specialized */
     , (45161, 34, 0, 3, 0, 395, 0, 0) /* WarMagic            Specialized */
     , (45161, 45, 0, 3, 0, 445, 0, 0) /* LightWeapons        Specialized */
     , (45161, 46, 0, 3, 0, 445, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45161,  0,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45161,  1,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45161,  2,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45161,  3,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45161,  4,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45161,  5,  4, 400, 0.75,  225,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45161,  6,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45161,  7,  4,  0,    0,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45161,  8,  4, 400, 0.75,  225,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (45161,  1786,   2.143) /* Nuhmudira's Spines */
     , (45161,  5531,   2.167) /* Bloodstone Bolt VII */
     , (45161,  4424,     2.2) /* Incantation of Force Arc */
     , (45161,  4442,    2.25) /* Incantation of Force Blast */
     , (45161,  4443,   2.334) /* Incantation of Force Bolt */
     , (45161,  4489,   2.501) /* Incantation of Fester Other */
     , (45161,  2166,   3.002) /* Tusker's Gift */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (45161, 9, 35105,  1, 0, 0.10, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (45161, 9,     0,  0, 0, 0.90, False) /* Create nothing for ContainTreasure */
     ...
     , (45161, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
     , (45161, 9, 45193,  0, 0, 0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45161, 9,     0,  0, 0, 0.2, False) /* Create nothing for Contain Treasure */;
