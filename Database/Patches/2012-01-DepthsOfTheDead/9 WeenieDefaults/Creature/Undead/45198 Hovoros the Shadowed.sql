...
VALUES (45198, 'ace45198-hovorostheshadowed', 10, '2021-05-14 02:52:05') /* Creature */;
...
VALUES (45198,   1,       5) /* HeartbeatInterval */
     ...
     , (45198,  14,    0.90) /* ArmorModVsPierce */
     , (45198,  15,    0.85) /* ArmorModVsBludgeon */
     , (45198,  16,    0.90) /* ArmorModVsCold */
     , (45198,  17,    0.80) /* ArmorModVsFire */
     , (45198,  18,    0.85) /* ArmorModVsAcid */
     , (45198,  19,    0.90) /* ArmorModVsElectric */
...
VALUES (45198,   1,   33560277) /* Setup */
     ...
     , (45198,   7,  268437294) /* ClothingBase */
...
/* @teleloc 0x57640106 [6.159413 -18.774160 -53.991749] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45198,  0,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45198,  1,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45198,  2,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45198,  3,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45198,  4,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45198,  5,  4,150, 0.75,  480,  375,  375,  375,  375,  375,  375,  375,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45198,  6,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45198,  7,  4,  0,    0,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45198,  8,  4,155, 0.75,  480,  375,  375,  375,  375,  375,  375,  375,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45198,  2074,   2.1) /* Gossamer Flesh */
     ...
     , (45198,  5551,   3.0) /* Incantation of Nether Blast */;
