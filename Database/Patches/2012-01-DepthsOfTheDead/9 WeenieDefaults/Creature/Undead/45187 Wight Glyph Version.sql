...
VALUES (45187, 'ace45187-wight', 10, '2021-05-15 08:00:51') /* Creature */;
...
VALUES (45187,   1,   33560225) /* Setup */
     ...
     , (45187,   7,  268435558) /* ClothingBase */
...
VALUES (45187,  0,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45187,  1,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45187,  2,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45187,  3,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45187,  4,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45187,  5,  4,150, 0.75,  275,  137,  137,  137,  137,  137,  137,  137,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45187,  6,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45187,  7,  4,  0,    0,  275,  137,  137,  137,  137,  137,  137,  137,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45187,  8,  4,155, 0.75,  275,  137,  137,  137,  137,  137,  137,  137,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45187,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (45187,  7, 0, 3, 0, 367, 0, 0) /* MissileDefense      Specialized */
     , (45187, 15, 0, 3, 0, 345, 0, 0) /* MagicDefense        Specialized */
     , (45187, 20, 0, 3, 0, 420, 0, 0) /* Deception           Specialized */
     , (45187, 33, 0, 3, 0, 375, 0, 0) /* LifeMagic           Specialized */
     , (45187, 34, 0, 3, 0, 375, 0, 0) /* WarMagic            Specialized */
     , (45187, 41, 0, 3, 0, 445, 0, 0) /* TwoHandedCombat     Specialized */
     , (45187, 44, 0, 3, 0, 445, 0, 0) /* HeavyWeapons        Specialized */
     , (45187, 45, 0, 3, 0, 445, 0, 0) /* LightWeapons        Specialized */
     , (45187, 46, 0, 3, 0, 445, 0, 0) /* FinesseWeapons      Specialized */
     , (45187, 47, 0, 3, 0, 445, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45187, 5 /* HeartBeat */, 0.042, NULL, 0x8000003D /* NonCombat */, 0x41000003 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45187, 32 /* GotoSet */, 0.25, NULL, NULL, NULL, 'PickSay', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45187, 32 /* GotoSet */, 0.5, NULL, NULL, NULL, 'PickSay', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45187, 32 /* GotoSet */, 0.75, NULL, NULL, NULL, 'PickSay', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45187, 32 /* GotoSet */, 1, NULL, NULL, NULL, 'PickSay', NULL, NULL, NULL);
...
VALUES (45187, 9, 35105,  1, 0,  0.1, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (45187, 9,     0,  0, 0,  0.9, False) /* Create nothing for ContainTreasure */
     ...
     , (45187, 9,     0,  0, 0,0.922, False) /* Create nothing for ContainTreasure */
     , (45187, 9, 45151,  0, 0,  0.8, False) /* Create Mhoire Oubliette Portal Glyph (45151) for Contain Treasure */
     , (45187, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */
     , (45187, 9, 45193,  0, 0,  0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45187, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */;
