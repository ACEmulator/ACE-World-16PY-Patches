...
VALUES (45156, 'ace45156-pyreskeleton', 10, '2019-08-22 00:00:00') /* Creature */;
...
VALUES (45156,   1,   33560230) /* Setup */
     ...
     , (45156,   4,  805306368) /* CombatTable */
     , (45156,   6,   67116522) /* PaletteBase */
     , (45156,   7,  268437008) /* ClothingBase */
     , (45156,   8,  100669124) /* Icon */
     , (45156,  22,  872415269) /* PhysicsEffectTable */
     , (45156,  35,       2000) /* DeathTreasureType - Loot Tier: 8 */;
...
VALUES (45156,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     , (45156,  7, 0, 3, 0, 377, 0, 0) /* MissileDefense      Specialized */
     , (45156, 15, 0, 3, 0, 320, 0, 0) /* MagicDefense        Specialized */
     , (45156, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (45156, 33, 0, 3, 0, 260, 0, 0) /* LifeMagic           Specialized */
     , (45156, 34, 0, 3, 0, 260, 0, 0) /* WarMagic            Specialized */
     , (45156, 44, 0, 3, 0, 545, 0, 0) /* Heavy Weapons       Specialized */
     , (45156, 45, 0, 3, 0, 545, 0, 0) /* Light Weapons       Specialized */
     , (45156, 46, 0, 3, 0, 545, 0, 0) /* Finesse Weapons     Specialized */
     , (45156, 47, 0, 3, 0, 545, 0, 0) /* Missile Weapons     Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45156,  0,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45156,  1,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45156,  2,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45156,  3,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45156,  4,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45156,  5,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45156,  6,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45156,  7,  4,  0,    0,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (45156,  8,  4, 275, 0.75,  450,  450,  450,  450,  450,  450,  450,  450,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (45156, 2, 35095,  1, 0, 0, False) /* Create Pyre Claw (35095) for Wield */
     , (45156, 9, 38714,  0, 0, 0.10, False) /* Create Pyre Skeleton Jaw (38714) for ContainTreasure */
     , (45156, 9,     0,  0, 0, 0.90, False) /* Create nothing for ContainTreasure */
     , (45156, 9, 35105,  1, 0, 0.10, False) /* Create Pyre Shroud (35105) for ContainTreasure */
     , (45156, 9,     0,  0, 0, 0.90, False) /* Create nothing for ContainTreasure */
     ...
     , (45156, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
     , (45156, 9, 45193,  0, 0,  0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45156, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */;
