...
VALUES (45157, 'ace45157-pyreminion', 10, '2019-08-22 00:00:00') /* Creature */;
...
VALUES (45157,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     , (45157,  7, 0, 3, 0, 377, 0, 0) /* MissileDefense      Specialized */
     , (45157, 15, 0, 3, 0, 320, 0, 0) /* MagicDefense        Specialized */
     , (45157, 20, 0, 3, 0, 120, 0, 0) /* Deception           Specialized */
     , (45157, 33, 0, 3, 0, 260, 0, 0) /* LifeMagic           Specialized */
     , (45157, 34, 0, 3, 0, 260, 0, 0) /* WarMagic            Specialized */
     , (45157, 44, 0, 3, 0, 520, 0, 0) /* Heavy Weapons       Specialized */
     , (45157, 45, 0, 3, 0, 520, 0, 0) /* Light Weapons       Specialized */
     , (45157, 46, 0, 3, 0, 520, 0, 0) /* Finesse Weapons     Specialized */
     , (45157, 47, 0, 3, 0, 520, 0, 0) /* Missile Weapons     Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45157,  0,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45157,  1,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45157,  2,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (45157,  3,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45157,  4,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (45157,  5,  4, 185, 0.75,  350,  350,  350,  350,  350,  350,  350,  350,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (45157,  6,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (45157,  7,  4,  0,    0,  350,  350,  350,  350,  350,  350,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
...
VALUES (45157, 9, 38714,  0, 0, 0.1, False) /* Create Pyre Skeleton Jaw (38714) for ContainTreasure */
     ...
     , (45157, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
     , (45157, 9, 45193,  0, 0,  0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45157, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */;
