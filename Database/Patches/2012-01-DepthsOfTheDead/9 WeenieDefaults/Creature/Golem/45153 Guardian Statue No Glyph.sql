...
VALUES (45153,   1,       5) /* HeartbeatInterval */
     ...
     , (45153,  31,      24) /* VisualAwarenessRange */
...
VALUES (45153,   1,   33558554) /* Setup */
     ...
     , (45153,   4,  805306426) /* CombatTable */
     , (45153,   7,  268437288) /* ClothingBase */
...
VALUES (45153,  2074,    2.05)  /* Gossamer Flesh */
     , (45153,  2166,   2.053)  /* Tusker's Gift */
     , (45153,  2212,   2.056)  /* Wrath of Adja */
     , (45153,  2264,   2.059)  /* Wrath of Harlune */
     , (45153,  2318,   2.063)  /* Gravity Well */
     , (45153,  2320,   2.067)  /* Wrath of the Hieromancer */
     , (45153,  4427,   2.071)  /* Incantation of Shock Arc */
     , (45153,  4455,   2.077)  /* Incantation of Shock Wave */;
...
VALUES (45153,  6, 0, 3, 0, 340, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (45153, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (45153, 32, 0, 3, 0, 300, 0, 0) /* ItemEnchantment     Specialized */
     , (45153, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (45153, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45153,  0,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 1,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (45153, 10,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 3,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (45153, 13,  4, 200, 0.75,  650,  682,  650,  618,  618,  780,  780,  618,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (45153, 16,  4,  0,    0,  650,  682,  650,  618,  618,  780,  780,  618,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */
...
VALUES (45153, 9,  6353,  0, 0, 0.04, False) /* Create Pyreal Mote (6353) for ContainTreasure */
     ...
     , (45153, 9, 45193,  0, 0,  0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45153, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */;
