...
VALUES (45165, 'ace45165-corrupteddread', 10, '2020-05-09 20:25:09') /* Creature */;
...
VALUES (45165,   1,       5) /* HeartbeatInterval */
     ...
     , (45165,   5,       2) /* ManaRate */
     , (45165,  12,     0.5) /* Shade */
     , (45165,  13,    0.64) /* ArmorModVsSlash */
     , (45165,  14,    0.96) /* ArmorModVsPierce */
     , (45165,  15,    0.96) /* ArmorModVsBludgeon */
     , (45165,  16,       1) /* ArmorModVsCold */
     , (45165,  17,    0.64) /* ArmorModVsFire */
     , (45165,  18,    0.97) /* ArmorModVsAcid */
     , (45165,  19,    0.75) /* ArmorModVsElectric */
     ...
     , (45165,  69,    0.49) /* ResistAcid */
     , (45165,  70,    0.84) /* ResistElectric */
...
VALUES (45165,   1,   33558816) /* Setup */
     ...
     , (45165,   4,  805306429) /* CombatTable */
     , (45165,   6,   67115251) /* PaletteBase */
     , (45165,   7,  268436835) /* ClothingBase */
...
VALUES (45165,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (45165,  7, 0, 3, 0, 520, 0, 0) /* MissileDefense      Specialized */
     , (45165, 14, 0, 3, 0, 263, 0, 0) /* ArcaneLore          Specialized */
     , (45165, 15, 0, 3, 0, 340, 0, 0) /* MagicDefense        Specialized */
     , (45165, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (45165, 24, 0, 3, 0, 600, 0, 0) /* Run                 Specialized */
     , (45165, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (45165, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (45165, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */
     , (45165, 45, 0, 3, 0, 420, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (45165,  0,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (45165,  1,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (45165,  2,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen */
     , (45165,  3,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (45165,  4,  1,  0,    0,  250,  200,  250,  250,  250,  250,  250,  200,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm */
...
VALUES (45165, 9, 48908,  0, 0, 0.04, False) /* Create Shattered Legendary Key (48908) for ContainTreasure */
     ...
     , (45165, 9,     0,  0, 0, 0.922, False) /* Create nothing for ContainTreasure */
     , (45165, 9, 45193,  0, 0,  0.8, False) /* Create Red Veined Grub (45193) for Contain Treasure */
     , (45165, 9,     0,  0, 0,  0.2, False) /* Create nothing for Contain Treasure */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45165,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45165,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45165,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45165,  5 /* HeartBeat */,  0.075, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (45165,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
