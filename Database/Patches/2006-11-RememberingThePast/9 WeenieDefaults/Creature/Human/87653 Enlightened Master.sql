...
VALUES (87653, 'ace87653-enlightenedmaster', 10, '2021-10-21 14:43:31') /* Creature */;
...
VALUES (87653,  6, 0, 3, 0, 277, 0, 0) /* MeleeDefense        Specialized */
     , (87653,  7, 0, 3, 0, 208, 0, 0) /* MissileDefense      Specialized */
     , (87653, 15, 0, 3, 0, 189, 0, 0) /* MagicDefense        Specialized */
     ...
     , (87653, 45, 0, 3, 0, 325, 0, 0) /* LightWeapons        Specialized */
     , (87653, 47, 0, 3, 0, 255, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (87653,  0,  4,  0,    0,  225,  225,  225,  225,  200,  100,   75,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (87653,  1,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (87653,  2,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (87653,  3,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (87653,  4,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (87653,  5,  4,  4, 0.75,  265,  225,  225,  225,  200,  100,   75,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (87653,  6,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (87653,  7,  4,  0,    0,  265,  225,  225,  225,  200,  100,   75,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (87653,  8,  4,  8, 0.75,  265,  225,  225,  225,  200,  100,   75,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (87653,    97,   2.02)  /* Whirling Blade VI */
     , (87653,   234,   2.03)  /* Vulnerability Other VI */
     , (87653,   285,   2.03)  /* Magic Yield Other VI */
     , (87653,  1327,   2.03)  /* Imperil Other VI */;
