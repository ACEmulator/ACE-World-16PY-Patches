DELETE FROM `weenie` WHERE `class_Id` = 87282;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (87282, 'ace87282-ulgrimsstout', 1, '2019-02-10 00:00:00') /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (87282,   1,        128) /* ItemType - Misc */
     , (87282,   5,         40) /* EncumbranceVal */
     , (87282,  19,         10) /* Value */
     , (87282,  33,          0) /* Bonded - Normal */
     , (87282,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (87282, 114,          0) /* Attuned - Normal */
     , (87282, 151,          2) /* HookType - Wall */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (87282,   1, True ) /* Stuck */
     , (87282,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (87282,  39,     1.3) /* DefaultScale */
     , (87282,  54,       3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (87282,   1, 'Stout') /* Name */
     , (87282,  16, 'One of Ulgrim''s mugs used in the Drinking Contest.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (87282,   1,   33560131) /* Setup */
     , (87282,   3,  536870932) /* SoundTable */
     , (87282,   8,  100689280) /* Icon */
     , (87282,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87282, 7 /* Use */, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (87282, 12 /* QuestSuccess */, 1, NULL, NULL, NULL, 'UlgrimsDrinkingContestFlag', NULL, NULL, NULL);
...
VALUES (@parent_id, 0, 18 /* DirectBroadcast */, 0, 1, NULL, 'You drink the stout.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     , (@parent_id, 1, 24 /* StopEvent */, 0, 1, NULL, 'UlgrimsMug5event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
