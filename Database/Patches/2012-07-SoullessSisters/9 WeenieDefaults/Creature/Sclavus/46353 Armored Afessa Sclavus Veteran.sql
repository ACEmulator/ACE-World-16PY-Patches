...
VALUES (46353,   1,   33560597) /* Setup */
     ...
     , (46353,   4,  805306393) /* CombatTable */
     , (46353,   6,   67111936) /* PaletteBase */
     , (46353,   7,  268435727) /* ClothingBase */
...
VALUES (46353,  0,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46353,  1,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46353,  2,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46353,  3,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46353,  4,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46353,  5,  4, 350, 0.75,  600,  440,  401,  341,  210,  401,  275,  275,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46353,  6,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46353,  7,  4,  0,    0,  600,  440,  401,  341,  210,  401,  275,  275,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46353,  8,  4, 350, 0.75,  600,  440,  401,  341,  210,  401,  275,  275,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
