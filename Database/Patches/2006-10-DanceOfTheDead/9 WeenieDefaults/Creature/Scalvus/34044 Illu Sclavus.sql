...
VALUES (34044,   1,       5) /* HeartbeatInterval */
     ...
     , (34044,  64,    0.68) /* ResistSlash */
     , (34044,  65,    0.68) /* ResistPierce */
     , (34044,  66,    0.46) /* ResistBludgeon */
     , (34044,  67,    0.75) /* ResistFire */
     , (34044,  68,    0.79) /* ResistCold */
...
VALUES (34044,  6, 0, 3, 0, 388, 0, 0) /* MeleeDefense        Specialized */
     , (34044,  7, 0, 3, 0, 281, 0, 0) /* MissileDefense      Specialized */
     , (34044, 14, 0, 3, 0, 240, 0, 0) /* ArcaneLore          Specialized */
     , (34044, 15, 0, 3, 0, 223, 0, 0) /* MagicDefense        Specialized */
     , (34044, 20, 0, 3, 0, 140, 0, 0) /* Deception           Specialized */
     , (34044, 24, 0, 3, 0, 560, 0, 0) /* Run                 Specialized */
     , (34044, 31, 0, 3, 0, 300, 0, 0) /* CreatureEnchantment Specialized */
     , (34044, 33, 0, 3, 0, 300, 0, 0) /* LifeMagic           Specialized */
     , (34044, 34, 0, 3, 0, 300, 0, 0) /* WarMagic            Specialized */
     , (34044, 44, 0, 3, 0, 368, 0, 0) /* HeavyWeapons        Specialized */
     , (34044, 45, 0, 3, 0, 368, 0, 0) /* LightWeapons        Specialized */
     , (34044, 46, 0, 3, 0, 388, 0, 0) /* FinesseWeapons      Specialized */
     , (34044, 47, 0, 3, 0, 303, 0, 0) /* MissileWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (34044,  0,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (34044,  1,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (34044,  2,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (34044,  3,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (34044,  4,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (34044,  5,  4, 75, 0.75,  330,  268,  253,  253,  145,  125,  253,  253,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (34044,  6,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (34044,  7,  4,  0,    0,  330,  268,  253,  253,  145,  125,  253,  253,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (34044,  8,  4, 75, 0.75,  330,  268,  253,  253,  145,  125,  253,  253,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
