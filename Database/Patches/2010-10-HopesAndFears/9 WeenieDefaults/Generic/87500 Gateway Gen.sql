...
VALUES (87500,   1,   33555051) /* Setup */
     , (87500,   8,  100667494) /* Icon */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87500, -1, 87499, 1, 1, 1, 1, 4, 0, 0, 0, 4181394377, 54.3196, 121.945, -57.995, 0.355594, 0, 0, 0.934641) /* Generate Gateway (87499) (x1 up to max of 1) - Regenerate upon Destruction - Location to (re)Generate: Specific */
