...
VALUES (43272,   1,       5) /* HeartbeatInterval */
     ...
     , (43272,  64,    0.75) /* ResistSlash */
     , (43272,  65,    0.75) /* ResistPierce */
     , (43272,  66,    0.75) /* ResistBludgeon */
     , (43272,  67,    0.75) /* ResistFire */
     , (43272,  68,    0.75) /* ResistCold */
     , (43272,  69,    0.75) /* ResistAcid */
     , (43272,  70,    0.75) /* ResistElectric */
...
VALUES (43272,   1,   33561125) /* Setup */
     ...
     , (43272,   4,  805306372) /* CombatTable */
     , (43272,   8,  100691499) /* Icon */
     , (43272,  22,  872415347) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (43272,  16, 2140385599) /* ActivationTarget */;
...
VALUES (43272,  6, 0, 3, 0, 397, 0, 0) /* MeleeDefense        Specialized */
     , (43272,  7, 0, 3, 0, 399, 0, 0) /* MissileDefense      Specialized */
     , (43272, 14, 0, 3, 0, 240, 0, 0) /* ArcaneLore          Specialized */
     , (43272, 15, 0, 3, 0, 440, 0, 0) /* MagicDefense        Specialized */
     , (43272, 20, 0, 3, 0,  90, 0, 0) /* Deception           Specialized */
     , (43272, 31, 0, 3, 0, 490, 0, 0) /* CreatureEnchantment Specialized */
     , (43272, 33, 0, 3, 0, 460, 0, 0) /* LifeMagic           Specialized */
     , (43272, 34, 0, 3, 0, 460, 0, 0) /* WarMagic            Specialized */
     , (43272, 45, 0, 3, 0, 433, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (43272,  0,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (43272,  1,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (43272,  2,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (43272,  3,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (43272,  4,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (43272,  5,  4,  1, 0.75,  300,  250,  250,  250,  250,  250,  250,  250,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (43272,  6,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (43272,  7,  4,  0,    0,  300,  250,  250,  250,  250,  250,  250,  250,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (43272,  8,  4,  1, 0.75,  300,  250,  250,  250,  250,  250,  250,  250,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
