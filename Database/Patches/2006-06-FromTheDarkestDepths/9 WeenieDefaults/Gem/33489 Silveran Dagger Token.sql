...
VALUES (33489,   1,       2048) /* ItemType - Gem */
     ...
     , (33489,  33,          1) /* Bonded - Bonded */
     , (33489,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (33489, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (33489,  22, True ) /* Inscribable */
     , (33489,  23, True ) /* DestroyOnSell */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (33489,   1, 'Silveran Dagger Token') /* Name */
     , (33489,  16, 'This token represents a Silveran Dagger.  You may only pick up one Silveran weapon token.  Turn it in to the Rossu Morta Chamberlain to receive your reward.') /* LongDesc */
     , (33489,  37, 'CanPickupSilveranToken') /* QuestRestriction */;
...
VALUES (33489, 10 /* PickUp */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
