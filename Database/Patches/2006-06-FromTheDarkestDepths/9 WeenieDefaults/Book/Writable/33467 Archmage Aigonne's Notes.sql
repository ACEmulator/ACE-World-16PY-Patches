...
VALUES (33467, 'ace33467-archmageaigonnesnotes', 8, '2021-10-05 03:18:11') /* Book */;
...
VALUES (33467,   1,   33554773) /* Setup */
     , (33467,   3,  536870932) /* SoundTable */
     , (33467,   8,  100668176) /* Icon */
     , (33467,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (33467, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (33467, 0, 4294967295, 'Count Dardante', 'prewritten', False, 'Aigonne,
