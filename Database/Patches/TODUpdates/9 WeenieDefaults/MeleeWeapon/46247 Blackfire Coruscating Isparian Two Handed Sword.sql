/* Weenie - Blackfire Coruscating Isparian Two Handed Sword (46247) */
DELETE FROM `weenie` WHERE `class_Id` = 46247;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46247, 'ace46247-blackfirecoruscatingispariantwohandedsword', 6) /* MeleeWeapon */;
...
VALUES (46247,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (46247,  53,        101) /* PlacementPosition */
