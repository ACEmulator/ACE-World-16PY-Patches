/* Weenie - Princely Runed Flamberge (32982) */
DELETE FROM `weenie` WHERE `class_Id` = 32982;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (32982, 'ace32982-princelyrunedflamberge', 6) /* MeleeWeapon */;
...
VALUES (32982,  2074,      0)  /* Gossamer Flesh */
     , (32982,  2096,      2)  /* Aura of Infected Caress */
