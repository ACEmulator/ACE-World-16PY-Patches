/* Weenie - Brador's Frozen Eye (45461) */
DELETE FROM `weenie` WHERE `class_Id` = 45461;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (45461, 'ace45461-bradorsfrozeneye', 6) /* MeleeWeapon */;
...
VALUES (45461,   1,   33559394) /* Setup */
     ...
     , (45461,   7,  268437600) /* ClothingBase */
     , (45461,   8,  100686771) /* Icon */
     , (45461,  22,  872415275) /* PhysicsEffectTable */
     , (45461,  36,  234881042) /* MutateFilter */
     , (45461,  46,  939524146) /* TsysMutationFilter */
