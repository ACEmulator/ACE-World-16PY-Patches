/* Weenie - Blackfire Flaming Isparian Two Handed Sword (46245) */
DELETE FROM `weenie` WHERE `class_Id` = 46245;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46245, 'ace46245-blackfireflamingispariantwohandedsword', 6) /* MeleeWeapon */;
...
VALUES (46245,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (46245,  53,        101) /* PlacementPosition */
