/* Weenie - Princely Runed Poniard (32985) */
DELETE FROM `weenie` WHERE `class_Id` = 32985;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (32985, 'ace32985-princelyrunedponiard', 6) /* MeleeWeapon */;
...
VALUES (32985,  2074,      0)  /* Gossamer Flesh */
     , (32985,  2096,      2)  /* Aura of Infected Caress */
