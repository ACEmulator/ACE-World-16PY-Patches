/* Weenie - Blackfire Chilling Isparian Two Handed Sword (46243) */
DELETE FROM `weenie` WHERE `class_Id` = 46243;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46243, 'ace46243-blackfirechillingispariantwohandedsword', 6) /* MeleeWeapon */;
...
VALUES (46243,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (46243,  53,        101) /* PlacementPosition */
