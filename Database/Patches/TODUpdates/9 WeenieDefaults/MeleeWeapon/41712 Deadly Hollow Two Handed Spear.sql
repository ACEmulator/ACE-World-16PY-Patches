/* Weenie - Deadly Hollow Two Handed Spear (41712) */
DELETE FROM `weenie` WHERE `class_Id` = 41712;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (41712, 'ace41712-deadlyhollowtwohandedspear', 6) /* MeleeWeapon */;
...
VALUES (41712,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (41712,  52,          1) /* ParentLocation */
     , (41712,  53,          1) /* PlacementPosition */
