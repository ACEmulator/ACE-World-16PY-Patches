/* Weenie - Major Chilling Isparian Two Handed Sword (46195) */
DELETE FROM `weenie` WHERE `class_Id` = 46195;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46195, 'ace46195-majorchillingispariantwohandedsword', 6) /* MeleeWeapon */;
...
VALUES (46195,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (46195,  53,        101) /* PlacementPosition */
