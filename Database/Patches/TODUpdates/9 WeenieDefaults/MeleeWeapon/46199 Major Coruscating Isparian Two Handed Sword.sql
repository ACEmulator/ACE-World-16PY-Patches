/* Weenie - Major Coruscating Isparian Two Handed Sword (46199) */
DELETE FROM `weenie` WHERE `class_Id` = 46199;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46199, 'ace46199-majorcoruscatingispariantwohandedsword', 6) /* MeleeWeapon */;
...
VALUES (46199,   1,          1) /* ItemType - MeleeWeapon */
     ...
     , (46199,  53,        101) /* PlacementPosition */
