/* Weenie - Scroll of Two Handed Weapon Mastery Other V (41300) */
DELETE FROM `weenie` WHERE `class_Id` = 41300;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (41300, 'ace41300-scrolloftwohandedweaponmasteryotherv', 34) /* Scroll */;
...
VALUES (41300,   1,       8192) /* ItemType - Writable */
     ...
     , (41300,  19,        200) /* Value */
     , (41300,  53,        101) /* PlacementPosition */
