/* Weenie - Scroll of Two Handed Weapon Mastery Self VI (41261) */
DELETE FROM `weenie` WHERE `class_Id` = 41261;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (41261, 'ace41261-scrolloftwohandedweaponmasteryselfvi', 34) /* Scroll */;
...
VALUES (41261,  5104,      2)  /* Two Handed Combat Mastery Self VI */;
