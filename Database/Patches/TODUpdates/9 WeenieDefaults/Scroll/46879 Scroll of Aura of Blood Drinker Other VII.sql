/* Weenie - Scroll of Aura of Blood Drinker Other VII (46879) */
DELETE FROM `weenie` WHERE `class_Id` = 46879;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46879, 'ace46879-scrollofauraofblooddrinkerothervii', 34) /* Scroll */;
...
VALUES (46879,   1,       8192) /* ItemType - Writable */
     ...
     , (46879,  19,       2000) /* Value */
     , (46879,  53,        101) /* PlacementPosition */
