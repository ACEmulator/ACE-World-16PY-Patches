/* Weenie - Scroll of Aura of Spirit Drinker Other IV (46871) */
DELETE FROM `weenie` WHERE `class_Id` = 46871;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46871, 'ace46871-scrollofauraofspiritdrinkerotheriv', 34) /* Scroll */;
...
VALUES (46871,   1,       8192) /* ItemType - Writable */
     ...
     , (46871,  19,        100) /* Value */
     , (46871,  53,        101) /* PlacementPosition */
