/* Weenie - Scroll of Shield Mastery Other III (45318) */
DELETE FROM `weenie` WHERE `class_Id` = 45318;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (45318, 'ace45318-scrollofshieldmasteryotheriii', 34) /* Scroll */;
...
VALUES (45318,   1,       8192) /* ItemType - Writable */
     ...
     , (45318,  19,         20) /* Value */
     , (45318,  53,        101) /* PlacementPosition */
...
VALUES (45318,  5845,      2)  /* Shield Mastery Other III */;
