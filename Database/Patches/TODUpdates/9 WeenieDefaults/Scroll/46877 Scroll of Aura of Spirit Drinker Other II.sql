/* Weenie - Scroll of Aura of Spirit Drinker Other II (46877) */
DELETE FROM `weenie` WHERE `class_Id` = 46877;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46877, 'ace46877-scrollofauraofspiritdrinkerotherii', 34) /* Scroll */;
...
VALUES (46877,   1,       8192) /* ItemType - Writable */
     ...
     , (46877,  19,          5) /* Value */
     , (46877,  53,        101) /* PlacementPosition */
