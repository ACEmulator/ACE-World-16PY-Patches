/* Weenie - Scroll of Dual Wield Ineptitude Other VII (45266) */
DELETE FROM `weenie` WHERE `class_Id` = 45266;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (45266, 'ace45266-scrollofdualwieldineptitudeothervii', 34) /* Scroll */;
...
VALUES (45266,   1,       8192) /* ItemType - Writable */
     ...
     , (45266,  19,       2000) /* Value */
     , (45266,  53,        101) /* PlacementPosition */
