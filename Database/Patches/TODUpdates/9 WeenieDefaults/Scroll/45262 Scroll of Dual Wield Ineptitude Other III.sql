/* Weenie - Scroll of Dual Wield Ineptitude Other III (45262) */
DELETE FROM `weenie` WHERE `class_Id` = 45262;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (45262, 'ace45262-scrollofdualwieldineptitudeotheriii', 34) /* Scroll */;
...
VALUES (45262,   1,       8192) /* ItemType - Writable */
     ...
     , (45262,  19,         20) /* Value */
     , (45262,  53,        101) /* PlacementPosition */
