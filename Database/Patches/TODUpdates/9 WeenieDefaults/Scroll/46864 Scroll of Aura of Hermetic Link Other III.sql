/* Weenie - Scroll of Aura of Hermetic Link Other III (46864) */
DELETE FROM `weenie` WHERE `class_Id` = 46864;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46864, 'ace46864-scrollofauraofhermeticlinkotheriii', 34) /* Scroll */;
...
VALUES (46864,   1,       8192) /* ItemType - Writable */
     ...
     , (46864,  19,         20) /* Value */
     , (46864,  53,        101) /* PlacementPosition */
