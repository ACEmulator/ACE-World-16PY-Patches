/* Weenie - Scroll of Two Handed Weapon Mastery Self III (41306) */
DELETE FROM `weenie` WHERE `class_Id` = 41306;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (41306, 'ace41306-scrolloftwohandedweaponmasteryselfiii', 34) /* Scroll */;
...
VALUES (41306,   1,       8192) /* ItemType - Writable */
     ...
     , (41306,  19,         20) /* Value */
     , (41306,  53,        101) /* PlacementPosition */
