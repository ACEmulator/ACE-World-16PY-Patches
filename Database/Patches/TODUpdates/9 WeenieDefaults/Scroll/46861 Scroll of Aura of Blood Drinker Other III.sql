/* Weenie - Scroll of Aura of Blood Drinker Other III (46861) */
DELETE FROM `weenie` WHERE `class_Id` = 46861;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46861, 'ace46861-scrollofauraofblooddrinkerotheriii', 34) /* Scroll */;
...
VALUES (46861,   1,       8192) /* ItemType - Writable */
     ...
     , (46861,  19,         20) /* Value */
     , (46861,  53,        101) /* PlacementPosition */
