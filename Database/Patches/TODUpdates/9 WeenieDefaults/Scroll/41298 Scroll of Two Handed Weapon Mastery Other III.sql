/* Weenie - Scroll of Two Handed Weapon Mastery Other III (41298) */
DELETE FROM `weenie` WHERE `class_Id` = 41298;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (41298, 'ace41298-scrolloftwohandedweaponmasteryotheriii', 34) /* Scroll */;
...
VALUES (41298,   1,       8192) /* ItemType - Writable */
     ...
     , (41298,  19,         20) /* Value */
     , (41298,  53,        101) /* PlacementPosition */
...
VALUES (41298,  5093,      2)  /* Two Handed Combat Mastery Other III */;
