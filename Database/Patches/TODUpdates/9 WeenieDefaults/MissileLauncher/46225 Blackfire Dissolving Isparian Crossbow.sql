/* Weenie - Blackfire Dissolving Isparian Crossbow (46225) */
DELETE FROM `weenie` WHERE `class_Id` = 46225;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46225, 'ace46225-blackfiredissolvingispariancrossbow', 3) /* MissileLauncher */;
...
VALUES (46225,   1,        256) /* ItemType - MissileWeapon */
     ...
     , (46225,  53,        101) /* PlacementPosition */
