/* Weenie - Major Coruscating Isparian Crossbow (46150) */
DELETE FROM `weenie` WHERE `class_Id` = 46150;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46150, 'ace46150-majorcoruscatingispariancrossbow', 3) /* MissileLauncher */;
...
VALUES (46150,   1,        256) /* ItemType - MissileWeapon */
     ...
     , (46150,  53,        101) /* PlacementPosition */
