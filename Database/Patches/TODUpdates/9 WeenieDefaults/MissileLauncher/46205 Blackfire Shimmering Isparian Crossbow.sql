/* Weenie - Blackfire Shimmering Isparian Crossbow (46205) */
DELETE FROM `weenie` WHERE `class_Id` = 46205;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46205, 'ace46205-blackfireshimmeringispariancrossbow', 3) /* MissileLauncher */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46205,   1,        256) /* ItemType - MissileWeapon */
     , (46205,   3,         20) /* PaletteTemplate - Silver */
     ...
     , (46205,  53,        101) /* PlacementPosition */
