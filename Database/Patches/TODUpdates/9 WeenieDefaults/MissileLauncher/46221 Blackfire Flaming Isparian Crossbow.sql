/* Weenie - Blackfire Flaming Isparian Crossbow (46221) */
DELETE FROM `weenie` WHERE `class_Id` = 46221;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46221, 'ace46221-blackfireflamingispariancrossbow', 3) /* MissileLauncher */;
...
VALUES (46221,   1,        256) /* ItemType - MissileWeapon */
     ...
     , (46221,  53,        101) /* PlacementPosition */
