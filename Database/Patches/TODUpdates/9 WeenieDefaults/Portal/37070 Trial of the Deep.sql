/* Weenie - Trial of the Deep (37070) */
DELETE FROM `weenie` WHERE `class_Id` = 37070;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (37070, 'ace37070-trialofthedeep', 7) /* Portal */;
...
VALUES (37070,   1, True ) /* Stuck */
     ...
     , (37070,  88, True ) /* PortalShowDestination */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (37070,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (37070,   1, 'Trial of the Deep') /* Name */
     , (37070,  38, 'Trial of the Deep') /* AppraisalPortalDestination */;
...
VALUES (37070, 2, 11075874, 0, -50, 0.005, 1, 0, 0, 0) /* Destination */
/* @teleloc 0x00A90122 [0.000000 -50.000000 0.005000] 1.000000 0.000000 0.000000 0.000000 */;
