/* Weenie - Darkened Halls Portal (04971) */
DELETE FROM `weenie` WHERE `class_Id` = 4971;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (4971, 'portaldarklight', 7) /* Portal */;
...
VALUES (4971,   1, True ) /* Stuck */
     ...
     , (4971,  88, True ) /* PortalShowDestination */;
...
VALUES (4971, 2, 21234100, 30, -50, 12, -4.37114E-08, 0, 0, -1) /* Destination */
