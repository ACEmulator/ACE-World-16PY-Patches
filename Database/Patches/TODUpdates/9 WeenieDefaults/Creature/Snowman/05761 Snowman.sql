/* Weenie - Snowman (05761) */
DELETE FROM `weenie` WHERE `class_Id` = 5761;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (5761, 'snowmanhappy', 10) /* Creature */;
...
VALUES (5761,   1,         16) /* ItemType - Creature */
     ...
     , (5761,  67,         64) /* Tolerance */
     , (5761,  68,          9) /* TargetingTactic */
...
VALUES (5761, 1,  5758,  1, 0, 0, False) /* Create  (5758) for Contain */
     , (5761, 1,  5768,  1, 0, 0, False) /* Create  (5768) for Contain */
     , (5761, 2,  5762,  9, 0, 0, False) /* Create  (5762) for Wield */
     , (5761, 9,     0,  0, 0, 0.9, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (5761, 9, 22825,  0, 0, 0.1, False) /* Create  (22825) for ContainTreasure */;
