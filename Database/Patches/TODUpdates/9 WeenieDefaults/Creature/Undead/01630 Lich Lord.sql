...
VALUES (1630,  1, 0, 3, 0, 125, 0, 310.242065429688) /* Axe                 Specialized */
     , (1630,  2, 0, 3, 0, 100, 0, 310.242065429688) /* Bow                 Specialized */
     , (1630,  3, 0, 3, 0, 100, 0, 310.242065429688) /* Crossbow            Specialized */
     , (1630,  5, 0, 3, 0, 125, 0, 310.242065429688) /* Mace                Specialized */
     , (1630,  6, 0, 3, 0, 125, 0, 310.242065429688) /* MeleeDefense        Specialized */
     , (1630,  7, 0, 3, 0, 240, 0, 310.242065429688) /* MissileDefense      Specialized */
     , (1630,  9, 0, 3, 0, 125, 0, 310.242065429688) /* Spear               Specialized */
     , (1630, 10, 0, 3, 0, 125, 0, 310.242065429688) /* Staff               Specialized */
     , (1630, 11, 0, 3, 0, 125, 0, 310.242065429688) /* Sword               Specialized */
     , (1630, 13, 0, 3, 0, 125, 0, 310.242065429688) /* UnarmedCombat       Specialized */
     , (1630, 14, 0, 2, 0, 200, 0, 310.242065429688) /* ArcaneLore          Trained */
     , (1630, 15, 0, 3, 0, 136, 0, 310.242065429688) /* MagicDefense        Specialized */
     , (1630, 20, 0, 2, 0,  50, 0, 310.242065429688) /* Deception           Trained */
     , (1630, 31, 0, 3, 0,  80, 0, 310.242065429688) /* CreatureEnchantment Specialized */
     , (1630, 33, 0, 3, 0,  80, 0, 310.242065429688) /* LifeMagic           Specialized */
     , (1630, 34, 0, 3, 0,  80, 0, 310.242065429688) /* WarMagic            Specialized */;
...
VALUES (1630, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.96, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1630, 9,  7041,  0, 0, 0.02, False) /* Create  (7041) for ContainTreasure */
     , (1630, 9,  9312,  0, 0, 0.04, False) /* Create  (9312) for ContainTreasure */
     , (1630, 9, 12225,  0, 0, 0.05, False) /* Create  (12225) for ContainTreasure */
     , (1630, 9, 15770,  0, 0, 0.02, False) /* Create  (15770) for ContainTreasure */
     , (1630, 9, 19477,  0, 0, 0.05, False) /* Create  (19477) for ContainTreasure */
     , (1630, 9, 22028,  0, 0, 0.05, False) /* Create  (22028) for ContainTreasure */
     , (1630, 9, 22032,  0, 0, 0.05, False) /* Create  (22032) for ContainTreasure */
     , (1630, 9, 22048,  0, 0, 0.05, False) /* Create  (22048) for ContainTreasure */;
