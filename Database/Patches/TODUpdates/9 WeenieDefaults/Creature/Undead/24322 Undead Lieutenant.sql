/* Weenie - Undead Lieutenant (24322) */
DELETE FROM `weenie` WHERE `class_Id` = 24322;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (24322, 'zombielichcaptainloclass', 10) /* Creature */;
...
VALUES (24322, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (24322, 9,  6876,  0, 0, 0.02, False) /* Create  (6876) for ContainTreasure */;
