/* Weenie - Mausoleum Warden (08815) */
DELETE FROM `weenie` WHERE `class_Id` = 8815;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (8815, 'undeadmausoleumwarden', 10) /* Creature */;
...
VALUES (8815, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8815, 9,  6876,  0, 0, 0.02, False) /* Create  (6876) for ContainTreasure */;
