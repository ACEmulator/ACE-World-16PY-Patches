/* Weenie - Revenant (01463) */
DELETE FROM `weenie` WHERE `class_Id` = 1463;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (1463, 'undeadspecial', 10) /* Creature */;
...
VALUES (1463, 8,  1436,  0, 0, 1, False) /* Create Hammer of Lightning  (1436) for Treasure */
     , (1463, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1463, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1463, 9,     0,  0, 0, 0.99, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1463, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1463, 9,  5873,  0, 0, 0.03, False) /* Create  (5873) for ContainTreasure */
     , (1463, 9,  6876,  0, 0, 0.01, False) /* Create  (6876) for ContainTreasure */
     , (1463, 9,  7041,  0, 0, 0.03, False) /* Create  (7041) for ContainTreasure */
     , (1463, 9,  9310,  0, 0, 0.03, False) /* Create  (9310) for ContainTreasure */;
