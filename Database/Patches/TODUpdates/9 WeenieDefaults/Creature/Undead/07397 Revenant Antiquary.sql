/* Weenie - Revenant Antiquary (07397) */
DELETE FROM `weenie` WHERE `class_Id` = 7397;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (7397, 'revenantsylsfear', 10) /* Creature */;
...
VALUES (7397,  1, 0, 3, 0, 125, 0, 528.968811035156) /* Axe                 Specialized */
     , (7397,  2, 0, 2, 0, 110, 0, 528.968811035156) /* Bow                 Trained */
     , (7397,  3, 0, 2, 0, 110, 0, 528.968811035156) /* Crossbow            Trained */
     , (7397,  4, 0, 3, 0, 120, 0, 528.968811035156) /* Dagger              Specialized */
     , (7397,  5, 0, 3, 0, 120, 0, 528.968811035156) /* Mace                Specialized */
     , (7397,  6, 0, 2, 0, 130, 0, 528.968811035156) /* MeleeDefense        Trained */
     , (7397,  7, 0, 2, 0, 120, 0, 528.968811035156) /* MissileDefense      Trained */
     , (7397,  9, 0, 2, 0, 100, 0, 528.968811035156) /* Spear               Trained */
     , (7397, 10, 0, 2, 0, 100, 0, 528.968811035156) /* Staff               Trained */
     , (7397, 11, 0, 3, 0, 120, 0, 528.968811035156) /* Sword               Specialized */
     , (7397, 13, 0, 2, 0, 200, 0, 528.968811035156) /* UnarmedCombat       Trained */
     , (7397, 14, 0, 2, 0, 230, 0, 528.968811035156) /* ArcaneLore          Trained */
     , (7397, 15, 0, 2, 0, 182, 0, 528.968811035156) /* MagicDefense        Trained */
     , (7397, 20, 0, 2, 0,  90, 0, 528.968811035156) /* Deception           Trained */
     , (7397, 31, 0, 2, 0, 230, 0, 528.968811035156) /* CreatureEnchantment Trained */
     , (7397, 33, 0, 2, 0, 230, 0, 528.968811035156) /* LifeMagic           Trained */
     , (7397, 34, 0, 2, 0, 230, 0, 528.968811035156) /* WarMagic            Trained */;
...
VALUES (7397, 8,  7398,  0, 0, 1, False) /* Create  (7398) for Treasure */
     , (7397, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7397, 9,  5873,  0, 0, 0.03, False) /* Create  (5873) for ContainTreasure */;
