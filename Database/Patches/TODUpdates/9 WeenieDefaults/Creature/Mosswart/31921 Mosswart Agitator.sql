/* Weenie - Mosswart Agitator (31921) */
DELETE FROM `weenie` WHERE `class_Id` = 31921;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (31921, 'ace31921-mosswartagitator', 10) /* Creature */;
...
VALUES (31921,   1,         16) /* ItemType - Creature */
     ...
     , (31921,  25,        185) /* Level */
     , (31921,  27,          0) /* ArmorType */
     , (31921,  40,          2) /* CombatMode - Melee */
     , (31921,  68,         13) /* TargetingTactic */
...
VALUES (31921, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (31921, 9, 24477,  0, 0, 0.03, False) /* Create  (24477) for ContainTreasure */
