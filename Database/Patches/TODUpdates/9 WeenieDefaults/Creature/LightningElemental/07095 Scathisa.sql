...
VALUES (7095, 2,  6383,  3, 0, 0, False) /* Create  (6383) for Wield */
     , (7095, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7095, 9,  6876,  0, 0, 0.02, False) /* Create  (6876) for ContainTreasure */;
