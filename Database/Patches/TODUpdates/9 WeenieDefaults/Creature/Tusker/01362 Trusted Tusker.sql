/* Weenie - Trusted Tusker (01362) */
DELETE FROM `weenie` WHERE `class_Id` = 1362;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (1362, 'sylsfeartuskermale', 10) /* Creature */;
...
VALUES (1362, 1,  1361,  0, 0, 1, False) /* Create  (1361) for Contain */
     , (1362, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1362, 9,    46,  0, 0, 0.2, False) /* Create  (46) for ContainTreasure */;
