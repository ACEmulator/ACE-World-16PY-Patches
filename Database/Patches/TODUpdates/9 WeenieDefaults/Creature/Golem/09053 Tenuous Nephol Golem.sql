/* Weenie - Tenuous Nephol Golem (09053) */
DELETE FROM `weenie` WHERE `class_Id` = 9053;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (9053, 'golemnephollonostone', 10) /* Creature */;
...
VALUES (9053,  6, 0, 3, 0,  50, 0, 620.210388183594) /* MeleeDefense        Specialized */
     , (9053,  7, 0, 3, 0,  40, 0, 620.210388183594) /* MissileDefense      Specialized */
     , (9053, 13, 0, 3, 0,  90, 0, 620.210388183594) /* UnarmedCombat       Specialized */
     , (9053, 14, 0, 3, 0, 190, 0, 620.210388183594) /* ArcaneLore          Specialized */
     , (9053, 15, 0, 3, 0, 115, 0, 620.210388183594) /* MagicDefense        Specialized */
     , (9053, 20, 0, 3, 0,  80, 0, 620.210388183594) /* Deception           Specialized */
     , (9053, 22, 0, 3, 0,  10, 0, 620.210388183594) /* Jump                Specialized */
     , (9053, 24, 0, 3, 0,  10, 0, 620.210388183594) /* Run                 Specialized */
     , (9053, 31, 0, 3, 0, 120, 0, 620.210388183594) /* CreatureEnchantment Specialized */
     , (9053, 33, 0, 3, 0, 120, 0, 620.210388183594) /* LifeMagic           Specialized */
     , (9053, 34, 0, 3, 0, 200, 0, 620.210388183594) /* WarMagic            Specialized */;
...
VALUES (9053, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (9053, 9,  9046,  0, 0, 0.02, False) /* Create  (9046) for ContainTreasure */;
