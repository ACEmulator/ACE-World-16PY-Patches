...
VALUES (7507,   1,       5) /* HeartbeatInterval */
     ...
     , (7507,   3, 0.899999976158142) /* HealthRate */
     , (7507,   4,     0.5) /* StaminaRate */
     , (7507,   5,       2) /* ManaRate */
     , (7507,   6, 0.100000001490116) /* HealthUponResurrection */
     , (7507,   7,    0.25) /* StaminaUponResurrection */
     , (7507,   8, 0.300000011920929) /* ManaUponResurrection */
     , (7507,  12,     0.5) /* Shade */
     , (7507,  13, 0.790000021457672) /* ArmorModVsSlash */
     , (7507,  14, 0.899999976158142) /* ArmorModVsPierce */
     , (7507,  15,       1) /* ArmorModVsBludgeon */
     , (7507,  16, 0.839999973773956) /* ArmorModVsCold */
     , (7507,  17, 0.839999973773956) /* ArmorModVsFire */
     , (7507,  18, 0.839999973773956) /* ArmorModVsAcid */
     , (7507,  19, 0.839999973773956) /* ArmorModVsElectric */
     , (7507,  31,      13) /* VisualAwarenessRange */
     , (7507,  34, 3.29999995231628) /* PowerupTime */
     , (7507,  64, 0.330000013113022) /* ResistSlash */
     , (7507,  65, 0.670000016689301) /* ResistPierce */
...
VALUES (7507,   1,   33556426) /* Setup */
     ...
     , (7507,   4,  805306376) /* CombatTable */
     , (7507,   6,   67112775) /* PaletteBase */
     , (7507,   7,  268436009) /* ClothingBase */
     , (7507,   8,  100667940) /* Icon */
     , (7507,  22,  872415321) /* PhysicsEffectTable */
     , (7507,  35,        462) /* DeathTreasureType */;
...
VALUES (7507,  6, 0, 3, 0, 235, 0, 535.697570800781) /* MeleeDefense        Specialized */
     , (7507,  7, 0, 3, 0, 340, 0, 535.697570800781) /* MissileDefense      Specialized */
     , (7507, 13, 0, 3, 0, 170, 0, 535.697570800781) /* UnarmedCombat       Specialized */
     , (7507, 14, 0, 3, 0, 300, 0, 535.697570800781) /* ArcaneLore          Specialized */
     , (7507, 15, 0, 3, 0, 200, 0, 535.697570800781) /* MagicDefense        Specialized */
     , (7507, 20, 0, 3, 0, 100, 0, 535.697570800781) /* Deception           Specialized */
     , (7507, 22, 0, 3, 0,  10, 0, 535.697570800781) /* Jump                Specialized */
     , (7507, 24, 0, 3, 0,  10, 0, 535.697570800781) /* Run                 Specialized */
     , (7507, 33, 0, 3, 0,  95, 0, 535.697570800781) /* LifeMagic           Specialized */
     , (7507, 34, 0, 3, 0,  95, 0, 535.697570800781) /* WarMagic            Specialized */;
...
VALUES (7507,  5 /* HeartBeat */,  0.075, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (7507,  5 /* HeartBeat */,      1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (7507, 9,     0,  0, 0, 0.96, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7507, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7507, 9,  6353,  0, 0, 0.04, False) /* Create  (6353) for ContainTreasure */
     , (7507, 9,  7605,  0, 0, 0.05, False) /* Create  (7605) for ContainTreasure */;
