/* Weenie - Tenuous Nephol Golem (09052) */
DELETE FROM `weenie` WHERE `class_Id` = 9052;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (9052, 'golemnepholloclass', 10) /* Creature */;
...
VALUES (9052, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (9052, 9,  9044,  0, 0, 1, False) /* Create  (9044) for ContainTreasure */
     , (9052, 9,  9046,  0, 0, 0.02, False) /* Create  (9046) for ContainTreasure */;
