/* Weenie - Fragment (08014) */
DELETE FROM `weenie` WHERE `class_Id` = 8014;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (8014, 'crystalfragmentneclass', 10) /* Creature */;
...
VALUES (8014, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8014, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8014, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8014, 9,  6055,  0, 0, 0.02, False) /* Create  (6055) for ContainTreasure */
     , (8014, 9,  6057,  0, 0, 0.02, False) /* Create  (6057) for ContainTreasure */
     , (8014, 9, 20860,  0, 0, 0.03, False) /* Create  (20860) for ContainTreasure */;
