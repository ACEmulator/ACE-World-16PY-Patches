/* Weenie - Broken Fragment (08010) */
DELETE FROM `weenie` WHERE `class_Id` = 8010;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (8010, 'crystalbrokenfragmentneclass', 10) /* Creature */;
...
VALUES (8010, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8010, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8010, 9,  6055,  0, 0, 0.02, False) /* Create  (6055) for ContainTreasure */
     , (8010, 9, 20860,  0, 0, 0.02, False) /* Create  (20860) for ContainTreasure */;
