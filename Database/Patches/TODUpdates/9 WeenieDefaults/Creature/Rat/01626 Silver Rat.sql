...
VALUES (1626, 'ratsilver', 10, '2019-02-04 06:52:23') /* Creature */;
...
VALUES (1626,   1,       5) /* HeartbeatInterval */
     ...
     , (1626,   3, 0.400000005960464) /* HealthRate */
     , (1626,   4,       5) /* StaminaRate */
     , (1626,   5,       2) /* ManaRate */
     , (1626,  12,     0.5) /* Shade */
     , (1626,  13, 0.400000005960464) /* ArmorModVsSlash */
     , (1626,  14, 0.400000005960464) /* ArmorModVsPierce */
     , (1626,  15, 0.800000011920929) /* ArmorModVsBludgeon */
     , (1626,  16, 0.119999997317791) /* ArmorModVsCold */
     , (1626,  17, 0.699999988079071) /* ArmorModVsFire */
     , (1626,  18, 0.119999997317791) /* ArmorModVsAcid */
     ...
     , (1626,  68, 0.579999983310699) /* ResistCold */
     , (1626,  69, 0.579999983310699) /* ResistAcid */
...
VALUES (1626,   1,   33554493) /* Setup */
     ...
     , (1626,   4,  805306387) /* CombatTable */
     , (1626,   6,   67109300) /* PaletteBase */
     , (1626,   7,  268435555) /* ClothingBase */
     , (1626,   8,  100667451) /* Icon */
     , (1626,  19,         86) /* ActivationAnimation */
     , (1626,  22,  872415267) /* PhysicsEffectTable */
     , (1626,  30,         85) /* PhysicsScript - BreatheFrost */
     , (1626,  35,        457) /* DeathTreasureType */;
...
VALUES (1626,  6, 0, 3, 0,  20, 0, 310.043548583984) /* MeleeDefense        Specialized */
     , (1626,  7, 0, 3, 0, 120, 0, 310.043548583984) /* MissileDefense      Specialized */
     , (1626, 13, 0, 3, 0, 110, 0, 310.043548583984) /* UnarmedCombat       Specialized */
     , (1626, 15, 0, 3, 0, 121, 0, 310.043548583984) /* MagicDefense        Specialized */
     , (1626, 20, 0, 2, 0,  50, 0, 310.043548583984) /* Deception           Trained */
     , (1626, 22, 0, 2, 0,  45, 0, 310.043548583984) /* Jump                Trained */
     , (1626, 24, 0, 2, 0,  40, 0, 310.043548583984) /* Run                 Trained */;
...
VALUES (1626,  5 /* HeartBeat */,    0.1, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1626,  5 /* HeartBeat */,  0.175, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1626,  5 /* HeartBeat */,    0.1, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (1626,  5 /* HeartBeat */,  0.175, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (1626, 9,     0,  0, 0, 0.99, False) /* Create nothing for ContainTreasure */
     , (1626, 9,  6876,  0, 0, 0.01, False) /* Create Sturdy Iron Key (6876) for ContainTreasure */;
