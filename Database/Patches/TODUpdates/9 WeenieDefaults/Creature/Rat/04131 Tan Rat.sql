/* Weenie - Tan Rat (04131) */
DELETE FROM `weenie` WHERE `class_Id` = 4131;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (4131, 'rattan', 10) /* Creature */;
...
VALUES (4131,   1,         16) /* ItemType - Creature */
     ...
     , (4131,  67,         64) /* Tolerance */
     , (4131,  68,          5) /* TargetingTactic */
...
VALUES (4131, 9,     0,  0, 0, 0.85, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (4131, 9,  4133,  0, 0, 0.15, False) /* Create  (4133) for ContainTreasure */;
