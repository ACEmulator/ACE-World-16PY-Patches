...
VALUES (28649,   1,         16) /* ItemType - Creature */
     ...
     , (28649,  25,         40) /* Level */
     , (28649,  27,          0) /* ArmorType */
     , (28649,  40,          2) /* CombatMode - Melee */
     , (28649,  68,          9) /* TargetingTactic */
...
VALUES (28649,   1,   33559202) /* Setup */
     ...
     , (28649,  35,        451) /* DeathTreasureType */;
...
VALUES (28649,  6, 0, 3, 0, 225, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (28649, 13, 0, 3, 0, 200, 0, 0) /* UnarmedCombat       Specialized */
...
VALUES (28649,  0,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28649,  1,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28649,  2,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28649,  3,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28649,  4,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28649,  5,  4, 35,  0.5,  220,  325,  325,  325,  325,  225,  325,  250,    0, 1,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28649,  6,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28649,  7,  4,  0,    0,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28649,  8,  4, 35, 0.75,  220,  300,  325,  325,  325,  225,  325,  250,    0, 1,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
