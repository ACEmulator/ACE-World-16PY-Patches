...
VALUES (28821,   1,         16) /* ItemType - Creature */
     ...
     , (28821,  25,        115) /* Level */
     , (28821,  27,          0) /* ArmorType */
     , (28821,  40,          2) /* CombatMode - Melee */
     , (28821,  68,          9) /* TargetingTactic */
...
VALUES (28821,   1, True ) /* Stuck */
     ...
     , (28821, 102, True ) /* CorpseGeneratedRare */;
...
VALUES (28821,   1,   33559202) /* Setup */
     ...
     , (28821,  35,        452) /* DeathTreasureType */;
...
VALUES (28821,  6, 0, 3, 0, 225, 0, 0) /* MeleeDefense        Specialized */
     ...
     , (28821, 13, 0, 3, 0, 210, 0, 0) /* UnarmedCombat       Specialized */
...
VALUES (28821,  0,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (28821,  1,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (28821,  2,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (28821,  3,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (28821,  4,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (28821,  5,  4, 45,  0.4,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (28821,  6,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (28821,  7,  4,  0,    0,  300,  350,  360,  360,  360,  285,  360,  300,    0, 1,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (28821,  8,  4, 45,  0.4,  300,  350,  360,  360,  360,  280,  360,  300,    0, 1,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
