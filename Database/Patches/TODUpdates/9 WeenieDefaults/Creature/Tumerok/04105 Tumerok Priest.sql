/* Weenie - Tumerok Priest (04105) */
DELETE FROM `weenie` WHERE `class_Id` = 4105;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (4105, 'tumerokpriestarcher', 10) /* Creature */;
...
VALUES (4105, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (4105, 9,  7825,  0, 0, 0.03, False) /* Create  (7825) for ContainTreasure */;
