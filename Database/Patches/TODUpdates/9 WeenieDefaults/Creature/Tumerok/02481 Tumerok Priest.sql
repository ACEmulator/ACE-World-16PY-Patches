/* Weenie - Tumerok Priest (02481) */
DELETE FROM `weenie` WHERE `class_Id` = 2481;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (2481, 'tumerokkeya', 10) /* Creature */;
...
VALUES (2481, 1,  2201,  0, 0, 1, False) /* Create  (2201) for Contain */
     , (2481, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (2481, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (2481, 9,  7825,  0, 0, 0.03, False) /* Create  (7825) for ContainTreasure */
     , (2481, 9, 20855,  0, 0, 0.03, False) /* Create  (20855) for ContainTreasure */;
