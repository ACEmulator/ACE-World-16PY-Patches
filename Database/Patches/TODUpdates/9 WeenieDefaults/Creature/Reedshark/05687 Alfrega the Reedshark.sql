/* Weenie - Alfrega the Reedshark (05687) */
DELETE FROM `weenie` WHERE `class_Id` = 5687;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (5687, 'reedsharkalfrega', 10) /* Creature */;
...
VALUES (5687, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (5687, 9,  4239,  0, 0, 0.05, False) /* Create  (4239) for ContainTreasure */;
