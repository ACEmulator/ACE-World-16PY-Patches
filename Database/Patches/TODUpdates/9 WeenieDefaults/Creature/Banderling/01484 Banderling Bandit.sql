/* Weenie - Banderling Bandit (01484) */
DELETE FROM `weenie` WHERE `class_Id` = 1484;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (1484, 'banderlingbanditfast', 10) /* Creature */;
...
VALUES (1484, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1484, 9,     0,  0, 0, 0.97, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (1484, 9,  1481,  0, 0, 1, False) /* Create Quarter Staff of Fire (1481) for ContainTreasure */
     , (1484, 9,  7825,  0, 0, 0.03, False) /* Create  (7825) for ContainTreasure */;
