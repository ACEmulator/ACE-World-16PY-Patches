/* Weenie - Small Shadow Child (08423) */
...
VALUES (8423, 9,     0,  0, 0, 0.99, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (8423, 9,  6060,  0, 0, 0.01, False) /* Create  (6060) for ContainTreasure */;
