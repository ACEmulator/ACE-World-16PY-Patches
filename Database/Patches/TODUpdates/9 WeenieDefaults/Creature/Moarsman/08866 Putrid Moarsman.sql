/* Weenie - Putrid Moarsman (08866) */
DELETE FROM `weenie` WHERE `class_Id` = 8866;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (8866, 'moarsmanputridadja', 10) /* Creature */;
...
VALUES (8866,   1,   33556882) /* Setup */
     ...
     , (8866,  30,         83) /* PhysicsScript - PortalExit */
     , (8866,  35,        460) /* DeathTreasureType */;
...
VALUES (8866, 9,  8511,  0, 0, 1, False) /* Create  (8511) for ContainTreasure */;
