/* Weenie - Ashen Moarsman (07180) */
DELETE FROM `weenie` WHERE `class_Id` = 7180;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (7180, 'moarsmanashen', 10) /* Creature */;
...
VALUES (7180, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7180, 9, 25561,  0, 0, 0.05, False) /* Create  (25561) for ContainTreasure */;
