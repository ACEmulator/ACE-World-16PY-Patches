/* Weenie - Chef Jonus (31841) */
DELETE FROM `weenie` WHERE `class_Id` = 31841;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (31841, 'ace31841-chefjonus', 10) /* Creature */;
...
VALUES (31841, 2,   133,  1, 18, 0.25, False) /* Create Slippers (133) for Wield */
     , (31841, 2,  2587,  1, 90, 0.0909, False) /* Create  (2587) for Wield */
     , (31841, 2,  2601,  1, 90, 0.0179, False) /* Create Pants (2601) for Wield */
     , (31841, 2,  9622,  1, 9, 0.6667, False) /* Create  (9622) for Wield */
