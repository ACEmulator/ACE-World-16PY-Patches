/* Weenie - Gnawer Shreth (04108) */
DELETE FROM `weenie` WHERE `class_Id` = 4108;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (4108, 'shrethgnawer', 10) /* Creature */;
...
VALUES (4108, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (4108, 9, 11687,  0, 0, 0.02, False) /* Create  (11687) for ContainTreasure */;
