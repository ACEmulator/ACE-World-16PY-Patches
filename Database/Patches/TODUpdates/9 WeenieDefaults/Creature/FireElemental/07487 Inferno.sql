/* Weenie - Inferno (07487) */
DELETE FROM `weenie` WHERE `class_Id` = 7487;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (7487, 'fireelementalinferno_nospawn', 10) /* Creature */;
...
VALUES (7487, 2,  5709,  3, 0, 0, False) /* Create  (5709) for Wield */
     , (7487, 9,     0,  0, 0, 0.99, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7487, 9,  6876,  0, 0, 0.01, False) /* Create  (6876) for ContainTreasure */;
