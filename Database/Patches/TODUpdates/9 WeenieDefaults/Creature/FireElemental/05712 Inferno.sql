...
VALUES (5712, 2,  5709,  3, 0, 0, False) /* Create  (5709) for Wield */
     , (5712, 9,     0,  0, 0, 0.99, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (5712, 9,  6876,  0, 0, 0.01, False) /* Create  (6876) for ContainTreasure */;
