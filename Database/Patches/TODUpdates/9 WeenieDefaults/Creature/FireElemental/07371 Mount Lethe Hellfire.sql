/* Weenie - Mount Lethe Hellfire (07371) */
...
VALUES (7371,  6, 0, 3, 0, 193, 0, 527.723815917969) /* MeleeDefense        Specialized */
     , (7371,  7, 0, 3, 0, 334, 0, 527.723815917969) /* MissileDefense      Specialized */
     , (7371, 12, 0, 3, 0, 215, 0, 527.723815917969) /* ThrownWeapon        Specialized */
     , (7371, 13, 0, 3, 0, 223, 0, 527.723815917969) /* UnarmedCombat       Specialized */
     , (7371, 14, 0, 3, 0, 200, 0, 527.723815917969) /* ArcaneLore          Specialized */
     , (7371, 15, 0, 3, 0, 208, 0, 527.723815917969) /* MagicDefense        Specialized */
     , (7371, 20, 0, 3, 0, 100, 0, 527.723815917969) /* Deception           Specialized */
     , (7371, 24, 0, 3, 0, 100, 0, 527.723815917969) /* Run                 Specialized */
     , (7371, 31, 0, 3, 0, 149, 0, 527.723815917969) /* CreatureEnchantment Specialized */
     , (7371, 33, 0, 3, 0, 149, 0, 527.723815917969) /* LifeMagic           Specialized */
     , (7371, 34, 0, 3, 0, 149, 0, 527.723815917969) /* WarMagic            Specialized */;
...
VALUES (7371, 2,  7799,  3, 0, 0, False) /* Create  (7799) for Wield */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     ...
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,     0,  0, 0, 0, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7371, 9,  7420,  0, 0, 1, False) /* Create  (7420) for ContainTreasure */
     , (7371, 9,  7420,  0, 0, 1, False) /* Create  (7420) for ContainTreasure */
     , (7371, 9,  7420,  0, 0, 1, False) /* Create  (7420) for ContainTreasure */
     , (7371, 9,  7420,  0, 0, 1, False) /* Create  (7420) for ContainTreasure */
     , (7371, 9,  7420,  0, 0, 1, False) /* Create  (7420) for ContainTreasure */
