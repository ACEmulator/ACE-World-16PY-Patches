...
VALUES (7093, 2,  7799,  3, 0, 0, False) /* Create  (7799) for Wield */
     , (7093, 9,     0,  0, 0, 0.98, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (7093, 9,  6876,  0, 0, 0.02, False) /* Create  (6876) for ContainTreasure */;
