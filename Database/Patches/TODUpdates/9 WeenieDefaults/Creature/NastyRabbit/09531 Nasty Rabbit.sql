/* Weenie - Nasty Rabbit (09531) */
DELETE FROM `weenie` WHERE `class_Id` = 9531;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (9531, 'rabbitgardengreen', 10) /* Creature */;
...
VALUES (9531, 9,     0,  0, 0, 0.95, False) /* Create UNKNOWN RANDOMLY GENERATED TREASURE for ContainTreasure */
     , (9531, 9,  9539,  0, 0, 0.05, False) /* Create  (9539) for ContainTreasure */;
