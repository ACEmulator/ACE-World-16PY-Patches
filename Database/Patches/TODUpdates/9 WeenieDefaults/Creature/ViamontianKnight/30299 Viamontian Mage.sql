...
VALUES (30299, 2, 28614,  0, 11, 0.1786, True) /* Create Hooded Vestiri Robe (28614) for Wield */
     , (30299, 10, 30946,  1, 0, 1, False) /* Create Bandit Dagger (30946) for WieldTreasure */;
