...
/* Weenie - MissileWeapons - Minor Sparking Atlan Bow (46060) */
DELETE FROM weenie WHERE class_Id = 46060;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46060, 'minorsparkingatlanbow', 3) /* MissileLauncher */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46060,   1,        256) /* ItemType - MissileWeapon */
     , (46060,   3,         13) /* PaletteTemplate - Purple */
     ...
     , (46060,  44,          6) /* Damage */
     , (46060,  45,         64) /* DamageType - Electric */
     ...
     , (46060, 263,         64) /* ResistanceModifierType - Electric */;
