...
/* Weenie - MissileWeapons - Major Sparking Atlan Bow (46059) */
DELETE FROM weenie WHERE class_Id = 46059;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46059, 'majorsparkingatlanbow', 3) /* MissileLauncher */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46059,   1,        256) /* ItemType - MissileWeapon */
     , (46059,   3,         13) /* PaletteTemplate - Purple */
     ...
     , (46059,  44,          8) /* Damage */
     , (46059,  45,         64) /* DamageType - Electric */
     ...
     , (46059, 263,         64) /* ResistanceModifierType - Electric */;
...
VALUES (46059,   1, 'Major Sparking Atlan Bow') /* Name */;
