...
/* Weenie - MissileWeapons - Minor Smoldering Atlan Bow (46057) */
DELETE FROM weenie WHERE class_Id = 46057;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46057, 'minorsmolderingatlanbow', 3) /* MissileLauncher */;
...
VALUES (46057,   1, 'Minor Smoldering Atlan Bow') /* Name */;
