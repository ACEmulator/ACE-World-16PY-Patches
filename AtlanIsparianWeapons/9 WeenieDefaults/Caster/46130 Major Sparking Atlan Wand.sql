...
/* Weenie - Casters - Major Sparking Atlan Wand (46124) */
DELETE FROM weenie WHERE class_Id = 46124;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`)
VALUES (46124, 'majorsparkingatlanwand', 35) /* Caster */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46124,   1,      32768) /* ItemType - Caster */
     , (46124,   3,         13) /* PaletteTemplate - Purple */
     ...
     , (46124,  45,         64) /* DamageType - Electric */
     ...
     , (46124, 263,         64) /* ResistanceModifierType - Electric */;
